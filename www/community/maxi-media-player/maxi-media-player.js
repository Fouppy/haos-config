...
var ACTIVE_PLAYER_EVENT = "mxmp-dispatch-event-active-player";
...
var CardEditor = class extends BaseEditor {
	...
	renderTabContent() {
		...
		return r(this.activeTab, [
			["Common", () => x`<mxmp-common-tab .config=${c} .hass=${h}></mxmp-common-tab>`],
			["Player", () => x`<mxmp-player-tab .config=${c} .hass=${h}></mxmp-player-tab>`],
			["Media Browser", () => x`<mxmp-media-browser-tab .config=${c} .hass=${h}></mxmp-media-browser-tab>`],
