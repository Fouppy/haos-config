 ...
 */class Tc extends Cc{get _delta(){return this._metrics.itemSize1+this._metrics.gap1}_getItemSize(e){return{[this._sizeDim]:this._metrics.itemSize1,[this._secondarySizeDim]:this._metrics.itemSize2}}_getActiveItems(){const e=this._metrics,{rolumns:t}=e;if(t===0)this._first=-1,this._last=-1,this._physicalMin=0,this._physicalMax=0;else{const{padding1:a}=e,s=Math.max(0,this._scrollPosition-this._overhang),r=Math.min(this._scrollSize,this._scrollPosition+this._viewDim1+this._overhang),n=Math.max(0,Math.floor((s-a.start)/this._delta)),o=Math.max(0,Math.ceil((r-a.start)/this._delta));this._first=n*t,this._last=Math.min(o*t-1,this.items.length-1),this._physicalMin=a.start+this._delta*n,this._physicalMax=a.start+this._delta*o}}_getItemPosition(e){const{rolumns:t,padding1:a,positions:s,itemSize1:r,itemSize2:n}=this._metrics;return{[this._positionDim]:a.start+Math.floor(e/t)*this._delta,[this._secondaryPositionDim]:s[e%t],[jt(this.direction)]:r,[en(this.direction)]:n}}_updateScrollSize(){const{rolumns:e,gap1:t,padding1:a,itemSize1:s}=this._metrics;let r=1;if(e>0){const n=Math.ceil(this.items.length/e);r=a.start+n*s+(n-1)*t+a.end}this._scrollSize=r}}class Ic extends Tc{constructor(e,t){super(e,t),this._columns=t?.columns||4,this.flex={preserve:"aspect-ratio"},this.justify="start";const a=t?.itemSize?.width||150,s=t?.itemSize?.height||195,r=parseInt(a)||150,n=parseInt(s)||195;this._aspectRatio=n/r,this._extraHeight=n-r}set columns(e){e!==this._columns&&(this._columns=e,this._triggerReflow())}get columns(){return this._columns}set itemSize(e){if(super.itemSize=e,e){const t=parseInt(e.width)||150,a=parseInt(e.height)||195;this._aspectRatio=a/t,this._extraHeight=a-t}}_updateLayout(){const e=this.justify,[t,a]=this._padding2,s=this.flex||["start","center","end"].includes(e),r=t===1/0?this._gap2:t,n=a===1/0?this._gap2:a,o=this._viewDim2-r-n;if(o>0){const l=s?this._gap2:0,c=(o-(this._columns-1)*l)/this._columns;if(this.direction!=="horizontal"){const d=Math.max(10,Math.floor(c));this._itemSize.width=d,this._itemSize.height=Math.max(10,Math.floor(d+this._extraHeight))}else{const d=Math.max(10,Math.floor(c));this._itemSize.height=d,this._itemSize.width=Math.max(10,Math.floor(d-this._extraHeight))}}super._updateLayout()}}const Mc=i=>Object.assign({type:Ic},i);var Pc={common:{not_found:"Entity not found.",search:"Search",power:"Power",favorite:"Favorite",loading:"Loading...",no_results:"No results.",close:"Close",vol_up:"Volume Up",vol_down:"Volume Down",media_player:"Media Player",edit_entity:"Edit Entity Settings",edit_action:"Edit Action Settings",mute:"Mute",unmute:"Unmute",seek:"Seek",volume:"Volume",play_now:"Play Now",more_options:"More Options",unavailable:"Unavailable",back:"Back",cancel:"Cancel",reset_default:"Reset to default",unpin:"Unpin",clear:"Clear",album_art:"Album Art"},editor:{tabs:{entities:"Entities",behavior:"Behavior",look_and_feel:"Look and Feel",artwork:"Artwork",actions:"Actions"},search_placeholder:"Search configuration options...",template_label:"Card Template",templates:{custom:{label:"Custom (Original Config)",description:"Your original, fully customized configuration."},large_modern:{label:"Big Ol' Modern YAMP",description:"A slightly larger modern design with adaptive controls."},crisp_clean:{label:"Clean",description:"A clean layout with scaled artwork and modern controls."},minimal_mini:{label:"MINImal",description:"A compact card with no artwork."},normal_mini:{label:"Mini Mode",description:"The standard compact card."},quick_and_easy:{label:"No Time To Explain",description:"Used for speed with persistent chip rows and quick grouping."},dedicated_search:{label:"All About That Search",description:"A standalone search card without the main media player."},dedicated_grouping:{label:"Group Therapy",description:"A standalone player grouping card. Requires multiple entities configured."},huge_yamp:{label:"That's a Huge YAMP!",description:"Maximized controls, large text, and a massive progress bar for across room viewing."}},placeholders:{search:"Search music..."},sections:{artwork:{general:{title:"General Settings",description:"Global controls for how artwork is displayed and retrieved."},idle:{title:"Idle Artwork",description:"Show a static image or entity snapshot whenever nothing is playing."},overrides:{title:"Artwork Overrides",description:"Overrides are evaluated from top to bottom. Drag to reorder."}},entities:{title:"Entities*",description:"Add the media players you want to control. Drag entities to reorder the chip row."},behavior:{idle_chips:{title:"Idle & Chips",description:"Choose when the card goes idle and how entity chips behave."},interactions_search:{title:"Interactions & Search",description:"Fine-tune how entities are pinned and how many results show at once."},lyrics:{title:"Lyrics",description:"Configure how lyrics are displayed and when they appear."}},look_and_feel:{theme_layout:{title:"Theme & Layout",description:"Match dashboard styling and control the overall footprint."},controls_typography:{title:"Controls & Typography",description:"Tune button sizing, entity labels, and adaptive text."},collapsed_idle:{title:"Collapsed & Idle States",description:"Control when the card collapses and which views show while idle."}},actions:{title:"Actions",description:"Build the action chips that appear in the card or its menu. Drag to reorder, click the pencil to configure each action."}},subtitles:{idle_timeout:"Time in milliseconds before the card enters idle mode. Set to 0 to disable idle behavior.",show_chip_row:'"Auto" hides the chip row when only one entity is configured. "In Menu" moves the chips into the menu overlay. "In Menu on Idle" shows chips inline when active but moves them to the menu when idle.',dim_chips:"When the card enters idle mode with an image, dim the entity and action chips for a cleaner look.",hold_to_pin:"Long press on entity chips instead of short press to pin them, preventing auto-switching during playback.",always_show_group:"Quick grouping controls (+/-/star) will be visible by default on page load. You can still toggle it manually via double-tap.",disable_autofocus:"Keep the search box from stealing focus so on-screen keyboards stay hidden.",search_within_filter:"Enable this to search within the current active filter (Favorites, Recently Played, etc) instead of clearing it.",close_search_on_play:"Automatically close the search screen when a track is played.",pin_search_headers:"Keep search input and filters fixed at the top while scrolling results.",hide_search_headers_on_idle:"Hide search input and filters when the player is idle.",disable_mass:"Disable the optional Mass Queue integration even if it is installed.",swap_pause_stop:"Replace the pause button with stop while using the modern layout.",show_album:"Display the album name next to the artist in the player details.",adaptive_controls:"Let the playback buttons grow or shrink to fit the available space.",hide_menu_player:"When chips live in the menu, hide the entity label at the bottom of the card.",hide_reorder_progress:"Hide the floating queue re-ordering progress indicator at the bottom.",adaptive_text:"Choose which text groups should scale with available space (leave empty to disable adaptive text).",collapse_expand:"Always Collapsed creates mini player mode. Expand on Search temporarily expands when searching.",disable_mini_menu:"Revert to standard lists instead of using the new mini grid menus in Always Collapsed mode.",idle_screen:"Choose which screen to display automatically when the card becomes idle.",hide_controls:"Select buttons to hide from the persistent playback controls row.",hide_remote_buttons:"Select buttons to hide from the Remote Control overlay.",hide_search_chips:"Hide specific search filter chips for this entity",hide_active_entity_on_idle:"Hide the entity label at the bottom of the card only when the player is idle.",follow_active_entity:"When enabled, the volume entity will automatically follow the active playback entity. Note: This overrides the selected volume entity.",search_limit_full:"Maximum number of search results to display (default: 20)",default_search_filter_full:"Choose which filter is active by default when the search screen opens.",default_search_favorites:"Start search with favorites active",result_sorting_full:"Choose how results are ordered.",card_height_full:"Leave blank for automatic height",control_layout_full:"Choose between the legacy evenly sized controls or the modern Home Assistant layout.",artwork_extend:"Let the artwork background continue underneath the chip and action rows.",artwork_extend_label:"Extend artwork",no_artwork_overrides:"No artwork overrides configured. Use the plus button below to add one.",missing_art_match:"Applies when the selected media provides no artwork.",idle_image_match:"Applies when the player is idle and an idle image is displaying.",entity_current_hint:"Use 'entity_id: current' to target the card's currently selected media player entity.",jinja_template_hint:"Enter a Jinja template that resolves to a single entity_id. Example switching MA based on a source selector:",jinja_template_vol_hint:"Enter a Jinja template that resolves to an entity_id (e.g. media_player.office_homepod or remote.soundbar). Example switching volume entity based on a boolean:",jinja_template_remote_hint:"Enter a Jinja template that resolves to a remote entity_id (e.g. remote.living_room_tv):",not_available_alt_collapsed:"Not available with Alternate Progress Bar or Always Collapsed mode",not_available_collapsed:"Not available when Always Collapsed is enabled",only_available_collapsed:"Only available when Always Collapsed is enabled",only_available_mini_menu:"Only available when Always Collapsed is true and Expand on Search is false",only_available_modern:"Only available with Modern layout",image_url_helper:"Enter a direct URL to an image or a local file path",selected_entity_helper:"Input text helper that will be updated with the currently selected media player entity ID.",select_entity_helper:"Input text helper to read the entity ID from. The card will automatically select the matching chip.",sync_entity_type:"Choose which entity ID to sync to the helper (defaults to Music Assistant entity if configured).",disable_auto_select:"Prevent this entity's chip from automatically being selected when it starts playing.",search_view:"Choose between a standard list or a card-based grid for search results.",search_card_columns:"Specify how many columns to use in the card view. Artwork will scale automatically.",card_type:"Choose the card mode. 'Default' is the standard media player. 'Dedicated Search' makes the card a permanent search interface.",queue_controls_style:"Choose between a drag handle or classic movement buttons for the queue.",always_show_lyrics:"Automatically open the lyrics view when the page is refreshed.",lyrics_source:"Music Assistant requires the mass_queue integration to fetch lyrics from its internal metadata engine.",lyrics_pre_roll:"Shift the lyrics highlight timing. Positive values speed it up, negative values slow it down (default: 0).",blurred_artwork:"Always blur the background artwork",hide_collapsed_artwork:"Hide the smaller artwork on the right when the card is collapsed",show_idle_artwork_when_not_playing:"When enabled, selecting a chip that is not currently playing will display the configured idle image instead of the active playback artwork.",prefer_ma_metadata:"Always use the paired Music Assistant entity for track title, artist, and artwork, even if the primary entity is playing.",show_volume_overlay:"Briefly display a large volume indicator over the artwork when the volume level changes."},titles:{edit_entity:"Edit Entity",edit_action:"Edit Action",service_data:"Service Data",add_artwork_override:"Add Artwork Override"},labels:{toggle_template_mode:"Toggle Template Mode",dim_chips:"Dim Chips on Idle",hold_to_pin:"Hold to Pin",always_show_group:"Quick Group by Default",disable_autofocus:"Disable Search Autofocus",keep_filters:"Keep Filters on Search",dismiss_on_play:"Dismiss search on play",pin_headers:"Pin search headers",hide_search_headers_on_idle:"Hide search headers on idle",default_search_filter:"Default Search Filter",default_search_favorites:"Default to Favorites Filter",disable_mass:"Disable Mass Queue",match_theme:"Match Theme",alt_progress:"Alternate Progress Bar",progress_bar_height:"Progress Bar Height",display_timestamps:"Display Timestamps",swap_pause_stop:"Swap Pause with Stop",show_album:"Show Album Name",adaptive_controls:"Adaptive Control Size",hide_active_entity:"Hide Active Entity Label",hide_active_entity_on_idle:"Hide Active Entity Label on Idle",collapse_on_idle:"Collapse on Idle",hide_menu_player_toggle:"Hide Menu Player",hide_reorder_progress_toggle:"Hide Re-ordering Progress",always_collapsed:"Always Collapsed",disable_mini_menu:"Disable mini grid menus",expand_on_search:"Expand on Search",script_var:"Script Variable (yamp_entity)",use_ma_template:"Use template for Music Assistant Entity",use_vol_template:"Use template for Volume Entity",follow_active_entity:"Volume Entity Follows Active Entity",use_url_path:"Use URL or Path",adaptive_text_elements:"Adaptive Text Size Elements",disable_auto_select:"Disable Auto-Select",always_show_lyrics:"Always Show Lyrics",lyrics_mode:"Lyrics Mode",lyrics_source:"Lyrics Source",lyrics_pre_roll:"Lyrics Pre-Roll (seconds)",blurred_artwork:"Blurred Artwork",hide_collapsed_artwork:"Hide Collapsed Artwork",show_idle_artwork_when_not_playing:"Show Idle Image When Not Playing",prefer_ma_metadata:"Prefer Music Assistant Metadata",show_volume_overlay:"Show Volume Overlay"},fields:{artwork_fit:"Artwork Fit",artwork_position:"Artwork Position",artwork_hostname:"Artwork Hostname",match_field:"Match Type",match_value:"Match Value",size_percent:"Size (%)",object_fit:"Object Fit",idle_timeout:"Idle Timeout (ms)",show_chip_row:"Show Chip Row",search_limit:"Search Results Limit",result_sorting:"Result Sorting",vol_step:"Volume Step (0.05 = 5%)",card_height:"Card Height (px)",control_layout:"Control Layout",idle_image:"Idle Image",image_url:"Image URL",fallback_image_url:"Fallback Image URL",move_to_main:"Move action to main chips",move_to_menu:"Move action into menu",delete_action:"Delete Action",volume_mode:"Volume Mode",idle_screen:"Idle Screen",name:"Name",hidden_controls:"Hidden Controls",hide_remote_buttons:"Hidden Remote Buttons",ma_template:"Music Assistant Entity Template (Jinja)",hidden_chips:"Hidden Search Filter Chips",vol_template:"Volume Entity Template (Jinja)",icon:"Icon",action_type:"Action Type",menu_item:"Menu Item",nav_path:"Navigation Path",service:"Service",service_data:"Service Data",idle_image_entity:"Idle Image Entity",match_entity:"Match Entity",ma_entity:"Music Assistant Entity",vol_entity:"Volume Entity",remote_entity:"Remote Entity",remote_template:"Remote Entity Template (Jinja)",selected_entity_helper:"Selected Entity Helper",sync_entity_type:"Sync Entity Type",placement:"Placement",card_trigger:"Card Trigger",search_view:"Search Result View",search_card_columns:"Card Columns",card_type:"Card Type",queue_controls_style:"Queue Controls Style",appearance:"Appearance",no_artwork_option:"No Artwork",details_alignment:"Details Alignment"},action_types:{menu:"Open a Card Menu Item",service:"Call a Service",navigate:"Navigate",prev_entity:"Previous Entity Chip",next_entity:"Next Entity Chip",sync_selected_entity:"Sync Selected Entity",select_entity:"Select Entity from Helper",toggle_lyrics:"Toggle Lyrics Overlay",remote_control:"Open Remote Controls Overlay"},action_helpers:{sync_selected_entity:"Sync Selected Entity \u2192",select_entity:"Select Entity \u2190",select_helper:"(select helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Music Assistant Entity if configured)",yamp_main_entity:"yamp_main_entity (Main Media Player Entity)",yamp_playback_entity:"yamp_playback_entity (Current Active Playback Entity)"},placements:{chip:"Action Chip",menu:"In Menu",hidden:"Hidden (Artwork Tap)",replace_search:"Replace Search",replace_power:"Replace Power",replace_mute:"Replace Mute",replace_favorite:"Replace Favorite",not_triggerable:"Not Triggerable"},triggers:{none:"None",tap:"Tap",hold:"Hold",double_tap:"Double Tap",swipe_left:"Swipe Left",swipe_right:"Swipe Right"},search_view_options:{list:"List",card:"Card",card_minimal:"Minimal Card"},card_type_options:{default:"Default",search:"Search",group_players:"Group Players",up_next:"Up Next",remote_control:"Remote Control"},queue_controls_style_options:{drag_handle:"Drag Handle",icons:"Movement Buttons"},appearance_options:{automatic:"Automatic",light:"Light",dark:"Dark"},artwork_fit:{default:"Global",cover:"Cover",contain:"Contain",fill:"Fill","scale-down":"Scale Down","scaled-contain":"Scaled Contain","scaled-contain-alternate":"Scaled Contain Alternate",none:"None"},artwork_position:{default:"Global",top:"Top",center:"Center",bottom:"Bottom"}},card:{sections:{details:"Now Playing Details",menu:"Menu & Search Sheets",action_chips:"Action Chips",lyrics:"Lyrics"},media_controls:{shuffle:"Shuffle",previous:"Previous",play_pause:"Play/Pause",stop:"Stop",next:"Next",repeat:"Repeat"},menu:{more_info:"More Info",search:"Search",source:"Source",remote_controls:"Remote Control",show_lyrics:"Show Lyrics",hide_lyrics:"Hide Lyrics",transfer_queue:"Transfer Queue",main_menu:"Main Menu",group_players:"Group Players",up_next:"Up Next",remote_control:"Remote Control",select_entity:"Select Entity for More Info",transfer_to:"Transfer Queue To",no_players:"No other Music Assistant players available."},remote:{title:"Remote Control",up:"Up",down:"Down",left:"Left",right:"Right",select:"Select",back:"Back",menu:"Menu",home:"Home",power:"Power"},grouping:{title:"Group Players",sync_volume:"Sync Volume",group_all:"Group All",ungroup_all:"Ungroup All",unavailable:"Player is unavailable",no_players:"No other group-capable players available.",master:"Master",joined:"Joined",available:"Available",current:"Current",unjoin_from:"Unjoin from {master}",join_with:"Join with {master}"}},search:{favorites:"Favorites",recently_played:"Recently Played",next_up:"Next Up",recommendations:"Recommendations",radio_mode:"Radio Mode",show_track_options:"Show track options",play_similar:"Play similar songs",close:"Close Search",no_results:"No results.",play_next:"Play next",replace_play:"Replace existing queue and play now",replace:"Replace queue",add_queue:"Add to the end of the queue",move_up:"Move Up",move_down:"Move Down",move_next:"Move to Next",remove:"Remove from Queue",drag_to_reorder:"Drag to reorder",added:"Added to queue!",added_to_playlist:"Added to playlist!",select_playlist:"Select Playlist for '{track}'",add_to_playlist:"Add to playlist",select_track_for_playlist:"Select the track to add for '{track}' by {artist}",labels:{replace:"Replace",next:"Next",replace_next:"Replace Next",add:"Add",add_to_playlist:"Add to Playlist"},results:"results",result:"result",filters:{all:"All",artist:"Artist",album:"Album",track:"Track",playlist:"Playlist",radio:"Radio",music:"Music",station:"Station",podcast:"Podcast",audiobook:"Audiobook"},search_artist:"Search for this artist",search_album:"Browse tracks from this album",browse_album:"Browse tracks from {album}",play_collection:"Play this collection",play_collection_error:"Unable to play this collection directly",play_item:"Play {item}"},lyrics:{finding:"Finding Lyrics...",none_found:"No lyrics found",not_available:"Lyrics not available",instrumental:"Instrumental Track",admin_only_mass:"Music Assistant lyrics fetch is for admin users only. It is recommended to switch to lrclib in the card configuration.",fallback_to_lrclib_non_admin:"Non-admin user detected. Falling back to lrclib for lyrics fetch."},lyrics_sources:{mass_lrclib:"Music Assistant (Fallback to LRCLIB)",mass:"Music Assistant Only",lrclib:"LRCLIB Only",lrclib_mass:"LRCLIB (Fallback to Music Assistant)"},lyrics_modes:{default:"Default (Highlight & Scroll)",scroll:"Scroll Only",text:"Text Only"}},zc={common:{not_found:"Entit\xE4t nicht gefunden.",search:"Suchen",power:"Ein/Aus",favorite:"Favorit",loading:"Laden...",no_results:"Keine Ergebnisse.",close:"Schlie\xDFen",vol_up:"Lauter",vol_down:"Leiser",media_player:"Mediaplayer",edit_entity:"Entit\xE4tseinstellungen bearbeiten",edit_action:"Aktionseinstellungen bearbeiten",mute:"Stumm",unmute:"Stummschaltung aufheben",seek:"Suchen",volume:"Lautst\xE4rke",play_now:"Jetzt abspielen",more_options:"Weitere Optionen",unavailable:"Nicht verf\xFCgbar",back:"Zur\xFCck",cancel:"Abbrechen",reset_default:"Auf Standard zur\xFCcksetzen",unpin:"Entpinnen",clear:"L\xF6schen",album_art:"Album-Artwork"},editor:{tabs:{entities:"Entit\xE4ten",behavior:"Verhalten",look_and_feel:"Design",artwork:"Artwork",actions:"Aktionen"},search_placeholder:"Konfigurationsoptionen suchen...",template_label:"Karten-Vorlage",templates:{custom:{label:"Benutzerdefiniert (Originalkonfiguration)",description:"Ihre urspr\xFCngliche, vollst\xE4ndig angepasste Konfiguration."},large_modern:{label:"Gro\xDFes modernes YAMP",description:"Ein etwas gr\xF6\xDFeres, modernes Design mit adaptiver Steuerung."},crisp_clean:{label:"Klar & Aufger\xE4umt",description:"Ein klares Layout mit skaliertem Artwork und modernen Bedienelementen."},minimal_mini:{label:"MINImal",description:"Eine kompakte Karte ohne Artwork."},normal_mini:{label:"Mini Mode",description:"Die Standard-Kompaktkarte."},quick_and_easy:{label:"Keine Zeit zu erkl\xE4ren",description:"F\xFCr Schnelligkeit mit dauerhaften Chip-Zeilen und schneller Gruppierung."},dedicated_search:{label:"Alles rund um die Suche",description:"Eine eigenst\xE4ndige Suchkarte ohne den Haupt-Mediaplayer."},dedicated_grouping:{label:"Gruppentherapie",description:"Eine eigenst\xE4ndige Player-Gruppierungskarte. Erfordert mehrere konfigurierte Entit\xE4ten."},huge_yamp:{label:"Das ist ein riesiges YAMP!",description:"Maximierte Steuerelemente, gro\xDFer Text und ein massiver Fortschrittsbalken f\xFCr die Betrachtung aus der Ferne."}},placeholders:{search:"Musik suchen..."},sections:{artwork:{general:{title:"Allgemeine Einstellungen",description:"Globale Steuerung der Artwork-Anzeige und -Abrufung."},idle:{title:"Artwork im Leerlauf",description:"Zeigt ein statisches Bild oder einen Entit\xE4ts-Schnappschuss an, wenn nichts abgespielt wird."},overrides:{title:"Artwork-\xDCberschreibungen",description:"\xDCberschreibungen werden von oben nach unten ausgewertet. Zum Neusortieren ziehen."}},entities:{title:"Entit\xE4ten*",description:"F\xFCgen Sie die zu steuernden Mediaplayer hinzu. Entit\xE4ten ziehen, um sie neu anzuordnen."},behavior:{idle_chips:{title:"Leerlauf & Chips",description:"W\xE4hlen Sie, wann die Karte in den Leerlauf wechselt und wie sich Entit\xE4ts-Chips verhalten."},interactions_search:{title:"Interaktionen & Suche",description:"Feineinstellung des Anpinnens von Entit\xE4ten und der Anzahl der Suchergebnisse."},lyrics:{title:"Liedtexte",description:"Konfigurieren Sie, wie Liedtexte angezeigt werden und wann sie erscheinen."}},look_and_feel:{theme_layout:{title:"Theme & Layout",description:"Anpassung an das Dashboard-Styling und Kontrolle des Platzbedarfs."},controls_typography:{title:"Steuerung & Typografie",description:"Anpassung von Schaltfl\xE4chengr\xF6\xDFe, Entit\xE4ts-Labels und adaptivem Text."},collapsed_idle:{title:"Eingeklappte & Leerlaufzust\xE4nde",description:"Steuerung der Karteneinklappung und der Ansichten im Leerlauf."}},actions:{title:"Aktionen",description:"Erstellen Sie Aktions-Chips f\xFCr die Karte oder das Men\xFC. Ziehen zum Sortieren, Stift zum Konfigurieren anklicken."}},subtitles:{idle_timeout:"Zeit in Millisekunden vor dem Wechsel in den Leerlaufmodus. 0 zum Deaktivieren.",show_chip_row:'"Auto" blendet die Chip-Leiste bei nur einer Entit\xE4t aus. "Im Men\xFC" verschiebt sie ins Men\xFC. "Im Men\xFC bei Inaktivit\xE4t" zeigt Chips inline wenn aktiv, verschiebt sie aber ins Men\xFC bei Inaktivit\xE4t.',dim_chips:"Entit\xE4ts- und Aktions-Chips im Leerlauf mit Bild abdunkeln f\xFCr einen sauberen Look.",hold_to_pin:"Langes Dr\xFCcken statt kurzem Dr\xFCcken zum Anpinnen, um automatisches Umschalten zu verhindern.",always_show_group:"Schnellgruppierungs-Steuerelemente (+/-/Stern) sind standardm\xE4\xDFig beim Laden der Seite sichtbar. Sie k\xF6nnen sie weiterhin manuell per Doppeltipp umschalten.",disable_autofocus:"Suchfeld-Autofokus deaktivieren, damit Bildschirmtastaturen ausgeblendet bleiben.",search_within_filter:"Innerhalb des aktiven Filters suchen (Favoriten, etc.), anstatt ihn zu l\xF6schen.",close_search_on_play:"Suchbildschirm beim Abspielen automatisch schlie\xDFen.",pin_search_headers:"Sucheingabe und Filter beim Scrollen oben fixieren.",hide_search_headers_on_idle:"Sucheingabe und Filter im Leerlauf ausblenden.",disable_mass:"Optionale Mass Queue Integration deaktivieren, auch wenn sie installiert ist.",swap_pause_stop:"Pause-Taste durch Stop-Taste im modernen Layout ersetzen.",show_album:"Den Albumnamen neben dem Interpreten in den Player-Details anzeigen.",adaptive_controls:"Wiedergabetasten an verf\xFCgbaren Platz anpassen.",hide_menu_player:"Entit\xE4ts-Label unten ausblenden, wenn Chips im Men\xFC sind.",hide_reorder_progress:"Die schwebende Fortschrittsanzeige f\xFCr die Warteschlangen-Neusortierung unten ausblenden.",adaptive_text:"Textgruppen w\xE4hlen, die mit dem Platz skalieren (leer lassen zum Deaktivieren).",collapse_expand:"Immer eingeklappt aktiviert den Mini-Player-Modus. Bei Suche ausklappen aktiviert ihn tempor\xE4r.",disable_mini_menu:"Kehrt zu Standardlisten zur\xFCck, anstatt die neuen Mini-Grid-Men\xFCs im Modus 'Immer eingeklappt' zu verwenden.",idle_screen:"W\xE4hlen Sie, welcher Bildschirm im Leerlauf automatisch angezeigt wird.",hide_controls:"W\xE4hlen Sie Steuerelemente aus, die f\xFCr diese Entit\xE4t ausgeblendet werden sollen.",hide_remote_buttons:"W\xE4hlen Sie die Tasten aus, die im Fernbedienungs-Overlay ausgeblendet werden sollen.",hide_search_chips:"Bestimmte Suchfilter-Chips f\xFCr diese Entit\xE4t ausblenden.",hide_active_entity_on_idle:"Blendet die Entit\xE4tsbeschriftung am unteren Rand der Karte nur aus, wenn der Player im Leerlauf ist.",follow_active_entity:"Lautst\xE4rke-Entit\xE4t folgt automatisch der aktiven Wiedergabe-Entit\xE4t.",search_limit_full:"Maximale Anzahl an Suchergebnissen (Standard: 20).",default_search_filter_full:"W\xE4hlen Sie den Filter, der beim \xD6ffnen der Suche standardm\xE4\xDFig aktiv ist.",default_search_favorites:"Suche mit aktiven Favoriten starten",result_sorting_full:"Sortierung der Suchergebnisse w\xE4hlen. Standard beh\xE4lt die Quellreihenfolge bei.",card_height_full:"Leer lassen f\xFCr automatische H\xF6he.",control_layout_full:"W\xE4hlen Sie zwischen manuellem oder modernem Home Assistant Layout.",artwork_extend:"Artwork-Hintergrund unter die Chip- und Aktionsleisten erweitern.",artwork_extend_label:"Artwork erweitern",no_artwork_overrides:"Keine Artwork-\xDCberschreibungen konfiguriert.",missing_art_match:"Wird angewendet, wenn die ausgew\xE4hlten Medien kein Cover haben.",idle_image_match:"Wird angewendet, wenn der Player inaktiv ist und ein Ruhebild angezeigt wird.",entity_current_hint:"'entity_id: current' verwenden, um den aktuell ausgew\xE4hlten Mediaplayer anzusteuern.",jinja_template_hint:"Jinja-Template eingeben, das eine entity_id ergibt.",jinja_template_vol_hint:"Jinja-Template eingeben, das eine Lautst\xE4rke-entity_id ergibt.",jinja_template_remote_hint:"Jinja-Template eingeben, das eine Remote-entity_id ergibt (z.B. remote.wohnzimmer_tv):",not_available_alt_collapsed:"Nicht verf\xFCgbar mit alternativem Fortschrittsbalken oder im Modus 'Immer eingeklappt'.",not_available_collapsed:"Nicht verf\xFCgbar, wenn 'Immer eingeklappt' aktiviert ist.",only_available_collapsed:"Nur verf\xFCgbar, wenn 'Immer eingeklappt' aktiviert ist.",only_available_mini_menu:"Nur verf\xFCgbar, wenn 'Immer eingeklappt' aktiviert und 'Bei Suche erweitern' deaktiviert ist",only_available_modern:"Nur verf\xFCgbar im modernen Layout.",image_url_helper:"Direkte Bild-URL oder lokalen Dateipfad eingeben.",selected_entity_helper:"Input-Text-Helper, der mit der aktuell ausgew\xE4hlten Mediaplayer-Entit\xE4ts-ID aktualisiert wird.",select_entity_helper:"Input-Text-Helper, aus dem die Entit\xE4ts-ID gelesen wird. Die Karte w\xE4hlt automatisch den passenden Chip aus.",sync_entity_type:"W\xE4hlen Sie, welche Entit\xE4ts-ID mit dem Helper synchronisiert werden soll (Standard: Music Assistant Entit\xE4t, falls konfiguriert).",disable_auto_select:"Verhindert, dass der Chip dieser Entit\xE4t automatisch ausgew\xE4hlt wird, wenn die Wiedergabe startet.",search_view:"W\xE4hlen Sie zwischen einer Standardliste oder einem kartenbasierten Raster f\xFCr Suchergebnisse.",search_card_columns:"Geben Sie an, wie viele Spalten in der Kartenansicht verwendet werden sollen. Das Artwork wird automatisch skaliert.",card_type:"W\xE4hlen Sie den Kartenmodus. 'Standard' ist der normale Mediaplayer. 'Dedizierte Suche' macht die Karte zu einer permanenten Suchoberfl\xE4che.",always_show_lyrics:"Liedtextansicht bei Seitenaktualisierung automatisch \xF6ffnen.",lyrics_source:"Music Assistant ben\xF6tigt die mass_queue-Integration, um Liedtexte von seiner internen Metadaten-Engine abzurufen.",lyrics_pre_roll:"Passen Sie das Timing der Songtext-Hervorhebung an. Positive Werte beschleunigen sie, negative verz\xF6gern sie (Standard: 0).",blurred_artwork:"Hintergrundbild immer weichzeichnen",hide_collapsed_artwork:"Das kleine Artwork auf der rechten Seite ausblenden, wenn die Karte eingeklappt ist",show_idle_artwork_when_not_playing:"Wenn aktiviert, wird beim Ausw\xE4hlen eines Chips, auf dem derzeit nichts abgespielt wird, das konfigurierte Ruhebild anstelle des aktiven Wiedergabe-Artworks angezeigt.",prefer_ma_metadata:"Verwenden Sie immer die gekoppelte Music Assistant-Entit\xE4t f\xFCr Titel, K\xFCnstler und Artwork, auch wenn die prim\xE4re Entit\xE4t gerade spielt.",show_volume_overlay:"Zeige kurz eine gro\xDFe Lautst\xE4rkeanzeige \xFCber dem Cover an, wenn sich die Lautst\xE4rke \xE4ndert.",queue_controls_style:"W\xE4hlen Sie, ob ein Ziehgriff oder einzelne Bewegungstasten f\xFCr Warteschlangenelemente angezeigt werden sollen."},titles:{edit_entity:"Entit\xE4t bearbeiten",edit_action:"Aktion bearbeiten",service_data:"Servicedaten",add_artwork_override:"Artwork-\xDCberschreibung hinzuf\xFCgen"},labels:{toggle_template_mode:"Vorlagenmodus umschalten",dim_chips:"Chips im Leerlauf abdunkeln",hold_to_pin:"Gedr\xFCckt halten zum Anpinnen",always_show_group:"Schnellgruppierung standardm\xE4\xDFig aktivieren",disable_autofocus:"Such-Autofocus deaktivieren",keep_filters:"Filter bei Suche beibehalten",dismiss_on_play:"Suche beim Abspielen beenden",pin_headers:"Such-Header fixieren",hide_search_headers_on_idle:"Such-Header im Leerlauf ausblenden",default_search_filter:"Standard-Suchfilter",default_search_favorites:"Standardm\xE4\xDFig Favoritenfilter verwenden",disable_mass:"Mass Queue deaktivieren",match_theme:"Theme anpassen",alt_progress:"Alternativer Fortschrittsbalken",progress_bar_height:"Fortschrittsbalkenh\xF6he",display_timestamps:"Zeitstempel anzeigen",swap_pause_stop:"Pause durch Stop ersetzen",show_album:"Albumname anzeigen",adaptive_controls:"Adaptive Tastengr\xF6\xDFe",hide_active_entity:"Aktives Entit\xE4ts-Label ausblenden",hide_active_entity_on_idle:"Aktive Entit\xE4tsbeschriftung im Leerlauf ausblenden",collapse_on_idle:"Bei Leerlauf einklappen",hide_menu_player_toggle:"Men\xFC-Player ausblenden",hide_reorder_progress_toggle:"Neusortierungs-Fortschritt ausblenden",always_collapsed:"Immer eingeklappt",disable_mini_menu:"Mini-Grid-Men\xFCs deaktivieren",expand_on_search:"Bei Suche ausklappen",script_var:"Skript-Variable (yamp_entity)",use_ma_template:"Template f\xFCr Music Assistant Entit\xE4t verwenden",use_vol_template:"Template f\xFCr Lautst\xE4rke-Entit\xE4t verwenden",follow_active_entity:"Lautst\xE4rke folgt aktiver Entit\xE4t",use_url_path:"URL oder Pfad verwenden",adaptive_text_elements:"Elemente f\xFCr adaptive Textgr\xF6\xDFe",disable_auto_select:"Auto-Auswahl deaktivieren",always_show_lyrics:"Liedtexte immer anzeigen",lyrics_mode:"Liedtext-Modus",lyrics_source:"Liedtext-Quelle",lyrics_pre_roll:"Liedtext Pre-Roll (Sekunden)",blurred_artwork:"Verschwommenes Artwork",hide_collapsed_artwork:"Verkleinertes Artwork ausblenden",show_idle_artwork_when_not_playing:"Ruhebild anzeigen, wenn nicht abgespielt wird",prefer_ma_metadata:"Music Assistant Metadaten bevorzugen",show_volume_overlay:"Lautst\xE4rke-Overlay anzeigen"},fields:{artwork_fit:"Artwork-Anpassung",artwork_position:"Artwork-Position",artwork_hostname:"Artwork-Hostname",match_field:"Match-Feld",match_value:"Match-Wert",size_percent:"Gr\xF6\xDFe (%)",object_fit:"Object-Fit",idle_timeout:"Leerlauf-Timeout (ms)",show_chip_row:"Chip-Leiste anzeigen",search_limit:"Suchlimit",result_sorting:"Ergebnissortierung",vol_step:"Lautst\xE4rke-Schritt (0.05 = 5%)",card_height:"Kartenh\xF6he (px)",control_layout:"Steuerungs-Layout",idle_image:"Ruhebild",image_url:"Bild-URL",fallback_image_url:"Fallback Bild-URL",move_to_main:"Aktion in Haupt-Chips verschieben",move_to_menu:"Aktion ins Men\xFC verschieben",delete_action:"Aktion l\xF6schen",volume_mode:"Lautst\xE4rke-Modus",idle_screen:"Leerlauf-Bildschirm",name:"Name",hidden_controls:"Ausgeblendete Steuerungen",hide_remote_buttons:"Ausgeblendete Fernbedienungstasten",ma_template:"Music Assistant Entit\xE4ts-Template (Jinja)",hidden_chips:"Ausgeblendete Suchfilter-Chips",vol_template:"Lautst\xE4rke-Entit\xE4ts-Template (Jinja)",icon:"Icon",action_type:"Aktionstyp",menu_item:"Men\xFCpunkt",nav_path:"Navigationspfad",service:"Dienst",service_data:"Servicedaten",idle_image_entity:"Leerlauf-Bild-Entit\xE4t",match_entity:"Match-Entit\xE4t",ma_entity:"Music Assistant Entit\xE4t",vol_entity:"Lautst\xE4rke-Entit\xE4t",remote_entity:"Fernbedienungs-Entit\xE4t",remote_template:"Fernbedienungs-Entit\xE4t Template (Jinja)",selected_entity_helper:"Ausgew\xE4hlter Entit\xE4ts-Helper",sync_entity_type:"Synchronisierungs-Entit\xE4tstyp",placement:"Platzierung",card_trigger:"Karten-Trigger",search_view:"Suchergebnis-Ansicht",search_card_columns:"Spaltenanzahl",card_type:"Kartentyp",appearance:"Erscheinungsbild",no_artwork_option:"Kein Artwork",details_alignment:"Detail-Ausrichtung",queue_controls_style:"Warteschlangen-Steuerungsstil"},action_types:{menu:"Kartenmen\xFCpunkt \xF6ffnen",service:"Dienst aufrufen",navigate:"Navigieren",prev_entity:"Vorheriger Entit\xE4ts-Chip",next_entity:"N\xE4chster Entit\xE4ts-Chip",sync_selected_entity:"Ausgew\xE4hlte Entit\xE4t synchronisieren",select_entity:"Entit\xE4t aus Helper ausw\xE4hlen",toggle_lyrics:"Liedtext-Overlay ein-/ausschalten",remote_control:"Fernbedienungs-Overlay \xF6ffnen"},action_helpers:{sync_selected_entity:"Entit\xE4t synchronisieren \u2192",select_entity:"Entit\xE4t ausw\xE4hlen \u2190",select_helper:"(Helper ausw\xE4hlen)"},sync_entity_options:{yamp_entity:"yamp_entity (Music Assistant Entit\xE4t, falls konfiguriert)",yamp_main_entity:"yamp_main_entity (Haupt-Mediaplayer-Entit\xE4t)",yamp_playback_entity:"yamp_playback_entity (Aktuelle aktive Wiedergabe-Entit\xE4t)"},placements:{chip:"Aktions-Chip",menu:"Im Men\xFC",hidden:"Ausgeblendet (Artwork-Tippen)",replace_search:"Suche ersetzen",replace_power:"Ein/Aus ersetzen",replace_mute:"Stummschaltung ersetzen",replace_favorite:"Favorit ersetzen",not_triggerable:"Nicht triggerbar"},triggers:{none:"Keiner",tap:"Tippen",hold:"Halten",double_tap:"Doppeltippen",swipe_left:"Nach links wischen",swipe_right:"Nach rechts wischen"},search_view_options:{list:"Liste",card:"Karte",card_minimal:"Minimal-Karte"},queue_controls_style_options:{drag_handle:"Ziehgriff",icons:"Bewegungstasten"},card_type_options:{default:"Standard",search:"Suche",group_players:"Player gruppieren",up_next:"Als N\xE4chstes",remote_control:"Fernbedienung"},appearance_options:{automatic:"Automatisch",light:"Hell",dark:"Dunkel"},artwork_fit:{default:"Global",cover:"Cover (Standard)",contain:"Einpassen",fill:"F\xFCllen","scale-down":"Verkleinern","scaled-contain":"Skaliertes Einpassen","scaled-contain-alternate":"Skaliertes Einpassen (Alternativ)",none:"Keine"},artwork_position:{default:"Global",top:"Oben",center:"Mitte",bottom:"Unten"}},card:{sections:{details:"Details zur Wiedergabe",menu:"Men\xFC & Suchbl\xE4tter",action_chips:"Aktions-Chips",lyrics:"Songtext"},media_controls:{shuffle:"Zufall",previous:"Zur\xFCck",play_pause:"Play/Pause",stop:"Stop",next:"Weiter",repeat:"Wiederholen"},menu:{more_info:"Mehr Info",search:"Suche",source:"Quelle",remote_controls:"Fernbedienung",show_lyrics:"Songtext anzeigen",hide_lyrics:"Songtext ausblenden",transfer_queue:"Warteschlange \xFCbertragen",main_menu:"Hauptmen\xFC",group_players:"Player gruppieren",up_next:"Als N\xE4chstes",remote_control:"Fernbedienung",select_entity:"Entit\xE4t f\xFCr mehr Info w\xE4hlen",transfer_to:"Warteschlange \xFCbertragen zu",no_players:"Keine anderen Music Assistant Player verf\xFCgbar."},remote:{title:"Fernbedienung",up:"Nach oben",down:"Nach unten",left:"Nach links",right:"Nach rechts",select:"Ausw\xE4hlen",back:"Zur\xFCck",menu:"Men\xFC",home:"Startseite",power:"Ein/Aus"},grouping:{title:"Player gruppieren",sync_volume:"Lautst\xE4rke synchronisieren",group_all:"Alle gruppieren",ungroup_all:"Alle trennen",unavailable:"Player ist nicht verf\xFCgbar",no_players:"Keine anderen gruppierungsf\xE4higen Player verf\xFCgbar.",master:"Master",joined:"Verbunden",available:"Verf\xFCgbar",current:"Aktuell",unjoin_from:"Von {master} trennen",join_with:"Mit {master} gruppieren"}},search:{favorites:"Favoriten",recently_played:"Zuletzt geh\xF6rt",next_up:"Als N\xE4chstes",recommendations:"Empfehlungen",radio_mode:"Radiomodus",show_track_options:"Titeloptionen anzeigen",play_similar:"\xC4hnliche Lieder abspielen",close:"Suche schlie\xDFen",no_results:"Keine Ergebnisse.",play_next:"Als N\xE4chstes spielen",replace_play:"Warteschlange ersetzen und jetzt spielen",replace:"Warteschlange ersetzen",add_queue:"Am Ende der Warteschlange hinzuf\xFCgen",move_up:"Nach oben",move_down:"Nach unten",move_next:"Als N\xE4chstes verschieben",remove:"Aus Warteschlange entfernen",drag_to_reorder:"Ziehen zum Sortieren",added:"Zur Warteschlange hinzugef\xFCgt!",added_to_playlist:"Zur Playlist hinzugef\xFCgt!",select_playlist:"Playlist f\xFCr '{track}' ausw\xE4hlen",add_to_playlist:"Zur Playlist hinzuf\xFCgen",select_track_for_playlist:"Titel zum Hinzuf\xFCgen f\xFCr '{track}' von {artist} ausw\xE4hlen",labels:{replace:"Ersetzen",next:"Weiter",replace_next:"Weiter ersetzen",add:"Hinzuf\xFCgen",add_to_playlist:"Zur Playlist hinzuf\xFCgen"},results:"Ergebnisse",result:"Ergebnis",filters:{all:"Alle",artist:"K\xFCnstler",album:"Album",track:"Titel",playlist:"Playlist",radio:"Radio",music:"Musik",station:"Station",podcast:"Podcast",audiobook:"H\xF6rbuch"},search_artist:"Nach diesem K\xFCnstler suchen",search_album:"Titel von diesem Album durchsuchen",browse_album:"Albentitel von {album} durchsuchen",play_collection:"Diese Sammlung abspielen",play_collection_error:"Diese Sammlung kann nicht direkt abgespielt werden",play_item:"{item} abspielen"},lyrics:{finding:"Suche Songtext...",none_found:"Kein Songtext gefunden",not_available:"Songtext nicht verf\xFCgbar",instrumental:"Instrumental-Titel",admin_only_mass:"Das Abrufen von Songtexten \xFCber Music Assistant ist nur f\xFCr Administratoren verf\xFCgbar. Es wird empfohlen, in der Kartenkonfiguration auf lrclib zu wechseln.",fallback_to_lrclib_non_admin:"Kein Administratorbenutzer erkannt. R\xFCckgriff auf lrclib f\xFCr den Abruf von Songtexten."},lyrics_sources:{mass_lrclib:"Music Assistant (Fallback zu LRCLIB)",mass:"Nur Music Assistant",lrclib:"Nur LRCLIB",lrclib_mass:"LRCLIB (Fallback zu Music Assistant)"},lyrics_modes:{default:"Standard (Hervorheben & Scrollen)",scroll:"Nur Scrollen",text:"Nur Text"}},jc={common:{not_found:"Entidad no encontrada.",search:"Buscar",power:"Encender/Apagar",favorite:"Favorito",loading:"Cargando...",no_results:"Sin resultados.",close:"Cerrar",vol_up:"Subir volumen",vol_down:"Bajar volumen",media_player:"Reproductor multimedia",edit_entity:"Editar ajustes de entidad",edit_action:"Editar ajustes de acci\xF3n",mute:"Silenciar",unmute:"Activar sonido",seek:"Buscar",volume:"Volumen",play_now:"Reproducir ahora",more_options:"M\xE1s opciones",unavailable:"No disponible",back:"Atr\xE1s",cancel:"Cancelar",reset_default:"Restablecer valores",unpin:"Desanclar",clear:"Limpiar",album_art:"Portada del \xE1lbum"},editor:{tabs:{entities:"Entidades",behavior:"Comportamiento",look_and_feel:"Apariencia",artwork:"Portada",actions:"Acciones"},search_placeholder:"Buscar opciones de configuraci\xF3n...",template_label:"Plantilla de tarjeta",templates:{custom:{label:"Personalizado (Configuraci\xF3n original)",description:"Tu configuraci\xF3n original totalmente personalizada."},large_modern:{label:"YAMP moderno y grande",description:"Un dise\xF1o moderno ligeramente m\xE1s grande con controles adaptables."},crisp_clean:{label:"Limpio",description:"Un dise\xF1o limpio con portada escalada y controles modernos."},minimal_mini:{label:"MINImal",description:"Una tarjeta compacta sin car\xE1tula."},normal_mini:{label:"Mini Mode",description:"La tarjeta compacta est\xE1ndar."},quick_and_easy:{label:"Sin tiempo que perder",description:"Dise\xF1ado para rapidez con filas de chips persistentes y agrupaci\xF3n r\xE1pida."},dedicated_search:{label:"Todo sobre la b\xFAsqueda",description:"Una tarjeta de b\xFAsqueda independiente sin el reproductor multimedia principal."},dedicated_grouping:{label:"Terapia de grupo",description:"Una tarjeta de agrupaci\xF3n de reproductores independiente. Requiere m\xFAltiples entidades configuradas."},huge_yamp:{label:"\xA1Vaya pedazo de YAMP!",description:"Controles maximizados, texto grande y una barra de progreso enorme para ver desde lejos."}},placeholders:{search:"Buscar m\xFAsica..."},sections:{artwork:{general:{title:"Ajustes generales",description:"Controles globales para la portada."},idle:{title:"Portada en reposo",description:"Mostrar imagen est\xE1tica cuando nada se reproduce."},overrides:{title:"Reemplazos de portada",description:"Los reemplazos se eval\xFAan de arriba a abajo. Arrastre para reordenar."}},entities:{title:"Entidades*",description:"A\xF1ada los reproductores multimedia. Arrastre para reordenar."},behavior:{idle_chips:{title:"Reposo y chips",description:"Elija cu\xE1ndo pasa a reposo y el comportamiento de los chips."},interactions_search:{title:"Interacciones y b\xFAsqueda",description:"Ajuste el fijado de entidades y l\xEDmite de resultados."},lyrics:{title:"Letras",description:"Configure c\xF3mo se muestran las letras y cu\xE1ndo aparecen."}},look_and_feel:{theme_layout:{title:"Tema y dise\xF1o",description:"Combine con el estilo de su dashboard."},controls_typography:{title:"Controles y tipograf\xEDa",description:"Ajuste tama\xF1o de botones y etiquetas."},collapsed_idle:{title:"Estados de reposo y contra\xEDdo",description:"Controle el contra\xEDdo de la tarjeta."}},actions:{title:"Acciones",description:"Cree chips de acci\xF3n. Arrastre para reordenar, pulse el l\xE1piz para configurar."}},subtitles:{idle_timeout:"Tiempo antes de reposo (ms). 0 para desactivar.",show_chip_row:'"Auto" oculta la fila si solo hay una entidad. "En men\xFA" mueve los chips. "En men\xFA en reposo" muestra los chips en l\xEDnea cuando est\xE1 activo pero los mueve al men\xFA cuando est\xE1 en reposo.',dim_chips:"Atenuar los chips en reposo para un aspecto m\xE1s limpio.",hold_to_pin:"Mantener pulsado para fijar en vez de pulsaci\xF3n corta.",always_show_group:"Los controles de agrupaci\xF3n r\xE1pida (+/-/estrella) estar\xE1n visibles por defecto al cargar la p\xE1gina. Todav\xEDa puedes cambiarlos manualmente mediante doble pulsaci\xF3n.",disable_autofocus:"Evitar que la b\xFAsqueda tome el foco autom\xE1ticamente.",search_within_filter:"Buscar dentro del filtro activo (Favoritos, etc.).",close_search_on_play:"Cerrar b\xFAsqueda al reproducir.",pin_search_headers:"Fijar encabezados de b\xFAsqueda al hacer scroll.",hide_search_headers_on_idle:"Ocultar encabezados de b\xFAsqueda en inactividad.",disable_mass:"Desactivar integraci\xF3n con Mass Queue.",swap_pause_stop:"Cambiar pausa por stop en dise\xF1o moderno.",show_album:"Mostrar el nombre del \xE1lbum junto al artista en los detalles del reproductor.",adaptive_controls:"Permitir que los botones se adapten al espacio.",hide_menu_player:"Ocultar nombre de entidad cuando est\xE1 en el men\xFA.",hide_reorder_progress:"Ocultar el indicador flotante de progreso de reordenaci\xF3n de la cola en la parte inferior.",adaptive_text:"Elegir qu\xE9 textos se adaptan al espacio.",collapse_expand:"Siempre contra\xEDdo activa el modo mini. Expandir al buscar expande temporalmente.",disable_mini_menu:"Vuelve a las listas est\xE1ndar en lugar de usar los nuevos men\xFAs de cuadr\xEDcula mini en el modo 'Siempre contra\xEDdo'.",idle_screen:"Elegir pantalla a mostrar en reposo.",hide_controls:"Seleccionar controles a ocultar.",hide_remote_buttons:"Seleccione botones para ocultar de la superposici\xF3n del mando a distancia.",hide_search_chips:"Ocultar chips de filtro de b\xFAsqueda.",hide_active_entity_on_idle:"Oculta la etiqueta de la entidad en la parte inferior de la tarjeta solo cuando el reproductor est\xE1 inactivo.",follow_active_entity:"La entidad de volumen seguir\xE1 a la activa.",search_limit_full:"M\xE1ximo de resultados (defecto: 20).",default_search_filter_full:"Elige qu\xE9 filtro est\xE1 activo por defecto cuando se abre la pantalla de b\xFAsqueda.",default_search_favorites:"Iniciar b\xFAsqueda con favoritos activos",result_sorting_full:"Elegir orden de resultados.",card_height_full:"Dejar vac\xEDo para altura autom\xE1tica.",control_layout_full:"Elegir entre dise\xF1o antiguo o moderno.",artwork_extend:"Extender portada bajo los chips.",artwork_extend_label:"Extender portada",no_artwork_overrides:"Sin reemplazos de portada configurados.",missing_art_match:"Se aplica cuando el medio seleccionado no proporciona car\xE1tula.",idle_image_match:"Se aplica cuando el reproductor est\xE1 inactivo y se muestra una imagen de reposo.",entity_current_hint:"Use 'entity_id: current' para el reproductor actual.",jinja_template_hint:"Plantilla Jinja para entity_id.",jinja_template_vol_hint:"Plantilla para entidad de volumen.",jinja_template_remote_hint:"Plantilla Jinja que resuelve un entity_id remoto (p.ej. remote.salon_tv):",not_available_alt_collapsed:"No disponible en modo contra\xEDdo.",not_available_collapsed:"No disponible si est\xE1 contra\xEDdo.",only_available_collapsed:"Solo disponible si est\xE1 contra\xEDdo.",only_available_mini_menu:"Solo disponible cuando 'Siempre contra\xEDdo' es verdadero y 'Expandir en la b\xFAsqueda' es falso",only_available_modern:"Solo disponible con dise\xF1o Moderno.",image_url_helper:"Ingrese una URL directa a una imagen o una ruta de archivo local",selected_entity_helper:"Helper de texto de entrada que se actualizar\xE1 con el ID de la entidad del reproductor de medios seleccionado actualmente.",select_entity_helper:"Helper de texto de entrada del que leer el ID de la entidad. La tarjeta seleccionar\xE1 autom\xE1ticamente el chip correspondiente.",sync_entity_type:"Elija qu\xE9 ID de entidad sincronizar con el helper (por defecto la entidad de Music Assistant si est\xE1 configurada).",disable_auto_select:"Evita que el chip de esta entidad se seleccione autom\xE1ticamente cuando comienza la reproducci\xF3n.",search_view:"Elegir entre una lista est\xE1ndar o una cuadr\xEDcula de tarjetas para los resultados de la b\xFAsqueda.",search_card_columns:"Especifica cu\xE1ntas columnas usar en la vista de tarjetas. El artwork se adaptar\xE1 autom\xE1ticamente.",card_type:"Elija el modo de tarjeta. 'Por defecto' es el reproductor de medios est\xE1ndar. 'B\xFAsqueda dedicada' convierte la tarjeta en una interfaz de b\xFAsqueda permanente.",always_show_lyrics:"Abrir autom\xE1ticamente la vista de letras al actualizar la p\xE1gina.",lyrics_source:"Music Assistant requiere la integraci\xF3n de mass_queue para obtener las letras de su motor de metadatos interno.",lyrics_pre_roll:"Ajusta el tiempo de resaltado de la letra. Los valores positivos lo aceleran, los negativos lo retrasan (por defecto: 0).",blurred_artwork:"Difuminar siempre la imagen de fondo",hide_collapsed_artwork:"Ocultar la imagen peque\xF1a a la derecha cuando la tarjeta est\xE9 contra\xEDda",show_idle_artwork_when_not_playing:"Cuando est\xE1 habilitado, al seleccionar una ficha que no se est\xE1 reproduciendo actualmente, se mostrar\xE1 la imagen de inactividad configurada en lugar de la car\xE1tula de reproducci\xF3n activa.",prefer_ma_metadata:"Utilizar siempre la entidad de Music Assistant emparejada para el t\xEDtulo de la pista, el artista y el arte, incluso si la entidad primaria est\xE1 reproduciendo.",show_volume_overlay:"Muestra brevemente un indicador de volumen grande sobre la car\xE1tula cuando cambia el nivel de volumen.",queue_controls_style:"Elige si mostrar un tirador de arrastre o botones de movimento individuales para los elementos de la cola."},titles:{edit_entity:"Editar entidad",edit_action:"Editar acci\xF3n",service_data:"Datos del servicio",add_artwork_override:"A\xF1adir reemplazo"},labels:{toggle_template_mode:"Alternar modo de plantilla",dim_chips:"Atenuar chips en reposo",hold_to_pin:"Mantener para fijar",always_show_group:"Grupo r\xE1pido por defecto",disable_autofocus:"Desactivar autofoco",keep_filters:"Mantener filtros",dismiss_on_play:"Cerrar al reproducir",pin_headers:"Fijar encabezados",hide_search_headers_on_idle:"Ocultar encabezados en inactividad",default_search_filter:"Filtro de b\xFAsqueda predeterminado",default_search_favorites:"Filtro de favoritos por defecto",disable_mass:"Desactivar Mass Queue",match_theme:"Seguir tema",alt_progress:"Barra de progreso alternativa",progress_bar_height:"Altura de la barra de progreso",display_timestamps:"Mostrar sellos de tiempo",swap_pause_stop:"Cambiar Pausa por Stop",show_album:"Mostrar nombre del \xE1lbum",adaptive_controls:"Tama\xF1o adaptativo",hide_active_entity:"Ocultar nombre de entidad activa",hide_active_entity_on_idle:"Ocultar etiqueta de entidad activa al estar inactivo",collapse_on_idle:"Contraer en reposo",hide_menu_player_toggle:"Ocultar reproductor del men\xFA",hide_reorder_progress_toggle:"Ocultar progreso de reordenaci\xF3n",always_collapsed:"Siempre contra\xEDdo",disable_mini_menu:"Desactivar men\xFAs de cuadr\xEDcula mini",expand_on_search:"Expandir al buscar",script_var:"Variable script (yamp_entity)",use_ma_template:"Usar plantilla MA",use_vol_template:"Usar plantilla Volumen",follow_active_entity:"Volumen sigue a entidad activa",use_url_path:"Usar URL o ruta",adaptive_text_elements:"Elementos para tama\xF1o de texto adaptativo",disable_auto_select:"Desactivar selecci\xF3n autom\xE1tica",always_show_lyrics:"Mostrar siempre las letras",lyrics_mode:"Modo de letras",lyrics_source:"Fuente de letras",lyrics_pre_roll:"Anticipo de letra (segundos)",blurred_artwork:"Imagen difuminada",hide_collapsed_artwork:"Ocultar imagen reducida",show_idle_artwork_when_not_playing:"Mostrar imagen de inactividad cuando no se reproduce",prefer_ma_metadata:"Preferir metadatos de Music Assistant",show_volume_overlay:"Mostrar superposici\xF3n de volumen"},fields:{artwork_fit:"Ajuste",artwork_position:"Posici\xF3n",artwork_hostname:"Host",match_field:"Campo",match_value:"Valor",size_percent:"Tama\xF1o (%)",object_fit:"Object Fit",idle_timeout:"Reposo (ms)",show_chip_row:"Mostrar chips",search_limit:"L\xEDmite de b\xFAsqueda",result_sorting:"Orden",vol_step:"Paso de volumen",card_height:"Altura (px)",control_layout:"Dise\xF1o",idle_image:"Imagen de reposo",image_url:"URL imagen",fallback_image_url:"URL de respaldo",move_to_main:"Mover a chips principales",move_to_menu:"Mover al men\xFA",delete_action:"Borrar acci\xF3n",volume_mode:"Modo volumen",idle_screen:"Pantalla reposo",name:"Nombre",hidden_controls:"Controles ocultos",hide_remote_buttons:"Botones del mando a distancia ocultos",ma_template:"Plantilla MA (Jinja)",hidden_chips:"Chips ocultos",vol_template:"Plantilla Volumen (Jinja)",icon:"Icono",action_type:"Tipo de acci\xF3n",menu_item:"Elemento de men\xFA",nav_path:"Ruta",service:"Servicio",service_data:"Datos",idle_image_entity:"Entidad imagen reposo",match_entity:"Entidad",ma_entity:"Entidad de Music Assistant",vol_entity:"Entidad de volumen",remote_entity:"Entidad de control remoto",remote_template:"Plantilla de entidad remota (Jinja)",selected_entity_helper:"Helper de entidad seleccionada",sync_entity_type:"Tipo de entidad a sincronizar",placement:"Colocaci\xF3n",card_trigger:"Activador de la tarjeta",search_view:"Vista de resultados de b\xFAsqueda",search_card_columns:"Columnas de tarjetas",card_type:"Tipo de tarjeta",appearance:"Apariencia",no_artwork_option:"Sin imagen",details_alignment:"Alineaci\xF3n de detalles",queue_controls_style:"Estilo de controles de cola"},action_types:{menu:"Abrir un elemento del men\xFA",service:"Llamar a un servicio",navigate:"Navegar",prev_entity:"Chip de entidad anterior",next_entity:"Chip de entidad siguiente",sync_selected_entity:"Sincronizar entidad seleccionada",select_entity:"Seleccionar entidad desde helper",toggle_lyrics:"Alternar superposici\xF3n de letras",remote_control:"Abrir superposici\xF3n de mando a distancia"},action_helpers:{sync_selected_entity:"Sincronizar entidad seleccionada \u2192",select_entity:"Seleccionar entidad \u2190",select_helper:"(seleccionar helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entidad de Music Assistant si est\xE1 configurada)",yamp_main_entity:"yamp_main_entity (Entidad principal del reproductor)",yamp_playback_entity:"yamp_playback_entity (Entidad de reproducci\xF3n activa actual)"},placements:{chip:"Chip de acci\xF3n",menu:"En el men\xFA",hidden:"Oculto (Toque en el arte)",replace_search:"Reemplazar B\xFAsqueda",replace_power:"Reemplazar Encendido",replace_mute:"Reemplazar Silencio",replace_favorite:"Reemplazar Favorito",not_triggerable:"No activable"},triggers:{none:"Ninguno",tap:"Toque",hold:"Mantener",double_tap:"Doble toque",swipe_left:"Deslizar a la izquierda",swipe_right:"Deslizar a la derecha"},search_view_options:{list:"Lista",card:"Tarjeta",card_minimal:"Tarjeta reducida"},queue_controls_style_options:{drag_handle:"Tirador de arrastre",icons:"Botones de movimiento"},card_type_options:{default:"Por defecto",search:"Buscar",group_players:"Agrupar",up_next:"A continuaci\xF3n",remote_control:"Control remoto"},appearance_options:{automatic:"Autom\xE1tico",light:"Claro",dark:"Oscuro"},artwork_fit:{default:"Global",cover:"Portada (por defecto)",contain:"Contener",fill:"Rellenar","scale-down":"Reducir","scaled-contain":"Contenido escalado","scaled-contain-alternate":"Contenido escalado alternativo",none:"Ninguno"},artwork_position:{default:"Global",top:"Arriba",center:"Centro",bottom:"Abajo"}},card:{sections:{details:"Detalles de reproducci\xF3n",menu:"Men\xFA y B\xFAsqueda",action_chips:"Chips de acci\xF3n",lyrics:"Letra"},media_controls:{shuffle:"Aleatorio",previous:"Anterior",play_pause:"Reproducir/Pausa",stop:"Detener",next:"Siguiente",repeat:"Repetir"},menu:{more_info:"M\xE1s info",search:"Buscar",source:"Fuente",remote_controls:"Mando a distancia",show_lyrics:"Mostrar letra",hide_lyrics:"Ocultar letra",transfer_queue:"Transferir cola",main_menu:"Men\xFA Principal",group_players:"Agrupar",up_next:"A continuaci\xF3n",remote_control:"Control remoto",select_entity:"Seleccionar",transfer_to:"Transferir a",no_players:"Sin reproductores MA."},remote:{title:"Mando a distancia",up:"Arriba",down:"Abajo",left:"Izquierda",right:"Derecha",select:"Seleccionar",back:"Atr\xE1s",menu:"Men\xFA",home:"Inicio",power:"Encendido"},grouping:{title:"Agrupar",sync_volume:"Sincronizar volumen",group_all:"Agrupar todos",ungroup_all:"Desagrupar todos",unavailable:"No disponible",no_players:"No agrupable.",master:"Maestro",joined:"Unido",available:"Disponible",current:"Actual",unjoin_from:"Desvincular de {master}",join_with:"Unirse a {master}"}},search:{favorites:"Favoritos",recently_played:"Reciente",next_up:"A continuaci\xF3n",recommendations:"Recomendaciones",radio_mode:"Modo Radio",show_track_options:"Mostrar opciones de canci\xF3n",play_similar:"Reproducir canciones similares",close:"Cerrar",no_results:"Sin resultados.",play_next:"Reprod. siguiente",replace_play:"Reemplazar y reproducir",replace:"Reemplazar cola",add_queue:"A\xF1adir al final",move_up:"Subir",move_down:"Bajar",move_next:"Pasar a siguiente",remove:"Quitar de cola",drag_to_reorder:"Arrastrar para reordenar",added:"\xA1A\xF1adido!",added_to_playlist:"\xA1A\xF1adido a la lista de reproducci\xF3n!",select_playlist:"Seleccionar lista de reproducci\xF3n para '{track}'",add_to_playlist:"A\xF1adir a la lista de reproducci\xF3n",select_track_for_playlist:"Seleccionar la canci\xF3n a a\xF1adir para '{track}' de {artist}",labels:{replace:"Remplazar",next:"Siguiente",replace_next:"Rempl. Sig.",add:"A\xF1adir",add_to_playlist:"A\xF1adir a la lista de reproducci\xF3n"},results:"resultados",result:"resultado",filters:{all:"Todo",artist:"Artista",album:"\xC1lbum",track:"Canci\xF3n",playlist:"Lista",radio:"Radio",music:"M\xFAsica",station:"Emisora",podcast:"P\xF3dcast",audiobook:"Audiolibro"},search_artist:"Buscar este artista",search_album:"Explorar pistas de este \xE1lbum",browse_album:"Explorar pistas de {album}",play_collection:"Reproducir esta colecci\xF3n",play_collection_error:"No se puede reproducir esta colecci\xF3n directamente",play_item:"Reproducir {item}"},lyrics:{finding:"Buscando letra...",none_found:"No se encontr\xF3 letra",not_available:"Letra no disponible",instrumental:"Pista instrumental",admin_only_mass:"La obtenci\xF3n de letras de Music Assistant es solo para usuarios administradores. Se recomienda cambiar a lrclib en la configuraci\xF3n de la tarjeta.",fallback_to_lrclib_non_admin:"Usuario no administrador detectado. Se utilizar\xE1 lrclib como respaldo para obtener las letras."},lyrics_sources:{mass_lrclib:"Music Assistant (Respaldo en LRCLIB)",mass:"Solo Music Assistant",lrclib:"Solo LRCLIB",lrclib_mass:"LRCLIB (Respaldo en Music Assistant)"},lyrics_modes:{default:"Predeterminado (Resaltar y desplazarse)",scroll:"Solo desplazarse",text:"Solo texto"}},Fc={common:{not_found:"Entit\xE9 non trouv\xE9e.",search:"Rechercher",power:"Alimentation",favorite:"Favori",loading:"Chargement...",no_results:"Aucun r\xE9sultat.",close:"Fermer",vol_up:"Monter le volume",vol_down:"Baisser le volume",media_player:"Lecteur Multim\xE9dia",edit_entity:"Modifier les param\xE8tres de l'entit\xE9",edit_action:"Modifier les param\xE8tres de l'action",mute:"Muet",unmute:"R\xE9tablir le son",seek:"Rechercher",volume:"Volume",play_now:"Lire maintenant",more_options:"Plus d'options",unavailable:"Indisponible",back:"Retour",cancel:"Annuler",reset_default:"R\xE9initialiser",unpin:"D\xE9s\xE9pingler",clear:"Effacer",album_art:"Illustration de l'album"},editor:{tabs:{entities:"Entit\xE9s",behavior:"Comportement",look_and_feel:"Apparence",artwork:"Illustrations",actions:"Actions"},search_placeholder:"Rechercher des options de configuration...",template_label:"Mod\xE8le de carte",templates:{custom:{label:"Personnalis\xE9 (Configuration d'origine)",description:"Votre configuration d'origine enti\xE8rement personnalis\xE9e."},large_modern:{label:"Grand YAMP moderne",description:"Un design moderne l\xE9g\xE8rement plus grand avec des contr\xF4les adaptatifs."},crisp_clean:{label:"\xC9pur\xE9",description:"Une disposition \xE9pur\xE9e avec pochette mise \xE0 l'\xE9chelle et contr\xF4les modernes."},minimal_mini:{label:"MINImal",description:"Une carte compacte sans pochette."},normal_mini:{label:"Mini Mode",description:"La carte compacte standard."},quick_and_easy:{label:"Pas le temps d'expliquer",description:"Con\xE7u pour la rapidit\xE9 avec des rang\xE9es de puces persistantes et un regroupement rapide."},dedicated_search:{label:"Tout sur la recherche",description:"Une carte de recherche autonome sans le lecteur multim\xE9dia principal."},dedicated_grouping:{label:"Th\xE9rapie de groupe",description:"Une carte autonome de regroupement de lecteurs. N\xE9cessite plusieurs entit\xE9s configur\xE9es."},huge_yamp:{label:"C'est un \xE9norme YAMP !",description:"Contr\xF4les maximis\xE9s, grand texte et barre de progression imposante pour une visibilit\xE9 \xE0 distance."}},placeholders:{search:"Rechercher de la musique..."},sections:{artwork:{general:{title:"Param\xE8tres G\xE9n\xE9raux",description:"Contr\xF4les globaux pour l'affichage des illustrations."},idle:{title:"Illustration au Repos",description:"Afficher une image statique lorsque rien n'est en lecture."},overrides:{title:"Remplacements d'Illustrations",description:"Les remplacements sont \xE9valu\xE9s de haut en bas. Glissez pour r\xE9ordonner."}},entities:{title:"Entit\xE9s*",description:"Ajoutez les lecteurs multim\xE9dias que vous souhaitez contr\xF4ler. Glissez pour r\xE9ordonner."},behavior:{idle_chips:{title:"Veille & Jetons",description:"Choisissez quand la carte passe en mode veille et comment les jetons se comportent."},interactions_search:{title:"Interactions & Recherche",description:"Affinez la fa\xE7on dont les entit\xE9s sont \xE9pingl\xE9es et le nombre de r\xE9sultats."},lyrics:{title:"Paroles",description:"Configurez la fa\xE7on dont les paroles sont affich\xE9es et quand elles apparaissent."}},look_and_feel:{theme_layout:{title:"Th\xE8me & Mise en page",description:"Adaptez au style de votre tableau de bord et contr\xF4lez l'empreinte globale."},controls_typography:{title:"Commandes & Typographie",description:"Ajustez la taille des boutons, les \xE9tiquettes et le texte adaptatif."},collapsed_idle:{title:"\xC9tats R\xE9duits & Veille",description:"Contr\xF4lez quand la carte se r\xE9duit et quelles vues s'affichent en veille."}},actions:{title:"Actions",description:"Cr\xE9ez les jetons d'action. Glissez pour r\xE9ordonner, cliquez sur le crayon pour configurer."}},subtitles:{idle_timeout:"Temps en millisecondes avant la mise en veille. 0 pour d\xE9sactiver.",show_chip_row:'"Auto" masque la barre de jetons si une seule entit\xE9 est configur\xE9e. "Dans le Menu" d\xE9place les jetons. "Dans le menu au repos" affiche les jetons en ligne lorsque actif mais les d\xE9place dans le menu au repos.',dim_chips:"Assombrir les jetons en mode veille pour un look plus \xE9pur\xE9.",hold_to_pin:"Appui long pour \xE9pingler au lieu d'un appui court.",always_show_group:"Les contr\xF4les de groupement rapide (+/-/\xE9toile) seront visibles par d\xE9faut au chargement de la page. Vous pouvez toujours les basculer manuellement via un double appui.",disable_autofocus:"Emp\xEAcher la recherche de prendre le focus automatiquement.",search_within_filter:"Rechercher dans le filtre actif actuel (Favoris, etc.).",close_search_on_play:"Fermer automatiquement la recherche \xE0 la lecture.",pin_search_headers:"Garder la recherche et les filtres fixes en haut.",hide_search_headers_on_idle:"Masquer la recherche et les filtres en mode veille.",disable_mass:"D\xE9sactiver l'int\xE9gration Mass Queue.",swap_pause_stop:"Remplacer le bouton pause par stop en mode moderne.",show_album:"Afficher le nom de l'album \xE0 c\xF4t\xE9 de l'artiste dans les d\xE9tails du lecteur.",adaptive_controls:"Laisser les boutons s'adapter \xE0 l'espace disponible.",hide_menu_player:"Masquer l'\xE9tiquette de l'entit\xE9 en bas quand les jetons sont dans le menu.",hide_reorder_progress:"Masquer l'indicateur flottant de progression de r\xE9organisation de la file d'attente en bas.",adaptive_text:"Choisir quels textes doivent s'adapter \xE0 l'espace.",collapse_expand:"Toujours r\xE9duit cr\xE9e un mini lecteur. Agrandir \xE0 la Recherche agrandit temporairement.",disable_mini_menu:"Revenir aux listes standards au lieu d'utiliser les nouveaux mini menus en grille en mode 'Toujours r\xE9duit'.",idle_screen:"Choisir l'\xE9cran \xE0 afficher automatiquement en veille.",hide_controls:"S\xE9lectionner les commandes \xE0 masquer pour cette entit\xE9.",hide_remote_buttons:"S\xE9lectionnez les boutons \xE0 masquer de la t\xE9l\xE9commande.",hide_search_chips:"Masquer des jetons de filtrage sp\xE9cifiques.",hide_active_entity_on_idle:"Masque l'\xE9tiquette de l'entit\xE9 au bas de la carte uniquement lorsque le lecteur est en veille.",follow_active_entity:"L'entit\xE9 de volume suivra automatiquement l'entit\xE9 active.",search_limit_full:"Nombre maximum de r\xE9sultats (d\xE9faut: 20).",default_search_filter_full:"Choisissez quel filtre est actif par d\xE9faut \xE0 l'ouverture de la recherche.",default_search_favorites:"D\xE9marrer la recherche avec les favoris actifs",result_sorting_full:"Choisir l'ordre des r\xE9sultats. Par d\xE9faut conserve l'ordre source.",card_height_full:"Laisser vide pour une hauteur automatique.",control_layout_full:"Choisir entre l'ancienne mise en page ou la moderne.",artwork_extend:"\xC9tendre l'illustration sous les lignes de jetons.",artwork_extend_label:"\xC9tendre l'illustration",no_artwork_overrides:"Aucun remplacement d'illustration configur\xE9.",missing_art_match:"S'applique lorsque le m\xE9dia s\xE9lectionn\xE9 ne fournit aucune illustration.",idle_image_match:"S'applique lorsque le lecteur est en veille et qu'une image de veille est affich\xE9e.",entity_current_hint:"Utilisez 'entity_id: current' pour cibler le lecteur actuel.",jinja_template_hint:"Entrez un mod\xE8le Jinja qui renvoie un entity_id.",jinja_template_vol_hint:"Mod\xE8le pour l'entit\xE9 de volume.",jinja_template_remote_hint:"Mod\xE8le Jinja r\xE9solvant un entity_id de t\xE9l\xE9commande (ex. remote.salon_tv) :",not_available_alt_collapsed:"Non disponible en mode 'Toujours r\xE9duit'.",not_available_collapsed:"Non disponible si 'Toujours r\xE9duit' est activ\xE9.",only_available_collapsed:"Uniquement disponible si 'Toujours r\xE9duit' est activ\xE9.",only_available_mini_menu:"Uniquement disponible lorsque 'Toujours r\xE9duit' est vrai et 'D\xE9velopper lors de la recherche' est faux",only_available_modern:"Uniquement disponible avec la mise en page Moderne.",image_url_helper:"Entrez une URL directe vers une image ou un chemin de fichier local",selected_entity_helper:"Helper de texte d'entr\xE9e qui sera mis \xE0 jour avec l'ID de l'entit\xE9 du lecteur multim\xE9dia actuellement s\xE9lectionn\xE9.",select_entity_helper:"Helper de texte d'entr\xE9e \xE0 partir duquel lire l'ID de l'entit\xE9. La carte s\xE9lectionnera automatiquement le jeton correspondant.",sync_entity_type:"Choisissez quel ID d'entit\xE9 synchroniser avec le helper (par d\xE9faut l'entit\xE9 Music Assistant si configur\xE9e).",disable_auto_select:"Emp\xEAche le jeton de cette entit\xE9 d'\xEAtre automatiquement s\xE9lectionn\xE9 au d\xE9but de la lecture.",search_view:"Choisissez entre une liste standard ou une grille de cartes pour les r\xE9sultats de recherche.",search_card_columns:"Sp\xE9cifiez le nombre de colonnes \xE0 utiliser dans la vue carte. L'illustration s'adaptera automatiquement.",card_type:"Choisissez le mode de la carte. 'Par d\xE9faut' est le lecteur multim\xE9dia standard. 'Recherche d\xE9di\xE9e' fait de la carte une interface de recherche permanente.",always_show_lyrics:"Ouvrir automatiquement la vue des paroles lors du rafra\xEEchissement de la page.",lyrics_source:"Music Assistant n\xE9cessite l'int\xE9gration mass_queue pour r\xE9cup\xE9rer les paroles de son moteur de m\xE9tadonn\xE9es interne.",lyrics_pre_roll:"Ajuste le timing de mise en \xE9vidence des paroles. Les valeurs positives l'acc\xE9l\xE8rent, les n\xE9gatives le ralentissent (par d\xE9faut : 0).",blurred_artwork:"Toujours flouter l'image d'arri\xE8re-plan",hide_collapsed_artwork:"Masquer l'image r\xE9duite sur la droite lorsque la carte est repli\xE9e",show_idle_artwork_when_not_playing:"Lorsqu'il est activ\xE9, la s\xE9lection d'un badge qui n'est pas en cours de lecture affichera l'image d'inactivit\xE9 configur\xE9e \xE0 la place de l'illustration de lecture active.",prefer_ma_metadata:"Toujours utiliser l'entit\xE9 Music Assistant associ\xE9e pour le titre de la piste, l'artiste et l'image, m\xEAme si l'entit\xE9 principale est en cours de lecture.",show_volume_overlay:"Affiche bri\xE8vement un grand indicateur de volume sur l'illustration lorsque le niveau de volume change.",queue_controls_style:"Choisissez d'afficher une poign\xE9e de glissement ou des boutons de d\xE9placement individuels pour les \xE9l\xE9ments de la file d'attente."},titles:{edit_entity:"Modifier l'entit\xE9",edit_action:"Modifier l'action",service_data:"Donn\xE9es du service",add_artwork_override:"Ajouter un remplacement"},labels:{toggle_template_mode:"Basculer le mode mod\xE8le",dim_chips:"Assombrir les jetons en veille",hold_to_pin:"Maintenir pour \xE9pingler",always_show_group:"Groupe rapide par d\xE9faut",disable_autofocus:"D\xE9sactiver l'autofocus",keep_filters:"Garder les filtres",dismiss_on_play:"Fermer en lecture",pin_headers:"\xC9pingler les en-t\xEAtes",hide_search_headers_on_idle:"Masquer les en-t\xEAtes en veille",default_search_filter:"Filtre de recherche par d\xE9faut",default_search_favorites:"Filtre des favoris par d\xE9faut",disable_mass:"D\xE9sactiver Mass Queue",match_theme:"Suivre le th\xE8me",alt_progress:"Barre de progression alternative",progress_bar_height:"Hauteur de la barre de progression",display_timestamps:"Afficher les horodatages",swap_pause_stop:"Remplacer Pause par Stop",show_album:"Afficher le nom de l'album",adaptive_controls:"Taille adaptative",hide_active_entity:"Masquer l'\xE9tiquette active",hide_active_entity_on_idle:"Masquer l'\xE9tiquette de l'entit\xE9 active en mode veille",collapse_on_idle:"R\xE9duire en veille",hide_menu_player_toggle:"Masquer le lecteur menu",hide_reorder_progress_toggle:"Masquer la progression de r\xE9organisation",always_collapsed:"Toujours r\xE9duit",disable_mini_menu:"D\xE9sactiver les mini menus en grille",expand_on_search:"Agrandir en recherche",script_var:"Variable script (yamp_entity)",use_ma_template:"Utiliser mod\xE8le MA",use_vol_template:"Utiliser mod\xE8le Volume",follow_active_entity:"Le volume suit l'entit\xE9 active",use_url_path:"Utiliser URL ou chemin",adaptive_text_elements:"\xC9l\xE9ments de texte adaptatif",disable_auto_select:"D\xE9sactiver la s\xE9lection automatique",always_show_lyrics:"Toujours afficher les paroles",lyrics_mode:"Mode des paroles",lyrics_source:"Source des paroles",lyrics_pre_roll:"Pr\xE9-roll des paroles (secondes)",blurred_artwork:"Image flout\xE9e",hide_collapsed_artwork:"Masquer l'image r\xE9duite",show_idle_artwork_when_not_playing:"Afficher l'image d'inactivit\xE9 si pas de lecture",prefer_ma_metadata:"Pr\xE9f\xE9rer les m\xE9tadonn\xE9es Music Assistant",show_volume_overlay:"Afficher la superposition de volume"},fields:{artwork_fit:"Ajustement",artwork_position:"Position",artwork_hostname:"H\xF4te",match_field:"Champ de correspondance",match_value:"Valeur de correspondance",size_percent:"Taille (%)",object_fit:"Object Fit",idle_timeout:"Veille (ms)",show_chip_row:"Afficher les jetons",search_limit:"Limite de r\xE9sultats",result_sorting:"Tri des r\xE9sultats",vol_step:"Pas du volume",card_height:"Hauteur (px)",control_layout:"Mise en page",idle_image:"Image de veille",image_url:"URL image",fallback_image_url:"URL de secours",move_to_main:"Mettre dans les jetons principaux",move_to_menu:"Mettre dans le menu",delete_action:"Supprimer l'action",volume_mode:"Mode volume",idle_screen:"\xC9cran de veille",name:"Nom",hidden_controls:"Commandes masqu\xE9es",hide_remote_buttons:"Boutons de t\xE9l\xE9commande masqu\xE9s",ma_template:"Mod\xE8le MA (Jinja)",hidden_chips:"Jetons masqu\xE9s",vol_template:"Mod\xE8le Volume (Jinja)",icon:"Ic\xF4ne",action_type:"Type d'action",menu_item:"\xC9l\xE9ment du menu",nav_path:"Chemin navigation",service:"Service",service_data:"Donn\xE9es",idle_image_entity:"Entit\xE9 image veille",match_entity:"Entit\xE9 de correspondance",ma_entity:"Entit\xE9 Music Assistant",vol_entity:"Entit\xE9 de volume",remote_entity:"Entit\xE9 de t\xE9l\xE9commande",remote_template:"Mod\xE8le d'entit\xE9 de t\xE9l\xE9commande (Jinja)",selected_entity_helper:"Helper d'entit\xE9 s\xE9lectionn\xE9e",sync_entity_type:"Type d'entit\xE9 \xE0 synchroniser",placement:"Placement",card_trigger:"D\xE9clencheur de carte",search_view:"Vue des r\xE9sultats de recherche",search_card_columns:"Nombre de colonnes",card_type:"Type de carte",appearance:"Apparence",no_artwork_option:"Pas d'illustration",details_alignment:"Alignement des d\xE9tails",queue_controls_style:"Style des commandes de file d'attente"},action_types:{menu:"Ouvrir un \xE9l\xE9ment de menu",service:"Appeler un service",navigate:"Naviguer",prev_entity:"Puce de l'entit\xE9 pr\xE9c\xE9dente",next_entity:"Puce de l'entit\xE9 suivante",sync_selected_entity:"Synchroniser l'entit\xE9 s\xE9lectionn\xE9e",select_entity:"S\xE9lectionner l'entit\xE9 depuis le helper",toggle_lyrics:"Activer/D\xE9sactiver la superposition des paroles",remote_control:"Ouvrir l'overlay t\xE9l\xE9commande"},action_helpers:{sync_selected_entity:"Synchroniser l'entit\xE9 s\xE9lectionn\xE9e \u2192",select_entity:"S\xE9lectionner l'entit\xE9 \u2190",select_helper:"(s\xE9lectionner helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entit\xE9 Music Assistant si configur\xE9e)",yamp_main_entity:"yamp_main_entity (Entit\xE9 principale du lecteur)",yamp_playback_entity:"yamp_playback_entity (Entit\xE9 de lecture active actuelle)"},placements:{chip:"Puce d'action",menu:"Dans le menu",hidden:"Masqu\xE9 (Appui sur l'image)",replace_search:"Remplacer Recherche",replace_power:"Remplacer Alimentation",replace_mute:"Remplacer Muet",replace_favorite:"Remplacer Favori",not_triggerable:"Non d\xE9clenchable"},triggers:{none:"Aucun",tap:"Appui",hold:"Maintenir",double_tap:"Double appui",swipe_left:"Glisser vers la gauche",swipe_right:"Glisser vers la droite"},search_view_options:{list:"Liste",card:"Carte",card_minimal:"Carte minimale"},queue_controls_style_options:{drag_handle:"Poign\xE9e de glissement",icons:"Boutons de d\xE9placement"},card_type_options:{default:"Par d\xE9faut",search:"Rechercher",group_players:"Grouper les lecteurs",up_next:"\xC0 suivre",remote_control:"T\xE9l\xE9commande"},appearance_options:{automatic:"Automatique",light:"Clair",dark:"Sombre"},artwork_fit:{default:"Global",cover:"Couverture (par d\xE9faut)",contain:"Contenir",fill:"Remplir","scale-down":"R\xE9duire","scaled-contain":"Contenir mis \xE0 l'\xE9chelle","scaled-contain-alternate":"Contenir mis \xE0 l'\xE9chelle alternatif",none:"Aucun"},artwork_position:{default:"Global",top:"Haut",center:"Centre",bottom:"Bas"}},card:{sections:{details:"D\xE9tails lecture",menu:"Menu & Recherche",action_chips:"Jetons d'action",lyrics:"Paroles"},media_controls:{shuffle:"Al\xE9atoire",previous:"Pr\xE9c\xE9dent",play_pause:"Lecture/Pause",stop:"Arr\xEAt",next:"Suivant",repeat:"R\xE9p\xE9ter"},menu:{more_info:"Plus d'infos",search:"Rechercher",source:"Source",remote_controls:"T\xE9l\xE9commande",show_lyrics:"Afficher les paroles",hide_lyrics:"Masquer les paroles",transfer_queue:"Transf\xE9rer la file",main_menu:"Menu Principal",group_players:"Grouper les lecteurs",up_next:"\xC0 suivre",remote_control:"T\xE9l\xE9commande",select_entity:"Choisir pour plus d'infos",transfer_to:"Transf\xE9rer vers",no_players:"Aucun lecteur MA disponible."},remote:{title:"T\xE9l\xE9commande",up:"Haut",down:"Bas",left:"Gauche",right:"Droite",select:"S\xE9lectionner",back:"Retour",menu:"Menu",home:"Accueil",power:"Alimentation"},grouping:{title:"Grouper les lecteurs",sync_volume:"Synchroniser volume",group_all:"Grouper tout",ungroup_all:"D\xE9grouper tout",unavailable:"Lecteur indisponible",no_players:"Aucun lecteur groupable.",master:"Ma\xEEtre",joined:"Li\xE9",available:"Disponible",current:"Actuel",unjoin_from:"Se d\xE9solidariser de {master}",join_with:"Se joindre \xE0 {master}"}},search:{favorites:"Favoris",recently_played:"R\xE9cemment lus",next_up:"\xC0 suivre",recommendations:"Recommandations",radio_mode:"Mode Radio",show_track_options:"Afficher les options du titre",play_similar:"Lire des chansons similaires",close:"Fermer la recherche",no_results:"Aucun r\xE9sultat.",play_next:"Lire apr\xE8s",replace_play:"Remplacer et lire",replace:"Remplacer file",add_queue:"Ajouter \xE0 la fin",move_up:"Monter",move_down:"Descendre",move_next:"Passer au suivant",remove:"Retirer de la file",drag_to_reorder:"Glisser pour r\xE9organiser",added:"Ajout\xE9 \xE0 la file !",added_to_playlist:"Ajout\xE9 \xE0 la playlist !",select_playlist:"S\xE9lectionner une playlist pour '{track}'",add_to_playlist:"Ajouter \xE0 la playlist",select_track_for_playlist:"S\xE9lectionner le titre \xE0 ajouter pour '{track}' par {artist}",labels:{replace:"Remplacer",next:"Suivant",replace_next:"Rempl. Suivant",add:"Ajouter",add_to_playlist:"Ajouter \xE0 la playlist"},results:"r\xE9sultats",result:"r\xE9sultat",filters:{all:"Tout",artist:"Artiste",album:"Album",track:"Titre",playlist:"Playlist",radio:"Radio",music:"Musique",station:"Station",podcast:"Podcast",audiobook:"Livre audio"},search_artist:"Chercher cet artiste",search_album:"Parcourir les pistes de cet album",browse_album:"Parcourir les titres de {album}",play_collection:"Lire cette collection",play_collection_error:"Impossible de lire cette collection directement",play_item:"Lire {item}"},lyrics:{finding:"Recherche des paroles...",none_found:"Aucune parole trouv\xE9e",not_available:"Paroles non disponibles",instrumental:"Piste instrumentale",admin_only_mass:"La r\xE9cup\xE9ration des paroles via Music Assistant est r\xE9serv\xE9e aux administrateurs. Il est recommand\xE9 de passer \xE0 lrclib dans la configuration de la carte.",fallback_to_lrclib_non_admin:"Utilisateur non administrateur d\xE9tect\xE9. Utilisation de lrclib pour la r\xE9cup\xE9ration des paroles."},lyrics_sources:{mass_lrclib:"Music Assistant (Repli sur LRCLIB)",mass:"Music Assistant uniquement",lrclib:"LRCLIB uniquement",lrclib_mass:"LRCLIB (Repli sur Music Assistant)"},lyrics_modes:{default:"Par d\xE9faut (Surligner et faire d\xE9filer)",scroll:"D\xE9filement uniquement",text:"Texte uniquement"}},Dc={common:{not_found:"Entit\xE0 non trovata.",search:"Cerca",power:"Accensione",favorite:"Preferito",loading:"Caricamento...",no_results:"Nessun risultato.",close:"Chiudi",vol_up:"Volume su",vol_down:"Volume gi\xF9",media_player:"Lettore multimediale",edit_entity:"Modifica impostazioni entit\xE0",edit_action:"Modifica impostazioni azione",mute:"Muto",unmute:"Riattiva audio",seek:"Cerca",volume:"Volume",play_now:"Riproduci ora",more_options:"Altre opzioni",unavailable:"Non disponibile",back:"Indietro",cancel:"Annulla",reset_default:"Ripristina predefiniti",unpin:"Rimuovi pin",clear:"Cancella",album_art:"Copertina dell'album"},editor:{tabs:{entities:"Entit\xE0",behavior:"Comportamento",look_and_feel:"Aspetto",artwork:"Copertina",actions:"Azioni"},search_placeholder:"Cerca opzioni di configurazione...",template_label:"Modello di scheda",templates:{custom:{label:"Personalizzato (Configurazione originale)",description:"La tua configurazione originale completamente personalizzata."},large_modern:{label:"YAMP moderno e grande",description:"Un design moderno leggermente pi\xF9 grande con controlli adattivi."},crisp_clean:{label:"Pulito",description:"Un layout pulito con copertina ridimensionata e controlli moderni."},minimal_mini:{label:"MINImal",description:"Una scheda compatta senza copertina."},normal_mini:{label:"Mini Mode",description:"La scheda compatta standard."},quick_and_easy:{label:"Niente tempo da perdere",description:"Progettato per la velocit\xE0 con righe di chip persistenti e raggruppamento rapido."},dedicated_search:{label:"Tutto sulla ricerca",description:"Una scheda di ricerca autonoma senza il lettore multimediale principale."},dedicated_grouping:{label:"Terapia di gruppo",description:"Una scheda di raggruppamento lettori autonoma. Richiede pi\xF9 entit\xE0 configurate."},huge_yamp:{label:"Questo \xE8 un enorme YAMP!",description:"Controlli ingranditi, testo grande e una barra di avanzamento massiccia per la visione a distanza."}},placeholders:{search:"Cerca musica..."},sections:{artwork:{general:{title:"Impostazioni generali",description:"Controlli globali per la copertina."},idle:{title:"Copertina in riposo",description:"Mostra un'immagine statica quando non c'\xE8 riproduzione."},overrides:{title:"Override copertina",description:"Gli override sono valutati dall'alto in basso."}},entities:{title:"Entit\xE0*",description:"Aggiungi i lettori da controllare."},behavior:{idle_chips:{title:"Riposo e chip",description:"Scegli quando andare in riposo."},interactions_search:{title:"Interazioni e ricerca",description:"Ajusta il fissaggio delle entit\xE0."},lyrics:{title:"Testi",description:"Configura come vengono visualizzati i testi e quando appaiono."}},look_and_feel:{theme_layout:{title:"Tema e layout",description:"Adatta allo stile del dashboard."},controls_typography:{title:"Controlli e tipografia",description:"Ajusta bottoni e etichette."},collapsed_idle:{title:"Stati contratto e riposo",description:"Controlla il contratto della scheda."}},actions:{title:"Azioni",description:"Crea chip azione."}},subtitles:{idle_timeout:"Tempo prima del riposo (ms). 0 per disabilitare.",show_chip_row:`"Auto" nasconde la riga se c'\xE8 una sola entit\xE0. "Nel menu" sposta i chip nel menu. "Nel menu in inattivit\xE0" mostra i chip in linea quando attivo ma li sposta nel menu quando inattivo.`,dim_chips:"Appanna i chip in riposo per un aspetto pi\xF9 pulito.",hold_to_pin:"Tieni premuto per fissare invece di un tocco breve.",always_show_group:"I controlli di raggruppamento rapido (+/-/stella) saranno visibili per impostazione predefinita al caricamento della pagina. Puoi comunque attivarli manualmente tramite doppio tocco.",disable_autofocus:"Evita che la ricerca prenda il focus automaticamente.",search_within_filter:"Cerca nel filtro attivo (Preferiti, ecc.).",close_search_on_play:"Chiudi ricerca alla riproduzione.",pin_search_headers:"Fissa le intestazioni di ricerca durante lo scorrimento.",hide_search_headers_on_idle:"Nascondi la ricerca e i filtri quando inattivo.",disable_mass:"Disabilita integrazione Mass Queue.",swap_pause_stop:"Sostituisci pausa con stop nel design moderno.",show_album:"Visualizza il nome dell'album accanto all'artista nei dettagli del lettore.",adaptive_controls:"Permetti ai pulsanti di adattarsi allo spazio.",hide_menu_player:"Nascondi nome entit\xE0 quando \xE8 nel menu.",hide_reorder_progress:"Nascondi l'indicatore mobile di avanzamento del riordinamento della coda in basso.",adaptive_text:"Scegli quali testi si adattano allo spazio.",collapse_expand:"Sempre contratto attiva il modo mini. Espandi alla ricerca espande temporaneamente.",disable_mini_menu:"Torna agli elenchi standard invece di usare i nuovi mini menu a griglia in modalit\xE0 'Sempre compresso'.",idle_screen:"Scegli schermata da mostrare in riposo.",hide_controls:"Seleziona controlli da nascondere.",hide_remote_buttons:"Seleziona i pulsanti da nascondere dal telecomando.",hide_search_chips:"Nascondi chip di filtro ricerca.",hide_active_entity_on_idle:"Nasconde l'etichetta dell'entit\xE0 in fondo alla scheda solo quando il lettore \xE8 inattivo.",follow_active_entity:"L'entit\xE0 volume seguir\xE0 quella attiva.",search_limit_full:"Massimo risultati (default: 20).",default_search_filter_full:"Scegli quale filtro \xE8 attivo per impostazione predefinita all'apertura della ricerca.",default_search_favorites:"Inizia ricerca con preferiti attivi",result_sorting_full:"Scegli ordine risultati.",card_height_full:"Lascia vuoto per altezza automatica.",control_layout_full:"Scegli tra design vecchio o moderno.",artwork_extend:"Estendi copertina sotto i chip.",artwork_extend_label:"Estendi copertina",no_artwork_overrides:"Nessun override copertina configurato.",missing_art_match:"Si applica quando il media selezionato non fornisce alcuna copertina.",idle_image_match:"Si applica quando il lettore \xE8 inattivo e viene visualizzata un'immagine di inattivit\xE0.",entity_current_hint:"Usa 'entity_id: current' per il lettore attuale.",jinja_template_hint:"Modello Jinja per entity_id.",jinja_template_vol_hint:"Modello per entit\xE0 volume.",jinja_template_remote_hint:"Modello Jinja che restituisce un entity_id telecomando (es. remote.salotto_tv):",not_available_alt_collapsed:"Non disponibile in modo contratto.",not_available_collapsed:"Non disponibile se contratto.",only_available_collapsed:"Solo disponibile se contratto.",only_available_mini_menu:"Disponibile solo quando 'Sempre compresso' \xE8 vero ed 'Espandi in ricerca' \xE8 falso",only_available_modern:"Solo disponibile con layout Moderno.",image_url_helper:"Inserisci un URL diretto a un'immagine o un percorso file locale",selected_entity_helper:"Helper di testo di input che verr\xE0 aggiornato con l'ID dell'entit\xE0 del lettore multimediale attualmente selezionato.",select_entity_helper:"Helper di testo di input da cui leggere l'ID dell'entit\xE0. La scheda selezioner\xE0 automaticamente il chip corrispondente.",sync_entity_type:"Scegli quale ID entit\xE0 sincronizzare con l'helper (predefinito l'entit\xE0 Music Assistant se configurata).",disable_auto_select:"Evita che il chip di questa entit\xE0 venga selezionato automaticamente all'inizio della riproduzione.",search_view:"Scegli tra una lista standard o una griglia di schede per i risultati della ricerca.",search_card_columns:"Specifica quante colonne utilizzare nella vista a schede. La copertina si adatter\xE0 automaticamente.",card_type:"Scegli la modalit\xE0 della scheda. 'Predefinito' \xE8 il lettore multimediale standard. 'Ricerca dedicata' rende la scheda un'interfaccia di ricerca permanente.",always_show_lyrics:"Apri automaticamente la visualizzazione dei testi quando la pagina viene aggiornata.",lyrics_source:"Music Assistant richiede l'integrazione mass_queue per recuperare i testi dal suo motore di metadati interno.",lyrics_pre_roll:"Sposta il tempismo dell'evidenziazione dei testi. I valori positivi lo accelerano, quelli negativi lo ritardano (predefinito: 0).",blurred_artwork:"Sfoca sempre l'immagine di sfondo",hide_collapsed_artwork:"Nascondi l'immagine piccola a destra quando la scheda \xE8 compressa",show_idle_artwork_when_not_playing:"Se abilitato, selezionando un chip che non \xE8 attualmente in riproduzione verr\xE0 mostrata l'immagine inattiva configurata invece della copertina di riproduzione attiva.",prefer_ma_metadata:"Utilizza sempre l'entit\xE0 Music Assistant associata per il titolo del brano, l'artista e l'artwork, anche se l'entit\xE0 principale \xE8 in riproduzione.",show_volume_overlay:"Visualizza brevemente un grande indicatore del volume sopra la copertina quando il livello del volume cambia.",queue_controls_style:"Scegli se mostrare una maniglia di trascinamento o pulsanti di movimento singoli per gli elementi della coda."},titles:{edit_entity:"Modifica entit\xE0",edit_action:"Modifica azione",service_data:"Dati servizio",add_artwork_override:"Aggiungi override"},labels:{toggle_template_mode:"Attiva/disattiva modalit\xE0 modello",dim_chips:"Appanna chip in riposo",hold_to_pin:"Tieni premuto per fissare",always_show_group:"Gruppo rapido predefinito",disable_autofocus:"Disabilita autofocus",keep_filters:"Mantieni filtri",dismiss_on_play:"Chiudi alla riproduzione",pin_headers:"Fissa intestazioni",hide_search_headers_on_idle:"Nascondi intestazioni in inattivit\xE0",default_search_filter:"Filtro di ricerca predefinito",default_search_favorites:"Filtro preferiti predefinito",disable_mass:"Disabilita Mass Queue",match_theme:"Segui tema",alt_progress:"Barra progresso alternativa",progress_bar_height:"Altezza barra di avanzamento",display_timestamps:"Mostra timestamp",swap_pause_stop:"Sostituisci Pausa con Stop",show_album:"Mostra nome album",adaptive_controls:"Dimensione adattativa",hide_active_entity:"Nascondi nome entit\xE0 attiva",hide_active_entity_on_idle:"Nascondi etichetta entit\xE0 attiva quando inattivo",collapse_on_idle:"Contrai in riposo",hide_menu_player_toggle:"Nascondi lettore menu",hide_reorder_progress_toggle:"Nascondi avanzamento riordinamento",always_collapsed:"Sempre contratto",disable_mini_menu:"Disabilita i mini menu a griglia",expand_on_search:"Espandi alla ricerca",script_var:"Variabile script (yamp_entity)",use_ma_template:"Usa modello MA",use_vol_template:"Usa modello Volume",follow_active_entity:"Volume segue entit\xE0 attiva",use_url_path:"Usa URL o percorso",adaptive_text_elements:"Elementi per dimensione testo adattiva",disable_auto_select:"Disabilita selezione automatica",always_show_lyrics:"Mostra sempre i testi",lyrics_mode:"Modalit\xE0 testi",lyrics_source:"Sorgente testi",lyrics_pre_roll:"Pre-roll testi (secondi)",blurred_artwork:"Immagine sfocata",hide_collapsed_artwork:"Nascondi immagine contratta",show_idle_artwork_when_not_playing:"Mostra immagine inattiva quando non in riproduzione",prefer_ma_metadata:"Preferisci i metadati di Music Assistant",show_volume_overlay:"Mostra overlay volume"},fields:{artwork_fit:"Adattamento",artwork_position:"Posizione",artwork_hostname:"Host",match_field:"Campo",match_value:"Valore",size_percent:"Dimensione (%)",object_fit:"Object Fit",idle_timeout:"Riposo (ms)",show_chip_row:"Mostra chip",search_limit:"Limite ricerca",result_sorting:"Ordine",vol_step:"Passo volume",card_height:"Altezza (px)",control_layout:"Design",idle_image:"Immagine di inattivit\xE0",image_url:"URL immagine",fallback_image_url:"URL fallback",move_to_main:"Sposta in chip principali",move_to_menu:"Sposta nel menu",delete_action:"Elimina azione",volume_mode:"Modo volume",idle_screen:"Schermo riposo",name:"Nome",hidden_controls:"Controlli nascosti",hide_remote_buttons:"Pulsanti del telecomando nascosti",ma_template:"Modello MA (Jinja)",hidden_chips:"Chip nascosti",vol_template:"Modello Volume (Jinja)",icon:"Icona",action_type:"Tipo azione",menu_item:"Elemento menu",nav_path:"Percorso",service:"Servizio",service_data:"Dati",idle_image_entity:"Entit\xE0 immagine riposo",match_entity:"Entit\xE0",ma_entity:"Entit\xE0 Music Assistant",vol_entity:"Entit\xE0 di volume",remote_entity:"Entit\xE0 telecomando",remote_template:"Template entit\xE0 telecomando (Jinja)",selected_entity_helper:"Helper entit\xE0 selezionata",sync_entity_type:"Tipo di entit\xE0 da sincronizzare",placement:"Posizionamento",card_trigger:"Trigger della scheda",search_view:"Vista risultati ricerca",search_card_columns:"Colonne schede",card_type:"Tipo di scheda",appearance:"Aspetto",no_artwork_option:"Nessuna copertina",details_alignment:"Allineamento dei dettagli",queue_controls_style:"Stile controlli coda"},action_types:{menu:"Apri un elemento del menu",service:"Chiama un servizio",navigate:"Naviga",prev_entity:"Chip entit\xE0 precedente",next_entity:"Chip entit\xE0 successiva",sync_selected_entity:"Sincronizza entit\xE0 selezionata",select_entity:"Seleziona entit\xE0 da helper",toggle_lyrics:"Attiva/disattiva sovrapposizione testi",remote_control:"Apri sovrapposizione telecomando"},action_helpers:{sync_selected_entity:"Sincronizza entit\xE0 selezionata \u2192",select_entity:"Seleziona entit\xE0 \u2190",select_helper:"(seleziona helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entit\xE0 Music Assistant se configurata)",yamp_main_entity:"yamp_main_entity (Entit\xE0 principale del lettore)",yamp_playback_entity:"yamp_playback_entity (Entit\xE0 di riproduzione attiva attuale)"},placements:{chip:"Chip d'azione",menu:"Nel menu",hidden:"Nascosto (Tocco sull'immagine)",replace_search:"Sostituisci Ricerca",replace_power:"Sostituisci Accensione",replace_mute:"Sostituisci Muto",replace_favorite:"Sostituisci Preferito",not_triggerable:"Non attivabile"},triggers:{none:"Nessuno",tap:"Tocco",hold:"Mantieni",double_tap:"Doppio tocco",swipe_left:"Scorri a sinistra",swipe_right:"Scorri a destra"},search_view_options:{list:"Lista",card:"Scheda",card_minimal:"Scheda minima"},queue_controls_style_options:{drag_handle:"Maniglia di trascinamento",icons:"Pulsanti di movimento"},card_type_options:{default:"Predefinito",search:"Cerca",group_players:"Raggruppa i lettori",up_next:"In coda",remote_control:"Telecomando"},appearance_options:{automatic:"Automatico",light:"Chiaro",dark:"Scuro"},artwork_fit:{default:"Globale",cover:"Copertina (predefinito)",contain:"Contieni",fill:"Riempi","scale-down":"Ridimensiona","scaled-contain":"Contieni scalato","scaled-contain-alternate":"Contieni scalato alternativo",none:"Nessuno"},artwork_position:{default:"Globale",top:"In alto",center:"Centro",bottom:"In basso"}},card:{sections:{details:"Dettagli riproduzione",menu:"Menu e Ricerca",action_chips:"Chip azione",lyrics:"Testi"},media_controls:{shuffle:"Casuale",previous:"Precedente",play_pause:"Riproduci/Pausa",stop:"Ferma",next:"Successivo",repeat:"Ripeti"},menu:{more_info:"Pi\xF9 info",search:"Cerca",source:"Sorgente",remote_controls:"Telecomando",show_lyrics:"Mostra testi",hide_lyrics:"Nascondi testi",transfer_queue:"Trasferisci coda",main_menu:"Menu Principale",group_players:"Raggruppa",up_next:"In coda",remote_control:"Telecomando",select_entity:"Seleziona",transfer_to:"Trasferisci a",no_players:"Senza lettori MA."},remote:{title:"Telecomando",up:"Su",down:"Gi\xF9",left:"Sinistra",right:"Destra",select:"Seleziona",back:"Indietro",menu:"Menu",home:"Home",power:"Accensione"},grouping:{title:"Raggruppa",sync_volume:"Sincronizza volume",group_all:"Raggruppa tutti",ungroup_all:"Separa tutti",unavailable:"Non disponibile",no_players:"Non raggruppabile.",master:"Master",joined:"Unito",available:"Disponibile",current:"Attuale",unjoin_from:"Scollegati da {master}",join_with:"Unisciti a {master}"}},search:{favorites:"Preferiti",recently_played:"Recenti",next_up:"A seguire",recommendations:"Raccomandazioni",radio_mode:"Modo Radio",show_track_options:"Mostra opzioni brano",play_similar:"Riproduci brani simili",close:"Chiudi",no_results:"Nessun risultato.",play_next:"Riprod. successivo",replace_play:"Sostituisci e riproduci",replace:"Sostituisci coda",add_queue:"Aggiungi alla fine",move_up:"Sposta su",move_down:"Sposta gi\xF9",move_next:"Passa al successivo",remove:"Rimuovi da coda",drag_to_reorder:"Trascina per riordinare",added:"Aggiunto!",added_to_playlist:"Aggiunto alla playlist!",select_playlist:"Seleziona playlist per '{track}'",add_to_playlist:"Aggiungi alla playlist",select_track_for_playlist:"Seleziona il brano da aggiungere per '{track}' di {artist}",labels:{replace:"Sostituisci",next:"Successivo",replace_next:"Sost. succ.",add:"Aggiungi",add_to_playlist:"Aggiungi alla playlist"},results:"risultati",result:"risultato",filters:{all:"Tutto",artist:"Artista",album:"Album",track:"Brano",playlist:"Playlist",radio:"Radio",music:"Musica",station:"Stazione",podcast:"Podcast",audiobook:"Audiolibro"},search_artist:"Cerca questo artista",search_album:"Sfoglia i brani di questo album",browse_album:"Sfoglia i brani di {album}",play_collection:"Riproduci questa collezione",play_collection_error:"Impossibile riprodurre direttamente questa collezione",play_item:"Riproduci {item}"},lyrics:{finding:"Ricerca testi...",none_found:"Nessun testo trovato",not_available:"Testi non disponibili",instrumental:"Traccia strumentale",admin_only_mass:"Il recupero dei testi tramite Music Assistant \xE8 riservato agli utenti amministratori. Si consiglia di passare a lrclib nella configurazione della scheda.",fallback_to_lrclib_non_admin:"Rilevato utente non amministratore. Passaggio a lrclib per il recupero dei testi."},lyrics_sources:{mass_lrclib:"Music Assistant (Fallback su LRCLIB)",mass:"Solo Music Assistant",lrclib:"Solo LRCLIB",lrclib_mass:"LRCLIB (Fallback su Music Assistant)"},lyrics_modes:{default:"Predefinito (Evidenzia e scorri)",scroll:"Solo scorrimento",text:"Solo testo"}},Rc={common:{not_found:"Entiteit niet gevonden.",search:"Zoeken",power:"Aan/Uit",favorite:"Favoriet",loading:"Laden...",no_results:"Geen resultaten.",close:"Sluiten",vol_up:"Volume Omhoog",vol_down:"Volume Omlaag",media_player:"Mediaspeler",edit_entity:"Entiteitsinstellingen Bewerken",edit_action:"Actie-instellingen Bewerken",mute:"Dempen",unmute:"Dempen opheffen",seek:"Zoeken",volume:"Volume",play_now:"Nu Spelen",more_options:"Meer Opties",unavailable:"Niet beschikbaar",back:"Terug",cancel:"Annuleren",reset_default:"Herstellen naar standaard",unpin:"Losmaken",clear:"Wissen",album_art:"Albumhoes"},editor:{tabs:{entities:"Entiteiten",behavior:"Gedrag",look_and_feel:"Uiterlijk",artwork:"Artwork",actions:"Acties"},search_placeholder:"Configuratieopties zoeken...",template_label:"Kaartsjabloon",templates:{custom:{label:"Aangepast (Originele configuratie)",description:"Uw originele, volledig aangepaste configuratie."},large_modern:{label:"Grote moderne YAMP",description:"Een iets groter modern ontwerp met adaptieve bedieningselementen."},crisp_clean:{label:"Strak",description:"Een strakke indeling met geschaalde albumhoes en moderne bediening."},minimal_mini:{label:"MINImal",description:"Een compacte kaart zonder artwork."},normal_mini:{label:"Mini Mode",description:"De standaard compacte kaart."},quick_and_easy:{label:"Geen tijd te verliezen",description:"Gemaakt voor snelheid met permanente chiprijen en snel groeperen."},dedicated_search:{label:"Alles over zoeken",description:"Een zelfstandige zoekkaart zonder de hoofdmediaspeler."},dedicated_grouping:{label:"Groepstherapie",description:"Een zelfstandige spelers-groeperingskaart. Vereist meerdere geconfigureerde entiteiten."},huge_yamp:{label:"Dat is een enorme YAMP!",description:"Gemaximaliseerde bediening, grote tekst en een enorme voortgangsbalk voor weergave op afstand."}},placeholders:{search:"Zoek muziek..."},sections:{artwork:{general:{title:"Algemene Instellingen",description:"Globale instellingen voor hoe artwork wordt weergegeven en opgehaald."},idle:{title:"Artwork bij Inactiviteit",description:"Toon een statische afbeelding of entiteits-snapshot wanneer er niets wordt afgespeeld."},overrides:{title:"Artwork Overschrijvingen",description:"Overschrijvingen worden van boven naar beneden ge\xEBvalueerd. Sleep om te sorteren."}},entities:{title:"Entiteiten*",description:"Voeg de mediaspelers toe die je wilt bedienen. Sleep entiteiten om de volgorde te wijzigen."},behavior:{idle_chips:{title:"Inactiviteit & Chips",description:"Kies wanneer de kaart inactief wordt en hoe entiteitschips zich gedragen."},interactions_search:{title:"Interacties & Zoeken",description:"Verfijn hoe entiteiten worden vastgezet en hoeveel resultaten er tegelijk worden getoond."},lyrics:{title:"Songteksten",description:"Configureer hoe songteksten worden weergegeven en wanneer ze verschijnen."}},look_and_feel:{theme_layout:{title:"Thema & Layout",description:"Stem af op de styling van het dashboard en beheer de totale voetafdruk."},controls_typography:{title:"Bediening & Typografie",description:"Pas knopgrootte, entiteitslabels en adaptieve tekst aan."},collapsed_idle:{title:"Ingeklapte & Inactieve Staten",description:"Beheer wanneer de kaart inklapt en welke weergaven getoond worden bij inactiviteit."}},actions:{title:"Acties",description:"Bouw de actiechips die in de kaart of het menu verschijnen. Sleep om te sorteren, klik op het potlood om te configureren."}},subtitles:{idle_timeout:"Tijd in milliseconden voordat de kaart naar de inactieve modus gaat. Stel in op 0 om inactiviteitsgedrag uit te schakelen.",show_chip_row:'"Auto" verbergt de chiprij wanneer er slechts \xE9\xE9n entiteit is geconfigureerd. "In Menu" verplaatst de chips naar het menu-overlay. "In menu bij inactiviteit" toont chips inline wanneer actief maar verplaatst ze naar het menu wanneer inactief.',dim_chips:"Wanneer de kaart inactief wordt met een afbeelding, dim dan de entiteits- en actiechips voor een strakker uiterlijk.",hold_to_pin:"Houd entiteitschips lang ingedrukt in plaats van kort om ze vast te zetten, om automatisch schakelen tijdens afspelen te voorkomen.",always_show_group:"Snelgroeperingsknoppen (+/-/ster) zijn standaard zichtbaar bij het laden van de pagina. Je kunt ze nog steeds handmatig in- of uitschakelen via dubbeltikken.",disable_autofocus:"Voorkom dat het zoekveld de focus steelt, zodat onscreen toetsenborden verborgen blijven.",search_within_filter:"Schakel dit in om te zoeken binnen het huidige actieve filter (Favorieten, Recent Afgespeeld, etc) in plaats van dit te wissen.",close_search_on_play:"Sluit het zoekscherm automatisch wanneer een nummer wordt afgespeeld.",pin_search_headers:"Houd de zoekinvoer en filters bovenaan vast tijdens het scrollen door resultaten.",hide_search_headers_on_idle:"Verberg zoekinvoer en filters wanneer inactief.",disable_mass:"Schakel de optionele Mass Queue integratie uit, zelfs als deze is ge\xEFnstalleerd.",swap_pause_stop:"Vervang de pauzeknop door stop bij gebruik van de moderne lay-out.",show_album:"Toon de albumnaam naast de artiest in de spelerdetails.",adaptive_controls:"Laat de afspeelknoppen groeien of krimpen om in de beschikbare ruimte te passen.",hide_menu_player:"Wanneer chips in het menu staan, verberg dan het entiteitslabel onderaan de kaart.",hide_reorder_progress:"Verberg de zwevende voortgangsindicator voor het opnieuw sorteren van de wachtrij onderaan.",adaptive_text:"Kies welke tekstgroepen moeten schalen met de beschikbare ruimte (laat leeg om adaptieve tekst uit te schakelen).",collapse_expand:"Altijd Ingeklapt cre\xEBert de mini-spelermodus. Uitklappen bij Zoeken klapt tijdelijk uit tijdens het zoeken.",disable_mini_menu:"Keer terug naar standaardlijsten in plaats van de nieuwe mini rastermenu's te gebruiken in de modus 'Altijd ingeklapt'.",idle_screen:"Kies welk scherm automatisch wordt weergegeven wanneer de kaart inactief wordt.",hide_controls:"Selecteer welke knoppen je wilt verbergen voor deze entiteit (standaard worden ze allemaal getoond)",hide_remote_buttons:"Selecteer knoppen om te verbergen in de afstandsbediening-overlay.",hide_search_chips:"Verberg specifieke zoekfilterchips voor deze entiteit",hide_active_entity_on_idle:"Verbergt het entiteitslabel onderaan de kaart alleen wanneer de speler inactief is.",follow_active_entity:"Indien ingeschakeld, zal de volume-entiteit automatisch de actieve afspeel-entiteit volgen. Let op: dit overschrijft de geselecteerde volume-entiteit.",search_limit_full:"Maximaal aantal zoekresultaten om weer te geven (standaard: 20)",default_search_filter_full:"Kies welk filter standaard actief is wanneer het zoekscherm wordt geopend.",default_search_favorites:"Start zoekopdracht met favorieten actief",result_sorting_full:"Kies hoe zoekresultaten worden gesorteerd. Standaard behoudt de bronvolgorde.",card_height_full:"Laat leeg voor automatische hoogte",control_layout_full:"Kies tussen de oude gelijkmatig verdeelde knoppen of de moderne Home Assistant lay-out.",artwork_extend:"Laat de artwork-achtergrond doorlopen onder de chip- en actierijen.",artwork_extend_label:"Artwork uitbreiden",no_artwork_overrides:"Geen artwork overschrijvingen geconfigureerd. Gebruik de plusknop hieronder om er een toe te voegen.",missing_art_match:"Is van toepassing wanneer de geselecteerde media geen hoesafbeelding biedt.",idle_image_match:"Is van toepassing wanneer de speler inactief is en er een rustafbeelding wordt weergegeven.",entity_current_hint:"Gebruik 'entity_id: current' om de momenteel geselecteerde mediaspeler op de kaart te targeten.",jinja_template_hint:"Voer een Jinja-sjabloon in dat resulteert in een enkele entity_id. Voorbeeld voor het wisselen van MA op basis van een bronselectie:",jinja_template_vol_hint:"Voer een Jinja-sjabloon in dat resulteert in een entity_id (bijv. media_player.kantoor). Voorbeeld voor het wisselen van volume-entiteit op basis van een boolean:",jinja_template_remote_hint:"Voer een Jinja-sjabloon in dat resulteert in een afstandsbediening entity_id (bijv. remote.woonkamer_tv):",not_available_alt_collapsed:"Niet beschikbaar met Alternatieve Voortgangsbalk of Altijd Ingeklapte modus",not_available_collapsed:"Niet beschikbaar wanneer Altijd Ingeklapt is ingeschakeld",only_available_collapsed:"Alleen beschikbaar wanneer Altijd Ingeklapt is ingeschakeld",only_available_mini_menu:"Alleen beschikbaar wanneer 'Altijd ingeklapt' waar is en 'Uitvouwen bij zoeken' onwaar is",only_available_modern:"Alleen beschikbaar met de Moderne lay-out",image_url_helper:"Voer een directe URL naar een afbeelding of een lokaal bestandspad in",selected_entity_helper:"Invoerteksthelper die wordt bijgewerkt met de momenteel geselecteerde media player-entiteits-ID.",select_entity_helper:"Invoerteksthelper waaruit het entiteits-ID wordt gelezen. De kaart selecteert automatisch de bijbehorende chip.",sync_entity_type:"Kies welk entiteits-ID moet worden gesynchroniseerd met de helper (standaard Music Assistant-entiteit indien geconfigureerd).",disable_auto_select:"Voorkomt dat de chip van deze entiteit automatisch wordt geselecteerd wanneer deze begint af te spelen.",search_view:"Kies tussen een standaardlijst of een raster van kaarten voor zoekresultaten.",search_card_columns:"Geef aan hoeveel kolommen er gebruikt moeten worden in de kaartweergave. De afbeelding wordt automatisch aangepast.",card_type:"Kies de kaartmodus. 'Standaard' is de standaard mediaspeler. 'Speciale zoekopdracht' maakt van de kaart een permanente zoekinterface.",always_show_lyrics:"Open automatisch de songtekstweergave wanneer de pagina wordt vernieuwd.",lyrics_source:"Music Assistant vereist de mass_queue-integratie om songteksten op te halen uit de interne metadata-engine.",lyrics_pre_roll:"Verschuif de timing van de songtekstmarkering. Positieve waarden versnellen het, negatieve waarden vertragen het (standaard: 0).",blurred_artwork:"Achtergrondafbeelding altijd vervagen",hide_collapsed_artwork:"Verberg de kleine afbeelding aan de rechterkant wanneer de kaart is ingeklapt",show_idle_artwork_when_not_playing:"Indien ingeschakeld, zal het selecteren van een chip die momenteel niet wordt afgespeeld de geconfigureerde stand-by afbeelding weergeven in plaats van de actieve afspeel-art.",prefer_ma_metadata:"Gebruik altijd de gekoppelde Music Assistant-entiteit voor de tracktitel, artiest en artwork, zelfs als de primaire entiteit wordt afgespeeld.",show_volume_overlay:"Geef kort een grote volume-indicator weer over het artwork wanneer het volumeniveau verandert.",queue_controls_style:"Kies of u een sleephandgreep of individuele bewegingsknoppen wilt weergeven voor wachtrij-items."},titles:{edit_entity:"Entiteit Bewerken",edit_action:"Actie Bewerken",service_data:"Servicegegevens",add_artwork_override:"Artwork Overschrijving Toevoegen"},labels:{toggle_template_mode:"Sjabloonmodus wisselen",dim_chips:"Chips dimmen bij inactiviteit",hold_to_pin:"Ingedrukt houden om vast te zetten",always_show_group:"Snelgroepering standaard aan",disable_autofocus:"Zoek-autofocus uitschakelen",keep_filters:"Filters behouden bij zoeken",dismiss_on_play:"Zoeken sluiten bij afspelen",pin_headers:"Zoekkoppen vastzetten",hide_search_headers_on_idle:"Zoekkoppen verbergen bij inactiviteit",default_search_filter:"Standaard zoekfilter",default_search_favorites:"Standaard naar favorietenfilter",disable_mass:"Mass Queue uitschakelen",match_theme:"Thema matchen",alt_progress:"Alternatieve Voortgangsbalk",progress_bar_height:"Hoogte voortgangsbalk",display_timestamps:"Tijdstempels Weergeven",swap_pause_stop:"Pauze vervangen door Stop",show_album:"Toon albumnaam",adaptive_controls:"Adaptieve Knoppen Grootte",hide_active_entity:"Label van Actieve Entiteit verbergen",hide_active_entity_on_idle:"Actieve entiteitslabel verbergen bij inactiviteit",collapse_on_idle:"Inklappen bij inactiviteit",hide_menu_player_toggle:"Menu-speler Verbergen",hide_reorder_progress_toggle:"Wachtrijsortering Verbergen",always_collapsed:"Altijd Ingeklapt",disable_mini_menu:"Mini rastermenu's uitschakelen",expand_on_search:"Uitklappen bij Zoeken",script_var:"Script Variabele (yamp_entity)",use_ma_template:"Sjabloon gebruiken voor Music Assistant Entiteit",use_vol_template:"Sjabloon gebruiken voor Volume Entiteit",follow_active_entity:"Volume Entiteit volgt Actieve Entiteit",use_url_path:"URL of Pad gebruiken",adaptive_text_elements:"Elementen voor adaptieve tekstgrootte",disable_auto_select:"Automatische selectie uitschakelen",always_show_lyrics:"Toon altijd songteksten",lyrics_mode:"Songtekstmodus",lyrics_source:"Songtekstbron",lyrics_pre_roll:"Songtekst Pre-Roll (seconden)",blurred_artwork:"Vervaagde afbeelding",hide_collapsed_artwork:"Verkleinde afbeelding verbergen",show_idle_artwork_when_not_playing:"Toon stand-by afbeelding wanneer niet afgespeeld",prefer_ma_metadata:"Voorkeur voor Music Assistant-metadata",show_volume_overlay:"Volume-overlay weergeven"},fields:{artwork_fit:"Artwork Passend Maken",artwork_position:"Artwork Positie",artwork_hostname:"Artwork Hostnaam",match_field:"Match Veld",match_value:"Match Waarde",size_percent:"Grootte (%)",object_fit:"Object Fit",idle_timeout:"Time-out voor Inactiviteit (ms)",show_chip_row:"Chiprij Tonen",search_limit:"Limiet Zoekresultaten",result_sorting:"Sortering Resultaten",vol_step:"Volume Stap (0.05 = 5%)",card_height:"Kaarthoogte (px)",control_layout:"Knoppen Lay-out",idle_image:"Rustafbeelding",image_url:"Afbeelding URL",fallback_image_url:"Fallback Afbeelding URL",move_to_main:"Verplaats actie naar hoofdchips",move_to_menu:"Verplaats actie naar menu",delete_action:"Actie Verwijderen",volume_mode:"Volume Modus",idle_screen:"Inactief Scherm",name:"Naam",hidden_controls:"Verborgen Knoppen",hide_remote_buttons:"Verborgen afstandsbediening knoppen",ma_template:"Music Assistant Entiteit Sjabloon (Jinja)",hidden_chips:"Verborgen Zoekfilterchips",vol_template:"Volume Entiteit Sjabloon (Jinja)",icon:"Icoon",action_type:"Actietype",menu_item:"Menu-item",nav_path:"Navigatiepad",service:"Service",service_data:"Servicegegevens",idle_image_entity:"Entiteit voor inactieve afbeelding",match_entity:"Match Entiteit",ma_entity:"Music Assistant-entiteit",vol_entity:"Volume-entiteit",remote_entity:"Afstandsbediening-entiteit",remote_template:"Afstandsbediening entiteit template (Jinja)",selected_entity_helper:"Geselecteerde entiteitshelper",sync_entity_type:"Synchronisatie entiteitstype",placement:"Plaatsing",card_trigger:"Kaart trigger",search_view:"Zoekresultaten weergave",search_card_columns:"Aantal kolommen",card_type:"Kaarttype",appearance:"Uiterlijk",no_artwork_option:"Geen afbeelding",details_alignment:"Details uitlijning",queue_controls_style:"Wachtrijbesturingsstijl"},action_types:{menu:"Open een kaartmenu-item",service:"Roep een service aan",navigate:"Navigeren",prev_entity:"Vorige entiteit chip",next_entity:"Volgende entiteit chip",sync_selected_entity:"Synchroniseer geselecteerde entiteit",select_entity:"Selecteer entiteit uit helper",toggle_lyrics:"Wisselen tussen songtekst-overlay",remote_control:"Afstandsbediening overlay openen"},action_helpers:{sync_selected_entity:"Geselecteerde entiteit synchroniseren",select_entity:"Entiteit selecteren uit helper",select_helper:"(selecteer helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Music Assistant-entiteit indien geconfigureerd)",yamp_main_entity:"yamp_main_entity (Hoofd media player-entiteit)",yamp_playback_entity:"yamp_playback_entity (Huidige actieve afspeelentiteit)"},placements:{chip:"Actiechip",menu:"In menu",hidden:"Verborgen (Artwork-tik)",replace_search:"Vervang Zoeken",replace_power:"Vervang Aan/Uit",replace_mute:"Vervang Dempen",replace_favorite:"Vervang Favoriet",not_triggerable:"Niet triggerbaar"},triggers:{none:"Geen",tap:"Tik",hold:"Vasthouden",double_tap:"Dubbeltik",swipe_left:"Veeg naar links",swipe_right:"Veeg naar rechts"},search_view_options:{list:"Lijst",card:"Kaart",card_minimal:"Minimale kaart"},queue_controls_style_options:{drag_handle:"Sleephandgreep",icons:"Bewegingsknoppen"},card_type_options:{default:"Standaard",search:"Zoeken",group_players:"Spelers groeperen",up_next:"Hierna",remote_control:"Afstandsbediening"},appearance_options:{automatic:"Automatisch",light:"Licht",dark:"Donker"},artwork_fit:{default:"Globaal",cover:"Cover (standaard)",contain:"Bevatten",fill:"Vullen","scale-down":"Verkleinen","scaled-contain":"Geschaalde contain","scaled-contain-alternate":"Geschaalde contain alternatief",none:"Geen"},artwork_position:{default:"Globaal",top:"Boven",center:"Midden",bottom:"Onder"}},card:{sections:{details:"Details van 'Nu Spelen'",menu:"Menu & Zoekschermen",action_chips:"Actie Chips",lyrics:"Songtekst"},media_controls:{shuffle:"Shuffle",previous:"Vorige",play_pause:"Afspelen/Pauzeren",stop:"Stop",next:"Volgende",repeat:"Herhalen"},menu:{more_info:"Meer Info",search:"Zoeken",source:"Bron",remote_controls:"Afstandsbediening",show_lyrics:"Songtekst weergeven",hide_lyrics:"Songtekst verbergen",transfer_queue:"Wachtrij Overdragen",main_menu:"Hoofdmenu",group_players:"Spelers Groeperen",up_next:"Hierna",remote_control:"Afstandsbediening",select_entity:"Selecteer Entiteit voor Meer Info",transfer_to:"Wachtrij Overdragen Naar",no_players:"Geen andere Music Assistant spelers beschikbaar."},remote:{title:"Afstandsbediening",up:"Omhoog",down:"Omlaag",left:"Links",right:"Rechts",select:"Selecteren",back:"Terug",menu:"Menu",home:"Startscherm",power:"AAN/UIT"},grouping:{title:"Spelers Groeperen",sync_volume:"Volume Synchroniseren",group_all:"Alles Groeperen",ungroup_all:"Alles Loskoppelen",unavailable:"Speler is niet beschikbaar",no_players:"Geen andere spelers beschikbaar die kunnen groeperen.",master:"Master",joined:"Gekoppeld",available:"Beschikbaar",current:"Huidig",unjoin_from:"Loskoppelen van {master}",join_with:"Koppelen met {master}"}},search:{favorites:"Favorieten",recently_played:"Recent Afgespeeld",next_up:"Volgende",recommendations:"Aanbevelingen",radio_mode:"Radiomodus",show_track_options:"Nummeropties weergeven",play_similar:"Vergelijkbare nummers afspelen",close:"Zoeken Sluiten",no_results:"Geen resultaten.",play_next:"Volgende afspelen",replace_play:"Huidige wachtrij vervangen en nu afspelen",replace:"Wachtrij vervangen",add_queue:"Toevoegen aan einde van de wachtrij",move_up:"Omhoog verplaatsen",move_down:"Omlaag verplaatsen",move_next:"Als volgende afspelen",remove:"Verwijderen uit wachtrij",drag_to_reorder:"Sleep om te herordenen",added:"Toegevoegd aan wachtrij!",added_to_playlist:"Toegevoegd aan afspeellijst!",select_playlist:"Selecteer afspeellijst voor '{track}'",add_to_playlist:"Toevoegen aan afspeellijst",select_track_for_playlist:"Selecteer het nummer om toe te voegen voor '{track}' van {artist}",labels:{replace:"Vervangen",next:"Volgende",replace_next:"Vervang Volgende",add:"Toevoegen",add_to_playlist:"Toevoegen aan afspeellijst"},results:"resultaten",result:"resultaat",filters:{all:"Alles",artist:"Artiest",album:"Album",track:"Nummer",playlist:"Afspeellijst",radio:"Radio",music:"Muziek",station:"Zender",podcast:"Podcast",audiobook:"Luisterboek"},search_artist:"Zoek naar deze artiest",search_album:"Blader door nummers van dit album",browse_album:"Tracks van {album} doorzoeken",play_collection:"Speel deze collectie af",play_collection_error:"Kan deze collectie niet direct afspelen",play_item:"{item} afspelen"},lyrics:{finding:"Songteksten zoeken...",none_found:"Geen songteksten gevonden",not_available:"Songtekst niet beschikbaar",instrumental:"Instrumentale Track",admin_only_mass:"Songteksten ophalen via Music Assistant is alleen voor beheerders. Het wordt aanbevolen om in de kaartconfiguratie over te schakelen naar lrclib.",fallback_to_lrclib_non_admin:"Niet-beheerder gebruiker gedetecteerd. Terugvallen op lrclib voor het ophalen van songteksten."},lyrics_sources:{mass_lrclib:"Music Assistant (Terugval naar LRCLIB)",mass:"Alleen Music Assistant",lrclib:"Alleen LRCLIB",lrclib_mass:"LRCLIB (Terugval naar Music Assistant)"},lyrics_modes:{default:"Standaard (Markeren & scrollen)",scroll:"Alleen scrollen",text:"Alleen tekst"}},Oc={common:{not_found:"Entidade n\xE3o encontrada.",search:"Procurar",power:"Ligar/Desligar",favorite:"Favorito",loading:"A carregar...",no_results:"Sem resultados.",close:"Fechar",vol_up:"Aumentar volume",vol_down:"Diminuir volume",media_player:"Leitor multim\xE9dia",edit_entity:"Editar defini\xE7\xF5es da entidade",edit_action:"Editar defini\xE7\xF5es da a\xE7\xE3o",mute:"Silenciar",unmute:"Ativar som",seek:"Procurar",volume:"Volume",play_now:"Reproduzir agora",more_options:"Mais op\xE7\xF5es",unavailable:"Indispon\xEDvel",back:"Voltar",cancel:"Cancelar",reset_default:"Repor predefini\xE7\xF5es",unpin:"Desafixar",clear:"Limpar",album_art:"Capa do \xE1lbum"},editor:{tabs:{entities:"Entidades",behavior:"Comportamento",look_and_feel:"Aspeto",artwork:"Capa",actions:"A\xE7\xF5es"},search_placeholder:"Pesquisar op\xE7\xF5es de configura\xE7\xE3o...",template_label:"Modelo de cart\xE3o",templates:{custom:{label:"Personalizado (Configura\xE7\xE3o original)",description:"A sua configura\xE7\xE3o original totalmente personalizada."},large_modern:{label:"YAMP moderno e grande",description:"Um design moderno ligeiramente maior com controlos adaptativos."},crisp_clean:{label:"Limpo",description:"Um layout limpo com capa dimensionada e controlos modernos."},minimal_mini:{label:"MINImal",description:"Um cart\xE3o compacto sem capa."},normal_mini:{label:"Mini Mode",description:"O cart\xE3o compacto padr\xE3o."},quick_and_easy:{label:"Sem tempo a perder",description:"Concebido para rapidez com linhas de chips persistentes e agrupamento r\xE1pido."},dedicated_search:{label:"Tudo sobre pesquisa",description:"Um cart\xE3o de pesquisa aut\xF3nomo sem o leitor multim\xE9dia principal."},dedicated_grouping:{label:"Terapia de grupo",description:"Um cart\xE3o aut\xF3nomo de agrupamento de leitores. Requer v\xE1rias entidades configuradas."},huge_yamp:{label:"Isto \xE9 um enorme YAMP!",description:"Controlos maximizados, texto grande e barra de progresso maci\xE7a para visualiza\xE7\xE3o \xE0 dist\xE2ncia."}},placeholders:{search:"Procurar m\xFAsica..."},sections:{artwork:{general:{title:"Defini\xE7\xF5es gerais",description:"Controlos globais para a capa."},idle:{title:"Capa em repouso",description:"Mostrar imagem est\xE1tica quando nada toca."},overrides:{title:"Substitui\xE7\xF5es de capa",description:"As substitui\xE7\xF5es s\xE3o avaliadas de cima para baixo."}},entities:{title:"Entidades*",description:"Adicione os leitores a controlar."},behavior:{idle_chips:{title:"Repouso e chips",description:"Escolha quando ir para repouso."},interactions_search:{title:"Intera\xE7\xF5es e procura",description:"Ajuste a fixa\xE7\xE3o de entidades."},lyrics:{title:"Letras",description:"Configure como as letras s\xE3o exibidas e quando aparecem."}},look_and_feel:{theme_layout:{title:"Tema e design",description:"Combine com o estilo do dashboard."},controls_typography:{title:"Controlos e tipografia",description:"Ajuste bot\xF5es e etiquetas."},collapsed_idle:{title:"Estados contra\xEDdo e repouso",description:"Controle o contra\xEDdo do cart\xE3o."}},actions:{title:"A\xE7\xF5es",description:"Crie chips de a\xE7\xE3o."}},subtitles:{idle_timeout:"Tempo antes de repouso (ms). 0 para desativar.",show_chip_row:'"Auto" oculta a linha se houver apenas uma entidade. "No menu" move os chips. "No menu em repouso" mostra os chips em linha quando ativo mas move-os para o menu quando em repouso.',dim_chips:"Escurecer chips em repouso para um aspeto mais limpo.",hold_to_pin:"Manter premido para fixar em vez de toque curto.",always_show_group:"Os controles de agrupamento r\xE1pido (+/-/estrela) estar\xE3o vis\xEDveis por padr\xE3o ao carregar a p\xE1gina. Voc\xEA ainda pode altern\xE1-los manualmente atrav\xE9s de um toque duplo.",disable_autofocus:"Evitar que a procura tome o foco automaticamente.",search_within_filter:"Procurar no filtro ativo (Favoritos, etc.).",close_search_on_play:"Fechar procura ao reproduzir.",pin_search_headers:"Fixar cabe\xE7alhos de procura ao fazer scroll.",hide_search_headers_on_idle:"Ocultar pesquisa e filtros quando inativo.",disable_mass:"Desativar integra\xE7\xE3o Mass Queue.",swap_pause_stop:"Substituir pausa por stop no design moderno.",show_album:"Exibir o nome do \xE1lbum ao lado do artista nos detalhes do reprodutor.",adaptive_controls:"Permitir que os bot\xF5es se adaptem ao espa\xE7o.",hide_menu_player:"Ocultar nome da entidade quando no menu.",hide_reorder_progress:"Ocultar o indicador flutuante de progresso de reordena\xE7\xE3o da fila na parte inferior.",adaptive_text:"Escolher que textos se adaptam ao espa\xE7o.",collapse_expand:"Sempre contra\xEDdo ativa modo mini. Expandir ao procurar expande temporariamente.",disable_mini_menu:"Reverter para listas padr\xE3o em vez de usar os novos mini menus em grade no modo 'Sempre recolhido'.",idle_screen:"Escolher ecr\xE3 a mostrar em repouso.",hide_controls:"Selecionar controlos a ocultar.",hide_remote_buttons:"Selecione bot\xF5es para ocultar do controle remoto.",hide_search_chips:"Ocultar chips de filtro de procura.",hide_active_entity_on_idle:"Oculta a etiqueta da entidade na parte inferior do cart\xE3o apenas quando o reprodutor est\xE1 inativo.",follow_active_entity:"A entidade de volume seguir\xE1 a ativa.",search_limit_full:"M\xE1ximo de resultados (default: 20).",default_search_filter_full:"Escolha qual filtro est\xE1 ativo por padr\xE3o quando a tela de pesquisa \xE9 aberta.",default_search_favorites:"Iniciar pesquisa com favoritos ativos",result_sorting_full:"Escolher ordem dos resultados.",card_height_full:"Deixar vazio para altura autom\xE1tica.",control_layout_full:"Escolher entre design antigo ou moderno.",artwork_extend:"Estender capa sob os chips.",artwork_extend_label:"Estender capa",no_artwork_overrides:"Sem substitui\xE7\xF5es de capa configuradas.",missing_art_match:"Aplica-se quando a m\xEDdia selecionada n\xE3o fornece arte.",idle_image_match:"Aplica-se quando o reprodutor est\xE1 inativo e uma imagem de inatividade est\xE1 sendo exibida.",entity_current_hint:"Use 'entity_id: current' para o leitor atual.",jinja_template_hint:"Modelo Jinja para entity_id.",jinja_template_vol_hint:"Modelo para entidade volume.",jinja_template_remote_hint:"Modelo Jinja que resolve um entity_id de controlo remoto (ex. remote.sala_tv):",not_available_alt_collapsed:"N\xE3o dispon\xEDvel em modo contra\xEDdo.",not_available_collapsed:"N\xE3o dispon\xEDvel se contra\xEDdo.",only_available_collapsed:"Apenas dispon\xEDvel se contra\xEDdo.",only_available_mini_menu:"Dispon\xEDvel apenas quando 'Sempre recolhido' \xE9 verdadeiro e 'Expandir na pesquisa' \xE9 falso",only_available_modern:"Apenas dispon\xEDvel com layout Moderno.",image_url_helper:"Insira um URL direto para uma imagem ou um caminho de arquivo local",selected_entity_helper:"Helper de texto de entrada que ser\xE1 atualizado com o ID da entidade do reprodutor de m\xEDdia selecionado no momento.",select_entity_helper:"Helper de texto de entrada do qual ler o ID da entidade. O cart\xE3o selecionar\xE1 automaticamente o chip correspondente.",sync_entity_type:"Escolha qual ID de entidade sincronizar com o helper (padr\xE3o entidade Music Assistant se configurada).",disable_auto_select:"Impede que o chip desta entidade seja selecionado automaticamente quando a reprodu\xE7\xE3o \xE9 iniciada.",search_view:"Escolha entre uma lista padr\xE3o ou uma grade de cart\xF5es para os resultados da pesquisa.",search_card_columns:"Especifique quantas colunas usar na visualiza\xE7\xE3o de cart\xF5es. A capa ser\xE1 redimensionada automaticamente.",card_type:"Escolha o modo do cart\xE3o. 'Padr\xE3o' \xE9 o reprodutor de m\xEDdia padr\xE3o. 'Busca dedicada' torna o cart\xE3o uma interface de busca permanente.",always_show_lyrics:"Abrir automaticamente a visualiza\xE7\xE3o de letras quando a p\xE1gina for atualizada.",lyrics_source:"O Music Assistant requer a integra\xE7\xE3o mass_queue para obter letras do seu motor de metadados interno.",lyrics_pre_roll:"Ajuste o tempo de destaque da letra. Valores positivos aceleram, valores negativos atrasam (padr\xE3o: 0).",blurred_artwork:"Sempre desfocar a imagem de fundo",hide_collapsed_artwork:"Ocultar a imagem pequena \xE0 direita quando o cart\xE3o estiver recolhido",show_idle_artwork_when_not_playing:"Quando ativado, a sele\xE7\xE3o de uma ficha que n\xE3o esteja sendo reproduzida exibir\xE1 a imagem de repouso configurada em vez da imagem de reprodu\xE7\xE3o ativa.",prefer_ma_metadata:"Utilizar sempre a entidade Music Assistant emparelhada para o t\xEDtulo da faixa, artista e arte, mesmo que a entidade prim\xE1ria esteja a ser reproduzida.",show_volume_overlay:"Exibe brevemente um indicador de volume grande sobre a arte quando o n\xEDvel de volume muda.",queue_controls_style:"Escolha se deseja mostrar uma al\xE7a de arrastar ou bot\xF5es de movimento individuais para itens da fila."},titles:{edit_entity:"Editar entidade",edit_action:"Editar a\xE7\xE3o",service_data:"Dados do servi\xE7o",add_artwork_override:"Adicionar substitui\xE7\xE3o"},labels:{toggle_template_mode:"Alternar modo de modelo",dim_chips:"Escurecer chips em repouso",hold_to_pin:"Manter para fixar",always_show_group:"Grupo r\xE1pido por padr\xE3o",disable_autofocus:"Desativar autofoco",keep_filters:"Manter filtros",dismiss_on_play:"Fechar ao reproduzir",pin_headers:"Fixar cabe\xE7alhos",hide_search_headers_on_idle:"Ocultar cabe\xE7alhos em inatividade",default_search_filter:"Filtro de pesquisa padr\xE3o",default_search_favorites:"Filtro de favoritos padr\xE3o",disable_mass:"Desativar Mass Queue",match_theme:"Seguir tema",alt_progress:"Barra de progresso alternativa",progress_bar_height:"Altura da barra de progresso",display_timestamps:"Mostrar carimbos de tempo",swap_pause_stop:"Substituir Pausa por Stop",show_album:"Mostrar nome do \xE1lbum",adaptive_controls:"Tamanho adaptativo",hide_active_entity:"Ocultar nome da entidade ativa",hide_active_entity_on_idle:"Ocultar etiqueta de entidade ativa quando inativo",collapse_on_idle:"Contrair em repouso",hide_menu_player_toggle:"Ocultar leitor do menu",hide_reorder_progress_toggle:"Ocultar progresso de reordena\xE7\xE3o",always_collapsed:"Sempre contra\xEDdo",disable_mini_menu:"Desativar mini menus em grade",expand_on_search:"Expandir ao procurar",script_var:"Vari\xE1vel script (yamp_entity)",use_ma_template:"Usar modelo MA",use_vol_template:"Usar modelo Volume",follow_active_entity:"Volume segue a entidade ativa",use_url_path:"Usar URL ou caminho",adaptive_text_elements:"Elementos de texto adaptativo",disable_auto_select:"Desativar sele\xE7\xE3o autom\xE1tica",always_show_lyrics:"Mostrar sempre as letras",lyrics_mode:"Modo de letras",lyrics_source:"Fonte das letras",lyrics_pre_roll:"Antecipa\xE7\xE3o de letra (segundos)",blurred_artwork:"Imagem desfocada",hide_collapsed_artwork:"Ocultar imagem reduzida",show_idle_artwork_when_not_playing:"Mostrar imagem de repouso quando n\xE3o reproduzindo",prefer_ma_metadata:"Preferir metadados do Music Assistant",show_volume_overlay:"Mostrar sobreposi\xE7\xE3o de volume"},fields:{artwork_fit:"Ajuste",artwork_position:"Posi\xE7\xE3o",artwork_hostname:"Host",match_field:"Campo",match_value:"Valor",size_percent:"Tamanho (%)",object_fit:"Object Fit",idle_timeout:"Repouso (ms)",show_chip_row:"Mostrar chips",search_limit:"Limite de procura",result_sorting:"Ordem",vol_step:"Passo de volume",card_height:"Altura (px)",control_layout:"Design",idle_image:"Imagem de inatividade",image_url:"URL imagem",fallback_image_url:"URL de reserva",move_to_main:"Mover para chips principais",move_to_menu:"Mover para o menu",delete_action:"Eliminar a\xE7\xE3o",volume_mode:"Modo volume",idle_screen:"Ecr\xE3 de repouso",name:"Nome",hidden_controls:"Controlos ocultos",hide_remote_buttons:"Bot\xF5es do controle remoto ocultos",ma_template:"Modelo MA (Jinja)",hidden_chips:"Chips ocultos",vol_template:"Modelo Volume (Jinja)",icon:"\xCDcone",action_type:"Tipo de a\xE7\xE3o",menu_item:"Item de menu",nav_path:"Caminho",service:"Servi\xE7o",service_data:"Dados",idle_image_entity:"Entidade imagem repouso",match_entity:"Entidade",ma_entity:"Entidade Music Assistant",vol_entity:"Entidade de volume",remote_entity:"Entidade de controlo remoto",remote_template:"Modelo de entidade remota (Jinja)",selected_entity_helper:"Helper de entidade selecionada",sync_entity_type:"Tipo de entidade a sincronizar",placement:"Posicionamento",card_trigger:"Gatilho do cart\xE3o",search_view:"Vista de resultados de pesquisa",search_card_columns:"Colunas de cart\xF5es",card_type:"Tipo de cart\xE3o",appearance:"Apar\xEAncia",no_artwork_option:"Sem imagem",details_alignment:"Alinhamento de detalhes",queue_controls_style:"Estilo de controles de fila"},action_types:{menu:"Abrir um item do menu",service:"Chamar um servi\xE7o",navigate:"Navegar",prev_entity:"Chip da entidade anterior",next_entity:"Chip da pr\xF3xima entidade",sync_selected_entity:"Sincronizar entidade selecionada",select_entity:"Selecionar entidade do helper",toggle_lyrics:"Alternar sobreposi\xE7\xE3o de letras",remote_control:"Abrir sobreposi\xE7\xE3o do controlo remoto"},action_helpers:{sync_selected_entity:"Sincronizar entidade selecionada \u2192",select_entity:"Selecionar entidade \u2190",select_helper:"(selecionar helper)"},sync_entity_options:{yamp_entity:"yamp_entity (Entidade Music Assistant se configurada)",yamp_main_entity:"yamp_main_entity (Entidade principal do reprodutor)",yamp_playback_entity:"yamp_playback_entity (Entidade de reprodu\xE7\xE3o ativa atual)"},placements:{chip:"Chip de a\xE7\xE3o",menu:"No menu",hidden:"Oculto (Toque no Artwork)",replace_search:"Substituir Pesquisa",replace_power:"Substituir Energia",replace_mute:"Substituir Mudo",replace_favorite:"Substituir Favorito",not_triggerable:"N\xE3o acion\xE1vel"},triggers:{none:"Nenhum",tap:"Toque",hold:"Manter premido",double_tap:"Toque duplo",swipe_left:"Deslizar para a esquerda",swipe_right:"Deslizar para a direita"},search_view_options:{list:"Lista",card:"Cart\xE3o",card_minimal:"Cart\xE3o minimalista"},queue_controls_style_options:{drag_handle:"Al\xE7a de arrastar",icons:"Bot\xF5es de movimento"},card_type_options:{default:"Padr\xE3o",search:"Procurar",group_players:"Agrupar",up_next:"A seguir",remote_control:"Controle Remoto"},appearance_options:{automatic:"Autom\xE1tico",light:"Claro",dark:"Escuro"},artwork_fit:{default:"Global",cover:"Capa (padr\xE3o)",contain:"Conter",fill:"Preencher","scale-down":"Reduzir","scaled-contain":"Conter dimensionado","scaled-contain-alternate":"Conter dimensionado alternativo",none:"Nenhum"},artwork_position:{default:"Global",top:"Topo",center:"Centro",bottom:"Inferior"}},card:{sections:{details:"Detalhes de reprodu\xE7\xE3o",menu:"Menu e Procura",action_chips:"Chips de a\xE7\xE3o",lyrics:"Letras"},media_controls:{shuffle:"Aleat\xF3rio",previous:"Anterior",play_pause:"Reproduzir/Pausa",stop:"Parar",next:"Seguinte",repeat:"Repetir"},menu:{more_info:"Mais info",search:"Procurar",source:"Fonte",remote_controls:"Controlo remoto",show_lyrics:"Mostrar letras",hide_lyrics:"Ocultar letras",transfer_queue:"Transferir fila",main_menu:"Menu Principal",group_players:"Agrupar",up_next:"A seguir",remote_control:"Controle Remoto",select_entity:"Selecionar",transfer_to:"Transferir para",no_players:"Sem leitores MA."},remote:{title:"Controlo remoto",up:"Para cima",down:"Para baixo",left:"Esquerda",right:"Direita",select:"Selecionar",back:"Voltar",menu:"Menu",home:"In\xEDcio",power:"Ligar/Desligar"},grouping:{title:"Agrupar",sync_volume:"Sincronizar volume",group_all:"Agrupar todos",ungroup_all:"Separar todos",unavailable:"Indispon\xEDvel",no_players:"N\xE3o agrup\xE1vel.",master:"Mestre",joined:"Unido",available:"Dispon\xEDvel",current:"Atual",unjoin_from:"Desvincular de {master}",join_with:"Juntar-se a {master}"}},search:{favorites:"Favoritos",recently_played:"Recentes",next_up:"A seguir",recommendations:"Recomenda\xE7\xF5es",radio_mode:"Modo R\xE1dio",show_track_options:"Mostrar op\xE7\xF5es da faixa",play_similar:"Tocar m\xFAsicas semelhantes",close:"Fechar",no_results:"Sem resultados.",play_next:"Reproduzir seguinte",replace_play:"Substituir e reproduzir",replace:"Substituir fila",add_queue:"Adicionar ao fim",move_up:"Subir",move_down:"Descer",move_next:"Passar para seguinte",remove:"Remover da fila",drag_to_reorder:"Arrastar para reordenar",added:"Adicionado!",added_to_playlist:"Adicionado \xE0 playlist!",select_playlist:"Selecionar playlist para '{track}'",add_to_playlist:"Adicionar \xE0 playlist",select_track_for_playlist:"Selecionar a faixa a adicionar para '{track}' de {artist}",labels:{replace:"Substituir",next:"Seguinte",replace_next:"Subst. seg.",add:"Adicionar",add_to_playlist:"Adicionar \xE0 playlist"},results:"resultados",result:"resultado",filters:{all:"Tudo",artist:"Artista",album:"\xC1lbum",track:"Faixa",playlist:"Lista",radio:"R\xE1dio",music:"M\xFAsica",station:"Esta\xE7\xE3o",podcast:"Podcast",audiobook:"Audiolivro"},search_artist:"Procurar este artista",search_album:"Navegar pelas faixas deste \xE1lbum",browse_album:"Explorar faixas de {album}",play_collection:"Reproduzir esta cole\xE7\xE3o",play_collection_error:"N\xE3o \xE9 poss\xEDvel reproduzir esta cole\xE7\xE3o diretamente",play_item:"Reproduzir {item}"},lyrics:{finding:"Procurando letra...",none_found:"Nenhuma letra encontrada",not_available:"Letra n\xE3o dispon\xEDvel",instrumental:"Faixa Instrumental",admin_only_mass:"A busca de letras pelo Music Assistant \xE9 apenas para usu\xE1rios administradores. Recomenda-se mudar para lrclib na configura\xE7\xE3o do cart\xE3o.",fallback_to_lrclib_non_admin:"Usu\xE1rio n\xE3o administrador detectado. Usando lrclib como alternativa para buscar as letras."},lyrics_sources:{mass_lrclib:"Music Assistant (Alternativa para LRCLIB)",mass:"Apenas Music Assistant",lrclib:"Apenas LRCLIB",lrclib_mass:"LRCLIB (Alternativa para Music Assistant)"},lyrics_modes:{default:"Padr\xE3o (Destacar e rolar)",scroll:"Apenas rolar",text:"Apenas texto"}},Lc={common:{not_found:"Entita sa nena\u0161la.",search:"H\u013Eada\u0165",power:"Nap\xE1janie",favorite:"Ob\u013E\xFAben\xE9",loading:"Na\u010D\xEDtava sa...",no_results:"\u017Diadne v\xFDsledky.",close:"Zatvori\u0165",vol_up:"Zv\xFD\u0161i\u0165 hlasitos\u0165",vol_down:"Zn\xED\u017Ei\u0165 hlasitos\u0165",media_player:"Prehr\xE1va\u010D m\xE9di\xED",edit_entity:"Upravi\u0165 nastavenia entity",edit_action:"Upravi\u0165 nastavenia akcie",mute:"Stlmi\u0165",unmute:"Zru\u0161i\u0165 stlmenie",seek:"Posun\xFA\u0165",volume:"Hlasitos\u0165",play_now:"Prehra\u0165 teraz",more_options:"Viac mo\u017Enost\xED",unavailable:"Nedostupn\xE9",back:"Sp\xE4\u0165",cancel:"Zru\u0161i\u0165",reset_default:"Obnovi\u0165 predvolen\xE9",unpin:"Odpn\xFA\u0165",clear:"Vymaza\u0165",album_art:"Grafika albumu"},editor:{tabs:{entities:"Entity",behavior:"Spr\xE1vanie",look_and_feel:"Vzh\u013Ead a dojem",artwork:"Grafika",actions:"Akcie"},search_placeholder:"Vyh\u013Eada\u0165 mo\u017Enosti konfigur\xE1cie...",template_label:"\u0160abl\xF3na karty",templates:{custom:{label:"Vlastn\xE9 (P\xF4vodn\xE1 konfigur\xE1cia)",description:"Va\u0161a p\xF4vodn\xE1, plne prisp\xF4soben\xE1 konfigur\xE1cia."},large_modern:{label:"Ve\u013Ek\xFD modern\xFD YAMP",description:"O nie\u010Do v\xE4\u010D\u0161\xED modern\xFD dizajn s adapt\xEDvnymi ovl\xE1dac\xEDmi prvkami."},crisp_clean:{label:"\u010Cist\xFD",description:"\u010Cist\xE9 rozlo\u017Eenie s prisp\xF4soben\xFDm obalom a modern\xFDmi ovl\xE1dac\xEDmi prvkami."},minimal_mini:{label:"MINImal",description:"Kompaktn\xE1 karta bez obalu."},normal_mini:{label:"Mini Mode",description:"\u0160tandardn\xE1 kompaktn\xE1 karta."},quick_and_easy:{label:"Niet \u010Dasu na vysvet\u013Eovanie",description:"Navrhnut\xE9 pre r\xFDchlos\u0165 s trval\xFDmi riadkami \u010Dipov a r\xFDchlym zoskupovan\xEDm."},dedicated_search:{label:"V\u0161etko o vyh\u013Ead\xE1van\xED",description:"Samostatn\xE1 vyh\u013Ead\xE1vacia karta bez hlavn\xE9ho prehr\xE1va\u010Da m\xE9di\xED."},dedicated_grouping:{label:"Skupinov\xE1 terapia",description:"Samostatn\xE1 karta na zoskupovanie prehr\xE1va\u010Dov. Vy\u017Eaduje viacero nakonfigurovan\xFDch ent\xEDt."},huge_yamp:{label:"To je poriadny YAMP!",description:"Maximalizovan\xE9 ovl\xE1dacie prvky, ve\u013Ek\xFD text a mas\xEDvny indik\xE1tor priebehu pre sledovanie z dia\u013Eky."}},placeholders:{search:"H\u013Eada\u0165 hudbu..."},sections:{artwork:{general:{title:"V\u0161eobecn\xE9 nastavenia",description:"Glob\xE1lne ovl\xE1danie toho, ako sa grafika zobrazuje a z\xEDskava."},idle:{title:"Grafika pri ne\u010Dinnosti",description:"Zobrazi\u0165 statick\xFD obr\xE1zok alebo sn\xEDmku entity, ke\u010F sa ni\u010D neprehr\xE1va."},overrides:{title:"Prep\xEDsania grafiky",description:"Prep\xEDsania sa vyhodnocuj\xFA zhora nadol. Poradie zmen\xEDte potiahnut\xEDm."}},entities:{title:"Entity*",description:"Pridajte prehr\xE1va\u010De m\xE9di\xED, ktor\xE9 chcete ovl\xE1da\u0165. Potiahnut\xEDm ent\xEDt zmen\xEDte poradie v riadku \u010Dipov."},behavior:{idle_chips:{title:"Ne\u010Dinnos\u0165 a \u010Dipy",description:"Vyberte, kedy karta prejde do ne\u010Dinnosti a ako sa spr\xE1vaj\xFA \u010Dipy ent\xEDt."},interactions_search:{title:"Interakcie a h\u013Eadanie",description:"Doladenie prip\xEDnania ent\xEDt a po\u010Dtu zobrazen\xFDch v\xFDsledkov."},lyrics:{title:"Texty piesn\xED",description:"Nastavte, ako sa maj\xFA texty piesn\xED zobrazova\u0165 a kedy sa maj\xFA objavi\u0165."}},look_and_feel:{theme_layout:{title:"T\xE9ma a rozlo\u017Eenie",description:"Prisp\xF4sobte \u0161t\xFDl panelu a ovl\xE1dajte celkov\xFD vzh\u013Ead."},controls_typography:{title:"Ovl\xE1danie a typografia",description:"Nastavenie ve\u013Ekosti tla\u010Didiel, \u0161t\xEDtkov ent\xEDt a adapt\xEDvneho textu."},collapsed_idle:{title:"Zbalen\xE9 stavy a ne\u010Dinnos\u0165",description:"Ovl\xE1dajte, kedy sa karta zbal\xED a ktor\xE9 zobrazenia sa uk\xE1\u017Eu po\u010Das ne\u010Dinnosti."}},actions:{title:"Akcie",description:"Vytvorte ak\u010Dn\xE9 \u010Dipy, ktor\xE9 sa zobrazia na karte alebo v jej menu. Potiahnut\xEDm zmen\xEDte poradie, kliknut\xEDm na ceruzku akciu nakonfigurujete."}},subtitles:{idle_timeout:"\u010Cas v milisekund\xE1ch, k\xFDm karta prejde do re\u017Eimu ne\u010Dinnosti. Nastavte na 0 pre vypnutie.",show_chip_row:'"Auto" skryje riadok \u010Dipov, ak je nakonfigurovan\xE1 len jedna entita. "V menu" presunie \u010Dipy do ponuky menu. "V menu pri ne\u010Dinnosti" zobraz\xED \u010Dipy v riadku ke\u010F je akt\xEDvne, ale presunie ich do menu pri ne\u010Dinnosti.',dim_chips:"Ke\u010F karta prejde do re\u017Eimu ne\u010Dinnosti s obr\xE1zkom, stlmte \u010Dipy ent\xEDt a akci\xED pre \u010Distej\u0161\xED vzh\u013Ead.",hold_to_pin:"Dlh\xFDm stla\u010Den\xEDm \u010Dipov ent\xEDt ich pripnete, \u010D\xEDm zabr\xE1nite automatick\xE9mu prep\xEDnaniu po\u010Das prehr\xE1vania.",always_show_group:"Ovl\xE1dacie prvky r\xFDchleho zoskupovania (+/-/hviezdi\u010Dka) bud\xFA predvolene vidite\u013En\xE9 pri na\u010D\xEDtan\xED str\xE1nky. St\xE1le ich m\xF4\u017Eete manu\xE1lne prep\xEDna\u0165 dvojit\xFDm klepnut\xEDm.",disable_autofocus:"Zabr\xE1ni vyh\u013Ead\xE1vaciemu po\u013Eu prebra\u0165 zameranie, aby zostali kl\xE1vesnice na obrazovke skryt\xE9.",search_within_filter:"Povoli\u0165 vyh\u013Ead\xE1vanie v r\xE1mci aktu\xE1lneho akt\xEDvneho filtra (Ob\u013E\xFAben\xE9, Ned\xE1vno prehr\xE1van\xE9 at\u010F.) namiesto jeho vymazania.",close_search_on_play:"Automaticky zatvori\u0165 obrazovku vyh\u013Ead\xE1vania po spusten\xED skladby.",pin_search_headers:"Ponecha\u0165 pole vyh\u013Ead\xE1vania a filtre pevne navrchu po\u010Das pos\xFAvania v\xFDsledkov.",hide_search_headers_on_idle:"Skry\u0165 vyh\u013Ead\xE1vanie a filtre, ke\u010F je prehr\xE1va\u010D ne\u010Dinn\xFD.",disable_mass:"Deaktivova\u0165 volite\u013En\xFA integr\xE1ciu Mass Queue, aj ke\u010F je nain\u0161talovan\xE1.",swap_pause_stop:"Nahradi\u0165 tla\u010Didlo pauzy tla\u010Didlom zastavenia pri pou\u017Eit\xED modern\xE9ho rozlo\u017Eenia.",show_album:"Zobrazi\u0165 n\xE1zov albumu ved\u013Ea interpreta v podrobnostiach prehr\xE1va\u010Da.",adaptive_controls:"Umo\u017Eni\u0165 tla\u010Didl\xE1m prehr\xE1vania meni\u0165 ve\u013Ekos\u0165 pod\u013Ea dostupn\xE9ho priestoru.",hide_menu_player:"Ke\u010F s\xFA \u010Dipy v menu, skry\u0165 n\xE1zov entity v spodnej \u010Dasti karty.",hide_reorder_progress:"Skry\u0165 pl\xE1vaj\xFAci indik\xE1tor priebehu preusporiadania frontu v spodnej \u010Dasti.",adaptive_text:"Vyberte skupiny textu, ktor\xE9 sa maj\xFA \u0161k\xE1lova\u0165 pod\u013Ea priestoru (nechajte pr\xE1zdne pre vypnutie).",collapse_expand:'"V\u017Edy zbalen\xE9" vytvor\xED re\u017Eim mini prehr\xE1va\u010Da. "Rozbali\u0165 pri h\u013Eadan\xED" kartu do\u010Dasne rozbal\xED pri vyh\u013Ead\xE1van\xED.',disable_mini_menu:"N\xE1vrat k \u0161tandardn\xFDm zoznamom namiesto pou\u017Eitia nov\xFDch mini mrie\u017Ekov\xFDch pon\xFAk v re\u017Eime 'V\u017Edy zbalen\xE9'.",idle_screen:"Vyberte obrazovku, ktor\xE1 sa m\xE1 automaticky zobrazi\u0165 v re\u017Eime ne\u010Dinnosti.",hide_controls:"Vyberte ovl\xE1dacie prvky, ktor\xE9 chcete pre t\xFAto entitu skry\u0165 (\u0161tandardne s\xFA zobrazen\xE9 v\u0161etky).",hide_remote_buttons:"Vyberte tla\u010Didl\xE1, ktor\xE9 chcete skry\u0165 v prekryt\xED dia\u013Ekov\xE9ho ovl\xE1dania.",hide_search_chips:"Skry\u0165 konkr\xE9tne \u010Dipy filtra vyh\u013Ead\xE1vania pre t\xFAto entitu.",hide_active_entity_on_idle:"Skryje \u0161t\xEDtok entity v dolnej \u010Dasti karty iba vtedy, ke\u010F je prehr\xE1va\u010D ne\u010Dinn\xFD.",follow_active_entity:"Ak je povolen\xE9, entita hlasitosti bude automaticky sledova\u0165 akt\xEDvny prehr\xE1va\u010D. Pozn\xE1mka: Toto prep\xED\u0161e vybran\xFA entitu hlasitosti.",search_limit_full:"Maxim\xE1lny po\u010Det v\xFDsledkov vyh\u013Ead\xE1vania (predvolen\xE9: 20).",default_search_filter_full:"Vyberte, ktor\xFD filter bude predvolene akt\xEDvny pri otvoren\xED vyh\u013Ead\xE1vania.",default_search_favorites:"Spusti\u0165 vyh\u013Ead\xE1vanie s akt\xEDvnymi ob\u013E\xFAben\xFDmi",result_sorting_full:"Vyberte sp\xF4sob zoradenia v\xFDsledkov. Predvolen\xE9 ponech\xE1va poradie zo zdroja.",card_height_full:"Nechajte pr\xE1zdne pre automatick\xFA v\xFD\u0161ku.",control_layout_full:"Vyberte si medzi star\u0161\xEDm (rovnako ve\u013Ek\xE9 prvky) alebo modern\xFDm rozlo\u017Een\xEDm Home Assistant.",artwork_extend:"Umo\u017Eni\u0165 pozadiu grafiky pokra\u010Dova\u0165 pod riadkami \u010Dipov a akci\xED.",artwork_extend_label:"Roz\u0161\xEDri\u0165 grafiku",no_artwork_overrides:"Nie s\xFA nastaven\xE9 \u017Eiadne prep\xEDsania grafiky. Pridajte ich pomocou tla\u010Didla plus.",missing_art_match:"Plat\xED, ke\u010F vybrat\xE9 m\xE9di\xE1 neposkytuj\xFA \u017Eiadny obr\xE1zok.",idle_image_match:"Plat\xED, ke\u010F je prehr\xE1va\u010D ne\u010Dinn\xFD a zobrazuje sa obr\xE1zok ne\u010Dinnosti.",entity_current_hint:"Pou\u017Eite 'entity_id: current' na zacielenie aktu\xE1lne vybranej entity na karte.",jinja_template_hint:"Zadajte Jinja \u0161abl\xF3nu, ktor\xE1 vr\xE1ti jedno entity_id. Pr\xEDklad prep\xEDnania MA na z\xE1klade v\xFDberu zdroja:",jinja_template_vol_hint:"Zadajte Jinja \u0161abl\xF3nu, ktor\xE1 vr\xE1ti entity_id (napr. media_player.obyvacka). Pr\xEDklad prep\xEDnania hlasitosti pod\u013Ea stavu:",jinja_template_remote_hint:"Zadajte Jinja \u0161abl\xF3nu, ktor\xE1 vr\xE1ti entity_id dia\u013Ekov\xE9ho ovl\xE1da\u010Da (napr. remote.obyvacka_tv):",not_available_alt_collapsed:"Nedostupn\xE9 s alternat\xEDvnym indik\xE1torom priebehu alebo v re\u017Eime V\u017Edy zbalen\xE9.",not_available_collapsed:"Nedostupn\xE9, ke\u010F je zapnut\xE9 V\u017Edy zbalen\xE9.",only_available_collapsed:"Dostupn\xE9 len pri zapnutom re\u017Eime V\u017Edy zbalen\xE9.",only_available_mini_menu:"K dispoz\xEDcii iba vtedy, ke\u010F je 'V\u017Edy zbalen\xE9' zapnut\xE9 a 'Rozbali\u0165 pri vyh\u013Ead\xE1van\xED' vypnut\xE9",only_available_modern:"Dostupn\xE9 len s modern\xFDm rozlo\u017Een\xEDm.",image_url_helper:"Zadajte priamu URL na obr\xE1zok alebo lok\xE1lnu cestu k s\xFAboru",selected_entity_helper:"Pomocn\xEDk pre vstupn\xFD text, ktor\xFD bude aktualizovan\xFD o ID aktu\xE1lne vybranej entity prehr\xE1va\u010Da m\xE9di\xED.",select_entity_helper:"Pomocn\xEDk pre vstupn\xFD text, z ktor\xE9ho sa \u010D\xEDta ID entity. Karta automaticky vyberie zodpovedaj\xFAci \u010Dip.",sync_entity_type:"Vyberte, ktor\xE9 ID entity sa m\xE1 synchronizova\u0165 s pomocn\xEDkom (predvolene entita Music Assistant, ak je nakonfigurovan\xE1).",disable_auto_select:"Zabr\xE1ni automatick\xE9mu v\xFDberu \u010Dipu tejto entity pri spusten\xED prehr\xE1vania.",search_view:"Vyberte si medzi \u0161tandardn\xFDm zoznamom alebo mrie\u017Ekou kariet pre v\xFDsledky vyh\u013Ead\xE1vania.",search_card_columns:"Zadajte, ko\u013Eko st\u013Apcov sa m\xE1 pou\u017Ei\u0165 v zobrazen\xED karty. Grafika sa automaticky prisp\xF4sob\xED.",card_type:"Vyberte re\u017Eim karty. 'Predvolen\xE9' je \u0161tandardn\xFD prehr\xE1va\u010D m\xE9di\xED. 'Vyhraden\xE9 vyh\u013Ead\xE1vanie' urob\xED z karty trval\xE9 rozhranie na vyh\u013Ead\xE1vanie.",always_show_lyrics:"Automaticky otvori\u0165 zobrazenie textov piesn\xED pri obnoven\xED str\xE1nky.",lyrics_source:"Music Assistant vy\u017Eaduje integr\xE1ciu mass_queue na na\u010D\xEDtanie textov z jeho intern\xE9ho metad\xE1tov\xE9ho modulu.",lyrics_pre_roll:"Posunutie na\u010Dasovania zv\xFDraznenia textu piesne. Kladn\xE9 hodnoty ho zr\xFDch\u013Euj\xFA, z\xE1porn\xE9 spoma\u013Euj\xFA (predvolen\xE9: 0).",blurred_artwork:"V\u017Edy rozmaza\u0165 obr\xE1zok na pozad\xED",hide_collapsed_artwork:"Skry\u0165 mal\xFD obr\xE1zok vpravo, ke\u010F je karta zbalen\xE1",show_idle_artwork_when_not_playing:"Ke\u010F je t\xE1to mo\u017Enos\u0165 povolen\xE1, pri v\xFDbere \u010Dipu, na ktorom sa moment\xE1lne ni\u010D neprehr\xE1va, sa namiesto akt\xEDvnej grafiky prehr\xE1vania zobraz\xED nakonfigurovan\xFD obr\xE1zok pri ne\u010Dinnosti.",prefer_ma_metadata:"V\u017Edy pou\u017E\xEDvajte sp\xE1rovan\xFA entitu Music Assistant pre n\xE1zov skladby, interpreta a grafiku, aj ke\u010F sa prehr\xE1va prim\xE1rna entita.",show_volume_overlay:"Pri zmene \xFArovne hlasitosti nakr\xE1tko zobraz\xED ve\u013Ek\xFD ukazovate\u013E hlasitosti cez grafiku albumu.",queue_controls_style:"Vyberte, \u010Di sa m\xE1 pre polo\u017Eky fronty zobrazi\u0165 \xFAchyt na \u0165ahanie alebo jednotliv\xE9 tla\u010Didl\xE1 pohybu."},titles:{edit_entity:"Upravi\u0165 entitu",edit_action:"Upravi\u0165 akciu",service_data:"Servisn\xE9 \xFAdaje",add_artwork_override:"Prida\u0165 prep\xEDsanie grafiky"},labels:{toggle_template_mode:"Prepn\xFA\u0165 re\u017Eim \u0161abl\xF3ny",dim_chips:"Stlmi\u0165 \u010Dipy pri ne\u010Dinnosti",hold_to_pin:"Podr\u017Ea\u0165 pre pripnutie",always_show_group:"R\xFDchle zoskupovanie ako predvolen\xE9",disable_autofocus:"Vypn\xFA\u0165 automatick\xE9 zameranie h\u013Eadania",keep_filters:"Zachova\u0165 filtre pri h\u013Eadan\xED",dismiss_on_play:"Zavrie\u0165 h\u013Eadanie po spusten\xED",pin_headers:"Pripn\xFA\u0165 hlavi\u010Dky h\u013Eadania",hide_search_headers_on_idle:"Skry\u0165 hlavi\u010Dky pri ne\u010Dinnosti",default_search_filter:"Predvolen\xFD filter vyh\u013Ead\xE1vania",default_search_favorites:"Predvolen\xFD filter ob\u013E\xFAben\xFDch",disable_mass:"Deaktivova\u0165 Mass Queue",match_theme:"Pod\u013Ea t\xE9my",alt_progress:"Alternat\xEDvny indik\xE1tor priebehu",progress_bar_height:"V\xFD\u0161ka indik\xE1tora priebehu",display_timestamps:"Zobrazi\u0165 \u010Dasov\xE9 \xFAdaje",swap_pause_stop:"Vymeni\u0165 pauzu za stop",show_album:"Zobrazi\u0165 n\xE1zov albumu",adaptive_controls:"Adapt\xEDvna ve\u013Ekos\u0165 ovl\xE1dania",hide_active_entity:"Skry\u0165 \u0161t\xEDtok akt\xEDvnej entity",hide_active_entity_on_idle:"Skry\u0165 \u0161t\xEDtok akt\xEDvnej entity pri ne\u010Dinnosti",collapse_on_idle:"Zbali\u0165 pri ne\u010Dinnosti",hide_menu_player_toggle:"Skry\u0165 prehr\xE1va\u010D v menu",hide_reorder_progress_toggle:"Skry\u0165 priebeh preusporiadania",always_collapsed:"V\u017Edy zbalen\xE9",disable_mini_menu:"Vypn\xFA\u0165 mini mrie\u017Ekov\xE9 ponuky",expand_on_search:"Rozbali\u0165 pri h\u013Eadan\xED",script_var:"Premenn\xE1 skriptu (yamp_entity)",use_ma_template:"Pou\u017Ei\u0165 \u0161abl\xF3nu pre Music Assistant",use_vol_template:"Pou\u017Ei\u0165 \u0161abl\xF3nu pre entitu hlasitosti",follow_active_entity:"Hlasitos\u0165 sleduje akt\xEDvnu entitu",use_url_path:"Pou\u017Ei\u0165 URL alebo cestu",adaptive_text_elements:"Prvky s adapt\xEDvnou ve\u013Ekos\u0165ou textu",disable_auto_select:"Zak\xE1za\u0165 automatick\xFD v\xFDber",always_show_lyrics:"V\u017Edy zobrazi\u0165 texty piesn\xED",lyrics_mode:"Re\u017Eim textov piesn\xED",lyrics_source:"Zdroj textov",lyrics_pre_roll:"Pre-roll textu piesne (sekundy)",blurred_artwork:"Rozmazan\xFD obr\xE1zok",hide_collapsed_artwork:"Skry\u0165 zmen\u0161en\xFD obr\xE1zok",show_idle_artwork_when_not_playing:"Zobrazi\u0165 obr\xE1zok ne\u010Dinnosti, ke\u010F sa neprehr\xE1va",prefer_ma_metadata:"Uprednostni\u0165 metad\xE1ta z Music Assistant",show_volume_overlay:"Zobrazi\u0165 prekrytie hlasitosti"},fields:{artwork_fit:"Prisp\xF4sobenie grafiky",artwork_position:"Poz\xEDcia grafiky",artwork_hostname:"Hostname pre grafiku",match_field:"Pole pre zhodu",match_value:"Hodnota pre zhodu",size_percent:"Ve\u013Ekos\u0165 (%)",object_fit:"Prisp\xF4sobenie objektu (Fit)",idle_timeout:"\u010Cas ne\u010Dinnosti (ms)",show_chip_row:"Zobrazi\u0165 riadok \u010Dipov",search_limit:"Limit v\xFDsledkov h\u013Eadania",result_sorting:"Zoradenie v\xFDsledkov",vol_step:"Krok hlasitosti (0.05 = 5%)",card_height:"V\xFD\u0161ka karty (px)",control_layout:"Rozlo\u017Eenie ovl\xE1dania",idle_image:"Obr\xE1zok ne\u010Dinnosti",image_url:"URL obr\xE1zka",fallback_image_url:"Z\xE1lo\u017En\xE1 URL obr\xE1zka",move_to_main:"Presun\xFA\u0165 do hlavn\xFDch \u010Dipov",move_to_menu:"Presun\xFA\u0165 do menu",delete_action:"Vymaza\u0165 akciu",volume_mode:"Re\u017Eim hlasitosti",idle_screen:"Obrazovka pri ne\u010Dinnosti",name:"N\xE1zov",hidden_controls:"Skryt\xE9 ovl\xE1dacie prvky",hide_remote_buttons:"Skryt\xE9 tla\u010Didl\xE1 dia\u013Ekov\xE9ho ovl\xE1dania",ma_template:"Jinja \u0161abl\xF3na pre Music Assistant",hidden_chips:"Skryt\xE9 \u010Dipy filtrov h\u013Eadania",vol_template:"Jinja \u0161abl\xF3na pre hlasitos\u0165",icon:"Ikona",action_type:"Typ akcie",menu_item:"Polo\u017Eka menu",nav_path:"Cesta navig\xE1cie",service:"Slu\u017Eba",service_data:"Servisn\xE9 \xFAdaje",idle_image_entity:"Entita obr\xE1zka pri ne\u010Dinnosti",match_entity:"Entita pre zhodu",ma_entity:"Entita Music Assistant",vol_entity:"Entita hlasitosti",remote_entity:"Entita dia\u013Ekov\xE9ho ovl\xE1da\u010Da",remote_template:"\u0160abl\xF3na entity dia\u013Ekov\xE9ho ovl\xE1da\u010Da (Jinja)",selected_entity_helper:"Pomocn\xEDk vybratej entity",sync_entity_type:"Typ entity na synchroniz\xE1ciu",placement:"Umiestnenie",card_trigger:"Sp\xFA\u0161\u0165a\u010D karty",search_view:"Zobrazenie v\xFDsledkov vyh\u013Ead\xE1vania",search_card_columns:"St\u013Apce karty",card_type:"Typ karty",appearance:"Vzh\u013Ead",no_artwork_option:"\u017Diadny obr\xE1zok",details_alignment:"Zarovnanie detailov",queue_controls_style:"\u0160t\xFDl ovl\xE1dac\xEDch prvkov fronty"},action_types:{menu:"Otvori\u0165 polo\u017Eku menu karty",service:"Zavola\u0165 slu\u017Ebu",navigate:"Navigova\u0165",prev_entity:"Predo\u0161l\xFD \u010Dip entity",next_entity:"\u010Eal\u0161\xED \u010Dip entity",sync_selected_entity:"Synchronizova\u0165 vybran\xFA entitu",select_entity:"Vybra\u0165 entitu z pomocn\xEDka",toggle_lyrics:"Prepn\xFA\u0165 prekrytie textov piesn\xED",remote_control:"Otvori\u0165 prekr\xFDvanie dia\u013Ekov\xE9ho ovl\xE1dania"},action_helpers:{sync_selected_entity:"Synchronizova\u0165 vybran\xFA entitu \u2192",select_entity:"Vybra\u0165 entitu \u2190",select_helper:"(vybra\u0165 pomocn\xEDka)"},sync_entity_options:{yamp_entity:"yamp_entity (Entita Music Assistant, ak je nakonfigurovan\xE1)",yamp_main_entity:"yamp_main_entity (Hlavn\xE1 entita prehr\xE1va\u010Da m\xE9di\xED)",yamp_playback_entity:"yamp_playback_entity (Aktu\xE1lna akt\xEDvna entita prehr\xE1vania)"},placements:{chip:"Ak\u010Dn\xFD \u010Dip",menu:"V menu",hidden:"Skryt\xE9 (\u0164uknutie na grafiku)",replace_search:"Nahradi\u0165 Vyh\u013Ead\xE1vanie",replace_power:"Nahradi\u0165 Nap\xE1janie",replace_mute:"Nahradi\u0165 Stlmenie",replace_favorite:"Nahradi\u0165 Ob\u013E\xFAben\xE9",not_triggerable:"Nespustite\u013En\xE9"},triggers:{none:"\u017Diadny",tap:"\u0164uknutie",hold:"Podr\u017Eanie",double_tap:"Dvojit\xE9 \u0165uknutie",swipe_left:"Potiahnutie do\u013Eava",swipe_right:"Potiahnutie doprava"},search_view_options:{list:"Zoznam",card:"Karta",card_minimal:"Minim\xE1lna karta"},queue_controls_style_options:{drag_handle:"\xDAchyt na \u0165ahanie",icons:"Tla\u010Didl\xE1 pohybu"},card_type_options:{default:"Predvolen\xE9",search:"H\u013Eada\u0165",group_players:"Zoskupi\u0165 prehr\xE1va\u010De",up_next:"Nasleduje",remote_control:"Dia\u013Ekov\xE9 ovl\xE1danie"},appearance_options:{automatic:"Automaticky",light:"Svetl\xFD",dark:"Tmav\xFD"},artwork_fit:{default:"Glob\xE1lne",cover:"Obal (predvolen\xE9)",contain:"Prisp\xF4sobi\u0165",fill:"Vyplni\u0165","scale-down":"Zmen\u0161i\u0165","scaled-contain":"\u0160k\xE1lovan\xE9 prisp\xF4sobenie","scaled-contain-alternate":"\u0160k\xE1lovan\xE9 prisp\xF4sobenie alternat\xEDvne",none:"\u017Diadne"},artwork_position:{default:"Glob\xE1lne",top:"Hore",center:"Stred",bottom:"Dole"}},card:{sections:{details:"Detaily prehr\xE1vania",menu:"Menu a vyh\u013Ead\xE1vanie",action_chips:"Ak\u010Dn\xE9 \u010Dipy",lyrics:"Texty piesn\xED"},media_controls:{shuffle:"N\xE1hodne",previous:"Predch\xE1dzaj\xFAce",play_pause:"Prehra\u0165/Pozastavi\u0165",stop:"Zastavi\u0165",next:"Nasleduj\xFAce",repeat:"Opakova\u0165"},menu:{more_info:"Viac inform\xE1ci\xED",search:"H\u013Eada\u0165",source:"Zdroj",remote_controls:"Dia\u013Ekov\xE9 ovl\xE1danie",show_lyrics:"Zobrazi\u0165 text piesne",hide_lyrics:"Skry\u0165 text piesne",transfer_queue:"Presun\xFA\u0165 frontu",main_menu:"Hlavn\xE9 menu",group_players:"Zoskupi\u0165 prehr\xE1va\u010De",up_next:"Nasleduje",remote_control:"Dia\u013Ekov\xE9 ovl\xE1danie",select_entity:"Vyberte entitu pre viac info",transfer_to:"Presun\xFA\u0165 frontu do",no_players:"\u017Diadne in\xE9 prehr\xE1va\u010De Music Assistant nie s\xFA k dispoz\xEDcii."},remote:{title:"Dia\u013Ekov\xE9 ovl\xE1danie",up:"Hore",down:"Dole",left:"Do\u013Eava",right:"Doprava",select:"Vybra\u0165",back:"Sp\xE4\u0165",menu:"Menu",home:"Domov",power:"Nap\xE1janie"},grouping:{title:"Zoskupi\u0165 prehr\xE1va\u010De",sync_volume:"Synchronizova\u0165 hlasitos\u0165",group_all:"Zoskupi\u0165 v\u0161etko",ungroup_all:"Zru\u0161i\u0165 zoskupenie v\u0161etk\xE9ho",unavailable:"Prehr\xE1va\u010D je nedostupn\xFD",no_players:"\u017Diadne in\xE9 prehr\xE1va\u010De schopn\xE9 zoskupenia nie s\xFA k dispoz\xEDcii.",master:"Hlavn\xFD (Master)",joined:"Pripojen\xFD",available:"Dostupn\xFD",current:"Aktu\xE1lny",unjoin_from:"Odpoji\u0165 od {master}",join_with:"Pripoji\u0165 k {master}"}},search:{favorites:"Ob\u013E\xFAben\xE9",recently_played:"Ned\xE1vno prehr\xE1van\xE9",next_up:"Nasleduj\xFAce",recommendations:"Odpor\xFA\u010Dania",radio_mode:"Re\u017Eim r\xE1dio",show_track_options:"Zobrazi\u0165 mo\u017Enosti skladby",play_similar:"Prehra\u0165 podobn\xE9 skladby",close:"Zatvori\u0165 vyh\u013Ead\xE1vanie",no_results:"\u017Diadne v\xFDsledky.",play_next:"Prehra\u0165 ako nasleduj\xFAce",replace_play:"Nahradi\u0165 frontu a prehra\u0165 teraz",replace:"Nahradi\u0165 frontu",add_queue:"Prida\u0165 na koniec fronty",move_up:"Posun\xFA\u0165 nahor",move_down:"Posun\xFA\u0165 nadol",move_next:"Presun\xFA\u0165 na nasleduj\xFAce",remove:"Odstr\xE1ni\u0165 z fronty",drag_to_reorder:"Potiahnite pre zmenu poradia",added:"Pridan\xE9 do fronty!",added_to_playlist:"Pridan\xE9 do playlistu!",select_playlist:"Vybra\u0165 playlist pre '{track}'",add_to_playlist:"Prida\u0165 do playlistu",select_track_for_playlist:"Vybra\u0165 skladbu na pridanie pre '{track}' od {artist}",labels:{replace:"Nahradi\u0165",next:"Nasleduj\xFAce",replace_next:"Nahradi\u0165 nasleduj\xFAce",add:"Prida\u0165",add_to_playlist:"Prida\u0165 do playlistu"},results:"v\xFDsledkov",result:"v\xFDsledok",filters:{all:"V\u0161etko",artist:"Interpret",album:"Album",track:"Skladba",playlist:"Playlist",radio:"R\xE1dio",music:"Hudba",station:"Stanica",podcast:"Podcast",audiobook:"Audiokniha"},search_artist:"H\u013Eada\u0165 tohto interpreta",search_album:"Preh\u013Ead\xE1va\u0165 skladby z tohto albumu",browse_album:"Preh\u013Ead\xE1va\u0165 skladby z {album}",play_collection:"Prehra\u0165 t\xFAto kolekciu",play_collection_error:"T\xFAto kolekciu nie je mo\u017En\xE9 prehra\u0165 priamo",play_item:"Prehra\u0165 {item}"},lyrics:{finding:"H\u013Eadanie textu piesne...",none_found:"\u017Diadny text piesne sa nena\u0161iel",not_available:"Text piesne nie je k dispoz\xEDcii",instrumental:"In\u0161trument\xE1lna skladba",admin_only_mass:"Z\xEDskavanie textov piesn\xED cez Music Assistant je dostupn\xE9 len pre administr\xE1torov. Odpor\xFA\u010Da sa prepn\xFA\u0165 na lrclib v konfigur\xE1cii karty.",fallback_to_lrclib_non_admin:"Zisten\xFD neadministr\xE1torsk\xFD pou\u017E\xEDvate\u013E. Prechod na lrclib pre z\xEDskanie textov piesn\xED."},lyrics_sources:{mass_lrclib:"Music Assistant (Z\xE1loha na LRCLIB)",mass:"Len Music Assistant",lrclib:"Len LRCLIB",lrclib_mass:"LRCLIB (Z\xE1loha na Music Assistant)"},lyrics_modes:{default:"Predvolen\xE9 (Zv\xFDrazni\u0165 a pos\xFAva\u0165)",scroll:"Len pos\xFAva\u0165",text:"Len text"}},qc={common:{not_found:"Entiteta ni najdena.",search:"I\u0161\u010Di",power:"Napajanje",favorite:"Priljubljeno",loading:"Nalaganje...",no_results:"Ni rezultatov.",close:"Zapri",vol_up:"Pove\u010Daj glasnost",vol_down:"Zmanj\u0161aj glasnost",media_player:"Predvajalnik predstavnosti",edit_entity:"Uredi nastavitve entitete",edit_action:"Uredi nastavitve dejanja",mute:"Uti\u0161aj",unmute:"Vklopi zvok",seek:"Previj",volume:"Glasnost",play_now:"Predvajaj zdaj",more_options:"Ve\u010D mo\u017Enosti",unavailable:"Ni na voljo",back:"Nazaj",cancel:"Prekli\u010Di",reset_default:"Ponastavi na privzeto",unpin:"Odpni",clear:"Po\u010Disti",album_art:"Naslovnica albuma"},editor:{tabs:{entities:"Entitete",behavior:"Vedenje",look_and_feel:"Videz in ob\u010Dutek",artwork:"Grafika",actions:"Dejanja"},search_placeholder:"Iskanje mo\u017Enosti konfiguracije...",template_label:"Predloga kartice",templates:{custom:{label:"Po meri (Izvirna konfiguracija)",description:"Va\u0161a izvirna, popolnoma prilagojena konfiguracija."},large_modern:{label:"Velik sodoben YAMP",description:"Nekoliko ve\u010Dji sodoben dizajn s prilagodljivimi kontrolami."},crisp_clean:{label:"\u010Cisto",description:"\u010Cista postavitev s prilagojeno sliko albuma in sodobnimi kontrolami."},minimal_mini:{label:"MINImal",description:"Kompaktna kartica brez naslovnice."},normal_mini:{label:"Mini Mode",description:"Standardna kompaktna kartica."},quick_and_easy:{label:"Ni \u010Dasa za razlago",description:"Zasnovano za hitrost s trajnimi vrsticami \u010Dipov in hitrim zdru\u017Eevanjem."},dedicated_search:{label:"Vse o iskanju",description:"Samostojna kartica za iskanje brez glavnega predvajalnika medijev."},dedicated_grouping:{label:"Skupinska terapija",description:"Samostojna kartica za zdru\u017Eevanje predvajalnikov. Zahteva ve\u010D konfiguriranih entitet."},huge_yamp:{label:"To je ogromen YAMP!",description:"Maksimizirane kontrole, veliko besedilo in masivna vrstica napredka za ogled od dale\u010D."}},placeholders:{search:"I\u0161\u010Di glasbo..."},sections:{artwork:{general:{title:"Splo\u0161ne nastavitve",description:"Globalni nadzor nad prikazom in pridobivanjem grafike."},idle:{title:"Grafika v mirovanju",description:"Prika\u017Ei stati\u010Dno sliko ali posnetek entitete, ko se ni\u010D ne predvaja."},overrides:{title:"Prepis grafike",description:"Prepisi se ocenjujejo od zgoraj navzdol. Povlecite za spremembo vrstnega reda."}},entities:{title:"Entitete*",description:"Dodajte predvajalnike, ki jih \u017Eelite upravljati. Povlecite entitete za spremembo vrstnega reda."},behavior:{idle_chips:{title:"Mirovanje in \u010Dipi",description:"Izberite, kdaj kartica preide v mirovanje in kako se obna\u0161ajo \u010Dipi entitet."},interactions_search:{title:"Interakcije in iskanje",description:"Nastavite pripenjanje entitet in \u0161tevilo prikazanih rezultatov."},lyrics:{title:"Besedila",description:"Konfigurirajte, kako so besedila prikazana in kdaj se pojavijo."}},look_and_feel:{theme_layout:{title:"Tema in postavitev",description:"Ujemanje s slogom nadzorne plo\u0161\u010De in nadzor velikosti."},controls_typography:{title:"Kontrolniki in tipografija",description:"Prilagodite velikost gumbov, oznake entitet in prilagodljivo besedilo."},collapsed_idle:{title:"Strnjeno in mirovanje",description:"Nadzorujte, kdaj se kartica skr\u010Di in kaj se prika\u017Ee v mirovanju."}},actions:{title:"Dejanja",description:"Ustvarite \u010Dipe dejanj, ki se prika\u017Eejo na kartici ali v meniju."}},subtitles:{idle_timeout:"\u010Cas v milisekundah, preden kartica preide v mirovanje. Nastavite na 0 za izklop.",show_chip_row:'"Samodejno" skrije \u010Dipe, \u010De je nastavljena ena entiteta. "V meniju" jih premakne v meni. "V meniju med nedejavnostjo" prika\u017Ee \u010Dipe v vrstici, ko je aktivna, a jih premakne v meni med nedejavnostjo.',dim_chips:"Ko kartica preide v mirovanje s sliko, se \u010Dipi zatemnijo.",hold_to_pin:"Dolgi pritisk za pripenjanje entitet namesto kratkega.",always_show_group:"Kontrolni elementi za hitro zdru\u017Eevanje (+/-/zvezda) bodo privzeto vidni ob nalaganju strani. \u0160e vedno jih lahko ro\u010Dno preklopite z dvojnim tapom.",disable_autofocus:"Prepre\u010Di samodejni fokus iskalnega polja.",search_within_filter:"I\u0161\u010Di znotraj trenutnega filtra.",close_search_on_play:"Samodejno zapri iskanje ob predvajanju.",pin_search_headers:"Pripni iskalno polje in filtre na vrh.",hide_search_headers_on_idle:"Skrij iskalno polje in filtre med mirovanjem.",disable_mass:"Onemogo\u010Di integracijo Mass Queue.",swap_pause_stop:"Zamenjaj gumb pavze z gumbom zaustavitve med uporabo moderne postavitve.",show_album:"Prika\u017Ei ime albuma zraven izvajalca v podrobnostih predvajalnika.",adaptive_controls:"Prilagodi velikost gumbov glede na prostor.",hide_menu_player:"Skrij oznako entitete v meniju.",hide_reorder_progress:"Skrij lebde\u010Di indikator napredka prerazvr\u0161\u010Danja \u010Dakalne vrste na dnu.",adaptive_text:"Izberi skupine besedila za prilagajanje velikosti.",collapse_expand:"Vedno skr\u010Deno ustvari mini predvajalnik.",disable_mini_menu:"Vrnite se na standardne sezname namesto uporabe novih mini mre\u017Enih menijev v na\u010Dinu 'Vedno strnjeno'.",idle_screen:"Izberi zaslon, prikazan v mirovanju.",hide_controls:"Izberi kontrolnike za skrivanje.",hide_remote_buttons:"Izberite gumbe za skrivanje na daljinskem upravljalniku.",hide_search_chips:"Skrij dolo\u010Dene iskalne filtre.",hide_active_entity_on_idle:"Skrije oznako entitete na dnu kartice le, ko je predvajalnik v stanju mirovanja.",follow_active_entity:"Entiteta glasnosti sledi aktivni entiteti. Opomba: To prepi\u0161e izbrano entiteto za glasnost.",search_limit_full:"Najve\u010Dje \u0161tevilo rezultatov (privzeto: 20).",default_search_filter_full:"Izberite, kateri filter je privzeto aktiven ob odprtju iskanja.",default_search_favorites:"Za\u010Dni iskanje z aktivnimi priljubljenimi",result_sorting_full:"Izberi razvr\u0161\u010Danje rezultatov.",card_height_full:"Pustite prazno za samodejno vi\u0161ino.",control_layout_full:"Izberi med staro in moderno postavitvijo.",artwork_extend:"Raz\u0161iri ozadje grafike pod \u010Dipe.",artwork_extend_label:"Raz\u0161iri grafiko",no_artwork_overrides:"Ni nastavljenih prepisov grafike.",missing_art_match:"Velja, ko izbrana vsebina nima slike.",idle_image_match:"Velja, ko predvajalnik miruje in se prikazuje slika v mirovanju.",entity_current_hint:"Uporabi entity_id: current za trenutno izbrano entiteto.",jinja_template_hint:"Vnesite Jinja predlogo, ki vrne en entity_id.",jinja_template_vol_hint:"Vnesite Jinja predlogo za entiteto glasnosti.",jinja_template_remote_hint:"Vnesite Jinja predlogo, ki vrne entity_id daljinskega upravljalnika (npr. remote.dnevna_soba_tv):",not_available_alt_collapsed:"Ni na voljo z alternativno vrstico napredka.",not_available_collapsed:"Ni na voljo v vedno skr\u010Denem na\u010Dinu.",only_available_collapsed:"Na voljo le v vedno skr\u010Denem na\u010Dinu.",only_available_mini_menu:"Na voljo samo, ko je 'Vedno strnjeno' omogo\u010Deno in 'Raz\u0161iri ob iskanju' onemogo\u010Deno",only_available_modern:"Na voljo le v moderni postavitvi.",image_url_helper:"Vnesite neposredni URL do slike ali lokalno pot do datoteke",selected_entity_helper:"Pomo\u010Dnik za vnos besedila, ki bo posodobljen z ID-jem trenutno izbranega predvajalnika medijev.",select_entity_helper:"Pomo\u010Dnik za vnos besedila, iz katerega se bere ID entitete. Kartica bo samodejno izbrala ustrezni \u010Dip.",sync_entity_type:"Izberite, kateri ID entitete \u017Eelite sinhronizirati s pomo\u010Dnikom (privzeto entiteto Music Assistant, \u010De je nastavljena).",disable_auto_select:"Prepre\u010Di samodejno izbiro \u010Dipa te entitete ob za\u010Detku predvajanja.",search_view:"Izberite med standardnim seznamom ali mre\u017Eo kartic za rezultate iskanja.",search_card_columns:"Dolo\u010Dite \u0161tevilo stolpcev v pogledu kartic. Grafika se bo samodejno prilagodila.",card_type:"Izberite na\u010Din kartice. 'Privzeto' je standardni medijski predvajalnik. 'Namensko iskanje' spremeni kartico v trajen iskalni vmesnik.",always_show_lyrics:"Samodejno odprite pogled besedila, ko se stran osve\u017Ei.",lyrics_source:"Music Assistant zahteva integracijo mass_queue za pridobivanje besedil iz svojega notranjega mehanizma metapodatkov.",lyrics_pre_roll:"Zamaknite \u010Dasovno uskladitev ozna\u010Devanja besedila. Pozitivne vrednosti ga pospe\u0161ijo, negativne pa upo\u010Dasnijo (privzeto: 0).",blurred_artwork:"Vedno zamegli ozadje",hide_collapsed_artwork:"Skrij majhno sliko na desni, ko je kartica strnjena",show_idle_artwork_when_not_playing:"Ko je to omogo\u010Deno, se ob izbiri \u010Dipa, na katerem se trenutno ni\u010D ne predvaja, prika\u017Ee nastavljena slika za nedejavnost namesto aktivne grafike predvajanja.",prefer_ma_metadata:"Za naslov skladbe, izvajalca in grafiko vedno uporabi seznanjeno entiteto Music Assistant, tudi \u010De se predvaja primarna entiteta.",show_volume_overlay:"Ob spremembi glasnosti za kratek \u010Das prika\u017Ee velik indikator glasnosti \u010Dez naslovnico.",queue_controls_style:"Izberite, ali \u017Eelite prikazati ro\u010Daj za vle\u010Denje ali posamezne gumbe za premikanje elementov \u010Dakalne vrste."},titles:{edit_entity:"Uredi entiteto",edit_action:"Uredi dejanje",service_data:"Podatki storitve",add_artwork_override:"Dodaj prepis grafike"},labels:{toggle_template_mode:"Preklopi na\u010Din predloge",dim_chips:"Zatemni \u010Dipe v mirovanju",hold_to_pin:"Dr\u017Ei za pripenjanje",always_show_group:"Hitro zdru\u017Eevanje kot privzeto",disable_autofocus:"Onemogo\u010Di samodejni fokus",keep_filters:"Ohrani filtre",dismiss_on_play:"Zapri iskanje ob predvajanju",pin_headers:"Pripni glave iskanja",hide_search_headers_on_idle:"Skrij glave iskanja med mirovanjem",default_search_filter:"Privzeti iskalni filter",default_search_favorites:"Privzeti filter priljubljenih",disable_mass:"Onemogo\u010Di Mass Queue",match_theme:"Ujemaj temo",alt_progress:"Alternativna vrstica napredka",progress_bar_height:"Vi\u0161ina vrstice napredka",display_timestamps:"Prika\u017Ei \u010Dasovne oznake",swap_pause_stop:"Zamenjaj pavzo z zaustavitvijo",show_album:"Prika\u017Ei ime albuma",adaptive_controls:"Prilagodljiva velikost gumbov",hide_active_entity:"Skrij oznako aktivne entitete",hide_active_entity_on_idle:"Skrij oznako aktivne entitete ob mirovanju",collapse_on_idle:"Skr\u010Di v mirovanju",hide_menu_player_toggle:"Skrij predvajalnik v meniju",hide_reorder_progress_toggle:"Skrij napredek prerazvr\u0161\u010Danja",always_collapsed:"Vedno skr\u010Deno",disable_mini_menu:"Onemogo\u010Di mini mre\u017Ene menije",expand_on_search:"Raz\u0161iri ob iskanju",script_var:"Skriptna spremenljivka",use_ma_template:"Uporabi predlogo za entiteto Music Assistant",use_vol_template:"Uporabi predlogo za glasnost",follow_active_entity:"Glasnost sledi aktivni entiteti",use_url_path:"Uporabi URL ali pot",adaptive_text_elements:"Elementi za prilagajanje velikosti besedila",disable_auto_select:"Onemogo\u010Di samodejno izbiro",always_show_lyrics:"Vedno prika\u017Ei besedilo",lyrics_mode:"Na\u010Din besedila",lyrics_source:"Vir besedil",lyrics_pre_roll:"Pre-roll besedila (sekunde)",blurred_artwork:"Zamegljena grafika",hide_collapsed_artwork:"Skrij skr\u010Deno grafika",show_idle_artwork_when_not_playing:"Prika\u017Ei sliko za nedejavnost, ko se ne predvaja",prefer_ma_metadata:"Prednost metapodatkom Music Assistant",show_volume_overlay:"Prika\u017Ei prekrivno plo\u0161\u010Do za glasnost"},fields:{artwork_fit:"Prileganje grafike",artwork_position:"Polo\u017Eaj grafike",artwork_hostname:"Ime gostitelja grafike",match_field:"Polje ujemanja",match_value:"Vrednost ujemanja",size_percent:"Velikost (%)",object_fit:"Prileganje objekta",idle_timeout:"\u010Cas mirovanja (ms)",show_chip_row:"Prika\u017Ei vrstico \u010Dipov",search_limit:"Omejitev rezultatov iskanja",result_sorting:"Razvr\u0161\u010Danje rezultatov",vol_step:"Korak glasnosti (0.05 = 5 %)",card_height:"Vi\u0161ina kartice (px)",control_layout:"Postavitev kontrolnikov",idle_image:"Slika v mirovanju",image_url:"URL slike",fallback_image_url:"Rezervni URL slike",move_to_main:"Premakni dejanje na glavno vrstico",move_to_menu:"Premakni dejanje v meni",delete_action:"Izbri\u0161i dejanje",volume_mode:"Na\u010Din glasnosti",idle_screen:"Zaslon v mirovanju",name:"Ime",hidden_controls:"Skriti kontrolniki",hide_remote_buttons:"Skriti gumbi daljinskega upravljalnika",ma_template:"Predloga Music Assistant (Jinja)",hidden_chips:"Skriti iskalni \u010Dipi",vol_template:"Predloga entitete glasnosti (Jinja)",icon:"Ikona",action_type:"Vrsta dejanja",menu_item:"Element menija",nav_path:"Navigacijska pot",service:"Storitev",service_data:"Podatki storitve",idle_image_entity:"Entiteta slike v mirovanju",match_entity:"Ujemajo\u010Da entiteta",ma_entity:"Entiteta Music Assistant",vol_entity:"Entiteta glasnosti",remote_entity:"Entiteta daljinskega upravljalnika",remote_template:"Predloga entitete daljinca (Jinja)",selected_entity_helper:"Pomo\u010Dnik izbrane entitete",sync_entity_type:"Vrsta entitete za sinhronizacijo",placement:"Namestitev",card_trigger:"Spro\u017Eilec kartice",search_view:"Pogled rezultatov iskanja",search_card_columns:"Stolpci kartic",card_type:"Vrsta kartice",appearance:"Videz",no_artwork_option:"Brez grafike",details_alignment:"Poravnava podrobnosti",queue_controls_style:"Slog kontrol \u010Dakalne vrste"},action_types:{menu:"Odpri element menija kartice",service:"Pokli\u010Di storitev",navigate:"Navigiraj",prev_entity:"Prej\u0161nji \u010Dip entitete",next_entity:"Naslednji \u010Dip entitete",sync_selected_entity:"Sinhroniziraj izbrano entiteto",select_entity:"Izberi entiteto iz pomo\u010Dnika",toggle_lyrics:"Preklopi prekrivanje besedila",remote_control:"Odpri prekrivanje daljinskega upravljalnika"},action_helpers:{sync_selected_entity:"Sinhroniziraj izbrano entiteto \u2192",select_entity:"Izberi entiteto \u2190",select_helper:"(izberite pomo\u010Dnika)"},sync_entity_options:{yamp_entity:"yamp_entity (entiteta Music Assistant, \u010De je nastavljena)",yamp_main_entity:"yamp_main_entity (glavna entiteta predvajalnika medijev)",yamp_playback_entity:"yamp_playback_entity (trenutno aktivna entitea predvajanja)"},placements:{chip:"\u010Cip dejanja",menu:"V meniju",hidden:"Skrito (dotik grafike)",replace_search:"Zamenjaj Iskanje",replace_power:"Zamenjaj Vklop/Izklop",replace_mute:"Zamenjaj Uti\u0161aj",replace_favorite:"Zamenjaj Priljubljeno",not_triggerable:"Ni mogo\u010De spro\u017Eiti"},triggers:{none:"Brez",tap:"Dotik",hold:"Pridr\u017Eanje",double_tap:"Dvojni dotik",swipe_left:"Podrsaj levo",swipe_right:"Podrsaj desno"},search_view_options:{list:"Seznam",card:"Kartica",card_minimal:"Minimalna kartica"},queue_controls_style_options:{drag_handle:"Ro\u010Daj za vle\u010Denje",icons:"Gumbi za premikanje"},card_type_options:{default:"Privzeto",search:"Iskanje",group_players:"Zoskupi predvajalnike",up_next:"Sledi",remote_control:"Daljinski upravljalnik"},appearance_options:{automatic:"Samodejno",light:"Svetlo",dark:"Temno"},artwork_fit:{default:"Globalno",cover:"Ovitek (privzeto)",contain:"Prilagodi",fill:"Zapolni","scale-down":"Pomanj\u0161aj","scaled-contain":"Pomanj\u0161ano prilagodi","scaled-contain-alternate":"Pomanj\u0161ano prilagodi alternativno",none:"Brez"},artwork_position:{default:"Globalno",top:"Zgoraj",center:"Sredina",bottom:"Spodaj"}},card:{sections:{details:"Podrobnosti predvajanja",menu:"Meni in iskanje",action_chips:"\u010Cipi dejanj",lyrics:"Besedilo"},media_controls:{shuffle:"Naklju\u010Dno",previous:"Prej\u0161nje",play_pause:"Predvajaj/Pavza",stop:"Ustavi",next:"Naslednje",repeat:"Ponovi"},menu:{more_info:"Ve\u010D informacij",search:"I\u0161\u010Di",source:"Vir",remote_controls:"Daljinski upravljalnik",show_lyrics:"Poka\u017Ei besedilo",hide_lyrics:"Skrij besedilo",transfer_queue:"Prenesi \u010Dakalno vrsto",main_menu:"Glavni meni",group_players:"Zdru\u017Ei predvajalnike",up_next:"Sledi",remote_control:"Daljinski upravljalnik",select_entity:"Izberi entiteto za ve\u010D informacij",transfer_to:"Prenesi \u010Dakalno vrsto na",no_players:"Ni drugih razpolo\u017Eljivih predvajalnikov Music Assistant."},remote:{title:"Daljinski upravljalnik",up:"Gor",down:"Dol",left:"Levo",right:"Desno",select:"Izberi",back:"Nazaj",menu:"Meni",home:"Domov",power:"Vklop/Izklop"},grouping:{title:"Zdru\u017Ei predvajalnike",sync_volume:"Sinhroniziraj glasnost",group_all:"Zdru\u017Ei vse",ungroup_all:"Razdru\u017Ei vse",unavailable:"Predvajalnik ni na voljo",no_players:"Ni drugih predvajalnikov za zdru\u017Eevanje.",master:"Glavni",joined:"Pridru\u017Een",available:"Na voljo",current:"Trenutni",unjoin_from:"Odslopi od {master}",join_with:"Pridru\u017Ei se {master}"}},search:{favorites:"Priljubljeni",recently_played:"Nedavno predvajano",next_up:"Naslednje",recommendations:"Priporo\u010Dila",radio_mode:"Radijski na\u010Din",show_track_options:"Prika\u017Ei mo\u017Enosti skladbe",play_similar:"Predvajaj podobne pesmi",close:"Zapri iskanje",no_results:"Ni rezultatov.",play_next:"Predvajaj naslednje",replace_play:"Zamenjaj \u010Dakalno vrsto in predvajaj",replace:"Zamenjaj \u010Dakalno vrsto",add_queue:"Dodaj na konec \u010Dakalne vrste",move_up:"Premakni gor",move_down:"Premakni dol",move_next:"Premakni na naslednje",remove:"Odstrani iz \u010Dakalne vrste",drag_to_reorder:"Povlecite za prerazvrstitev",added:"Dodano v \u010Dakalno vrsto!",added_to_playlist:"Dodano na seznam predvajanja!",select_playlist:"Izberite seznam predvajanja za '{track}'",add_to_playlist:"Dodaj na seznam predvajanja",select_track_for_playlist:"Izberite skladbo za dodajanje za '{track}' od {artist}",labels:{replace:"Zamenjaj",next:"Naslednje",replace_next:"Zamenjaj naslednje",add:"Dodaj",add_to_playlist:"Dodaj na seznam predvajanja"},results:"rezultati",result:"rezultat",filters:{all:"Vse",artist:"Izvajalec",album:"Album",track:"Skladba",playlist:"Seznam predvajanja",radio:"Radio",music:"Glasba",station:"Postaja",podcast:"Podcast",audiobook:"Zvo\u010Dna knjiga"},search_artist:"I\u0161\u010Di tega izvajalca",search_album:"Prebrskaj skladbe iz tega albuma",browse_album:"Prebrskaj skladbe iz {album}",play_collection:"Predvajaj to zbirko",play_collection_error:"Te zbirke ni mogo\u010De predvajati neposredno",play_item:"Predvajaj {item}"},lyrics:{finding:"Iskanje besedila...",none_found:"Besedila ni bilo mogo\u010De najti",not_available:"Besedilo ni na voljo",instrumental:"Instrumentalna skladba",admin_only_mass:"Pridobivanje besedil preko Music Assistant je na voljo samo administratorjem. Priporo\u010Dljivo je, da v konfiguraciji kartice preklopite na lrclib.",fallback_to_lrclib_non_admin:"Zaznan je ne-administratorski uporabnik. Preklop na lrclib za pridobivanje besedil."},lyrics_sources:{mass_lrclib:"Music Assistant (Rezerva na LRCLIB)",mass:"Samo Music Assistant",lrclib:"Samo LRCLIB",lrclib_mass:"LRCLIB (Rezerva na Music Assistant)"},lyrics_modes:{default:"Privzeto (Ozna\u010Di in pomakni)",scroll:"Samo pomikanje",text:"Samo besedilo"}};const ss={en:Pc,de:zc,es:jc,fr:Fc,it:Dc,nl:Rc,pt:Oc,sk:Lc,sl:qc};function h(i,e="",t=""){const a=(localStorage.getItem("selectedLanguage")||document.querySelector("home-assistant")?.hass?.language||"en").replace(/['"]+/g,"").replace("-","_"),s=ss[a]?a:a.split("_")[0];let r;const n=i.split("."),o=(l,c)=>{try{return c.reduce((d,u)=>d&&d[u]!==void 0?d[u]:void 0,l)}catch{return}};if(r=o(ss[s],n),r===void 0&&s!=="en"&&(r=o(ss.en,n)),r===void 0&&(r=i),typeof r!="string"&&(r=i),typeof e=="object"&&e!==null)for(const[l,c]of Object.entries(e))r=r.replaceAll(l,c);else e!==""&&t!==""&&(r=r.replaceAll(e,t));return r}const Ft=6,bi=Object.freeze({custom:{},large_modern:{match_theme:!0,appearance:"automatic",control_layout:"modern",adaptive_controls:!0,adaptive_text:!0,artwork_object_fit:"cover",extend_artwork:!0,show_chip_row:"in_menu_on_idle",hold_to_pin:!0,pin_search_headers:!0,progress_bar_height:16,search_view:"card",search_card_columns:3,display_timestamps:!0,details_alignment:"left"},crisp_clean:{match_theme:!0,volume_mode:"stepper",hold_to_pin:!0,volume_step:.05,show_chip_row:"in_menu",extend_artwork:!0,search_results_sort:"play_count_desc",control_layout:"modern",dismiss_search_on_play:!0,keep_filters_on_search:!1,display_timestamps:!0,search_view:"list",default_search_filter:"all",default_search_favorites:!0,appearance:"automatic",details_alignment:"center",artwork_object_fit:"scaled-contain-alternate",progress_bar_height:2},minimal_mini:{match_theme:!0,appearance:"automatic",always_collapsed:!0,show_chip_row:"in_menu",details_alignment:"left",hold_to_pin:!0,progress_bar_height:2,volume_mode:"stepper",extend_artwork:!0,blurred_artwork:!0,hide_collapsed_artwork:!0},normal_mini:{match_theme:!0,appearance:"automatic",always_collapsed:!0,show_chip_row:"auto",details_alignment:"left",hold_to_pin:!0,progress_bar_height:2,volume_mode:"slider",extend_artwork:!0,blurred_artwork:!0},dedicated_search:{match_theme:!0,appearance:"automatic",card_type:"search",search_view:"card",hide_menu_player:!0,hold_to_pin:!0,show_chip_row:"in_menu",disable_autofocus:!0},dedicated_grouping:{match_theme:!0,appearance:"automatic",card_type:"group_players",hide_menu_player:!0,show_chip_row:"in_menu"},quick_and_easy:{match_theme:!0,appearance:"automatic",always_show_quick_group:!0,show_chip_row:"always",dismiss_search_on_play:!0,extend_artwork:!0,show_volume_overlay:!0,hold_to_pin:!0},huge_yamp:{match_theme:!0,appearance:"automatic",control_layout:"modern",adaptive_controls:!0,adaptive_text:!0,progress_bar_height:48,display_timestamps:!0,artwork_object_fit:"cover",extend_artwork:!0,search_view:"card",search_card_columns:2,show_volume_overlay:!0}});Object.freeze(new Set(["card_height","artwork_override","name","icon","action_in_menu","placement","hide_controls","lyrics","title","subtitle","idle_artwork","idle_image"]));const rs=8,sn=16,rn=32,ns=128,os=256,Nc=4096,nn=32768,on=524288,ln=262144,cn=Object.freeze(["aspect_ratio","media_title","media_artist","media_album_name","media_content_id","media_channel","app_name","media_content_type","entity_id","entity_state"]),dn=new WeakMap;function ve(i,e){const t=i?.[e];return typeof t=="string"&&t.trim()!==""?t:null}async function Vc(i,e,t){if(!e||typeof e!="string")return t;if(!e.includes("{{")&&!e.includes("{%"))return e;try{const a=(await i.callApi("POST","template",{template:e})||"").toString().trim();return a&&/^([a-z_]+)\.[A-Za-z0-9_]+$/.test(a)?a:t}catch{return t}}async function ls(i,e,t={}){if(!e||typeof e!="string")return e;if(!e.includes("{{")&&!e.includes("{%")){if(/%7B%7B|%7B%25/i.test(e))try{e=decodeURIComponent(e)}catch{}if(!e.includes("{{")&&!e.includes("{%"))return e}let a=e;t&&Object.keys(t).length>0&&(a=`${Object.entries(t).map(([s,r])=>`{% set ${s} = ${JSON.stringify(r)} %}`).join(" ")} ${e}`);try{return(await i.callApi("POST","template",{template:a})||"").toString().trim()}catch(s){return console.warn("yamp: Error resolving template:",e,s),e}}function vt(i,e,t={}){if(!e||typeof e!="string")return e;let a=e;if(/%7B%7B|%7B%25/i.test(a))try{a=decodeURIComponent(a)}catch{}if(!a.includes("{{")&&!a.includes("{%"))return a;let s=a,r=!0;return s=s.replace(/\{\{\s*(.*?)\s*\}\}/g,(n,o)=>{let l=o.trim(),c=!1;l.endsWith("| urlencode")?(c=!0,l=l.replace(/\|\s*urlencode$/,"").trim()):l.endsWith("|urlencode")&&(c=!0,l=l.replace(/\|urlencode$/,"").trim());let d=l.match(/^state_attr\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"]?)([\w_]+)\3\s*\)$/);if(d){let _=d[2],m=t[_]!==void 0&&!d[1]?t[_]:_,f=d[4];const y=i?.states?.[m];if(y&&y.attributes&&y.attributes[f]!==void 0){let b=String(y.attributes[f]);return c?encodeURIComponent(b):b}return""}let u=l.match(/^states\(\s*(['"]?)([\w.]+)\1\s*\)(?:\s*(==|!=)\s*(['"])(.*?)\4)?$/);if(u){let _=u[2],m=t[_]!==void 0&&!u[1]?t[_]:_,f=u[3],y=u[5];const b=i?.states?.[m];let k="unknown";if(b&&b.state!==void 0&&(k=String(b.state)),f){let w=(f==="=="?k===y:k!==y)?"true":"false";return c?encodeURIComponent(w):w}return c?encodeURIComponent(k):k}let p=l.match(/^is_state\(\s*(['"]?)([\w.]+)\1\s*,\s*(['"])(.*?)\3\s*\)$/);if(p){let _=p[2],m=t[_]!==void 0&&!p[1]?t[_]:_,f=p[4];const y=i?.states?.[m];let b="unknown";y&&y.state!==void 0&&(b=String(y.state));let k=b===f?"true":"false";return c?encodeURIComponent(k):k}if(/^[\w_]+$/.test(l)&&t[l]!==void 0){let _=String(t[l]);return c?encodeURIComponent(_):_}return r=!1,n}),!r||s.includes("{%")?null:s}function Uc(i,e){if(!i?.states||!e)return[];const t=[],a=i.states[e];if(!a)return[];const s=a.attributes?.device_id,r=a.attributes?.friendly_name||e;for(const[n,o]of Object.entries(i.states))if(n.startsWith("button.")&&o.attributes){const l=o.attributes.device_id,c=o.attributes.friendly_name||n;s&&l===s?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"same_device"}):c.toLowerCase().includes(r.toLowerCase())||r.toLowerCase().includes(c.toLowerCase())?t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"name_similarity"}):n.toLowerCase().includes(e.split(".")[1].toLowerCase())&&t.push({entity_id:n,friendly_name:c,device_class:o.attributes.device_class,reason:"entity_id_match"})}return t}function Bc(i,e){if(!i?.states||!e)return null;const t=i.states[e];return t&&t.attributes&&(t.attributes.media_content_id||t.attributes.media_content_type||t.attributes.media_album_name||t.attributes.media_artist||t.attributes.media_title)?t:null}function xi(i){return!i||!i.attributes?!1:i.attributes.app_id==="music_assistant"||i.attributes.mass_player_type!==void 0}function Hc(i){if(!i)return"";const e=i.media_type||i.media_class||i.media_content_type,t=i.name||i.title||i.media_title||"Unknown Title",a=i.artists?.[0],s=i.artist||a?.name||(typeof a=="string"?a:void 0)||i.media_artist||"Unknown Artist";if(e==="track"){const r=i.album||i.media_album_name;return r?h("search.browse_album","{album}",r):`${t} - ${s}`}return e==="album"?h("search.browse_album","{album}",t):t}function Gc(i,e,t,a={}){if(!e||!Array.isArray(e)||!e.length)return null;const s=i?.attributes||{},r=i?.entity_id;if(a.isIdleImageActive){const u=e.find(p=>(p?.idle_image===!0||p?.idle_image_url!==void 0||p?.match_type==="idle_image")&&(!p?.entity_id||p.entity_id===r||p.entity_id==="*"));if(u){const p=u.idle_image_url||u.image_url||null;let _=null;return p&&(_=typeof t=="function"?t(u,p,"idle",i):p),{url:_,sizePercentage:u?.size_percentage,objectFit:u?.object_fit??null,objectPosition:u?.object_position??null}}return null}const n=()=>e.find(u=>u?.idle_image===!0||u?.match_type==="idle_image"?!1:cn.some(p=>{const _=u[p];if(_==null||_==="")return!1;if(p==="aspect_ratio"){const b=ve(s,"entity_picture_local")||ve(s,"entity_picture")||ve(s,"album_art")||null;if(!b)return!1;let k=b.trim();(k.startsWith("'")&&k.endsWith("'")||k.startsWith('"')&&k.endsWith('"'))&&k.length>=2&&(k=k.slice(1,-1).trim());const w=k.match(/^url\((.*)\)$/i);w&&w[1]!==void 0&&(k=w[1].trim(),(k.startsWith("'")&&k.endsWith("'")||k.startsWith('"')&&k.endsWith('"'))&&(k=k.slice(1,-1).trim()));const E=a.aspectRatioCache?a.aspectRatioCache[k]:void 0;if(E==null)return!1;let A=parseFloat(_);if(typeof _=="string"&&_.includes(":")){const C=_.split(":");C.length===2&&!isNaN(C[0])&&!isNaN(C[1])&&parseFloat(C[1])!==0&&(A=parseFloat(C[0])/parseFloat(C[1]))}return isNaN(A)?!1:Math.abs(E-A)<=.1}const m=p==="entity_id"?r:p==="entity_state"?i?.state:s[p];if(_==="*")return!0;let f=dn.get(u);f||(f={},dn.set(u,f));let y=f[p];if(y===void 0)if(typeof _=="string"&&_.includes("*")&&_!=="*")try{const b=_.replace(/\*+/g,"*");if((b.match(/\*/g)||[]).length<=5){const k=b.replace(/[.*+?^${}()|[\]\\]/g,"\\$&").replace(/\\\*/g,".*");y=new RegExp(`^${k}$`,"i"),f[p]=y}else f[p]=null,y=null}catch{f[p]=null,y=null}else f[p]=null,y=null;return y?y.test(String(m||"")):m===_})),o=ve(s,"entity_picture_local")||ve(s,"entity_picture")||ve(s,"album_art");let l=n(),c=null,d="image";if(l?.image_url?c=l.image_url:l?.missing_art_url&&!o?(c=l.missing_art_url,d="missing"):l&&o&&(c=ve(s,"entity_picture_local")||ve(s,"entity_picture")||ve(s,"album_art")),!l&&!o){const u=e.find(p=>p?.missing_art_url);u?.missing_art_url&&(l=u,c=u.missing_art_url,d="missing")}if(l){let u=null;return c&&(u=typeof t=="function"?t(l,c,d,i):c),{url:u,sizePercentage:l?.size_percentage,objectFit:l?.object_fit??null,objectPosition:l?.object_position??null}}return null}function cs(i,{hostname:e="",overrides:t=[],fallbackArtwork:a=null,artworkObjectFit:s=null,resolveOverrideSource:r=null,aspectRatioCache:n={},isIdleImageActive:o=!1}={}){if(!i||!i.attributes)return null;const l=i.attributes;let c=null,d=null,u=null;if(s==="no_artwork")return{url:null,sizePercentage:null,objectFit:"no_artwork"};const p=Gc(i,t,r,{aspectRatioCache:n||{},isIdleImageActive:o});let _=null;return p&&(c=p.url,d=p.sizePercentage,u=p.objectFit,_=p.objectPosition),!c&&!o&&(c=ve(l,"entity_picture_local")||ve(l,"entity_picture")||ve(l,"album_art")||null),!c&&a&&!o&&(a==="smart"?l.media_title==="TV"||l.media_channel||l.app_id==="tv"||l.app_id==="androidtv"?c="data:image/svg+xml;base64,":c="data:image/svg+xml;base64,":typeof a=="string"&&(c=a)),c=ds(c,e),{url:c,sizePercentage:d,objectFit:u,objectPosition:_}}function ds(i,e){let t=i;if(t&&e&&!/^https?:\/\//i.test(t)&&!t.startsWith("data:")){const a=e.endsWith("/")?e.slice(0,-1):e,s=t.startsWith("/")?t:`/${t}`;t=a+s}return t&&!wi(t)?null:t}function wi(i){if(!i||typeof i!="string"||i.includes("undefined")||i.includes("null")||i.trim()==="")return!1;if(i.startsWith("data:")||i.startsWith("/")||i.startsWith("./")||i.startsWith("../"))return!0;try{return new URL(i),!0}catch{return!1}}function ra(i,e){return i?.placement!==void 0?i.placement:typeof i?.in_menu=="string"?i.in_menu:i?.in_menu==="hidden"?"hidden":i?.in_menu===!0?"menu":"chip"}function Qc({idx:i,selected:e,playing:t,name:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:d,onPinClick:u,onPointerDown:p,onPointerMove:_,onPointerUp:m,objectFit:f,quickGroupingState:y,onQuickGroupClick:b,onDoubleClick:k}){const w=f?`object-fit: ${f};`:"";return g`
    ...
    >
      ...
      ${n?g`
              <span
                ...
                @click=${E=>{E.stopPropagation(),u(i,E)}}
                title="${h("common.unpin")}"
              >
                <ha-icon .icon=${"mdi:pin"}></ha-icon>
              </span>
            `:g`<span class="chip-pin-spacer"></span>`}
      ${un({idx:i,quickGroupingState:y,onQuickGroupClick:b})}
    </button>
  `}function Wc({idx:i,selected:e,playing:t,groupName:a,art:s,icon:r,pinned:n,holdToPin:o,maActive:l,onChipClick:c,onIconClick:d,onPinClick:u,onPointerDown:p,onPointerMove:_,onPointerUp:m,objectFit:f,quickGroupingState:y,onQuickGroupClick:b,onDoubleClick:k}){const w=f?`object-fit: ${f};`:"";return g`
    <button
      class="chip group"
      ?selected=${e}
      ?ma-active=${l}
    ...
    >
      <span
        ...
        @click=${E=>{E.stopPropagation(),d&&d(i,E)}}
      >
        ${s?g`<img
                class="chip-mini-art"
                src="${s}"
                style="cursor:pointer;${w}"
                onerror="this.style.display='none'"
                @click=${E=>{E.stopPropagation(),d&&d(i,E)}}
              />`:g`<ha-icon
                .icon=${r}
  ...
  `}function un({idx:i,quickGroupingState:e,onQuickGroupClick:t}){if(!e||!e.isGroupable)return v;const{isPrimary:a,isBusy:s,grouped:r,tooltip:n}=e;return g`
    <span
  ...
  `}function Yc({onPin:i,onHoldEnd:e,holdTime:t=600,moveThreshold:a=8}){let s=null,r=null,n=null,o=!1;return{pointerDown:(l,c)=>{r=l.clientX,n=l.clientY,o=!1,s=setTimeout(()=>{o||(i(c,l),e&&e(c))},t)},pointerMove:(l,c)=>{if(s&&r!==null&&n!==null){const d=Math.abs(l.clientX-r),u=Math.abs(l.clientY-n);(d>a||u>a)&&(o=!0,clearTimeout(s),s=null)}},pointerUp:(l,c)=>{s&&(clearTimeout(s),s=null),r=null,n=null,o=!1}}}function hn({groupedSortedEntityIds:i,entityIds:e,selectedEntityId:t,pinnedIndex:a,holdToPin:s,getChipName:r,getActualGroupMaster:n,getIsChipPlaying:o,getChipArt:l,getIsMaActive:c,isIdle:d,hass:u,artworkHostname:p="",mediaArtworkOverrides:_=[],fallbackArtwork:m=null,onChipClick:f,onIconClick:y,onPointerClick:b,onPinClick:k,onPointerDown:w,onPointerMove:E,onPointerUp:A,quickGroupingMode:C,getQuickGroupingState:M,onQuickGroupClick:j,onDoubleClick:F}){return!i||!i.length?v:g`
    ${i.map(I=>{if(I.length>1){const T=n(I),N=e.indexOf(T),R=u?.states?.[T],V=typeof o=="function"?o(T,t===T):R?.state==="playing",J=typeof l=="function"?l(T):cs(R,{hostname:p,overrides:_,fallbackArtwork:m}),ee=J?.url,B=J?.objectFit,L=R?.attributes?.icon||"mdi:cast",Y=typeof c=="function"?c(T):!1;return Wc({idx:N,selected:t===T,playing:V,groupName:r(T)+(I.length>1?` [${I.length}]`:""),art:ee,icon:L,pinned:a===N,holdToPin:s,maActive:Y,onChipClick:f,onIconClick:y,onPinClick:k,onPointerDown:X=>w(X,N),onPointerMove:X=>E(X,N),onPointerUp:X=>A(X,N),objectFit:B,quickGroupingState:C&&typeof M=="function"?M(T):null,onQuickGroupClick:j,onDoubleClick:F})}else{const T=I[0],N=e.indexOf(T),R=u?.states?.[T],V=typeof o=="function"?o(T,t===T):R?.state==="playing",J=typeof l=="function"?l(T):cs(R,{hostname:p,overrides:_,fallbackArtwork:m}),ee=J?.url,B=J?.objectFit,L=t===T?!d&&ee:V&&ee,Y=R?.attributes?.icon||"mdi:cast",X=typeof c=="function"?c(T):!1;return Qc({idx:N,selected:t===T,playing:V,name:r(T),art:L,icon:Y,pinned:a===N,holdToPin:s,maActive:X,onChipClick:f,onPinClick:k,onPointerDown:K=>w(K,N),onPointerMove:K=>E(K,N),onPointerUp:K=>A(K,N),objectFit:B,quickGroupingState:C&&typeof M=="function"?M(T):null,onQuickGroupClick:j,onDoubleClick:F})}})}
  `}function Kc({actions:i,onActionChipClick:e}){return i?.length?g`
  ...
  `:v}function Zc({stateObj:i,showStop:e,shuffleActive:t,repeatActive:a,onControlClick:s,supportsFeature:r,showFavorite:n,favoriteActive:o,hiddenControls:l={},adaptiveControls:c=!1,controlLayout:d="classic",swapPauseForStop:u=!1}){if(!i)return v;const p=d==="modern"?"modern":"classic",_=!i||i.state!=="playing";let m=!l.previous&&(r(i,sn)||_),f=!l.play_pause;const y=!l.stop&&e;let b=y,k=!l.next&&(r(i,rn)||_),w=!l.shuffle&&r(i,nn),E=!l.repeat&&r(i,ln),A=!l.favorite&&n,C=!l.power&&(r(i,os)||r(i,ns));const M=p==="modern"&&u&&y,j=i.state==="playing",F=M&&j;p==="modern"&&(b=!1,A=!1,C=!1);const I=us(i,r,n,l,e,p),T=c?"controls-row adaptive":"controls-row",N=p==="modern"?`${T} modern`:T;let R=c?`--yamp-control-count:${Math.max(I,1)};`:v;if(c){const V=I<=3?{icon:56,minWidth:78,maxWidth:150,minHeight:78,padding:14,gap:14}:I===4?{icon:48,minWidth:68,maxWidth:130,minHeight:68,padding:12,gap:12}:I===5?{icon:42,minWidth:58,maxWidth:110,minHeight:58,padding:10,gap:10}:I===6?{icon:36,minWidth:50,maxWidth:96,minHeight:52,padding:8,gap:8}:{icon:32,minWidth:44,maxWidth:88,minHeight:48,padding:6,gap:6};R+=[`--yamp-control-gap:${V.gap}px`,`--yamp-control-min-width:${V.minWidth}px`,`--yamp-control-max-width:${V.maxWidth}px`,`--yamp-control-min-height:${V.minHeight}px`,`--yamp-control-padding:${V.padding}px`,`--yamp-control-icon-size:${V.icon}px`].join(";")}return p==="modern"?g`
      <div class=${N} style=${R}>
        ...
        <div class="controls-center">
          ${f?g`
                  <button
                    class="modern-button primary${j?" active":""}"
                    @click=${()=>s(F?"stop":"play_pause")}
                    title="${F?h("card.media_controls.stop"):h("card.media_controls.play_pause")||"Play/Pause"}"
                  >
                    <ha-icon
                      .icon=${F?"mdi:stop":j?"mdi:pause":"mdi:play"}
                    ></ha-icon>
                  </button>
                `:v}
        </div>
  ...
  `}function us(i,e,t=!1,a={},s=!1,r="classic"){const n=r==="modern"?"modern":"classic",o=!i||i.state==="idle"||i.state==="paused"||i.state==="off"||i.state==="standby"||i.state==="unavailable";let l=0;return!a.previous&&(e(i,sn)||o)&&l++,a.play_pause||l++,n!=="modern"&&!a.stop&&s&&l++,!a.next&&(e(i,rn)||o)&&l++,!a.shuffle&&e(i,nn)&&l++,!a.repeat&&e(i,ln)&&l++,n!=="modern"&&!a.favorite&&t&&l++,n!=="modern"&&!a.power&&(e(i,os)||e(i,ns))&&l++,l}function Jc({isRemoteVolumeEntity:i,showSlider:e,vol:t,isMuted:a,supportsMute:s,onVolumeDragStart:r,onVolumeDragEnd:n,onVolumeInput:o,onVolumeChange:l,onVolumeStep:c,onMuteToggle:d,moreInfoMenu:u,leadingControlTemplate:p=v,reserveLeadingControlSpace:_=!1,showRightPlaceholder:m=!1,rightSlotTemplate:f=v,muteSlotTemplate:y=v,hideVolume:b=!1,collapseRow:k=void 0,isDragging:w=!1,dragVol:E=0}){const A=p!==v&&p!==void 0&&p!==null,C=(M,j)=>(s?j:M===0)||M===0?"mdi:volume-off":M<.2?"mdi:volume-low":M<.5?"mdi:volume-medium":"mdi:volume-high";return g`
    <div
      class="volume-row ${e&&!i?"has-slider":""}"
      style="${(typeof k=="boolean"?k:b&&u===v&&!A&&!m)?"display: none !important;":""}"
    >
      <div class="volume-left">
        ${A?p:_?g`<div class="volume-leading-placeholder"></div>`:v}
        <div
          style="${b||i?"visibility:hidden; opacity:0; pointer-events:none;":""} display: flex; align-items: center; justify-content: center;"
        >
          ${y!==v?y:g`
                  <button
        ...
        ${i?g`
              ...
              `:e?g`
                  <div class="volume-slider-container">
                    <div
                      class="volume-percentage-indicator ${w?"visible":""}"
  ...
  `}function pn(i){if(i==null||isNaN(i))return"0:00";const e=Math.floor(i/60),t=Math.floor(i%60);return`${e}:${t<10?"0":""}${t}`}function na({progress:i,seekEnabled:e,onSeek:t,collapsed:a,accent:s,height:r=Ft,style:n="",displayTimestamps:o=!1,currentTime:l=0,duration:c=0,customHeight:d=Ft}){const u=s||"var(--custom-accent, #ff9800)",p=a?Math.min(d,Math.max(4,Math.floor(d/2))):d,_=Math.min(6,p/2),m=Math.max(10,Math.min(24,Math.floor(p*.6+6))),f=`--progress-radius: ${_}px; --timestamp-size: ${m}px;`;return a?g`
      <div
    ...
    <div class="progress-bar-container" style="${f} ${n}">
      ...
      ${o?g`
              <div class="timestamps-container">
                <span>${pn(l)}</span>
                <span>-${pn(Math.max(0,c-l))}</span>
              </div>
            `:v}
    </div>
  `}const O=Object.freeze({MEDIA_BACKGROUND:0,MEDIA_OVERLAY:0,LYRICS_OVERLAY:1,FLOATING_ELEMENT:3,STICKY_CHIPS:3,ACCENT_FOREGROUND:3,FLOATING_CONTROLS:3,OVERLAY_BASE:4,MODAL_BACKDROP:4,MODAL_TOAST:4,SEARCH_SLIDE_OUT:3,SEARCH_SUCCESS:3,VOLUME_OVERLAY:5}),_n=Me`linear-gradient(to bottom, transparent 0px, black 30px, black calc(100% - 30px), transparent 100%)`,be=Me`
  scrollbar-width: none;
  -ms-overflow-style: none;
`,oa=Me`blur(5px)`,mn=Me`blur(10px)`,gn=Me`blur(20px)`,la=Me`linear-gradient(to bottom, black 0%, black calc(100% - 12px), transparent 100%)`,fn=Me`
  display: -webkit-box;
...
`,Xc=Me`
  ...
  .entity-options-overlay {
    ...
    top: 0;
    bottom: 0;
    z-index: ${O.OVERLAY_BASE};
    background: var(--yamp-overlay-bg);
    backdrop-filter: ${oa};
    -webkit-backdrop-filter: ${oa};
    display: flex;
    align-items: flex-start;
    justify-content: center;
  }
  ...
  .search-row-slide-out {
    ...
    backdrop-filter: ${mn};
    -webkit-backdrop-filter: ${mn};
    z-index: ${O.SEARCH_SLIDE_OUT};
    display: flex;
    align-items: center;
    padding: 0 8px;
...
`,ed=Me`
  ...
  .lyrics-scroll-container {
    ...
    mask-image: var(--yamp-lyrics-mask, ${_n});
    -webkit-mask-image: var(--yamp-lyrics-mask, ${_n});
    ${be}
    display: flex;
    flex-direction: column;
    align-items: center;
...
`,td=i=>class extends i{_findScrollParent(e){let t=e.parentElement;for(;t;){const a=window.getComputedStyle(t)?.overflowY;if(a==="auto"||a==="scroll")return t;!t.parentElement&&t.getRootNode&&t.getRootNode().host?t=t.getRootNode().host:t=t.parentElement}return null}_applyQueueDragVisuals(e,t,a){const s=this.renderRoot.querySelector(".queue-sortable-container");if(!s)return;const r=s.classList.contains("is-card-layout"),n=s.querySelectorAll(".queue-drag-wrapper");for(const o of n){const l=parseInt(o.dataset.queueIdx,10);if(!isNaN(l)){if(l===e){o.style.opacity="0",o.style.pointerEvents="none",r&&(o.style.order=a!==null?a:l);continue}if(r){o.style.transform="";let c=l;a!==null&&(e<a&&l>e&&l<=a?c=l-1:e>a&&l>=a&&l<e&&(c=l+1)),o.style.order=c}else o.style.order="",a===null?o.style.transform="":e<a?l>e&&l<=a?o.style.transform=`translateY(${-t}px)`:o.style.transform="":l>=a&&l<e?o.style.transform=`translateY(${t}px)`:o.style.transform=""}}}_clearQueueDragVisuals(){const e=this.renderRoot.querySelector(".queue-sortable-container");if(!e)return;const t=e.querySelectorAll(".queue-drag-wrapper");for(const a of t)a.style.transform="",a.style.maxHeight="",a.style.overflow="",a.style.margin="",a.style.padding="",a.style.opacity="",a.style.pointerEvents="",a.style.order=""}_onQueueDragStart(e){if((this.config?.queue_controls_style||"drag_handle")==="drag_handle"){if(!e.target.closest||!e.target.closest(".queue-drag-handle"))return}else return;const t=e.target.closest(".queue-drag-wrapper");if(!t)return;const a=parseInt(t.dataset.queueIdx,10);if(isNaN(a))return;this._activeDragCleanup&&this._activeDragCleanup(),e.stopPropagation();const s=e.clientY,r=e.clientX;let n=null,o=!1,l=null,c=0,d=0,u=null,p=0,_=null,m=null,f=null,y=null,b=null,k=!1,w=s,E=r,A=null,C=null,M=0;const j=e.pointerType==="touch"||e.pointerType==="pen",F=j?300:null;let I=0;const T=(Y,X)=>{if(!C)return;if(m)if(k){m._isActive||(m._isActive=!0,m.style.background="rgba(76, 175, 80, 0.4)",m.style.borderColor="#4caf50",m.style.borderStyle="solid",y&&(y.style.color="#4caf50"),b&&(b.style.color="#4caf50")),A!==0&&(A=0,this._queueDropTargetIdx=0,this._applyQueueDragVisuals(a,I,0));return}else m._isActive&&(m._isActive=!1,m.style.background="var(--ha-card-background, var(--card-background-color, #1c1c1c))",m.style.borderColor="var(--custom-accent, var(--accent-color, #ff9800))",m.style.borderStyle="dashed",y&&(y.style.color=""),b&&(b.style.color=""));const K=u?u.scrollTop-M:0;let Q=null,oe=1/0;for(const je of C){if(je.idx===a)continue;const Je=je.midY-K,It=Y-je.midX,ct=X-Je,Ue=Math.sqrt(It*It+ct*ct);Ue<oe&&(oe=Ue,Q=je.idx)}Q!==null&&Q!==A&&(A=Q,this._queueDropTargetIdx=Q,this._applyQueueDragVisuals(a,I,Q))},N=()=>{!o||!u||(p!==0&&(u.scrollTop+=p,T(E,w)),_=requestAnimationFrame(N))},R=()=>{o=!0,this._isDragging=!0,this._queueDragIdx=a,this._queueDropTargetIdx=null,A=null;const Y=t.getBoundingClientRect();I=Y.height;const X=this.renderRoot.querySelector(".queue-sortable-container");if(X){X.style.setProperty("--queue-drag-item-h",`${Y.height}px`),X.style.touchAction="none",u=this._findScrollParent(X),u&&(_=requestAnimationFrame(N),M=u.scrollTop);const Q=X.querySelectorAll(".queue-drag-wrapper > *:first-child");C=[];for(const Je of Q){const It=Je.parentElement,ct=parseInt(It.dataset.queueIdx,10);if(!isNaN(ct)){const Ue=Je.getBoundingClientRect();C.push({idx:ct,midX:Ue.left+Ue.width/2,midY:Ue.top+Ue.height/2})}}m=document.createElement("div"),m.className="queue-play-next-dropzone",m.innerHTML=`
          ...
          `;const oe=this.getBoundingClientRect(),je=Math.max(56,Math.round(oe.height*.1));m.style.cssText=`
            ...
            opacity: 0.95;
          `,this.renderRoot.appendChild(m),f=m.getBoundingClientRect(),y=m.querySelector(".dropzone-content"),b=m.querySelector("ha-icon")}this._applyQueueDragVisuals(a,I,null);const K=t.firstElementChild;if(K){const Q=K.getBoundingClientRect();c=s-Q.top,d=r-Q.left,l=K.cloneNode(!0),l.classList.add("queue-drag-clone"),l.style.cssText=`
            position: fixed;
            left: ${Q.left}px;
            top: ${Q.top}px;
            width: ${Q.width}px;
            ...
            will-change: top;
          `,this.renderRoot.appendChild(l)}};F!==null&&(n=setTimeout(R,F));const V=Y=>{if(Y.stopPropagation(),!o){const X=Math.abs(Y.clientY-s);j?X>10&&(n&&(clearTimeout(n),n=null),L()):X>5&&R();return}if(Y.preventDefault(),w=Y.clientY,E=Y.clientX,k=!1,f&&w>=f.top&&w<=f.bottom&&E>=f.left&&E<=f.right&&(k=!0),l&&(l.style.top=`${w-c}px`,l.style.left=`${E-d}px`),u)if(k)p=0;else{const X=u.getBoundingClientRect(),K=w-X.top,Q=X.bottom-w,oe=60;K<oe&&K>-50?p=-Math.max(2,(oe-K)*.3):Q<oe&&Q>-50?p=Math.max(2,(oe-Q)*.3):p=0}T(E,w)},J=Y=>{if(Y.stopPropagation(),n&&(clearTimeout(n),n=null),o){const X=Date.now();if(this._dragClickCaptureFn&&window.removeEventListener("click",this._dragClickCaptureFn,!0),this._dragClickCaptureTimeout&&clearTimeout(this._dragClickCaptureTimeout),this._dragClickCaptureFn=K=>{Date.now()-X<200&&(K.stopPropagation(),K.preventDefault()),window.removeEventListener("click",this._dragClickCaptureFn,!0),this._dragClickCaptureFn=null},window.addEventListener("click",this._dragClickCaptureFn,!0),this._dragClickCaptureTimeout=setTimeout(()=>{this._dragClickCaptureFn&&(window.removeEventListener("click",this._dragClickCaptureFn,!0),this._dragClickCaptureFn=null)},1e3),this._clearQueueDragVisuals(),A!==null&&A!==a){const K=A;this._queueDragIdx=null,this._queueDropTargetIdx=null,this._isDragging=!1,this._onQueueItemMoved({detail:{oldIndex:a,newIndex:K}})}else this._queueDragIdx=null,this._queueDropTargetIdx=null,this._isDragging=!1,this.requestUpdate()}else this._queueDragIdx=null,this._queueDropTargetIdx=null,this._isDragging=!1;L()},ee=Y=>{Y.stopPropagation(),n&&(clearTimeout(n),n=null),this._clearQueueDragVisuals(),this._queueDragIdx=null,this._queueDropTargetIdx=null,this._isDragging=!1,this.requestUpdate(),L()},B=Y=>{o&&Y.preventDefault()},L=()=>{window.removeEventListener("pointermove",V),window.removeEventListener("pointerup",J),window.removeEventListener("pointercancel",ee),window.removeEventListener("touchmove",B,{passive:!1}),n&&(clearTimeout(n),n=null),_&&(cancelAnimationFrame(_),_=null);const Y=this.renderRoot.querySelector(".queue-sortable-container");Y&&(Y.style.touchAction=""),l&&l.parentNode&&l.remove(),l=null,m&&m.parentNode&&m.remove(),m=null,f=null,y=null,b=null,this._activeDragCleanup=null};this._activeDragCleanup=L,window.addEventListener("pointermove",V),window.addEventListener("pointerup",J),window.addEventListener("pointercancel",ee),window.addEventListener("touchmove",B,{passive:!1})}};function bn(i){if(!i||typeof i!="string")return[];const e=i.split(/\r?\n/),t=[],a=/\[(\d+):([0-5]\d)(?:[.:](\d{2,3}))?\]/g;e.forEach(n=>{if(n=n.trim(),!n||n.match(/\[[a-zA-Z]+:[^\]]+\]/)&&!n.match(a))return;let o,l=n.replace(a,"").trim();const c=[];for(a.lastIndex=0;(o=a.exec(n))!==null;){const d=parseInt(o[1],10),u=parseInt(o[2],10),p=o[3]?parseInt(o[3],10):0,_=o[3]?o[3].length===3?1e3:100:1e3,m=d*60+u+p/_;c.push(m)}c.length>0?c.forEach(d=>{t.push({time:d,text:l})}):t.push({time:null,text:l})});const s=t.filter(n=>n.text!==""||n.time===null);s.sort((n,o)=>n.time===null&&o.time===null?0:n.time===null?1:o.time===null?-1:n.time-o.time);const r=s.filter(n=>n.time!==null);if(r.length>0){const n=[];r[0].time>=10&&n.push({time:0,text:"",isInstrumental:!0});for(let l=0;l<r.length;l++)if(n.push(r[l]),l<r.length-1){const c=r[l],d=r[l+1].time-c.time;if(d>=10){const u=d>=6?c.time+3:c.time+d/2;n.push({time:u,text:"",isInstrumental:!0})}}const o=s.filter(l=>l.time===null);return[...n,...o]}return s}class id extends it{static get properties(){return{hass:{type:Object},lyrics:{type:Array},position:{type:Number},loading:{type:Boolean},error:{type:Boolean},activeThemeColor:{type:String},mode:{type:String},preRoll:{type:Number},_activeIndex:{state:!0}}}static get styles(){return ed}constructor(){super(),this.lyrics=[],this.position=0,this.loading=!1,this.error=!1,this.activeThemeColor="#ffffff",this.mode="default",this.preRoll=0,this._activeIndex=-1,this._isScrolling=!1,this._scrollTimeout=null}disconnectedCallback(){super.disconnectedCallback(),this._scrollTimeout&&(clearTimeout(this._scrollTimeout),this._scrollTimeout=null)}firstUpdated(){if(this._activeIndex!==-1)this._scrollToActive("auto");else{const e=this.renderRoot.querySelector(".lyrics-scroll-container");e&&(e.scrollTop=0)}}updated(e){if(super.updated(e),e.has("lyrics")){this._activeIndex=-1;const t=!this.lyrics?.some(s=>s.time!==null),a=this.mode==="text";if(t||a){const s=this.renderRoot.querySelector(".lyrics-scroll-container");s&&s.scrollTo({top:0,behavior:"auto"})}else requestAnimationFrame(()=>this._scrollToActive("auto"))}(e.has("position")||e.has("lyrics"))&&this._updateActiveLyric()}_updateActiveLyric(){if(!this.lyrics||this.lyrics.length===0||this.mode==="text"||!this.lyrics.some(a=>a.time!==null))return;let e=-1;const t=this.position+this.preRoll;for(let a=0;a<this.lyrics.length;a++)if(this.lyrics[a].time!==null&&this.lyrics[a].time<=t)e=a;else if(this.lyrics[a].time!==null&&this.lyrics[a].time>t)break;e!==this._activeIndex&&(this._activeIndex=e,e!==-1&&this.updateComplete.then(()=>this._scrollToActive()))}_scrollToActive(e="smooth"){if(this._isScrolling&&e==="smooth")return;const t=this.renderRoot.querySelector(".lyrics-scroll-container"),a=t?.querySelector(".lyric-line.active");if(t&&a){const s=t.clientHeight/2,r=a.offsetTop,n=a.clientHeight,o=r+n/2-s;t.scrollTo({top:o,behavior:e})}}_handleScroll(){this._isScrolling=!0,this._scrollTimeout&&clearTimeout(this._scrollTimeout),this._scrollTimeout=setTimeout(()=>{this._isScrolling=!1,this._scrollToActive()},3e3)}render(){if(this.error)return g`
        <div class="lyrics-error">
          <ha-icon icon="mdi:text-box-remove-outline"></ha-icon>
          <div>${h("lyrics.not_available")}</div>
        </div>
      `;if(this.loading)return g``;if(!this.lyrics||this.lyrics.length===0)return g`
        <div class="lyrics-empty">
          <ha-icon icon="mdi:text-box-search-outline"></ha-icon>
          <div>${h("lyrics.none_found")}</div>
        </div>
      `;const e=!this.lyrics.some(a=>a.time!==null),t=this.mode==="text";return g`
      <div
        class="lyrics-scroll-container"
        @scroll=${this._handleScroll}
        style="--yamp-primary-color: ${this.activeThemeColor}"
      >
        ${e||t?g`<div class="plain-scroll-spacer-top"></div>`:g`<div class="scroll-spacer"></div>`}
        ${this.lyrics.map((a,s)=>{const r=s===this._activeIndex,n=this.mode==="scroll",o={"lyric-line":!0,active:r&&!e,unsynced:e||t,"scroll-mode":n&&!e,"is-instrumental":!!a.isInstrumental};return a.isInstrumental?g`
              <div class="${is(o)}" aria-label="Instrumental Break">
            ...
            `:g` <div class="${is(o)}">${a.text}</div> `})}
        ${e||t?g`<div class="plain-scroll-spacer-bottom"></div>`:g`<div class="scroll-spacer"></div>`}
      </div>
    `}}customElements.define("yamp-lyrics-view",id);const ad=[{mode:"replace",icon:"mdi:playlist-remove",label:h("search.replace")},{mode:"next",icon:"mdi:playlist-play",label:h("search.play_next")},{mode:"replace_next",icon:"mdi:playlist-music",label:h("search.replace_play")},{mode:"add",icon:"mdi:playlist-plus",label:h("search.add_queue")},{mode:"add_to_playlist",icon:"mdi:plus",label:h("search.add_to_playlist")}],ki=["artist","album","track","playlist","radio","podcast","audiobook"];function hs(i){return i&&(i.media_class==="track"||i.media_content_type==="track")}function xn(i){return i&&(i.media_class==="radio"||i.media_content_type==="radio")}function wn(i){return i==="card"||i==="card_minimal"}function sd(i,{searchMediaClassFilter:e="all",recentlyPlayedFilterActive:t=!1,upcomingFilterActive:a=!1,recommendationsFilterActive:s=!1}={}){const r=hs(i),n=e==="track"||e==="album";return r&&i.artist&&i.album?`${i.artist} - ${i.album}`:(n||t||a||s)&&i.artist?i.artist:i.media_class?i.media_class.charAt(0).toUpperCase()+i.media_class.slice(1):""}const Dt=(i,{cap:e,floor:t}={})=>{const a=Number(i);if(!Number.isFinite(a)||a<=0)return;let s=a;return typeof t=="number"&&(s=Math.max(t,s)),typeof e=="number"&&(s=Math.min(e,s)),s},kn=3e4;let Rt=null,ca=0;function En(i,e,t){let a=null;if(i.entities&&typeof i.entities=="object"){const s=Object.values(i.entities);if(e&&i.entities[e]&&i.entities[e].device_id){const r=i.entities[e].device_id;i.devices&&i.devices[r]&&i.devices[r].config_entries&&i.devices[r].config_entries.length>0&&(a=i.devices[r].config_entries[0])}if(!a){const r=s.find(n=>n&&t.includes(n.platform));if(r){if(r.config_entry_id)a=r.config_entry_id;else if(r.device_id&&i.devices&&i.devices[r.device_id]){const n=i.devices[r.device_id];n.config_entries&&n.config_entries.length>0&&(a=n.config_entries[0])}}}}return a}async function da(i,e=null){if(!i)return null;const t=Date.now();if(Rt&&t-ca<kn)return Rt;try{return(i.services||{}).music_assistant?(Rt=En(i,e,["music_assistant","mass"])||"auto",ca=t,Rt):(Rt=null,ca=t,null)}catch{return Rt=null,ca=t,null}}let at=null,Ei=0;async function Si(i,e=null){if(!i)return null;const t=Date.now();if(at&&t-Ei<kn)return at;try{if(!(i.services||{}).mass_queue)return at=null,Ei=t,null;if(i.user&&i.user.is_admin)try{const a=await i.connection.sendMessagePromise({type:"config_entries/get",domain:"mass_queue"});if(a&&a.length>0)return at=a[0].entry_id,Ei=t,at}catch{}return at=En(i,null,["mass_queue"])||"auto",Ei=t,at}catch{return at=null,Ei=t,null}}function Ot(i){return i?{title:i.name,media_content_id:i.uri,media_content_type:i.media_type,media_class:i.media_type,item_id:i.item_id,thumbnail:i.image,...i.artists&&{artist:i.artists.map(e=>e.name).join(", ")},...i.album&&{album:i.album.name,album_uri:i.album.uri},is_browsable:i.media_type==="artist"||i.media_type==="album"||i.media_type==="playlist"||i.media_type==="track",is_editable:i.is_editable===!0}:null}function Sn({item:i,onPlay:e,onOptionsToggle:t,upcomingFilterActive:a=!1,isMusicAssistant:s=!1,massQueueAvailable:r=!1,searchView:n="list",isInline:o=!1,queueControlsStyle:l="drag_handle",onMoveUp:c,onMoveDown:d,onMoveNext:u,onRemove:p,minimal:_=!1,hideActions:m=!1}){if(m)return v;const f=!!(a&&i.queue_item_id&&s&&r),y=wn(n),b=o?"entity-options-search-buttons":y?"card-overlay-buttons":"search-sheet-buttons",k=o?"entity-options-search-play":y?"search-sheet-play icon-only":"search-sheet-play",w=o?"entity-options-search-queue":y?"search-sheet-queue icon-only":"search-sheet-queue";return g`
    <div class="${b}">
      ${f&&o?g`
  ...
  `}function rd({item:i,activeSearchRowMenuId:e,onPlayOption:t,onOptionsToggle:a,searchView:s="list",isQueueItem:r=!1,massQueueAvailable:n=!1,onMoveUp:o,onMoveDown:l,onMoveNext:c,onRemove:d,hideActions:u=!1}){if(u)return v;const p=e!=null&&i.media_content_id!=null&&e===i.media_content_id,_=wn(s);return g`
  ...
  `}function nd({item:i,isCard:e,isMinimal:t,isGridMode:a,activeSearchRowMenuId:s,loadingSearchRowMenuId:r,errorSearchRowMenuId:n,successSearchRowMenuId:o,successSearchRowType:l,isSelectionFlow:c,massQueueAvailable:d,upcomingFilterActive:u,recentlyPlayedFilterActive:p=!1,recommendationsFilterActive:_=!1,searchMediaClassFilter:m="all",queueControlsStyle:f="drag_handle",onPlay:y,onResultClick:b,onResultTouch:k,onOptionsToggle:w,onPlayOption:E,onMoveUp:A,onMoveDown:C,onMoveNext:M,onRemove:j,isMusicAssistant:F=!1,isValidArtwork:I=R=>!!R,getClickTitle:T=R=>"",artworkHostname:N=""}){if(!i)return g`<div class="yamp-search-result placeholder"></div>`;const R=F,V=!!i.is_browsable||c,J=e?t?"card_minimal":"card":"list",ee=s!=null&&i.media_content_id!=null&&s===i.media_content_id,B=c;return a?g`
      <button
        class="entity-options-item menu-action-item search-result-grid-mode ${u&&d&&f==="drag_handle"?"queue-drag-handle":"nodrag no-drag ignore-drag"} ${i._justMoved?"just-moved":""} ${ee?"menu-active":""}"
        @click=${L=>{c?b?.(i,L):y?.(i,L)}}
        title=${T(i)||i.title}
      >
        ${i.thumbnail&&I(i.thumbnail)?g`
                <img
                  class="yamp-search-result-thumb"
                  src=${ds(i.thumbnail,N)}
                  alt=${i.title}
                  onerror="this.style.display='none'"
                />
              `:g`
              ...
              `}
        <span class="menu-action-label">${i.title}</span>
      </button>
    `:g`
    <div
      class="yamp-search-result nodrag no-drag ignore-drag ${e?"search-result-card":""} ${t?"minimal":""} ${i._justMoved?"just-moved":""} ${ee?"menu-active":""} ${V?"clickable":""}"
      @click=${L=>{c||!e&&V?b?.(i,L):e&&y?.(i,L)}}
    >
      <div class="search-sheet-thumb-container" data-clickable="${e}">
        ${i.thumbnail&&I(i.thumbnail)?g`
              ...
              `}
        ${e?Sn({item:i,onPlay:y,onOptionsToggle:w,upcomingFilterActive:!!u,isMusicAssistant:R,massQueueAvailable:d,searchView:J,queueControlsStyle:f,onMoveUp:A,onMoveDown:C,onMoveNext:M,onRemove:j,minimal:t,hideActions:B}):v}
      </div>

      ${t?v:g`
              <div class="yamp-search-result-info">
                <span
                  class="yamp-search-result-title ${V?"clickable-search-result":""}"
                  @touchstart=${L=>k&&k(i,L)}
                  @click=${L=>{(V||c)&&(L.stopPropagation(),b&&b(i,L))}}
                  title=${T(i)}
                >
                  ${i.title}
                </span>
                <span
                  class="yamp-search-result-subtitle ${V?"clickable-search-result":""}"
                  @touchstart=${L=>k&&k(i,L)}
                  @click=${L=>{(V||c)&&(L.stopPropagation(),b&&b(i,L))}}
                >
                  ${sd(i,{searchMediaClassFilter:m,recentlyPlayedFilterActive:p,upcomingFilterActive:u,recommendationsFilterActive:_})}
                </span>
                ${e&&!xn(i)&&!B?g`
                        <div
                          class="card-menu-button ${u&&d&&f==="drag_handle"?"queue-drag-handle":""}"
                          @click=${L=>{L.preventDefault(),L.stopPropagation(),w(i)}}
                        >
                          <ha-icon icon="mdi:dots-vertical"></ha-icon>
                        </div>
                      `:v}
            ...
            `}
      ${e?v:Sn({item:i,onPlay:y,onOptionsToggle:w,upcomingFilterActive:!!u,isMusicAssistant:R,massQueueAvailable:d,searchView:J,isInline:!0,queueControlsStyle:f,onMoveUp:A,onMoveDown:C,onMoveNext:M,onRemove:j,hideActions:B})}
      ${rd({item:i,activeSearchRowMenuId:s,onPlayOption:E,onOptionsToggle:w,searchView:J,isQueueItem:R&&i.queue_item_id&&u&&d,massQueueAvailable:d,onMoveUp:A,onMoveDown:C,onMoveNext:M,onRemove:j,hideActions:B})}
      ...
      ${n!=null&&i.media_content_id!=null&&n===i.media_content_id?g`
            ...
            `:v}
      ${o!=null&&i.media_content_id!=null&&o===i.media_content_id?g`
              <div class="search-row-success-overlay">
                <span>✅</span>
                <span
                  >${h(l==="playlist"?"search.added_to_playlist":"search.added")}</span
                >
              </div>
            `:v}
    </div>
  `}function od({item:i,onClose:e,onPlayOption:t,massQueueAvailable:a=!1}){return i?g`
    <div class="entity-options-overlay entity-options-overlay-opening" @click=${e}>
      ...
      >
        <div class="entity-options-sheet">
          ...
          ${ad.filter(s=>s.mode==="add_to_playlist"?hs(i)&&a:!0).map(s=>g`
                <button
  ...
  `:v}async function An(i,e,t,a=null,s={},r=20){const n=await da(i,e);if(n)try{if(s.favorites){const u=a&&a!=="all"?[a]:ki,p=[];return await Promise.all(u.map(async _=>{try{const m={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{...n&&n!=="auto"&&{config_entry_id:n},media_type:_,favorite:!0,search:t},return_response:!0},f=Dt(r);f!==void 0&&(m.service_data.limit=f),s.orderBy&&s.orderBy!=="default"&&(m.service_data.order_by=s.orderBy),((await i.connection.sendMessagePromise(m))?.response?.items||[]).forEach(y=>{const b=Ot(y);b&&p.push(b)})}catch(m){console.error("yamp: Error searching favorites for type",_,m)}})),{results:p,usedMusicAssistant:!0}}if((!t||t.trim()==="")&&a&&a!=="all"&&!s.favorites){if(!ki.includes(a))return console.warn(`yamp: Unsupported media type for browsing: ${a}. Skipping get_library call.`),{results:[],usedMusicAssistant:!0};try{const u={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{...n&&n!=="auto"&&{config_entry_id:n},media_type:a},return_response:!0},p=Dt(r);p!==void 0&&(u.service_data.limit=p),s.orderBy&&s.orderBy!=="default"&&(u.service_data.order_by=s.orderBy);const _=(await i.connection.sendMessagePromise(u))?.response?.items||[],m=[];return _.forEach(f=>{const y=Ot(f);y&&m.push(y)}),{results:m,usedMusicAssistant:!0}}catch(u){return console.error("yamp: Error browsing library for type",a,u),{results:[],usedMusicAssistant:!0}}}const o={name:t,...n&&n!=="auto"&&{config_entry_id:n}},l=Dt(r,{cap:a==="all"?8:void 0});l!==void 0&&(o.limit=l),a&&a!=="all"&&(o.media_type=a),s.artist&&(o.artist=s.artist),s.album&&(o.album=s.album);const c={type:"call_service",domain:"music_assistant",service:"search",service_data:o,return_response:!0},d=(await i.connection.sendMessagePromise(c))?.response;if(d){const u=[];return Object.entries(d).forEach(([p,_])=>{Array.isArray(_)&&_.forEach(m=>{const f=Ot(m);f&&u.push(f)})}),{results:u,usedMusicAssistant:!0}}}catch(o){console.error("yamp: Error in searchMedia:",o)}return{results:await cd(i,e,t,a,s),usedMusicAssistant:!1}}async function ld(i,e,t=null,a=20,s={}){const r=await da(i,e);if(!r)return{results:[],usedMusicAssistant:!1};const n=typeof s.onChunk=="function"?s.onChunk:null,o=async(l,c={})=>{const d={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{...r&&r!=="auto"&&{config_entry_id:r},media_type:l,order_by:"last_played_desc"},return_response:!0},u=Dt(a,c);return u!==void 0&&(d.service_data.limit=u),((await i.connection.sendMessagePromise(d))?.response?.items||[]).map(Ot).filter(Boolean)};try{if(t==="all"){const c=[];return await Promise.all(ki.map(async d=>{const u=await o(d,{cap:5});u.length&&(c.push(...u),n&&n(u,d))})),{results:c,usedMusicAssistant:!0}}const l=await o(t||"track");return l.length&&n&&n(l,t||"track"),{results:l,usedMusicAssistant:!0}}catch(l){return console.error("yamp: Error getting recently played from Music Assistant:",l),{results:[],usedMusicAssistant:!1}}}async function $n(i,e,t=null,a=20,s={}){const r=await da(i,e);if(!r)return{results:[],usedMusicAssistant:!1};const n=typeof s.onChunk=="function"?s.onChunk:null,o=async l=>{const c={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{...r&&r!=="auto"&&{config_entry_id:r},media_type:l,favorite:!0},return_response:!0},d=Dt(a,{cap:l==="all"?8:void 0});d!==void 0&&(c.service_data.limit=d),s.orderBy&&s.orderBy!=="default"&&(c.service_data.order_by=s.orderBy);try{return((await i.connection.sendMessagePromise(c))?.response?.items||[]).map(Ot).filter(Boolean)}catch(u){return console.error("yamp: Error loading favorites for type",l,u),[]}};try{if(t&&t!=="all"){const c=await o(t);return c.length&&n&&n(c,t),{results:c,usedMusicAssistant:!0}}const l=[];return await Promise.all(ki.map(async c=>{const d=await o(c);d.length&&(l.push(...d),n&&n(d,c))})),{results:l,usedMusicAssistant:!0}}catch(l){return console.error("yamp: Error loading favorites",l),{results:[],usedMusicAssistant:!1}}}async function cd(i,e,t,a,s={}){const r={entity_id:e,search_query:t};a&&a!=="all"&&(r.media_content_type=a);const n={type:"call_service",domain:"media_player",service:"search_media",service_data:r,return_response:!0},o=await i.connection.sendMessagePromise(n);return o?.response?.[e]?.result||o?.result||[]}function dd(i,e,t){return i.callService("media_player","play_media",{entity_id:e,media_content_type:t.media_content_type,media_content_id:t.media_content_id})}async function ud(i,e,t=null,a=null,s=null,r=20){if(!e)return!1;try{const n=await da(i,t);if(!n)return!1;let o=t;if(!o){const c=Object.values(i.states).find(d=>xi(d)&&d.entity_id.startsWith("media_player."));if(c)o=c.entity_id;else return!1}const l=await Si(i,o);if(l&&e.includes("://"))try{const c={type:"call_service",domain:"mass_queue",service:"send_command",service_data:{command:"music/item_by_uri",data:{uri:e},...l&&l!=="auto"&&{config_entry_id:l}},return_response:!0},d=await i.connection.sendMessagePromise(c),u=d?.response?.response||d?.response||d?.result;if(u&&typeof u=="object"){const p=typeof u.favorite=="boolean"?u.favorite:typeof u.is_favorite=="boolean"?u.is_favorite:null;if(p!==null)return p}}catch{}if(a||e)try{const c={type:"call_service",domain:"music_assistant",service:"get_library",service_data:{...n&&n!=="auto"&&{config_entry_id:n},media_type:"track",favorite:!0,...a&&{search:a.trim()}},return_response:!0},d=Dt(r,{cap:10});d!==void 0&&(c.service_data.limit=d);const u=await i.connection.sendMessagePromise(c),p=u?.response?.items||u?.response||[];if(Array.isArray(p)){const _=(e.split("/").pop()||"").trim();return p.some(m=>m.uri===e||m.item_id&&e.endsWith(`/${m.item_id}`)||_&&m.uri&&m.uri.endsWith(`/${_}`))}}catch{}return!1}catch{return!1}}/*! js-yaml 5.3.0 https://github.com/nodeca/js-yaml @license MIT */var G=Symbol("NOT_RESOLVED");function pe(i,e){return{tagName:i,nodeKind:"scalar",implicit:e.implicit??!1,matchByTagPrefix:e.matchByTagPrefix??!1,implicitFirstChars:e.implicitFirstChars??null,resolve:e.resolve,identify:e.identify,represent:e.represent??(t=>String(t)),representTagName:e.representTagName??(()=>i)}}function ps(i,e){const t=e.finalize===void 0;return{tagName:i,nodeKind:"sequence",implicit:!1,matchByTagPrefix:e.matchByTagPrefix??!1,create:e.create,addItem:e.addItem,finalize:e.finalize??(a=>a),carrierIsResult:t,identify:e.identify,represent:e.represent??(a=>a),representTagName:e.representTagName??(()=>i)}}function ua(i,e){const t=e.finalize===void 0;return{tagName:i,nodeKind:"mapping",implicit:!1,matchByTagPrefix:e.matchByTagPrefix??!1,create:e.create,addPair:e.addPair,has:e.has,keys:e.keys,get:e.get,finalize:e.finalize??(a=>a),carrierIsResult:t,identify:e.identify,represent:e.represent??(a=>a),representTagName:e.representTagName??(()=>i)}}var hd=pe("tag:yaml.org,2002:str",{resolve:i=>i,identify:i=>typeof i=="string"}),pd=["","~","null","Null","NULL"],_d=pe("tag:yaml.org,2002:null",{implicit:!0,implicitFirstChars:["","~","n","N"],resolve:i=>pd.indexOf(i)!==-1?null:G,identify:i=>i===null,represent:()=>"null"}),md=pe("tag:yaml.org,2002:null",{implicit:!0,implicitFirstChars:["n"],resolve:(i,e)=>i==="null"||e&&i===""?null:G,identify:i=>i===null,represent:()=>"null"}),gd=["","~","null","Null","NULL"],fd=pe("tag:yaml.org,2002:null",{implicit:!0,implicitFirstChars:["","~","n","N"],resolve:i=>gd.indexOf(i)!==-1?null:G,identify:i=>i===null,represent:()=>"null"}),yd=["true","True","TRUE"],vd=["false","False","FALSE"],bd=pe("tag:yaml.org,2002:bool",{implicit:!0,implicitFirstChars:["t","T","f","F"],resolve:i=>yd.indexOf(i)!==-1?!0:vd.indexOf(i)!==-1?!1:G,identify:i=>Object.prototype.toString.call(i)==="[object Boolean]",represent:i=>i?"true":"false"}),xd=["true"],wd=["false"],kd=pe("tag:yaml.org,2002:bool",{implicit:!0,implicitFirstChars:["t","f"],resolve:i=>xd.indexOf(i)!==-1?!0:wd.indexOf(i)!==-1?!1:G,identify:i=>Object.prototype.toString.call(i)==="[object Boolean]",represent:i=>i?"true":"false"}),Ed=["true","True","TRUE","y","Y","yes","Yes","YES","on","On","ON"],Sd=["false","False","FALSE","n","N","no","No","NO","off","Off","OFF"],Ad=pe("tag:yaml.org,2002:bool",{implicit:!0,implicitFirstChars:["y","Y","n","N","t","T","f","F","o","O"],resolve:i=>Ed.indexOf(i)!==-1?!0:Sd.indexOf(i)!==-1?!1:G,identify:i=>Object.prototype.toString.call(i)==="[object Boolean]",represent:i=>i?"true":"false"}),$d=new RegExp("^(?:0o[0-7]+|0x[0-9a-fA-F]+|[-+]?[0-9]+)$"),Cd=new RegExp("^(?:[-+]?0b[0-1]+|[-+]?0o[0-7]+|[-+]?0x[0-9a-fA-F]+|[-+]?[0-9]+)$");function Td(i){let e=i,t=1;return(e[0]==="-"||e[0]==="+")&&(e[0]==="-"&&(t=-1),e=e.slice(1)),e.startsWith("0b")?t*parseInt(e.slice(2),2):e.startsWith("0o")?t*parseInt(e.slice(2),8):e.startsWith("0x")?t*parseInt(e.slice(2),16):t*parseInt(e,10)}function Id(i,e){if(e){if(!Cd.test(i))return G}else if(!$d.test(i))return G;const t=Td(i);return Number.isFinite(t)?t:G}var Cn=pe("tag:yaml.org,2002:int",{implicit:!0,implicitFirstChars:["-","+",..."0123456789"],resolve:Id,identify:i=>Number.isInteger(i)&&!Object.is(i,-0)&&i.toString(10).indexOf("e")<0,represent:i=>i.toString(10)}),Md=new RegExp("^-?(?:0|[1-9][0-9]*)$"),Pd=new RegExp("^(?:[-+]?0b[0-1]+|[-+]?0o[0-7]+|[-+]?0x[0-9a-fA-F]+|[-+]?[0-9]+)$");function zd(i){let e=i,t=1;return(e[0]==="-"||e[0]==="+")&&(e[0]==="-"&&(t=-1),e=e.slice(1)),e.startsWith("0b")?t*parseInt(e.slice(2),2):e.startsWith("0o")?t*parseInt(e.slice(2),8):e.startsWith("0x")?t*parseInt(e.slice(2),16):t*parseInt(e,10)}function jd(i,e){if(e){if(!Pd.test(i))return G}else if(!Md.test(i))return G;const t=zd(i);return Number.isFinite(t)?t:G}var Fd=pe("tag:yaml.org,2002:int",{implicit:!0,implicitFirstChars:["-",..."0123456789"],resolve:jd,identify:i=>Number.isInteger(i)&&!Object.is(i,-0)&&i.toString(10).indexOf("e")<0,represent:i=>i.toString(10)}),Dd=new RegExp("^(?:[-+]?0b[0-1_]+|[-+]?0[0-7_]+|[-+]?0x[0-9a-fA-F_]+|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+|[-+]?(?:0|[1-9][0-9_]*))$");function Rd(i){let e=i.replace(/_/g,""),t=1;if((e[0]==="-"||e[0]==="+")&&(e[0]==="-"&&(t=-1),e=e.slice(1)),e.startsWith("0b"))return t*parseInt(e.slice(2),2);if(e.startsWith("0x"))return t*parseInt(e.slice(2),16);if(e.includes(":")){let a=0;for(const s of e.split(":"))a=a*60+Number(s);return t*a}return e!=="0"&&e[0]==="0"?t*parseInt(e,8):t*parseInt(e,10)}function Od(i){if(!Dd.test(i))return G;const e=Rd(i);return Number.isFinite(e)?e:G}var _s=pe("tag:yaml.org,2002:int",{implicit:!0,implicitFirstChars:["-","+",..."0123456789"],resolve:Od,identify:i=>Number.isInteger(i)&&!Object.is(i,-0)&&i.toString(10).indexOf("e")<0,represent:i=>i.toString(10)}),Ld=new RegExp("^(?:[-+]?[0-9]+(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|[-+]?\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"),qd=new RegExp("^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Nd(i){if(!Ld.test(i))return G;let e=i.toLowerCase();const t=e[0]==="-"?-1:1;if("+-".includes(e[0])&&(e=e.slice(1)),e===".inf")return t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY;if(e===".nan")return NaN;const a=t*parseFloat(e);return Number.isFinite(a)||qd.test(i)?a:G}function Vd(i){if(isNaN(i))return".nan";if(i===Number.POSITIVE_INFINITY)return".inf";if(i===Number.NEGATIVE_INFINITY)return"-.inf";if(Object.is(i,-0))return"-0.0";const e=i.toString(10);return/^[-+]?[0-9]+e/.test(e)?e.replace("e",".e"):e}var Tn=pe("tag:yaml.org,2002:float",{implicit:!0,implicitFirstChars:["-","+",".",..."0123456789"],resolve:Nd,identify:i=>typeof i=="number"&&(!Number.isInteger(i)||Object.is(i,-0)||i.toString(10).indexOf("e")>=0),represent:Vd}),Ud=new RegExp("^-?(?:0|[1-9][0-9]*)(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$"),Bd=new RegExp("^(?:[-+]?[0-9]+(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|[-+]?\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Hd(i,e){if(e){if(!Bd.test(i))return G;let a=i.toLowerCase();const s=a[0]==="-"?-1:1;if("+-".includes(a[0])&&(a=a.slice(1)),a===".inf")return s===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY;if(a===".nan")return NaN;const r=s*parseFloat(a);return Number.isFinite(r)?r:G}if(!Ud.test(i))return G;const t=Number(i);return Number.isFinite(t)?t:G}function Gd(i){if(isNaN(i))return".nan";if(i===Number.POSITIVE_INFINITY)return".inf";if(i===Number.NEGATIVE_INFINITY)return"-.inf";if(Object.is(i,-0))return"-0.0";const e=i.toString(10);return/^[-+]?[0-9]+e/.test(e)?e.replace("e",".e"):e}var Qd=pe("tag:yaml.org,2002:float",{implicit:!0,implicitFirstChars:["-",..."0123456789"],resolve:Hd,identify:i=>typeof i=="number"&&(!Number.isInteger(i)||Object.is(i,-0)||i.toString(10).indexOf("e")>=0),represent:Gd}),Wd=new RegExp("^(?:[-+]?(?:(?:[0-9][0-9_]*)?\\.[0-9_]*)(?:[eE][-+][0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"),Yd=new RegExp("^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Kd(i){if(!Wd.test(i))return G;let e=i.toLowerCase().replace(/_/g,"");const t=e[0]==="-"?-1:1;if("+-".includes(e[0])&&(e=e.slice(1)),e===".inf")return t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY;if(e===".nan")return NaN;let a=0;if(e.includes(":")){for(const s of e.split(":"))a=a*60+Number(s);a*=t}else a=t*parseFloat(e);return Number.isFinite(a)||Yd.test(i)?a:G}function Zd(i){if(isNaN(i))return".nan";if(i===Number.POSITIVE_INFINITY)return".inf";if(i===Number.NEGATIVE_INFINITY)return"-.inf";if(Object.is(i,-0))return"-0.0";const e=i.toString(10);return/^[-+]?[0-9]+e/.test(e)?e.replace("e",".e"):e}var ms=pe("tag:yaml.org,2002:float",{implicit:!0,implicitFirstChars:["-","+",".",..."0123456789"],resolve:Kd,identify:i=>typeof i=="number"&&(!Number.isInteger(i)||Object.is(i,-0)||i.toString(10).indexOf("e")>=0),represent:Zd}),Jd=pe("tag:yaml.org,2002:merge",{implicit:!0,implicitFirstChars:["<"],resolve:(i,e)=>i==="<<"||e&&i===""?"<<":G,identify:()=>!1}),Xd=/^[A-Za-z0-9+/]*={0,2}$/;function eu(i){const e=i.replace(/\s/g,"");if(e.length%4!==0||!Xd.test(e))return G;const t=atob(e),a=new Uint8Array(t.length);for(let s=0;s<t.length;s++)a[s]=t.charCodeAt(s);return a}function tu(i){let e="";for(let t=0;t<i.length;t++)e+=String.fromCharCode(i[t]);return btoa(e)}var iu=pe("tag:yaml.org,2002:binary",{resolve:eu,identify:i=>Object.prototype.toString.call(i)==="[object Uint8Array]",represent:tu}),au=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),su=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function In(i,e,t,a=0,s=0,r=0,n=0){const o=new Date(Date.UTC(i,e,t,a,s,r,n));return o.setUTCFullYear(i,e,t),o}function ru(i){let e=au.exec(i);if(e===null&&(e=su.exec(i)),e===null)return G;const t=+e[1],a=+e[2]-1,s=+e[3];if(!e[4]){const d=In(t,a,s);return d.getUTCFullYear()!==t||d.getUTCMonth()!==a||d.getUTCDate()!==s?G:d}const r=+e[4],n=+e[5],o=+e[6];let l=0;if(r>23||n>59||o>59)return G;if(e[7]){let d=e[7].slice(0,3);for(;d.length<3;)d+="0";l=+d}const c=In(t,a,s,r,n,o,l);if(c.getUTCFullYear()!==t||c.getUTCMonth()!==a||c.getUTCDate()!==s)return G;if(e[9]){const d=+e[10],u=+(e[11]||0);if(d>23||u>59)return G;const p=(d*60+u)*6e4;c.setTime(c.getTime()-(e[9]==="-"?-p:p))}return c}var nu=pe("tag:yaml.org,2002:timestamp",{implicit:!0,implicitFirstChars:[..."0123456789"],resolve:ru,identify:i=>i instanceof Date,represent:i=>i.toISOString()}),ou=ps("tag:yaml.org,2002:seq",{create:()=>[],addItem:(i,e)=>{i.push(e)},identify:Array.isArray});function ha(i){if(i===null||typeof i!="object"||Array.isArray(i))return!1;const e=Object.getPrototypeOf(i);return e===null||e===Object.prototype}function gs(i,e){const t={};for(const a of e)i[a]!==void 0&&(t[a]=i[a]);return t}var lu=ps("tag:yaml.org,2002:omap",{create:()=>({list:[],seen:new Set}),addItem:(i,e)=>{let t;if(e instanceof Map){if(e.size!==1)return"cannot resolve an ordered map item";t=e.keys().next().value}else if(ha(e)){const a=Object.keys(e);if(a.length!==1)return"cannot resolve an ordered map item";t=a[0]}else return"cannot resolve an ordered map item";return i.seen.has(t)?"duplicate key in ordered map":(i.seen.add(t),i.list.push(e),"")},finalize:i=>i.list,identify:()=>!1}),cu=ps("tag:yaml.org,2002:pairs",{create:()=>[],addItem:(i,e)=>{if(e instanceof Map)return e.size!==1?"cannot resolve a pairs item":(i.push(e.entries().next().value),"");if(Object.prototype.toString.call(e)!=="[object Object]")return"cannot resolve a pairs item";const t=e,a=Object.keys(t);return a.length!==1?"cannot resolve a pairs item":(i.push([a[0],t[a[0]]]),"")},identify:()=>!1}),du=ua("tag:yaml.org,2002:map",{create:()=>({}),identify:ha,represent:i=>{const e=new Map;for(const t of Object.keys(i))e.set(t,i[t]);return e},addPair:(i,e,t)=>{if(e!==null&&typeof e=="object")return"object-based map does not support complex keys";const a=String(e);return a==="__proto__"?Object.defineProperty(i,a,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[a]=t,""},has:(i,e)=>e!==null&&typeof e=="object"?!1:Object.prototype.hasOwnProperty.call(i,String(e)),keys:i=>Object.keys(i),get:(i,e)=>{const t=String(e);return Object.prototype.hasOwnProperty.call(i,t)?i[t]:null}}),uu=ua("tag:yaml.org,2002:set",{create:()=>new Set,identify:i=>i instanceof Set,represent:i=>{const e=new Map;for(const t of i)e.set(t,null);return e},addPair:(i,e,t)=>t!==null?"cannot resolve a set item":(i.add(e),""),has:(i,e)=>i.has(e),keys:i=>i.keys(),get:()=>null});function hu(){return{scalar:Object.create(null),sequence:Object.create(null),mapping:Object.create(null)}}function pu(){return{scalar:[],sequence:[],mapping:[]}}function _u(i){const e=[];for(const t of i){let a=e.length;for(let s=0;s<e.length;s++){const r=e[s];if(r.nodeKind===t.nodeKind&&r.tagName===t.tagName&&r.matchByTagPrefix===t.matchByTagPrefix){a=s;break}}e[a]=t}return e}var pa=class Wo{constructor(e){de(this,"tags");de(this,"implicitScalarTags");de(this,"implicitScalarByFirstChar");de(this,"implicitScalarAnyFirstChar");de(this,"defaultScalarTag");de(this,"defaultSequenceTag");de(this,"defaultMappingTag");de(this,"exact");de(this,"prefix");const t=_u(e),a=[],s=hu(),r=pu();for(const d of t){if(d.nodeKind==="scalar"&&d.implicit){if(d.matchByTagPrefix)throw new Error("Implicit scalar tags cannot match by tag prefix");a.push(d)}switch(d.nodeKind){case"scalar":d.matchByTagPrefix?r.scalar.push(d):s.scalar[d.tagName]=d;break;case"sequence":d.matchByTagPrefix?r.sequence.push(d):s.sequence[d.tagName]=d;break;case"mapping":d.matchByTagPrefix?r.mapping.push(d):s.mapping[d.tagName]=d;break}}const n=a.filter(d=>d.implicitFirstChars===null),o=new Set;for(const d of a)if(d.implicitFirstChars!==null)for(const u of d.implicitFirstChars)o.add(u);const l=new Map;for(const d of o)l.set(d,a.filter(u=>u.implicitFirstChars===null||u.implicitFirstChars.indexOf(d)!==-1));const c=s.scalar["tag:yaml.org,2002:str"];if(!c)throw new Error("schema does not define the default scalar tag (tag:yaml.org,2002:str)");this.tags=t,this.implicitScalarTags=a,this.implicitScalarByFirstChar=l,this.implicitScalarAnyFirstChar=n,this.defaultScalarTag=c,this.defaultSequenceTag=s.sequence["tag:yaml.org,2002:seq"],this.defaultMappingTag=s.mapping["tag:yaml.org,2002:map"],this.exact=s,this.prefix=r}lookupScalarTag(e){const t=this.exact.scalar[e];if(t)return t;for(const a of this.prefix.scalar)if(e.startsWith(a.tagName))return a}lookupSequenceTag(e){const t=this.exact.sequence[e];if(t)return t;for(const a of this.prefix.sequence)if(e.startsWith(a.tagName))return a}lookupMappingTag(e){const t=this.exact.mapping[e];if(t)return t;for(const a of this.prefix.mapping)if(e.startsWith(a.tagName))return a}resolveImplicitScalarTag(e){const t=this.implicitScalarByFirstChar.get(e.charAt(0))??this.implicitScalarAnyFirstChar;for(const s of t){const r=s.resolve(e,!1,s.tagName);if(r!==G)return{value:r,tag:s}}const a=this.defaultScalarTag;return{value:a.resolve(e,!1,a.tagName),tag:a}}withTags(...e){let t=[];for(const a of e)t=t.concat(a);return new Wo([...this.tags,...t])}},fs=new pa([hd,ou,du]);new pa([...fs.tags,md,kd,Fd,Qd]);var mu=new pa([...fs.tags,_d,bd,Cn,Tn]),gu=new pa([...fs.tags,fd,Ad,_s,ms,nu,Jd,iu,lu,cu,uu]),fu=gu.withTags({..._s,resolve:(i,e,t)=>{const a=_s.resolve(i,e,t);return a===G?Cn.resolve(i,e,t):a}},{...ms,resolve:(i,e,t)=>{const a=ms.resolve(i,e,t);return a===G?Tn.resolve(i,e,t):a}});ua("tag:yaml.org,2002:map",{create:()=>new Map,addPair:(i,e,t)=>(i.set(e,t),""),has:(i,e)=>i.has(e),keys:i=>i.keys(),get:(i,e)=>i.get(e),identify:i=>i instanceof Map||ha(i),represent:i=>{if(i instanceof Map)return i;const e=new Map,t=i;for(const a of Object.keys(t))e.set(a,t[a]);return e}});function Mn(i){if(Array.isArray(i)){const e=Array.prototype.slice.call(i);for(let t=0;t<e.length;t++){if(Array.isArray(e[t]))return null;typeof e[t]=="object"&&Object.prototype.toString.call(e[t])==="[object Object]"&&(e[t]="[object Object]")}return String(e)}return typeof i=="object"&&Object.prototype.toString.call(i)==="[object Object]"?"[object Object]":String(i)}ua("tag:yaml.org,2002:map",{create:()=>({}),identify:ha,represent:i=>{const e=new Map;for(const t of Object.keys(i))e.set(t,i[t]);return e},addPair:(i,e,t)=>{const a=Mn(e);return a===null?"nested arrays are not supported inside keys":(a==="__proto__"?Object.defineProperty(i,a,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[a]=t,"")},has:(i,e)=>{const t=Mn(e);return t!==null&&Object.prototype.hasOwnProperty.call(i,t)},keys:i=>Object.keys(i),get:(i,e)=>{const t=String(e);return Object.prototype.hasOwnProperty.call(i,t)?i[t]:null}});var yu={maxLength:79,indent:1,linesBefore:3,linesAfter:2};function ys(i,e,t,a,s){let r="",n="";const o=Math.floor(s/2)-1;return a-e>o&&(r=" ... ",e=a-o+r.length),t-a>o&&(n=" ...",t=a+o-n.length),{str:r+i.slice(e,t).replace(/\t/g,"\u2192")+n,pos:a-e+r.length}}function vs(i,e){return" ".repeat(Math.max(e-i.length,0))+i}function vu(i,e){if(!i.buffer)return null;const t={...yu,...e},a=/\r?\n|\r|\0/g,s=[0],r=[];let n,o=-1;for(;n=a.exec(i.buffer);)r.push(n.index),s.push(n.index+n[0].length),i.position<=n.index&&o<0&&(o=s.length-2);o<0&&(o=s.length-1);let l="";const c=Math.min(i.line+t.linesAfter,r.length).toString().length,d=t.maxLength-(t.indent+c+3);for(let p=1;p<=t.linesBefore&&!(o-p<0);p++){const _=ys(i.buffer,s[o-p],r[o-p],i.position-(s[o]-s[o-p]),d);l=`${" ".repeat(t.indent)}${vs((i.line-p+1).toString(),c)} | ${_.str}
${l}`}const u=ys(i.buffer,s[o],r[o],i.position,d);l+=`${" ".repeat(t.indent)}${vs((i.line+1).toString(),c)} | ${u.str}
`,l+=`${"-".repeat(t.indent+c+3+u.pos)}^
`;for(let p=1;p<=t.linesAfter&&!(o+p>=r.length);p++){const _=ys(i.buffer,s[o+p],r[o+p],i.position-(s[o]-s[o+p]),d);l+=`${" ".repeat(t.indent)}${vs((i.line+p+1).toString(),c)} | ${_.str}
`}return l.replace(/\n$/,"")}function Pn(i,e){let t="";return i.mark?(i.mark.name&&(t+=`in "${i.mark.name}" `),t+=`(${i.mark.line+1}:${i.mark.column+1})`,!e&&i.mark.snippet&&(t+=`

${i.mark.snippet}`),`${i.reason} ${t}`):i.reason}var st=class Yo extends Error{constructor(t,a){super();de(this,"reason");de(this,"mark");this.name="YAMLException",this.reason=t,this.mark=a,this.message=Pn(this,!1),Error.captureStackTrace&&Error.captureStackTrace(this,this.constructor)}toString(t){return`${this.name}: ${Pn(this,t)}`}static throwAt(t,a,s,r=""){let n=0,o=0;for(let c=0;c<a;c++){const d=t.charCodeAt(c);d===10?(n++,o=c+1):d===13&&(n++,t.charCodeAt(c+1)===10&&c++,o=c+1)}const l={name:r,buffer:t,position:a,line:n,column:a-o};throw l.snippet=vu(l),new Yo(s,l)}},_e={DOCUMENT:1,SEQUENCE:2,MAPPING:3,SCALAR:4,ALIAS:5,POP:6},Pe={PLAIN:1,SINGLE_QUOTED:2,DOUBLE_QUOTED:3,LITERAL_BLOCK:4,FOLDED_BLOCK:5},Lt={BLOCK:1,FLOW:2},qe={CLIP:1,STRIP:2,KEEP:3},bu=-1;function zn(i){switch(i){case 48:return"\0";case 97:return"\x07";case 98:return"\b";case 116:return"	";case 9:return"	";case 110:return`
`;case 118:return"\v";case 102:return"\f";case 114:return"\r";case 101:return"\x1B";case 32:return" ";case 34:return'"';case 47:return"/";case 92:return"\\";case 78:return"\x85";case 95:return"\xA0";case 76:return"\u2028";case 80:return"\u2029";default:return""}}var jn=new Array(256),Fn=new Array(256);for(let i=0;i<256;i++)jn[i]=zn(i)?1:0,Fn[i]=zn(i);function xu(i){return i<=65535?String.fromCharCode(i):String.fromCharCode((i-65536>>10)+55296,(i-65536&1023)+56320)}function wu(i){return i>=48&&i<=57?i-48:(i|32)-97+10}function ku(i){return i===120?2:i===117?4:8}function _a(i,e,t){let a=0;for(;e<t;){const s=i.charCodeAt(e);if(s===10)a++,e++;else if(s===13)a++,e++,i.charCodeAt(e)===10&&e++;else if(s===32||s===9)e++;else break}return{position:e,breaks:a}}function bs(i){return i===1?" ":`
`.repeat(i-1)}function Eu(i,e,t){let a="",s=e,r=e,n=e;for(;s<t;){const o=i.charCodeAt(s);if(o===10||o===13){a+=i.slice(r,n);const l=_a(i,s,t);a+=bs(l.breaks),s=r=n=l.position}else s++,o!==32&&o!==9&&(n=s)}return a+i.slice(r,n)}function Su(i,e,t){let a="",s=e,r=e,n=e;for(;s<t;){const o=i.charCodeAt(s);if(o===39)a+=i.slice(r,s)+"'",s+=2,r=n=s;else if(o===10||o===13){a+=i.slice(r,n);const l=_a(i,s,t);a+=bs(l.breaks),s=r=n=l.position}else s++,o!==32&&o!==9&&(n=s)}return a+i.slice(r,t)}function Au(i,e,t){let a="",s=e,r=e,n=e;for(;s<t;){const o=i.charCodeAt(s);if(o===92){a+=i.slice(r,s),s++;const l=i.charCodeAt(s);if(l===10||l===13)s=_a(i,s,t).position;else if(l<256&&jn[l])a+=Fn[l],s++;else{let c=ku(l),d=0;for(;c>0;c--){s++;const u=wu(i.charCodeAt(s));d=(d<<4)+u}a+=xu(d),s++}r=n=s}else if(o===10||o===13){a+=i.slice(r,n);const l=_a(i,s,t);a+=bs(l.breaks),s=r=n=l.position}else s++,o!==32&&o!==9&&(n=s)}return a+i.slice(r,t)}function Dn(i,e,t,a,s,r){const n=a<0?0:a,o=i.slice(e,t).replace(/\r\n?/g,`
`),l=o===""?[]:(o.endsWith(`
`)?o.slice(0,-1):o).split(`
...
`.repeat(u):c+=`
`.repeat(d?1+u:u),c+=f,d=!0,u=0}return s===qe.KEEP?c+=`
`.repeat(d?1+u:u):s!==qe.STRIP&&d&&(c+=`
`),c}function $u(i,e){if(e.valueStart===bu)return"";const{valueStart:t,valueEnd:a}=e;if(e.fast)return i.slice(t,a);switch(e.style){case Pe.SINGLE_QUOTED:return Su(i,t,a);case Pe.DOUBLE_QUOTED:return Au(i,t,a);case Pe.LITERAL_BLOCK:return Dn(i,t,a,e.indent,e.chomping,!1);case Pe.FOLDED_BLOCK:return Dn(i,t,a,e.indent,e.chomping,!0);default:return Eu(i,t,a)}}var Cu=Object.assign(Object.create(null),{"!":"!","!!":"tag:yaml.org,2002:"});function xs(i){return encodeURI(i).replace(/!/g,"%21")}function Rn(i,e){if(i.startsWith("!<")&&i.endsWith(">"))return decodeURIComponent(i.slice(2,-1));const t=i.indexOf("!",1),a=t===-1?"!":i.slice(0,t+1),s=e?.[a]??Cu[a]??a;return decodeURIComponent(s)+decodeURIComponent(i.slice(a.length))}function On(i){let e=i;return e.charCodeAt(0)===33?(e=e.slice(1),`!${xs(e)}`):e.slice(0,18)==="tag:yaml.org,2002:"?`!!${xs(e.slice(18))}`:`!<${xs(e)}>`}var qt=-1,Tu="tag:yaml.org,2002:merge",ws={filename:"",schema:mu,json:!1,maxTotalMergeKeys:1e4,maxAliases:-1};function Iu(i){return"tagStart"in i&&i.tagStart!==qt?i.tagStart:"anchorStart"in i&&i.anchorStart!==qt?i.anchorStart:"valueStart"in i&&i.valueStart!==qt?i.valueStart:"start"in i?i.start:0}function me(i,e){st.throwAt(i.source,i.position,e,i.filename)}function Ln(i,e,t,a){try{return t.finalize(a)}catch(s){if(s instanceof st)throw s;st.throwAt(i.source,e,s instanceof Error?s.message:String(s),i.filename)}}function Mu(i,e){const t=$u(i.source,e),a=e.tagStart===qt?"":i.source.slice(e.tagStart,e.tagEnd),s=i.schema.defaultScalarTag;if(a!==""){if(a==="!")return{value:t,tag:s};const r=Rn(a,i.tagHandlers),n=i.schema.lookupScalarTag(r);if(n){const l=n.resolve(t,!0,r);return l===G&&me(i,`cannot resolve a node with !<${r}> explicit tag`),{value:l,tag:n}}const o=i.schema.lookupMappingTag(r)??i.schema.lookupSequenceTag(r);if(o){t!==""&&me(i,`cannot resolve a node with !<${r}> explicit tag`);const l=o.create(r);return{value:o.carrierIsResult?l:Ln(i,i.position,o,l),tag:o}}me(i,`unknown scalar tag !<${r}>`)}return e.style===Pe.PLAIN?i.schema.resolveImplicitScalarTag(t):{value:s.resolve(t,!1,s.tagName),tag:s}}function qn(i,e,t){const a=e.tagStart===qt?"":i.source.slice(e.tagStart,e.tagEnd);return a===""||a==="!"?t:Rn(a,i.tagHandlers)}function Nn(i){return i.nodeKind==="mapping"}function Vn(i,e,t,a){for(const s of a.keys(t)){if(i.maxTotalMergeKeys!==-1&&++i.totalMergeKeys>i.maxTotalMergeKeys&&me(i,`merge keys exceeded maxTotalMergeKeys (${i.maxTotalMergeKeys})`),e.tag.has(e.value,s))continue;const r=e.tag.addPair(e.value,s,a.get(t,s));r&&me(i,r),(e.overridable??=new Set).add(s)}}function Pu(i,e,t,a){if(i.position=e.keyPosition,Nn(a))Vn(i,e,t,a);else if(a.nodeKind==="sequence"&&Array.isArray(t))for(const s of t){const r=i.nodeTags.get(s);r||me(i,"cannot merge mappings; the provided source object is unacceptable"),Vn(i,e,s,r)}else me(i,"cannot merge mappings; the provided source object is unacceptable")}function zu(i,e,t,a,s){if(i.position=e.keyPosition,e.keyIsMerge){Pu(i,e,a,s);return}!i.json&&e.tag.has(e.value,t)&&!e.overridable?.has(t)&&me(i,"duplicated mapping key");const r=e.tag.addPair(e.value,t,a);r&&me(i,r),e.overridable?.delete(t)}function ks(i,e,t){const a=i.frames[i.frames.length-1];if(a.kind==="document")a.value=e,a.hasValue=!0;else if(a.kind==="sequence"){Nn(t)&&i.nodeTags.set(e,t);const s=a.tag.addItem(a.value,e,a.index++);s&&me(i,s)}else if(a.hasKey){const s=a.key;a.key=void 0,a.hasKey=!1,zu(i,a,s,e,t)}else a.key=e,a.keyPosition=i.position,a.hasKey=!0,a.keyIsMerge=t.tagName===Tu}function Es(i,e,t,a,s){if(e.anchorStart!==qt){const r={value:t,tag:a,isValueFinal:s};return i.anchors.set(i.source.slice(e.anchorStart,e.anchorEnd),r),r}return null}function ju(i,e){const t={...ws,...e,events:i,documents:[],eventIndex:0,position:0,frames:[],anchors:new Map,nodeTags:new Map,tagHandlers:Object.create(null),totalMergeKeys:0,aliasCount:0};for(;t.eventIndex<t.events.length;){const a=t.events[t.eventIndex++];switch(t.position=Iu(a),a.type){case _e.DOCUMENT:t.anchors=new Map,t.nodeTags=new Map,t.aliasCount=0,t.tagHandlers=Object.create(null);for(const s of a.directives)s.kind==="tag"&&(t.tagHandlers[s.handle]=s.prefix);t.frames.push({kind:"document",position:t.position,value:void 0,hasValue:!1});break;case _e.SCALAR:{const{value:s,tag:r}=Mu(t,a);Es(t,a,s,r,!0),ks(t,s,r);break}case _e.SEQUENCE:{const s=qn(t,a,"tag:yaml.org,2002:seq"),r=t.schema.lookupSequenceTag(s);r||me(t,`unknown sequence tag !<${s}>`);const n=r.create(s),o=Es(t,a,n,r,r.carrierIsResult);t.frames.push({kind:"sequence",position:t.position,value:n,tag:r,anchor:o,index:0});break}case _e.MAPPING:{const s=qn(t,a,"tag:yaml.org,2002:map"),r=t.schema.lookupMappingTag(s);r||me(t,`unknown mapping tag !<${s}>`);const n=r.create(s),o=Es(t,a,n,r,r.carrierIsResult);t.frames.push({kind:"mapping",position:t.position,value:n,tag:r,anchor:o,key:void 0,keyPosition:t.position,hasKey:!1,keyIsMerge:!1,overridable:null});break}case _e.ALIAS:{t.maxAliases!==-1&&++t.aliasCount>t.maxAliases&&me(t,`aliases exceeded maxAliases (${t.maxAliases})`);const s=t.source.slice(a.anchorStart,a.anchorEnd),r=t.anchors.get(s);r||me(t,`unidentified alias "${s}"`),r.isValueFinal||me(t,`recursive alias "${s}" is not supported for tag ${r.tag.tagName} because it uses finalize()`),ks(t,r.value,r.tag);break}case _e.POP:{const s=t.frames.pop();if(s.kind==="mapping"&&s.hasKey&&(t.position=s.keyPosition,me(t,"incomplete mapping pair in event stream")),s.kind==="document")t.documents.push(s.value);else{const r=s.tag.carrierIsResult?s.value:Ln(t,s.position,s.tag,s.value);s.anchor&&(s.anchor.value=r,s.anchor.isValueFinal=!0),ks(t,r,s.tag)}break}}}return t.documents}var W=-1,Un=Object.prototype.hasOwnProperty,Nt=1,Ss=2,Bn=3,ma=4,Fu=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Du=/[,\[\]{}]/,Hn=/^(?:!|!!|![0-9A-Za-z-]+!)$/,As=String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$,_.!~*'()\[\]])`,Gn=String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$.~*'()_])`,Ru=new RegExp(`^(?:${As})*$`),Ou=new RegExp(`^(?:${Gn})+$`),Lu=new RegExp(`^(?:!(?:${As})*|${Gn}(?:${As})*)$`),$s={filename:"",maxDepth:100};function qu(i,e,t){i.events.push({type:_e.DOCUMENT,explicitStart:e,explicitEnd:t,directives:i.directives})}function Qn(i,e,t,a,s,r,n){i.events.push({type:_e.SEQUENCE,start:e,anchorStart:t,anchorEnd:a,tagStart:s,tagEnd:r,style:n})}function Cs(i,e,t,a,s,r,n){i.events.push({type:_e.MAPPING,start:e,anchorStart:t,anchorEnd:a,tagStart:s,tagEnd:r,style:n})}function Wn(i,e){i.events.splice(e.eventsLength,0,{type:_e.MAPPING,start:e.position,anchorStart:W,anchorEnd:W,tagStart:W,tagEnd:W,style:Lt.FLOW})}function Vt(i,e,t,a,s,r,n,o,l=qe.CLIP,c=-1,d=!1){i.events.push({type:_e.SCALAR,valueStart:e,valueEnd:t,anchorStart:a,anchorEnd:s,tagStart:r,tagEnd:n,style:o,chomping:l,indent:c,fast:d})}function Nu(i,e,t){i.events.push({type:_e.ALIAS,anchorStart:e,anchorEnd:t})}function Ut(i){i.events.push({type:_e.POP})}function xe(i){Vt(i,W,W,W,W,W,W,Pe.PLAIN)}function Yn(){return{anchorStart:W,anchorEnd:W,tagStart:W,tagEnd:W}}function Ai(i){return{position:i.position,line:i.line,lineStart:i.lineStart,lineIndent:i.lineIndent,firstTabInLine:i.firstTabInLine,eventsLength:i.events.length}}function Bt(i,e){i.position=e.position,i.line=e.line,i.lineStart=e.lineStart,i.lineIndent=e.lineIndent,i.firstTabInLine=e.firstTabInLine,i.events.length=e.eventsLength}function $(i,e){st.throwAt(i.input.slice(0,i.length),i.position,e,i.filename)}function ue(i){return i===10||i===13}function bt(i){return i===9||i===32}function Fe(i){return bt(i)||ue(i)}function Qe(i){return i===0||Fe(i)}function xt(i){return i===44||i===91||i===93||i===123||i===125}function Vu(i){return i>=48&&i<=57?i-48:-1}function Uu(i){if(i>=48&&i<=57)return i-48;const e=i|32;return e>=97&&e<=102?e-97+10:-1}function Bu(i){return i===120?2:i===117?4:i===85?8:0}function Hu(i){return i===48||i===97||i===98||i===116||i===9||i===110||i===118||i===102||i===114||i===101||i===32||i===34||i===47||i===92||i===78||i===95||i===76||i===80}function ga(i){i.input.charCodeAt(i.position)===10?i.position++:(i.position++,i.input.charCodeAt(i.position)===10&&i.position++),i.line++,i.lineStart=i.position,i.lineIndent=0,i.firstTabInLine=-1}function we(i,e){let t=0,a=i.input.charCodeAt(i.position),s=i.position===i.lineStart||Fe(i.input.charCodeAt(i.position-1));for(;a!==0;){for(;bt(a);)s=!0,a===9&&i.firstTabInLine===-1&&(i.firstTabInLine=i.position),a=i.input.charCodeAt(++i.position);if(e&&s&&a===35)do a=i.input.charCodeAt(++i.position);while(!ue(a)&&a!==0);if(!ue(a))break;for(ga(i),t++,s=!0,a=i.input.charCodeAt(i.position);a===32;)i.lineIndent++,a=i.input.charCodeAt(++i.position)}return t}function wt(i,e=i.position){const t=i.input.charCodeAt(e);if((t===45||t===46)&&t===i.input.charCodeAt(e+1)&&t===i.input.charCodeAt(e+2)){const a=i.input.charCodeAt(e+3);return a===0||Fe(a)}return!1}function Kn(i){let e=i.input.charCodeAt(i.position);for(;e!==0&&!ue(e);)e=i.input.charCodeAt(++i.position)}function Zn(i,e,t){Fu.test(i.input.slice(e,t))&&$(i,"the stream contains non-printable characters")}function Gu(i,e,t){if(i.input.charCodeAt(i.position)!==33)return!1;e.tagStart!==W&&$(i,"duplication of a tag property");const a=i.position;let s=!1,r=!1,n="!",o=i.input.charCodeAt(++i.position);o===60?(s=!0,o=i.input.charCodeAt(++i.position)):o===33&&(r=!0,n="!!",o=i.input.charCodeAt(++i.position));let l=i.position,c;if(s){for(;o!==0&&o!==62;)o=i.input.charCodeAt(++i.position);o!==62&&$(i,"unexpected end of the stream within a verbatim tag"),c=i.input.slice(l,i.position),i.position++}else{for(;o!==0&&!Fe(o)&&!(t&&xt(o));)o===33&&(r?$(i,"tag suffix cannot contain exclamation marks"):(n=i.input.slice(l-1,i.position+1),Hn.test(n)||$(i,"named tag handle cannot contain such characters"),r=!0,l=i.position+1)),o=i.input.charCodeAt(++i.position);c=i.input.slice(l,i.position),Du.test(c)&&$(i,"tag suffix cannot contain flow indicator characters")}return c&&!(s?Ru.test(c):Ou.test(c))&&$(i,`tag name cannot contain such characters: ${c}`),!s&&n!=="!"&&n!=="!!"&&!Un.call(i.tagHandlers,n)&&$(i,`undeclared tag handle "${n}"`),e.tagStart=a,e.tagEnd=i.position,!0}function Qu(i,e){if(i.input.charCodeAt(i.position)!==38)return!1;e.anchorStart!==W&&$(i,"duplication of an anchor property"),i.position++;const t=i.position;for(;i.input.charCodeAt(i.position)!==0&&!Fe(i.input.charCodeAt(i.position))&&!xt(i.input.charCodeAt(i.position));)i.position++;return i.position===t&&$(i,"name of an anchor node must contain at least one character"),e.anchorStart=t,e.anchorEnd=i.position,!0}function Wu(i,e){if(i.input.charCodeAt(i.position)!==42)return!1;(e.anchorStart!==W||e.tagStart!==W)&&$(i,"alias node should not have any properties"),i.position++;const t=i.position;for(;i.input.charCodeAt(i.position)!==0&&!Fe(i.input.charCodeAt(i.position))&&!xt(i.input.charCodeAt(i.position));)i.position++;return i.position===t&&$(i,"name of an alias node must contain at least one character"),Nu(i,t,i.position),!0}function Ts(i,e){we(i,!1),i.lineIndent<e&&$(i,"deficient indentation")}function Yu(i,e,t){if(i.input.charCodeAt(i.position)!==39)return!1;i.position++;const a=i.position;let s=!0;for(;i.input.charCodeAt(i.position)!==0;){const r=i.input.charCodeAt(i.position);if(r===39){if(i.input.charCodeAt(i.position+1)===39){s=!1,i.position+=2;continue}const n=i.position;return i.position++,Vt(i,a,n,t.anchorStart,t.anchorEnd,t.tagStart,t.tagEnd,Pe.SINGLE_QUOTED,qe.CLIP,-1,s),!0}ue(r)?(s=!1,Ts(i,e)):i.position===i.lineStart&&wt(i)?$(i,"unexpected end of the document within a single quoted scalar"):r!==9&&r<32?$(i,"expected valid JSON character"):i.position++}$(i,"unexpected end of the stream within a single quoted scalar")}function Ku(i,e,t){if(i.input.charCodeAt(i.position)!==34)return!1;i.position++;const a=i.position;let s=!0;for(;i.input.charCodeAt(i.position)!==0;){const r=i.input.charCodeAt(i.position);if(r===34){const n=i.position;return i.position++,Vt(i,a,n,t.anchorStart,t.anchorEnd,t.tagStart,t.tagEnd,Pe.DOUBLE_QUOTED,qe.CLIP,-1,s),!0}if(r===92){s=!1;const n=i.input.charCodeAt(++i.position);if(ue(n))Ts(i,e);else if(Hu(n))i.position++;else{let o=Bu(n);for(o===0&&$(i,"unknown escape sequence");o-- >0;)i.position++,Uu(i.input.charCodeAt(i.position))<0&&$(i,"expected hexadecimal character");i.position++}}else ue(r)?(s=!1,Ts(i,e)):i.position===i.lineStart&&wt(i)?$(i,"unexpected end of the document within a double quoted scalar"):r!==9&&r<32?$(i,"expected valid JSON character"):i.position++}$(i,"unexpected end of the stream within a double quoted scalar")}function Zu(i,e,t){const a=i.input.charCodeAt(i.position);let s=qe.CLIP,r=-1,n=!1;if(a!==124&&a!==62)return!1;const o=a===124?Pe.LITERAL_BLOCK:Pe.FOLDED_BLOCK;for(i.position++;i.input.charCodeAt(i.position)!==0;){const _=i.input.charCodeAt(i.position),m=Vu(_);if(_===43||_===45)s!==qe.CLIP&&$(i,"repeat of a chomping mode identifier"),s=_===43?qe.KEEP:qe.STRIP,i.position++;else if(m>=0)m===0&&$(i,"bad explicit indentation width of a block scalar; it cannot be less than one"),n&&$(i,"repeat of an indentation width identifier"),r=e+m-1,n=!0,i.position++;else break}let l=!1;for(;bt(i.input.charCodeAt(i.position));)l=!0,i.position++;l&&i.input.charCodeAt(i.position)===35&&Kn(i),ue(i.input.charCodeAt(i.position))?ga(i):i.input.charCodeAt(i.position)!==0&&$(i,"a line break is expected");let c=n?r:-1,d=0;const u=i.position;let p=i.position;for(;i.input.charCodeAt(i.position)!==0;){const _=i.position;let m=0;for(;i.input.charCodeAt(_+m)===32;)m++;const f=i.input.charCodeAt(_+m);if(f===0){c>=0?m>c&&(p=_+m):m>0&&(p=_+m);break}if(_===i.lineStart&&wt(i,_))break;if(!n&&c===-1&&ue(f)&&(d=Math.max(d,m)),!n&&c===-1&&!ue(f)&&(f===9&&m<e&&(i.position=_+m,$(i,"tab characters must not be used in indentation")),m<d&&(i.position=_+m,$(i,"bad indentation of a mapping entry"))),c===-1&&f!==0&&!ue(f)&&m<e){i.lineIndent=m,i.position=_+m;break}!n&&f!==0&&!ue(f)&&c===-1&&(c=m);const y=c===-1?e+1:c;if(f!==0&&!ue(f)&&m<y){i.lineIndent=m,i.position=_+m;break}Kn(i),p=i.position,ue(i.input.charCodeAt(i.position))&&(ga(i),p=i.position)}return Zn(i,u,p),Vt(i,u,p,t.anchorStart,t.anchorEnd,t.tagStart,t.tagEnd,o,s,c),!0}function Ju(i,e){const t=i.input.charCodeAt(i.position),a=e===Nt;if(t===0||Fe(t)||t===35||t===38||t===42||t===33||t===124||t===62||t===39||t===34||t===37||t===64||t===96||a&&xt(t))return!1;if(t===63||t===45){const s=i.input.charCodeAt(i.position+1);if(Qe(s)||a&&xt(s))return!1}return!0}function Xu(i,e,t,a){if(!Ju(i,t))return!1;const s=i.position;let r=i.position,n=i.input.charCodeAt(i.position);const o=t===Nt;let l=!1;for(;n!==0&&!(i.position===i.lineStart&&wt(i));){if(n===58){const c=i.input.charCodeAt(i.position+1);if(Qe(c)||o&&xt(c))break}else if(n===35){if(Fe(i.input.charCodeAt(i.position-1)))break}else{if(o&&xt(n))break;if(ue(n)){const c=i.position,d=i.line,u=i.lineStart,p=i.lineIndent;if(we(i,!1),i.lineIndent>=e){l=!0,n=i.input.charCodeAt(i.position);continue}i.position=c,i.line=d,i.lineStart=u,i.lineIndent=p;break}}bt(n)||(r=i.position+1),n=i.input.charCodeAt(++i.position)}return r===s?!1:(Zn(i,s,r),Vt(i,s,r,a.anchorStart,a.anchorEnd,a.tagStart,a.tagEnd,Pe.PLAIN,qe.CLIP,-1,!l),!0)}function $i(i,e){const t=i.line;we(i,!0),(i.line>t&&i.lineIndent<e||i.firstTabInLine!==-1&&i.lineIndent<e)&&$(i,"deficient indentation")}function eh(i,e,t){const a=i.input.charCodeAt(i.position),s=a===123,r=i.position;let n=!0;if(a!==91&&a!==123)return!1;const o=s?125:93;for(s?Cs(i,r,t.anchorStart,t.anchorEnd,t.tagStart,t.tagEnd,Lt.FLOW):Qn(i,r,t.anchorStart,t.anchorEnd,t.tagStart,t.tagEnd,Lt.FLOW),i.position++;i.input.charCodeAt(i.position)!==0;){$i(i,e);let l=i.input.charCodeAt(i.position);if(l===o)return i.position++,Ut(i),!0;n?l===44&&$(i,"expected the node content, but found ','"):$(i,"missed comma between flow collection entries");let c=!1,d=!1;l===63&&Fe(i.input.charCodeAt(i.position+1))&&(c=d=!0,i.position+=1,$i(i,e));const u=i.line,p=Ai(i),_=kt(i,e,Nt,!1,!0);$i(i,e),l=i.input.charCodeAt(i.position),(s||d||i.line===u)&&l===58?(c=!0,i.position++,$i(i,e),s||Wn(i,p),_||xe(i),kt(i,e,Nt,!1,!0)||xe(i),$i(i,e),s||Ut(i)):s&&c?(_||xe(i),xe(i)):s?xe(i):c&&(Wn(i,p),_||xe(i),xe(i),Ut(i)),l=i.input.charCodeAt(i.position),l===44?(n=!0,i.position++):n=!1}$(i,"unexpected end of the stream within a flow collection")}function Jn(i,e,t){if(i.firstTabInLine!==-1||i.input.charCodeAt(i.position)!==45||!Qe(i.input.charCodeAt(i.position+1)))return!1;for(Qn(i,i.position,t.anchorStart,t.anchorEnd,t.tagStart,t.tagEnd,Lt.BLOCK);i.input.charCodeAt(i.position)===45&&Qe(i.input.charCodeAt(i.position+1));){i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,$(i,"tab characters must not be used in indentation"));const a=i.line;i.position++;const s=we(i,!0)>0;if(i.firstTabInLine!==-1&&i.input.charCodeAt(i.position)===45&&Qe(i.input.charCodeAt(i.position+1))&&$(i,"bad indentation of a sequence entry"),s&&i.lineIndent<=e?xe(i):kt(i,e,Bn,!1,!0),we(i,!0),i.lineIndent<e||i.position>=i.length)break;i.lineIndent>e&&$(i,"bad indentation of a sequence entry"),i.line===a&&i.input.charCodeAt(i.position)===45&&Qe(i.input.charCodeAt(i.position+1))&&$(i,"bad indentation of a sequence entry")}return Ut(i),!0}function Is(i,e,t,a){let s=!1,r=!1,n=!1,o=!1;if(i.firstTabInLine!==-1)return!1;let l=i.input.charCodeAt(i.position);for(;l!==0;){!s&&i.firstTabInLine!==-1&&(i.position=i.firstTabInLine,$(i,"tab characters must not be used in indentation"));const c=i.input.charCodeAt(i.position+1),d=i.line;if((l===63||l===58)&&Qe(c))n||(Cs(i,i.position,a.anchorStart,a.anchorEnd,a.tagStart,a.tagEnd,Lt.BLOCK),n=!0),l===63?(s&&xe(i),r=!0,s=!0):(s||(xe(i),r=!0),s=!1),i.position+=1,o=!0;else{s&&(xe(i),s=!1);const u=Ai(i);if(!kt(i,t,Ss,!1,!0))break;if(i.line===d){for(l=i.input.charCodeAt(i.position);bt(l);)l=i.input.charCodeAt(++i.position);if(l===58){if(l=i.input.charCodeAt(++i.position),Qe(l)||$(i,"a whitespace character is expected after the key-value separator within a block mapping"),!n){for(Bt(i,u),Cs(i,u.position,a.anchorStart,a.anchorEnd,a.tagStart,a.tagEnd,Lt.BLOCK),n=!0,kt(i,t,Ss,!1,!0),l=i.input.charCodeAt(i.position);bt(l);)l=i.input.charCodeAt(++i.position);i.position++}r=!0,s=!1,o=!1}else if(r)$(i,"expected ':' after a mapping key");else return a.anchorStart!==W||a.tagStart!==W?(Bt(i,u),!1):!0}else if(r)$(i,"can not read a block mapping entry; a multiline key may not be an implicit key");else return a.anchorStart!==W||a.tagStart!==W?(Bt(i,u),!1):!0}if(kt(i,e,ma,!0,o)&&(o=!1),s||o&&(xe(i),o=!1),we(i,!0),l=i.input.charCodeAt(i.position),(i.line===d||i.lineIndent>e)&&l!==0)$(i,"bad indentation of a mapping entry");else if(i.lineIndent<e)break}return r?(s&&xe(i),n&&Ut(i),!0):!1}function kt(i,e,t,a,s,r=!0){i.depth>=i.maxDepth&&$(i,`nesting exceeded maxDepth (${i.maxDepth})`),i.depth++;let n=1,o=!1,l=!1,c=null;const d=Yn();let u=t===ma||t===Bn,p=u;const _=u;if(a&&we(i,!0)&&(o=!0,i.lineIndent>e?n=1:i.lineIndent===e?n=0:n=-1),n===1)for(;;){const m=i.input.charCodeAt(i.position),f=Ai(i);if(o&&n!==1&&(m===33||m===38))break;if(o&&_&&(d.tagStart!==W||d.anchorStart!==W)&&(m===33||m===38)){const y=Ai(i),b=e+1;if(Is(i,i.position-i.lineStart,b,d)&&i.events[y.eventsLength]?.type===_e.MAPPING)return i.depth--,!0;Bt(i,y)}if(o&&(m===33&&d.tagStart!==W||m===38&&d.anchorStart!==W)||!Gu(i,d,t===Nt)&&!Qu(i,d))break;c===null&&(c=f),we(i,!0)?(o=!0,p=_,i.lineIndent>e?n=1:i.lineIndent===e?n=0:n=-1):p=!1}if(p&&(p=o||s),n===1||t===ma){const m=t===Nt||t===Ss?e:e+1,f=i.position-i.lineStart;if(n===1)if(p&&(Jn(i,f,d)||Is(i,f,m,d))||eh(i,m,d))l=!0;else{const y=i.input.charCodeAt(i.position);if(c!==null&&r&&_&&!p&&y!==124&&y!==62){const b=Ai(i),k=c.position-c.lineStart;Bt(i,c),Is(i,k,m,Yn())&&i.events[b.eventsLength]?.type===_e.MAPPING?l=!0:Bt(i,b)}!l&&(u&&Zu(i,m,d)||Yu(i,m,d)||Ku(i,m,d)||Wu(i,d)||Xu(i,m,t,d))&&(l=!0)}else n===0&&(l=p&&Jn(i,f,d))}return u=u&&!l,!l&&(d.anchorStart!==W||d.tagStart!==W||u)&&(Vt(i,W,W,d.anchorStart,d.anchorEnd,d.tagStart,d.tagEnd,Pe.PLAIN),l=!0),i.depth--,l||d.anchorStart!==W||d.tagStart!==W}function th(i){if(i.lineIndent>0||i.input.charCodeAt(i.position)!==37)return!1;i.position++;const e=i.position;for(;i.input.charCodeAt(i.position)!==0&&!Fe(i.input.charCodeAt(i.position));)i.position++;const t=i.input.slice(e,i.position),a=[];for(t.length===0&&$(i,"directive name must not be less than one character in length");i.input.charCodeAt(i.position)!==0&&!ue(i.input.charCodeAt(i.position));){for(;bt(i.input.charCodeAt(i.position));)i.position++;if(i.input.charCodeAt(i.position)===35||ue(i.input.charCodeAt(i.position))||i.input.charCodeAt(i.position)===0)break;const s=i.position;for(;i.input.charCodeAt(i.position)!==0&&!Fe(i.input.charCodeAt(i.position));)i.position++;a.push(i.input.slice(s,i.position))}if(ue(i.input.charCodeAt(i.position))&&ga(i),t==="YAML"){i.directives.some(r=>r.kind==="yaml")&&$(i,"duplication of %YAML directive"),a.length!==1&&$(i,"YAML directive accepts exactly one argument");const s=/^([0-9]+)\.([0-9]+)$/.exec(a[0]);s===null&&$(i,"ill-formed argument of the YAML directive"),parseInt(s[1],10)!==1&&$(i,"unacceptable YAML version of the document"),i.directives.push({kind:"yaml",version:a[0]})}else if(t==="TAG"){a.length!==2&&$(i,"TAG directive accepts exactly two arguments");const[s,r]=a;Hn.test(s)||$(i,"ill-formed tag handle (first argument) of the TAG directive"),Un.call(i.tagHandlers,s)&&$(i,`there is a previously declared suffix for "${s}" tag handle`),Lu.test(r)||$(i,"ill-formed tag prefix (second argument) of the TAG directive"),i.tagHandlers[s]=r,i.directives.push({kind:"tag",handle:s,prefix:r})}return!0}function ih(i){i.directives=[],i.tagHandlers=Object.create(null);let e=!1;for(we(i,!0);th(i);)e=!0,we(i,!0);let t=!1,a=!1,s=!0;if(i.lineIndent===0&&i.input.charCodeAt(i.position)===45&&i.input.charCodeAt(i.position+1)===45&&i.input.charCodeAt(i.position+2)===45&&Qe(i.input.charCodeAt(i.position+3))){t=!0;const o=i.line;i.position+=3,we(i,!0),s=i.line>o}else e&&$(i,"directives end mark is expected");const r=i.events.length;if(!t&&i.position===i.lineStart&&i.input.charCodeAt(i.position)===46&&wt(i)){i.position+=3,we(i,!0);return}if(qu(i,t,!1),kt(i,i.lineIndent-1,ma,!1,s,s)||xe(i),we(i,!0),i.position===i.lineStart&&wt(i)&&(a=i.input.charCodeAt(i.position)===46,a)){const o=i.line;i.position+=3,we(i,!0),i.line===o&&i.position<i.length&&$(i,"end of the stream or a document separator is expected")}const n=i.events[r];n?.type===_e.DOCUMENT&&(n.explicitEnd=a),Ut(i),!a&&i.position<i.length&&!(i.position===i.lineStart&&wt(i))&&$(i,"end of the stream or a document separator is expected")}function ah(i,e){const t=i.length,a={...$s,...e,input:`${i}\0`,length:t,position:0,line:0,lineStart:0,lineIndent:0,firstTabInLine:-1,depth:0,directives:[],tagHandlers:Object.create(null),events:[]},s=i.indexOf("\0");for(s!==-1&&st.throwAt(i,s,"null byte is not allowed in input",a.filename),a.input.charCodeAt(a.position)===65279&&a.position++;a.position<a.length&&(we(a,!0),!(a.position>=a.length));){const r=a.position;ih(a),a.position===r&&$(a,"can not read a document")}return a.events}var sh={...$s,...ws};function rh(i,e={}){const t={...sh,...e},a=String(i),s=Object.keys($s),r=Object.keys(ws);return ju(ah(a,gs(t,s)),{...gs(t,r),source:a})}function nh(i,e){const t=rh(i,e);if(t.length===0)throw new st("expected a document, but the input is empty");if(t.length===1)return t[0];throw new st("expected a single document in the stream, but found more")}var fa=class{constructor(){de(this,"tagged",!1);de(this,"flow",!1);de(this,"singleQuoted",!1);de(this,"doubleQuoted",!1);de(this,"literal",!1);de(this,"folded",!1)}},Et=Symbol("INVALID");function oh(i){const e=new Set([i.defaultScalarTag,i.defaultSequenceTag,i.defaultMappingTag].filter(r=>r!==void 0)),t=i.implicitScalarTags,a=i.tags.filter(r=>!(r.nodeKind==="scalar"&&r.implicit)&&!e.has(r)),s=i.tags.filter(r=>e.has(r));return[...t.map(r=>({tag:r,implicitTag:!0})),...a.map(r=>({tag:r,implicitTag:!1})),...s.map(r=>({tag:r,implicitTag:!0}))]}function lh(i,e){for(let t=0,a=i.representTypes.length;t<a;t+=1){const{tag:s,implicitTag:r}=i.representTypes[t];if(s.identify(e)){let n;return s.matchByTagPrefix?n=s.representTagName(e):n=s.tagName,{tag:s,tagName:n,implicitTag:r}}}return null}function Ci(i,e){if(!i.noRefs&&e!==null&&typeof e=="object"){const d=i.refs.get(e);if(d)return d.anchor===void 0&&(d.anchor=`ref_${i.refCounter++}`),{kind:"alias",tag:"",style:new fa,anchor:d.anchor}}const t=lh(i,e);if(!t){if(e===void 0||i.skipInvalid)return Et;throw new st(`unacceptable kind of an object to dump ${Object.prototype.toString.call(e)}`)}const{tag:a,tagName:s,implicitTag:r}=t,n=r?s:On(s);if(a.nodeKind==="scalar"){const d=new fa;return d.tagged=!r,{kind:"scalar",tag:n,style:d,value:a.represent(e)}}if(a.nodeKind==="sequence"){const d=a.represent(e),u=new fa;u.tagged=!r;const p={kind:"sequence",tag:n,style:u,items:[]};i.noRefs||i.refs.set(e,p);for(let _=0,m=d.length;_<m;_+=1){let f=Ci(i,d[_]);f===Et&&d[_]===void 0&&(f=Ci(i,null)),f!==Et&&p.items.push(f)}return p}const o=a.represent(e),l=new fa;l.tagged=!r;const c={kind:"mapping",tag:n,style:l,items:[]};i.noRefs||i.refs.set(e,c);for(const[d,u]of o){const p=Ci(i,d);if(p===Et)continue;const _=Ci(i,u);_!==Et&&c.items.push({key:p,value:_})}return c}function ch(i,e,t={}){const a=Ci({representTypes:oh(e),noRefs:t.noRefs??!1,skipInvalid:t.skipInvalid??!1,refs:new Map,refCounter:0},i);return[{contents:a===Et?null:a,directives:[]}]}var dh=Symbol("visit:break"),Xn=Symbol("visit:skip");function ya(i,e,t){const a=e(i,t);if(a===dh)return!0;if(a===Xn)return!1;const s=t.depth+1;switch(i.kind){case"sequence":for(const r of i.items)if(ya(r,e,{depth:s,parent:i,isKey:!1}))return!0;break;case"mapping":for(const{key:r,value:n}of i.items)if(ya(r,e,{depth:s,parent:i,isKey:!0})||ya(n,e,{depth:s,parent:i,isKey:!1}))return!0;break}return!1}function uh(i,e){for(const t of i)if(t.contents&&ya(t.contents,e,{depth:0,parent:null,isKey:!1}))return}var Ms=65279,hh=9,St=10,eo=13,ph=32,_h=33,to=34,Ps=35,mh=37,gh=38,io=39,fh=42,zs=44,js=45,Ti=58,yh=61,vh=62,ao=63,bh=64,Fs=91,Ds=93,xh=96,Rs=123,wh=124,Os=125,ge={};ge[0]="\\0",ge[7]="\\a",ge[8]="\\b",ge[9]="\\t",ge[10]="\\n",ge[11]="\\v",ge[12]="\\f",ge[13]="\\r",ge[27]="\\e",ge[34]='\\"',ge[92]="\\\\",ge[133]="\\N",ge[160]="\\_",ge[8232]="\\L",ge[8233]="\\P";var Ls={indent:2,seqNoIndent:!1,seqInlineFirst:!0,sortKeys:!1,lineWidth:80,flowBracketPadding:!1,flowSkipCommaSpace:!1,flowSkipColonSpace:!1,quoteFlowKeys:!1,quoteStyle:"single",forceQuotes:!1,tagBeforeAnchor:!1};function kh(i){return i.style.tagged?i.tag:On(i.tag)}function Eh(i){const e={...Ls,...i};return{...e,defaultScalarTagName:e.schema.defaultScalarTag.tagName}}function Sh(i){const e=i.toString(16).toUpperCase(),t=i<=255?"x":"u",a=i<=255?2:4;return`\\${t}${"0".repeat(a-e.length)}${e}`}function so(i,e){const t=" ".repeat(e);let a=0,s="";const r=i.length;for(;a<r;){let n;const o=i.indexOf(`
`,a);o===-1?(n=i.slice(a),a=r):(n=i.slice(a,o+1),a=o+1),n.length&&n!==`
`&&(s+=t),s+=n}return s}function qs(i,e){return`
${" ".repeat(i.indent*e)}`}function Ah(i,e){const t=i.indent*Math.max(1,e);return{indent:t,blockIndent:e===0?i.indent+1:i.indent,lineWidth:i.lineWidth===-1?-1:Math.max(Math.min(i.lineWidth,40),i.lineWidth-t)}}function Ht(i){return i===ph||i===hh}function $h(i){const e=i.charCodeAt(0);if(e!==js&&e!==46||i.charCodeAt(1)!==e||i.charCodeAt(2)!==e)return!1;if(i.length===3)return!0;const t=i.charCodeAt(3);return Ht(t)||t===eo||t===St}function Ii(i){return i>=32&&i<=126||i>=161&&i<=55295&&i!==8232&&i!==8233||i>=57344&&i<=65533&&i!==Ms||i>=65536&&i<=1114111}function ro(i){return Ii(i)&&i!==Ms&&i!==eo&&i!==St}function Ns(i,e,t){const a=ro(i),s=a&&!Ht(i);return(t?a:a&&i!==zs&&i!==Fs&&i!==Ds&&i!==Rs&&i!==Os)&&i!==Ps&&!(e===Ti&&!s)||ro(e)&&!Ht(e)&&i===Ps||e===Ti&&s&&(t||i!==zs&&i!==Fs&&i!==Ds&&i!==Rs&&i!==Os)}function Ch(i){return Ii(i)&&i!==Ms&&!Ht(i)&&i!==js&&i!==ao&&i!==Ti&&i!==zs&&i!==Fs&&i!==Ds&&i!==Rs&&i!==Os&&i!==Ps&&i!==gh&&i!==fh&&i!==_h&&i!==wh&&i!==yh&&i!==vh&&i!==io&&i!==to&&i!==mh&&i!==bh&&i!==xh}function Th(i,e){const t=Gt(i,0);if(Ch(t))return!0;if(i.length>1&&(t===js||t===ao||t===Ti)){const a=Gt(i,1);return!Ht(a)&&Ns(a,t,e)}return!1}function Ih(i){return!Ht(i)&&i!==Ti}function Gt(i,e){const t=i.charCodeAt(e);let a;return t>=55296&&t<=56319&&e+1<i.length&&(a=i.charCodeAt(e+1),a>=56320&&a<=57343)?(t-55296)*1024+a-56320+65536:t}function no(i){return/^\n* /.test(i)}var Mi=1,Pi=2,Vs=3,Us=4,rt=5;function Mh(i,e,t,a,s,r){const{blockIndent:n,lineWidth:o}=t;let l,c=0,d=-1,u=!1,p=!1;const _=o!==-1;let m=-1,f=!$h(e)&&Th(e,r)&&Ih(Gt(e,e.length-1));if(a||s)for(l=0;l<e.length;c>=65536?l+=2:l++){if(c=Gt(e,l),!Ii(c))return rt;f=f&&Ns(c,d,r),d=c}else{for(l=0;l<e.length;c>=65536?l+=2:l++){if(c=Gt(e,l),c===St)u=!0,_&&(p=p||l-m-1>o&&!zi(e[m+1]),m=l);else if(!Ii(c))return rt;f=f&&Ns(c,d,r),d=c}p=p||_&&l-m-1>o&&!zi(e[m+1])}return!u&&!p?f&&!s?Mi:i.quoteStyle==="double"?rt:Pi:n>9&&no(e)?rt:p?Us:Vs}function Ph(i,e,t){const{indent:a,blockIndent:s,lineWidth:r}=t;switch(e){case Mi:return lo(i,a);case Pi:return`'${lo(i,a).replace(/'/g,"''")}'`;case Vs:return"|"+oo(i,s)+co(so(i,a));case Us:return">"+oo(i,s)+co(so(jh(i,r),a));case rt:return`"${Fh(i)}"`}}function zh(i,e,t,a,s){const r=a||!s;if(e.style.singleQuoted)return Pi;if(e.style.doubleQuoted)return rt;if(!r){if(e.style.literal)return Vs;if(e.style.folded)return Us}const n=e.value;if(n.length===0)return e.style.tagged||i.schema.resolveImplicitScalarTag(n).tag.tagName===e.tag?Mi:i.quoteStyle==="double"?rt:Pi;const o=Mh(i,n,t,r,i.forceQuotes&&!a,s);return o===Mi&&!e.style.tagged&&i.schema.resolveImplicitScalarTag(n).tag.tagName!==e.tag?i.quoteStyle==="double"?rt:Pi:o}function oo(i,e){const t=no(i)?String(e):"",a=i[i.length-1]===`
`;return`${t}${a&&(i[i.length-2]===`
`||i===`
`)?"+":a?"":"-"}
`}function lo(i,e){let t=i.indexOf(`
...
`.repeat(o+1)+a+l}return s}function co(i){return i[i.length-1]===`
`?i.slice(0,-1):i}function zi(i){return i===" "||i==="	"}function jh(i,e){const t=/(\n+)([^\n]*)/g;let a=i.indexOf(`
`);a===-1&&(a=i.length),t.lastIndex=a;let s=uo(i.slice(0,a),e),r=i[0]===`
`||zi(i[0]),n,o;for(;o=t.exec(i);){const l=o[1],c=o[2];n=c!==""&&zi(c[0]),s+=l+(!r&&!n&&c!==""?`
`:"")+uo(c,e),r=n}return s}function uo(i,e){if(i===""||zi(i[0]))return i;const t=/ [^ \t]/g;let a,s=0,r,n=0,o=0,l="";for(;a=t.exec(i);)o=a.index,o-s>e&&(r=n>s?n:o,l+=`
${i.slice(s,r)}`,s=r+1),n=o;return l+=`
`,i.length-s>e&&n>s?l+=`${i.slice(s,n)}
${i.slice(n+1)}`:l+=i.slice(s),l.slice(1)}function Fh(i){let e="",t=0;for(let a=0;a<i.length;t>=65536?a+=2:a++){t=Gt(i,a);const s=ge[t];if(s){e+=s;continue}if(Ii(t)){e+=i[a],t>=65536&&(e+=i[a+1]);continue}e+=Sh(t)}return e}function Dh(i,e,t){let a="";for(let r=0,n=t.items.length;r<n;r+=1){const o=We(i,e,t.items[r],{});a!==""&&(a+=`,${i.flowSkipCommaSpace?"":" "}`),a+=o}const s=i.flowBracketPadding&&a!==""?" ":"";return`[${s}${a}${s}]`}function ho(i,e,t,a){let s="";for(let r=0,n=t.items.length;r<n;r+=1){const o=We(i,e+1,t.items[r],{block:!0,compact:i.seqInlineFirst,isblockseq:!0});(!a||s!=="")&&(s+=qs(i,e)),o===""||St===o.charCodeAt(0)?s+="-":s+="- ",s+=o}return s}function Rh(i,e,t){let a="";const s=po(i,t.items);for(const{key:n,value:o}of s){let l="";a!==""&&(l+=`,${i.flowSkipCommaSpace?"":" "}`);const c=We(i,e,n,{iskey:!0}),d=c.length>1024;d?l+="? ":i.quoteFlowKeys&&(l+='"');const u=We(i,e,o,{}),p=i.flowSkipColonSpace||u===""?"":" ";l+=`${c}${i.quoteFlowKeys&&!d?'"':""}:${p}${u}`,a+=l}const r=i.flowBracketPadding&&a!==""?" ":"";return`{${r}${a}${r}}`}function va(i){return i.kind==="scalar"?i.value:i}function po(i,e){if(!i.sortKeys)return e;const t=e.slice();if(i.sortKeys===!0)t.sort((a,s)=>{const r=va(a.key),n=va(s.key);return r<n?-1:r>n?1:0});else{const a=i.sortKeys;t.sort((s,r)=>a(va(s.key),va(r.key)))}return t}function Oh(i,e,t,a){let s="";const r=po(i,t.items);for(let n=0,o=r.length;n<o;n+=1){let l="";(!a||s!=="")&&(l+=qs(i,e));const{key:c,value:d}=r[n],u=(c.kind==="mapping"||c.kind==="sequence")&&!c.style.flow&&c.items.length!==0||c.kind==="scalar"&&(c.style.literal||c.style.folded),p=u?We(i,e+1,c,{block:!0,compact:!0,isblockseq:!Bs(i,c,e+1)}):We(i,e+1,c,{block:!0,compact:!0,iskey:!0}),_=c.kind==="scalar"&&c.value.indexOf(`
`)!==-1,m=u||_||p.length>1024;m&&(p&&St===p.charCodeAt(0)?l+="?":l+="? "),l+=p,m&&(l+=qs(i,e));const f=We(i,e+1,d,{block:!0,compact:m,isblockseq:m&&!Bs(i,d,e+1)}),y=c.kind==="scalar"&&c.value===""&&p!==""&&p.charCodeAt(p.length-1)!==io&&p.charCodeAt(p.length-1)!==to,b=!m&&(c.kind==="alias"||y)?" ":"";f===""||St===f.charCodeAt(0)?l+=`${b}:`:l+=`${b}: `,l+=f,s+=l}return s}function Bs(i,e,t){return e.style.tagged||e.anchor!==void 0||i.indent<2&&t>0}function We(i,e,t,a){if(t.kind==="alias")return`*${t.anchor}`;const{block:s=!1,iskey:r=!1,isblockseq:n=!1}=a;let o=a.compact??!1;const l=t.anchor!==void 0;Bs(i,t,e)&&(o=!1);let c,d=t.style.tagged;const u=s&&(t.kind==="mapping"||t.kind==="sequence")&&!t.style.flow&&t.items.length!==0;if(t.kind==="mapping")u?c=Oh(i,e,t,o):c=Rh(i,e,t);else if(t.kind==="sequence")u?i.seqNoIndent&&!n&&e>0?c=ho(i,e-1,t,o):c=ho(i,e,t,o):c=Dh(i,e,t);else{const p=Ah(i,e),_=zh(i,t,p,r,s);c=Ph(t.value,_,p),d=t.style.tagged||_!==Mi&&t.tag!==i.defaultScalarTagName}if(u&&o&&e>0&&i.indent>2&&(c=`${" ".repeat(i.indent-2)}${c}`),d||l){const p=[],_=d?kh(t):null,m=l?`&${t.anchor}`:null;i.tagBeforeAnchor?(_!==null&&p.push(_),m!==null&&p.push(m)):(m!==null&&p.push(m),_!==null&&p.push(_));const f=c===""||c.charCodeAt(0)===St?"":" ";c=`${p.join(" ")}${f}${c}`}return c}function Lh(i){return(i.kind==="sequence"||i.kind==="mapping")&&!i.style.flow&&i.items.length!==0&&!i.style.tagged&&i.anchor===void 0}function qh(i){let e=i;for(;(e.kind==="sequence"||e.kind==="mapping")&&!e.style.flow&&e.items.length!==0;)e=e.kind==="sequence"?e.items[e.items.length-1]:e.items[e.items.length-1].value;if(e.kind!=="scalar"||!(e.style.literal||e.style.folded))return!1;const{value:t}=e;return t.endsWith(`

`)||t===`
`}function Nh(i){let e="";for(const t of i.directives){if(t.kind==="yaml"){e+=`%YAML ${t.version}
`;continue}const{handle:a,prefix:s}=t;e+=`%TAG ${a} ${s}
`}return e}function Vh(i,e){const t=Eh(e);let a="",s=!1;for(let r=0;r<i.length;r+=1){const n=i[r],o=Nh(n),l=o!=="",c=n.explicitStart||l||r>0&&!s;if(a+=o,n.contents===null)c&&(a+=`---
`);else if(c){const d=We(t,0,n.contents,{block:!0,compact:!0}),u=d===""?"":l||Lh(n.contents)?`
`:" ";a+=`---${u}${d}
`}else a+=We(t,0,n.contents,{block:!0,compact:!0})+`
`;s=n.explicitEnd||n.contents!==null&&qh(n.contents),s&&(a+=`...
`)}return a}var Uh={...Ls,schema:fu,skipInvalid:!1,noRefs:!1,flowLevel:-1,transform:()=>{}};function Bh(i,e={}){const t={...Uh,...e},a=ch(i,t.schema,{noRefs:t.noRefs,skipInvalid:t.skipInvalid});return t.flowLevel>=0&&uh(a,(s,r)=>{if(!(r.depth<t.flowLevel))return s.style.flow=!0,Xn}),t.transform(a),Vh(a,{...gs(t,Object.keys(Ls)),schema:t.schema})}/**!
 * Sortable 1.15.7
 * @author	RubaXa   <trash@rubaxa.org>
 * @author	owenm    <owen23355@gmail.com>
 * @license MIT
 */function Hh(i,e,t){return(e=Yh(e))in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}function Ye(){return Ye=Object.assign?Object.assign.bind():function(i){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var a in t)({}).hasOwnProperty.call(t,a)&&(i[a]=t[a])}return i},Ye.apply(null,arguments)}function _o(i,e){var t=Object.keys(i);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(i);e&&(a=a.filter(function(s){return Object.getOwnPropertyDescriptor(i,s).enumerable})),t.push.apply(t,a)}return t}function Ne(i){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?_o(Object(t),!0).forEach(function(a){Hh(i,a,t[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(t)):_o(Object(t)).forEach(function(a){Object.defineProperty(i,a,Object.getOwnPropertyDescriptor(t,a))})}return i}function Gh(i,e){if(i==null)return{};var t,a,s=Qh(i,e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(i);for(a=0;a<r.length;a++)t=r[a],e.indexOf(t)===-1&&{}.propertyIsEnumerable.call(i,t)&&(s[t]=i[t])}return s}function Qh(i,e){if(i==null)return{};var t={};for(var a in i)if({}.hasOwnProperty.call(i,a)){if(e.indexOf(a)!==-1)continue;t[a]=i[a]}return t}function Wh(i,e){if(typeof i!="object"||!i)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var a=t.call(i,e);if(typeof a!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(i)}function Yh(i){var e=Wh(i,"string");return typeof e=="symbol"?e:e+""}function Hs(i){"@babel/helpers - typeof";return Hs=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Hs(i)}var Kh="1.15.7";function Ke(i){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(i)}var Ze=Ke(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),ji=Ke(/Edge/i),mo=Ke(/firefox/i),Fi=Ke(/safari/i)&&!Ke(/chrome/i)&&!Ke(/android/i),Gs=Ke(/iP(ad|od|hone)/i),go=Ke(/chrome/i)&&Ke(/android/i),fo={capture:!1,passive:!1};function U(i,e,t){i.addEventListener(e,t,!Ze&&fo)}function q(i,e,t){i.removeEventListener(e,t,!Ze&&fo)}function ba(i,e){if(e){if(e[0]===">"&&(e=e.substring(1)),i)try{if(i.matches)return i.matches(e);if(i.msMatchesSelector)return i.msMatchesSelector(e);if(i.webkitMatchesSelector)return i.webkitMatchesSelector(e)}catch{return!1}return!1}}function yo(i){return i.host&&i!==document&&i.host.nodeType&&i.host!==i?i.host:i.parentNode}function De(i,e,t,a){if(i){t=t||document;do{if(e!=null&&(e[0]===">"?i.parentNode===t&&ba(i,e):ba(i,e))||a&&i===t)return i;if(i===t)break}while(i=yo(i))}return null}var vo=/\s+/g;function Ce(i,e,t){if(i&&e)if(i.classList)i.classList[t?"add":"remove"](e);else{var a=(" "+i.className+" ").replace(vo," ").replace(" "+e+" "," ");i.className=(a+(t?" "+e:"")).replace(vo," ")}}function P(i,e,t){var a=i&&i.style;if(a){if(t===void 0)return document.defaultView&&document.defaultView.getComputedStyle?t=document.defaultView.getComputedStyle(i,""):i.currentStyle&&(t=i.currentStyle),e===void 0?t:t[e];!(e in a)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),a[e]=t+(typeof t=="string"?"":"px")}}function Qt(i,e){var t="";if(typeof i=="string")t=i;else do{var a=P(i,"transform");a&&a!=="none"&&(t=a+" "+t)}while(!e&&(i=i.parentNode));var s=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return s&&new s(t)}function bo(i,e,t){if(i){var a=i.getElementsByTagName(e),s=0,r=a.length;if(t)for(;s<r;s++)t(a[s],s);return a}return[]}function Ve(){var i=document.scrollingElement;return i||document.documentElement}function re(i,e,t,a,s){if(!(!i.getBoundingClientRect&&i!==window)){var r,n,o,l,c,d,u;if(i!==window&&i.parentNode&&i!==Ve()?(r=i.getBoundingClientRect(),n=r.top,o=r.left,l=r.bottom,c=r.right,d=r.height,u=r.width):(n=0,o=0,l=window.innerHeight,c=window.innerWidth,d=window.innerHeight,u=window.innerWidth),(e||t)&&i!==window&&(s=s||i.parentNode,!Ze))do if(s&&s.getBoundingClientRect&&(P(s,"transform")!=="none"||t&&P(s,"position")!=="static")){var p=s.getBoundingClientRect();n-=p.top+parseInt(P(s,"border-top-width")),o-=p.left+parseInt(P(s,"border-left-width")),l=n+r.height,c=o+r.width;break}while(s=s.parentNode);if(a&&i!==window){var _=Qt(s||i),m=_&&_.a,f=_&&_.d;_&&(n/=f,o/=m,u/=m,d/=f,l=n+d,c=o+u)}return{top:n,left:o,bottom:l,right:c,width:u,height:d}}}function xo(i,e,t){for(var a=nt(i,!0),s=re(i)[e];a;){var r=re(a)[t],n=void 0;if(n=s>=r,!n)return a;if(a===Ve())break;a=nt(a,!1)}return!1}function Wt(i,e,t,a){for(var s=0,r=0,n=i.children;r<n.length;){if(n[r].style.display!=="none"&&n[r]!==z.ghost&&(a||n[r]!==z.dragged)&&De(n[r],t.draggable,i,!1)){if(s===e)return n[r];s++}r++}return null}function Qs(i,e){for(var t=i.lastElementChild;t&&(t===z.ghost||P(t,"display")==="none"||e&&!ba(t,e));)t=t.previousElementSibling;return t||null}function ze(i,e){var t=0;if(!i||!i.parentNode)return-1;for(;i=i.previousElementSibling;)i.nodeName.toUpperCase()!=="TEMPLATE"&&i!==z.clone&&(!e||ba(i,e))&&t++;return t}function wo(i){var e=0,t=0,a=Ve();if(i)do{var s=Qt(i),r=s.a,n=s.d;e+=i.scrollLeft*r,t+=i.scrollTop*n}while(i!==a&&(i=i.parentNode));return[e,t]}function Zh(i,e){for(var t in i)if(i.hasOwnProperty(t)){for(var a in e)if(e.hasOwnProperty(a)&&e[a]===i[t][a])return Number(t)}return-1}function nt(i,e){if(!i||!i.getBoundingClientRect)return Ve();var t=i,a=!1;do if(t.clientWidth<t.scrollWidth||t.clientHeight<t.scrollHeight){var s=P(t);if(t.clientWidth<t.scrollWidth&&(s.overflowX=="auto"||s.overflowX=="scroll")||t.clientHeight<t.scrollHeight&&(s.overflowY=="auto"||s.overflowY=="scroll")){if(!t.getBoundingClientRect||t===document.body)return Ve();if(a||e)return t;a=!0}}while(t=t.parentNode);return Ve()}function Jh(i,e){if(i&&e)for(var t in e)e.hasOwnProperty(t)&&(i[t]=e[t]);return i}function Ws(i,e){return Math.round(i.top)===Math.round(e.top)&&Math.round(i.left)===Math.round(e.left)&&Math.round(i.height)===Math.round(e.height)&&Math.round(i.width)===Math.round(e.width)}var Di;function ko(i,e){return function(){if(!Di){var t=arguments,a=this;t.length===1?i.call(a,t[0]):i.apply(a,t),Di=setTimeout(function(){Di=void 0},e)}}}function Xh(){clearTimeout(Di),Di=void 0}function Eo(i,e,t){i.scrollLeft+=e,i.scrollTop+=t}function So(i){var e=window.Polymer,t=window.jQuery||window.Zepto;return e&&e.dom?e.dom(i).cloneNode(!0):t?t(i).clone(!0)[0]:i.cloneNode(!0)}function Ao(i,e,t){var a={};return Array.from(i.children).forEach(function(s){var r,n,o,l;if(!(!De(s,e.draggable,i,!1)||s.animated||s===t)){var c=re(s);a.left=Math.min((r=a.left)!==null&&r!==void 0?r:1/0,c.left),a.top=Math.min((n=a.top)!==null&&n!==void 0?n:1/0,c.top),a.right=Math.max((o=a.right)!==null&&o!==void 0?o:-1/0,c.right),a.bottom=Math.max((l=a.bottom)!==null&&l!==void 0?l:-1/0,c.bottom)}}),a.width=a.right-a.left,a.height=a.bottom-a.top,a.x=a.left,a.y=a.top,a}var Ae="Sortable"+new Date().getTime();function ep(){var i=[],e;return{captureAnimationState:function(){if(i=[],!!this.options.animation){var a=[].slice.call(this.el.children);a.forEach(function(s){if(!(P(s,"display")==="none"||s===z.ghost)){i.push({target:s,rect:re(s)});var r=Ne({},i[i.length-1].rect);if(s.thisAnimationDuration){var n=Qt(s,!0);n&&(r.top-=n.f,r.left-=n.e)}s.fromRect=r}})}},addAnimationState:function(a){i.push(a)},removeAnimationState:function(a){i.splice(Zh(i,{target:a}),1)},animateAll:function(a){var s=this;if(!this.options.animation){clearTimeout(e),typeof a=="function"&&a();return}var r=!1,n=0;i.forEach(function(o){var l=0,c=o.target,d=c.fromRect,u=re(c),p=c.prevFromRect,_=c.prevToRect,m=o.rect,f=Qt(c,!0);f&&(u.top-=f.f,u.left-=f.e),c.toRect=u,c.thisAnimationDuration&&Ws(p,u)&&!Ws(d,u)&&(m.top-u.top)/(m.left-u.left)===(d.top-u.top)/(d.left-u.left)&&(l=ip(m,p,_,s.options)),Ws(u,d)||(c.prevFromRect=d,c.prevToRect=u,l||(l=s.options.animation),s.animate(c,m,u,l)),l&&(r=!0,n=Math.max(n,l),clearTimeout(c.animationResetTimer),c.animationResetTimer=setTimeout(function(){c.animationTime=0,c.prevFromRect=null,c.fromRect=null,c.prevToRect=null,c.thisAnimationDuration=null},l),c.thisAnimationDuration=l)}),clearTimeout(e),r?e=setTimeout(function(){typeof a=="function"&&a()},n):typeof a=="function"&&a(),i=[]},animate:function(a,s,r,n){if(n){P(a,"transition",""),P(a,"transform","");var o=Qt(this.el),l=o&&o.a,c=o&&o.d,d=(s.left-r.left)/(l||1),u=(s.top-r.top)/(c||1);a.animatingX=!!d,a.animatingY=!!u,P(a,"transform","translate3d("+d+"px,"+u+"px,0)"),this.forRepaintDummy=tp(a),P(a,"transition","transform "+n+"ms"+(this.options.easing?" "+this.options.easing:"")),P(a,"transform","translate3d(0,0,0)"),typeof a.animated=="number"&&clearTimeout(a.animated),a.animated=setTimeout(function(){P(a,"transition",""),P(a,"transform",""),a.animated=!1,a.animatingX=!1,a.animatingY=!1},n)}}}}function tp(i){return i.offsetWidth}function ip(i,e,t,a){return Math.sqrt(Math.pow(e.top-i.top,2)+Math.pow(e.left-i.left,2))/Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))*a.animation}var Yt=[],Ys={initializeByDefault:!0},Ri={mount:function(e){for(var t in Ys)Ys.hasOwnProperty(t)&&!(t in e)&&(e[t]=Ys[t]);Yt.forEach(function(a){if(a.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),Yt.push(e)},pluginEvent:function(e,t,a){var s=this;this.eventCanceled=!1,a.cancel=function(){s.eventCanceled=!0};var r=e+"Global";Yt.forEach(function(n){t[n.pluginName]&&(t[n.pluginName][r]&&t[n.pluginName][r](Ne({sortable:t},a)),t.options[n.pluginName]&&t[n.pluginName][e]&&t[n.pluginName][e](Ne({sortable:t},a)))})},initializePlugins:function(e,t,a,s){Yt.forEach(function(o){var l=o.pluginName;if(!(!e.options[l]&&!o.initializeByDefault)){var c=new o(e,t,e.options);c.sortable=e,c.options=e.options,e[l]=c,Ye(a,c.defaults)}});for(var r in e.options)if(e.options.hasOwnProperty(r)){var n=this.modifyOption(e,r,e.options[r]);typeof n<"u"&&(e.options[r]=n)}},getEventProperties:function(e,t){var a={};return Yt.forEach(function(s){typeof s.eventProperties=="function"&&Ye(a,s.eventProperties.call(t[s.pluginName],e))}),a},modifyOption:function(e,t,a){var s;return Yt.forEach(function(r){e[r.pluginName]&&r.optionListeners&&typeof r.optionListeners[t]=="function"&&(s=r.optionListeners[t].call(e[r.pluginName],a))}),s}};function ap(i){var e=i.sortable,t=i.rootEl,a=i.name,s=i.targetEl,r=i.cloneEl,n=i.toEl,o=i.fromEl,l=i.oldIndex,c=i.newIndex,d=i.oldDraggableIndex,u=i.newDraggableIndex,p=i.originalEvent,_=i.putSortable,m=i.extraEventProperties;if(e=e||t&&t[Ae],!!e){var f,y=e.options,b="on"+a.charAt(0).toUpperCase()+a.substr(1);window.CustomEvent&&!Ze&&!ji?f=new CustomEvent(a,{bubbles:!0,cancelable:!0}):(f=document.createEvent("Event"),f.initEvent(a,!0,!0)),f.to=n||t,f.from=o||t,f.item=s||t,f.clone=r,f.oldIndex=l,f.newIndex=c,f.oldDraggableIndex=d,f.newDraggableIndex=u,f.originalEvent=p,f.pullMode=_?_.lastPutMode:void 0;var k=Ne(Ne({},m),Ri.getEventProperties(a,e));for(var w in k)f[w]=k[w];t&&t.dispatchEvent(f),y[b]&&y[b].call(e,f)}}var sp=["evt"],$e=function(e,t){var a=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},s=a.evt,r=Gh(a,sp);Ri.pluginEvent.bind(z)(e,t,Ne({dragEl:S,parentEl:ae,ghostEl:D,rootEl:te,nextEl:At,lastDownEl:xa,cloneEl:ie,cloneHidden:ot,dragStarted:Li,putSortable:he,activeSortable:z.active,originalEvent:s,oldIndex:Kt,oldDraggableIndex:Oi,newIndex:Te,newDraggableIndex:lt,hideGhostForTarget:zo,unhideGhostForTarget:jo,cloneNowHidden:function(){ot=!0},cloneNowShown:function(){ot=!1},dispatchSortableEvent:function(o){ke({sortable:t,name:o,originalEvent:s})}},r))};function ke(i){ap(Ne({putSortable:he,cloneEl:ie,targetEl:S,rootEl:te,oldIndex:Kt,oldDraggableIndex:Oi,newIndex:Te,newDraggableIndex:lt},i))}var S,ae,D,te,At,xa,ie,ot,Kt,Te,Oi,lt,wa,he,Zt=!1,ka=!1,Ea=[],$t,Re,Ks,Zs,$o,Co,Li,Jt,qi,Ni=!1,Sa=!1,Aa,fe,Js=[],Xs=!1,$a=[],Ca=typeof document<"u",Ta=Gs,To=ji||Ze?"cssFloat":"float",rp=Ca&&!go&&!Gs&&"draggable"in document.createElement("div"),Io=(function(){if(Ca){if(Ze)return!1;var i=document.createElement("x");return i.style.cssText="pointer-events:auto",i.style.pointerEvents==="auto"}})(),Mo=function(e,t){var a=P(e),s=parseInt(a.width)-parseInt(a.paddingLeft)-parseInt(a.paddingRight)-parseInt(a.borderLeftWidth)-parseInt(a.borderRightWidth),r=Wt(e,0,t),n=Wt(e,1,t),o=r&&P(r),l=n&&P(n),c=o&&parseInt(o.marginLeft)+parseInt(o.marginRight)+re(r).width,d=l&&parseInt(l.marginLeft)+parseInt(l.marginRight)+re(n).width;if(a.display==="flex")return a.flexDirection==="column"||a.flexDirection==="column-reverse"?"vertical":"horizontal";if(a.display==="grid")return a.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(r&&o.float&&o.float!=="none"){var u=o.float==="left"?"left":"right";return n&&(l.clear==="both"||l.clear===u)?"vertical":"horizontal"}return r&&(o.display==="block"||o.display==="flex"||o.display==="table"||o.display==="grid"||c>=s&&a[To]==="none"||n&&a[To]==="none"&&c+d>s)?"vertical":"horizontal"},np=function(e,t,a){var s=a?e.left:e.top,r=a?e.right:e.bottom,n=a?e.width:e.height,o=a?t.left:t.top,l=a?t.right:t.bottom,c=a?t.width:t.height;return s===o||r===l||s+n/2===o+c/2},op=function(e,t){var a;return Ea.some(function(s){var r=s[Ae].options.emptyInsertThreshold;if(!(!r||Qs(s))){var n=re(s),o=e>=n.left-r&&e<=n.right+r,l=t>=n.top-r&&t<=n.bottom+r;if(o&&l)return a=s}}),a},Po=function(e){function t(r,n){return function(o,l,c,d){var u=o.options.group.name&&l.options.group.name&&o.options.group.name===l.options.group.name;if(r==null&&(n||u))return!0;if(r==null||r===!1)return!1;if(n&&r==="clone")return r;if(typeof r=="function")return t(r(o,l,c,d),n)(o,l,c,d);var p=(n?o:l).options.group.name;return r===!0||typeof r=="string"&&r===p||r.join&&r.indexOf(p)>-1}}var a={},s=e.group;(!s||Hs(s)!="object")&&(s={name:s}),a.name=s.name,a.checkPull=t(s.pull,!0),a.checkPut=t(s.put),a.revertClone=s.revertClone,e.group=a},zo=function(){!Io&&D&&P(D,"display","none")},jo=function(){!Io&&D&&P(D,"display","")};Ca&&!go&&document.addEventListener("click",function(i){if(ka)return i.preventDefault(),i.stopPropagation&&i.stopPropagation(),i.stopImmediatePropagation&&i.stopImmediatePropagation(),ka=!1,!1},!0);var Ct=function(e){if(S){e=e.touches?e.touches[0]:e;var t=op(e.clientX,e.clientY);if(t){var a={};for(var s in e)e.hasOwnProperty(s)&&(a[s]=e[s]);a.target=a.rootEl=t,a.preventDefault=void 0,a.stopPropagation=void 0,t[Ae]._onDragOver(a)}}},lp=function(e){S&&S.parentNode[Ae]._isOutsideThisEl(e.target)};function z(i,e){if(!(i&&i.nodeType&&i.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(i));this.el=i,this.options=e=Ye({},e),i[Ae]=this;var t={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(i.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return Mo(i,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(n,o){n.setData("Text",o.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:z.supportPointer!==!1&&"PointerEvent"in window&&(!Fi||Gs),emptyInsertThreshold:5};Ri.initializePlugins(this,i,t);for(var a in t)!(a in e)&&(e[a]=t[a]);Po(e);for(var s in this)s.charAt(0)==="_"&&typeof this[s]=="function"&&(this[s]=this[s].bind(this));this.nativeDraggable=e.forceFallback?!1:rp,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?U(i,"pointerdown",this._onTapStart):(U(i,"mousedown",this._onTapStart),U(i,"touchstart",this._onTapStart)),this.nativeDraggable&&(U(i,"dragover",this),U(i,"dragenter",this)),Ea.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),Ye(this,ep())}z.prototype={constructor:z,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(Jt=null)},_getDirection:function(e,t){return typeof this.options.direction=="function"?this.options.direction.call(this,e,t,S):this.options.direction},_onTapStart:function(e){if(e.cancelable){var t=this,a=this.el,s=this.options,r=s.preventOnFilter,n=e.type,o=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,l=(o||e).target,c=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||l,d=s.filter;if(gp(a),!S&&!(/mousedown|pointerdown/.test(n)&&e.button!==0||s.disabled)&&!c.isContentEditable&&!(!this.nativeDraggable&&Fi&&l&&l.tagName.toUpperCase()==="SELECT")&&(l=De(l,s.draggable,a,!1),!(l&&l.animated)&&xa!==l)){if(Kt=ze(l),Oi=ze(l,s.draggable),typeof d=="function"){if(d.call(this,e,l,this)){ke({sortable:t,rootEl:c,name:"filter",targetEl:l,toEl:a,fromEl:a}),$e("filter",t,{evt:e}),r&&e.preventDefault();return}}else if(d&&(d=d.split(",").some(function(u){if(u=De(c,u.trim(),a,!1),u)return ke({sortable:t,rootEl:u,name:"filter",targetEl:l,fromEl:a,toEl:a}),$e("filter",t,{evt:e}),!0}),d)){r&&e.preventDefault();return}s.handle&&!De(c,s.handle,a,!1)||this._prepareDragStart(e,o,l)}}},_prepareDragStart:function(e,t,a){var s=this,r=s.el,n=s.options,o=r.ownerDocument,l;if(a&&!S&&a.parentNode===r){var c=re(a);if(te=r,S=a,ae=S.parentNode,At=S.nextSibling,xa=a,wa=n.group,z.dragged=S,$t={target:S,clientX:(t||e).clientX,clientY:(t||e).clientY},$o=$t.clientX-c.left,Co=$t.clientY-c.top,this._lastX=(t||e).clientX,this._lastY=(t||e).clientY,S.style["will-change"]="all",l=function(){if($e("delayEnded",s,{evt:e}),z.eventCanceled){s._onDrop();return}s._disableDelayedDragEvents(),!mo&&s.nativeDraggable&&(S.draggable=!0),s._triggerDragStart(e,t),ke({sortable:s,name:"choose",originalEvent:e}),Ce(S,n.chosenClass,!0)},n.ignore.split(",").forEach(function(d){bo(S,d.trim(),er)}),U(o,"dragover",Ct),U(o,"mousemove",Ct),U(o,"touchmove",Ct),n.supportPointer?(U(o,"pointerup",s._onDrop),!this.nativeDraggable&&U(o,"pointercancel",s._onDrop)):(U(o,"mouseup",s._onDrop),U(o,"touchend",s._onDrop),U(o,"touchcancel",s._onDrop)),mo&&this.nativeDraggable&&(this.options.touchStartThreshold=4,S.draggable=!0),$e("delayStart",this,{evt:e}),n.delay&&(!n.delayOnTouchOnly||t)&&(!this.nativeDraggable||!(ji||Ze))){if(z.eventCanceled){this._onDrop();return}n.supportPointer?(U(o,"pointerup",s._disableDelayedDrag),U(o,"pointercancel",s._disableDelayedDrag)):(U(o,"mouseup",s._disableDelayedDrag),U(o,"touchend",s._disableDelayedDrag),U(o,"touchcancel",s._disableDelayedDrag)),U(o,"mousemove",s._delayedDragTouchMoveHandler),U(o,"touchmove",s._delayedDragTouchMoveHandler),n.supportPointer&&U(o,"pointermove",s._delayedDragTouchMoveHandler),s._dragStartTimer=setTimeout(l,n.delay)}else l()}},_delayedDragTouchMoveHandler:function(e){var t=e.touches?e.touches[0]:e;Math.max(Math.abs(t.clientX-this._lastX),Math.abs(t.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){S&&er(S),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;q(e,"mouseup",this._disableDelayedDrag),q(e,"touchend",this._disableDelayedDrag),q(e,"touchcancel",this._disableDelayedDrag),q(e,"pointerup",this._disableDelayedDrag),q(e,"pointercancel",this._disableDelayedDrag),q(e,"mousemove",this._delayedDragTouchMoveHandler),q(e,"touchmove",this._delayedDragTouchMoveHandler),q(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,t){t=t||e.pointerType=="touch"&&e,!this.nativeDraggable||t?this.options.supportPointer?U(document,"pointermove",this._onTouchMove):t?U(document,"touchmove",this._onTouchMove):U(document,"mousemove",this._onTouchMove):(U(S,"dragend",this),U(te,"dragstart",this._onDragStart));try{document.selection?Ma(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,t){if(Zt=!1,te&&S){$e("dragStarted",this,{evt:t}),this.nativeDraggable&&U(document,"dragover",lp);var a=this.options;!e&&Ce(S,a.dragClass,!1),Ce(S,a.ghostClass,!0),z.active=this,e&&this._appendGhost(),ke({sortable:this,name:"start",originalEvent:t})}else this._nulling()},_emulateDragOver:function(){if(Re){this._lastX=Re.clientX,this._lastY=Re.clientY,zo();for(var e=document.elementFromPoint(Re.clientX,Re.clientY),t=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(Re.clientX,Re.clientY),e!==t);)t=e;if(S.parentNode[Ae]._isOutsideThisEl(e),t)do{if(t[Ae]){var a=void 0;if(a=t[Ae]._onDragOver({clientX:Re.clientX,clientY:Re.clientY,target:e,rootEl:t}),a&&!this.options.dragoverBubble)break}e=t}while(t=yo(t));jo()}},_onTouchMove:function(e){if($t){var t=this.options,a=t.fallbackTolerance,s=t.fallbackOffset,r=e.touches?e.touches[0]:e,n=D&&Qt(D,!0),o=D&&n&&n.a,l=D&&n&&n.d,c=Ta&&fe&&wo(fe),d=(r.clientX-$t.clientX+s.x)/(o||1)+(c?c[0]-Js[0]:0)/(o||1),u=(r.clientY-$t.clientY+s.y)/(l||1)+(c?c[1]-Js[1]:0)/(l||1);if(!z.active&&!Zt){if(a&&Math.max(Math.abs(r.clientX-this._lastX),Math.abs(r.clientY-this._lastY))<a)return;this._onDragStart(e,!0)}if(D){n?(n.e+=d-(Ks||0),n.f+=u-(Zs||0)):n={a:1,b:0,c:0,d:1,e:d,f:u};var p="matrix(".concat(n.a,",").concat(n.b,",").concat(n.c,",").concat(n.d,",").concat(n.e,",").concat(n.f,")");P(D,"webkitTransform",p),P(D,"mozTransform",p),P(D,"msTransform",p),P(D,"transform",p),Ks=d,Zs=u,Re=r}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!D){var e=this.options.fallbackOnBody?document.body:te,t=re(S,!0,Ta,!0,e),a=this.options;if(Ta){for(fe=e;P(fe,"position")==="static"&&P(fe,"transform")==="none"&&fe!==document;)fe=fe.parentNode;fe!==document.body&&fe!==document.documentElement?(fe===document&&(fe=Ve()),t.top+=fe.scrollTop,t.left+=fe.scrollLeft):fe=Ve(),Js=wo(fe)}D=S.cloneNode(!0),Ce(D,a.ghostClass,!1),Ce(D,a.fallbackClass,!0),Ce(D,a.dragClass,!0),P(D,"transition",""),P(D,"transform",""),P(D,"box-sizing","border-box"),P(D,"margin",0),P(D,"top",t.top),P(D,"left",t.left),P(D,"width",t.width),P(D,"height",t.height),P(D,"opacity","0.8"),P(D,"position",Ta?"absolute":"fixed"),P(D,"zIndex","100000"),P(D,"pointerEvents","none"),z.ghost=D,e.appendChild(D),P(D,"transform-origin",$o/parseInt(D.style.width)*100+"% "+Co/parseInt(D.style.height)*100+"%")}},_onDragStart:function(e,t){var a=this,s=e.dataTransfer,r=a.options;if($e("dragStart",this,{evt:e}),z.eventCanceled){this._onDrop();return}$e("setupClone",this),z.eventCanceled||(ie=So(S),ie.removeAttribute("id"),ie.draggable=!1,ie.style["will-change"]="",this._hideClone(),Ce(ie,this.options.chosenClass,!1),z.clone=ie),a.cloneId=Ma(function(){$e("clone",a),!z.eventCanceled&&(a.options.removeCloneOnHide||te.insertBefore(ie,S),a._hideClone(),ke({sortable:a,name:"clone"}))}),!t&&Ce(S,r.dragClass,!0),t?(ka=!0,a._loopId=setInterval(a._emulateDragOver,50)):(q(document,"mouseup",a._onDrop),q(document,"touchend",a._onDrop),q(document,"touchcancel",a._onDrop),s&&(s.effectAllowed="move",r.setData&&r.setData.call(a,s,S)),U(document,"drop",a),P(S,"transform","translateZ(0)")),Zt=!0,a._dragStartId=Ma(a._dragStarted.bind(a,t,e)),U(document,"selectstart",a),Li=!0,window.getSelection().removeAllRanges(),Fi&&P(document.body,"user-select","none")},_onDragOver:function(e){var t=this.el,a=e.target,s,r,n,o=this.options,l=o.group,c=z.active,d=wa===l,u=o.sort,p=he||c,_,m=this,f=!1;if(Xs)return;function y(L,Y){$e(L,m,Ne({evt:e,isOwner:d,axis:_?"vertical":"horizontal",revert:n,dragRect:s,targetRect:r,canSort:u,fromSortable:p,target:a,completed:k,onMove:function(K,Q){return Ia(te,t,S,s,K,re(K),e,Q)},changed:w},Y))}function b(){y("dragOverAnimationCapture"),m.captureAnimationState(),m!==p&&p.captureAnimationState()}function k(L){return y("dragOverCompleted",{insertion:L}),L&&(d?c._hideClone():c._showClone(m),m!==p&&(Ce(S,he?he.options.ghostClass:c.options.ghostClass,!1),Ce(S,o.ghostClass,!0)),he!==m&&m!==z.active?he=m:m===z.active&&he&&(he=null),p===m&&(m._ignoreWhileAnimating=a),m.animateAll(function(){y("dragOverAnimationComplete"),m._ignoreWhileAnimating=null}),m!==p&&(p.animateAll(),p._ignoreWhileAnimating=null)),(a===S&&!S.animated||a===t&&!a.animated)&&(Jt=null),!o.dragoverBubble&&!e.rootEl&&a!==document&&(S.parentNode[Ae]._isOutsideThisEl(e.target),!L&&Ct(e)),!o.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),f=!0}function w(){Te=ze(S),lt=ze(S,o.draggable),ke({sortable:m,name:"change",toEl:t,newIndex:Te,newDraggableIndex:lt,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),a=De(a,o.draggable,t,!0),y("dragOver"),z.eventCanceled)return f;if(S.contains(e.target)||a.animated&&a.animatingX&&a.animatingY||m._ignoreWhileAnimating===a)return k(!1);if(ka=!1,c&&!o.disabled&&(d?u||(n=ae!==te):he===this||(this.lastPutMode=wa.checkPull(this,c,S,e))&&l.checkPut(this,c,S,e))){if(_=this._getDirection(e,a)==="vertical",s=re(S),y("dragOverValid"),z.eventCanceled)return f;if(n)return ae=te,b(),this._hideClone(),y("revert"),z.eventCanceled||(At?te.insertBefore(S,At):te.appendChild(S)),k(!0);var E=Qs(t,o.draggable);if(!E||hp(e,_,this)&&!E.animated){if(E===S)return k(!1);if(E&&t===e.target&&(a=E),a&&(r=re(a)),Ia(te,t,S,s,a,r,e,!!a)!==!1)return b(),E&&E.nextSibling?t.insertBefore(S,E.nextSibling):t.appendChild(S),ae=t,w(),k(!0)}else if(E&&up(e,_,this)){var A=Wt(t,0,o,!0);if(A===S)return k(!1);if(a=A,r=re(a),Ia(te,t,S,s,a,r,e,!1)!==!1)return b(),t.insertBefore(S,A),ae=t,w(),k(!0)}else if(a.parentNode===t){r=re(a);var C=0,M,j=S.parentNode!==t,F=!np(S.animated&&S.toRect||s,a.animated&&a.toRect||r,_),I=_?"top":"left",T=xo(a,"top","top")||xo(S,"top","top"),N=T?T.scrollTop:void 0;Jt!==a&&(M=r[I],Ni=!1,Sa=!F&&o.invertSwap||j),C=pp(e,a,r,_,F?1:o.swapThreshold,o.invertedSwapThreshold==null?o.swapThreshold:o.invertedSwapThreshold,Sa,Jt===a);var R;if(C!==0){var V=ze(S);do V-=C,R=ae.children[V];while(R&&(P(R,"display")==="none"||R===D))}if(C===0||R===a)return k(!1);Jt=a,qi=C;var J=a.nextElementSibling,ee=!1;ee=C===1;var B=Ia(te,t,S,s,a,r,e,ee);if(B!==!1)return(B===1||B===-1)&&(ee=B===1),Xs=!0,setTimeout(dp,30),b(),ee&&!J?t.appendChild(S):a.parentNode.insertBefore(S,ee?J:a),T&&Eo(T,0,N-T.scrollTop),ae=S.parentNode,M!==void 0&&!Sa&&(Aa=Math.abs(M-re(a)[I])),w(),k(!0)}if(t.contains(S))return k(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){q(document,"mousemove",this._onTouchMove),q(document,"touchmove",this._onTouchMove),q(document,"pointermove",this._onTouchMove),q(document,"dragover",Ct),q(document,"mousemove",Ct),q(document,"touchmove",Ct)},_offUpEvents:function(){var e=this.el.ownerDocument;q(e,"mouseup",this._onDrop),q(e,"touchend",this._onDrop),q(e,"pointerup",this._onDrop),q(e,"pointercancel",this._onDrop),q(e,"touchcancel",this._onDrop),q(document,"selectstart",this)},_onDrop:function(e){var t=this.el,a=this.options;if(Te=ze(S),lt=ze(S,a.draggable),$e("drop",this,{evt:e}),ae=S&&S.parentNode,Te=ze(S),lt=ze(S,a.draggable),z.eventCanceled){this._nulling();return}Zt=!1,Sa=!1,Ni=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),tr(this.cloneId),tr(this._dragStartId),this.nativeDraggable&&(q(document,"drop",this),q(t,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),Fi&&P(document.body,"user-select",""),P(S,"transform",""),e&&(Li&&(e.cancelable&&e.preventDefault(),!a.dropBubble&&e.stopPropagation()),D&&D.parentNode&&D.parentNode.removeChild(D),(te===ae||he&&he.lastPutMode!=="clone")&&ie&&ie.parentNode&&ie.parentNode.removeChild(ie),S&&(this.nativeDraggable&&q(S,"dragend",this),er(S),S.style["will-change"]="",Li&&!Zt&&Ce(S,he?he.options.ghostClass:this.options.ghostClass,!1),Ce(S,this.options.chosenClass,!1),ke({sortable:this,name:"unchoose",toEl:ae,newIndex:null,newDraggableIndex:null,originalEvent:e}),te!==ae?(Te>=0&&(ke({rootEl:ae,name:"add",toEl:ae,fromEl:te,originalEvent:e}),ke({sortable:this,name:"remove",toEl:ae,originalEvent:e}),ke({rootEl:ae,name:"sort",toEl:ae,fromEl:te,originalEvent:e}),ke({sortable:this,name:"sort",toEl:ae,originalEvent:e})),he&&he.save()):Te!==Kt&&Te>=0&&(ke({sortable:this,name:"update",toEl:ae,originalEvent:e}),ke({sortable:this,name:"sort",toEl:ae,originalEvent:e})),z.active&&((Te==null||Te===-1)&&(Te=Kt,lt=Oi),ke({sortable:this,name:"end",toEl:ae,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){$e("nulling",this),te=S=ae=D=At=ie=xa=ot=$t=Re=Li=Te=lt=Kt=Oi=Jt=qi=he=wa=z.dragged=z.ghost=z.clone=z.active=null;var e=this.el;$a.forEach(function(t){e.contains(t)&&(t.checked=!0)}),$a.length=Ks=Zs=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":S&&(this._onDragOver(e),cp(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],t,a=this.el.children,s=0,r=a.length,n=this.options;s<r;s++)t=a[s],De(t,n.draggable,this.el,!1)&&e.push(t.getAttribute(n.dataIdAttr)||mp(t));return e},sort:function(e,t){var a={},s=this.el;this.toArray().forEach(function(r,n){var o=s.children[n];De(o,this.options.draggable,s,!1)&&(a[r]=o)},this),t&&this.captureAnimationState(),e.forEach(function(r){a[r]&&(s.removeChild(a[r]),s.appendChild(a[r]))}),t&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,t){return De(e,t||this.options.draggable,this.el,!1)},option:function(e,t){var a=this.options;if(t===void 0)return a[e];var s=Ri.modifyOption(this,e,t);typeof s<"u"?a[e]=s:a[e]=t,e==="group"&&Po(a)},destroy:function(){$e("destroy",this);var e=this.el;e[Ae]=null,q(e,"mousedown",this._onTapStart),q(e,"touchstart",this._onTapStart),q(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(q(e,"dragover",this),q(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(t){t.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),Ea.splice(Ea.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!ot){if($e("hideClone",this),z.eventCanceled)return;P(ie,"display","none"),this.options.removeCloneOnHide&&ie.parentNode&&ie.parentNode.removeChild(ie),ot=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(ot){if($e("showClone",this),z.eventCanceled)return;S.parentNode==te&&!this.options.group.revertClone?te.insertBefore(ie,S):At?te.insertBefore(ie,At):te.appendChild(ie),this.options.group.revertClone&&this.animate(S,ie),P(ie,"display",""),ot=!1}}};function cp(i){i.dataTransfer&&(i.dataTransfer.dropEffect="move"),i.cancelable&&i.preventDefault()}function Ia(i,e,t,a,s,r,n,o){var l,c=i[Ae],d=c.options.onMove,u;return window.CustomEvent&&!Ze&&!ji?l=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(l=document.createEvent("Event"),l.initEvent("move",!0,!0)),l.to=e,l.from=i,l.dragged=t,l.draggedRect=a,l.related=s||e,l.relatedRect=r||re(e),l.willInsertAfter=o,l.originalEvent=n,i.dispatchEvent(l),d&&(u=d.call(c,l,n)),u}function er(i){i.draggable=!1}function dp(){Xs=!1}function up(i,e,t){var a=re(Wt(t.el,0,t.options,!0)),s=Ao(t.el,t.options,D),r=10;return e?i.clientX<s.left-r||i.clientY<a.top&&i.clientX<a.right:i.clientY<s.top-r||i.clientY<a.bottom&&i.clientX<a.left}function hp(i,e,t){var a=re(Qs(t.el,t.options.draggable)),s=Ao(t.el,t.options,D),r=10;return e?i.clientX>s.right+r||i.clientY>a.bottom&&i.clientX>a.left:i.clientY>s.bottom+r||i.clientX>a.right&&i.clientY>a.top}function pp(i,e,t,a,s,r,n,o){var l=a?i.clientY:i.clientX,c=a?t.height:t.width,d=a?t.top:t.left,u=a?t.bottom:t.right,p=!1;if(!n){if(o&&Aa<c*s){if(!Ni&&(qi===1?l>d+c*r/2:l<u-c*r/2)&&(Ni=!0),Ni)p=!0;else if(qi===1?l<d+Aa:l>u-Aa)return-qi}else if(l>d+c*(1-s)/2&&l<u-c*(1-s)/2)return _p(e)}return p=p||n,p&&(l<d+c*r/2||l>u-c*r/2)?l>d+c/2?1:-1:0}function _p(i){return ze(S)<ze(i)?1:-1}function mp(i){for(var e=i.tagName+i.className+i.src+i.href+i.textContent,t=e.length,a=0;t--;)a+=e.charCodeAt(t);return a.toString(36)}function gp(i){$a.length=0;for(var e=i.getElementsByTagName("input"),t=e.length;t--;){var a=e[t];a.checked&&$a.push(a)}}function Ma(i){return setTimeout(i,0)}function tr(i){return clearTimeout(i)}Ca&&U(document,"touchmove",function(i){(z.active||Zt)&&i.cancelable&&i.preventDefault()}),z.utils={on:U,off:q,css:P,find:bo,is:function(e,t){return!!De(e,t,e,!1)},extend:Jh,throttle:ko,closest:De,toggleClass:Ce,clone:So,index:ze,nextTick:Ma,cancelNextTick:tr,detectDirection:Mo,getChild:Wt,expando:Ae},z.get=function(i){return i[Ae]},z.mount=function(){for(var i=arguments.length,e=new Array(i),t=0;t<i;t++)e[t]=arguments[t];e[0].constructor===Array&&(e=e[0]),e.forEach(function(a){if(!a.prototype||!a.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(a));a.utils&&(z.utils=Ne(Ne({},z.utils),a.utils)),Ri.mount(a)})},z.create=function(i,e){return new z(i,e)},z.version=Kh;var ne=[],Vi,ir,ar=!1,sr,rr,Pa,Ui;function fp(){function i(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return i.prototype={dragStarted:function(t){var a=t.originalEvent;this.sortable.nativeDraggable?U(document,"dragover",this._handleAutoScroll):this.options.supportPointer?U(document,"pointermove",this._handleFallbackAutoScroll):a.touches?U(document,"touchmove",this._handleFallbackAutoScroll):U(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(t){var a=t.originalEvent;!this.options.dragOverBubble&&!a.rootEl&&this._handleAutoScroll(a)},drop:function(){this.sortable.nativeDraggable?q(document,"dragover",this._handleAutoScroll):(q(document,"pointermove",this._handleFallbackAutoScroll),q(document,"touchmove",this._handleFallbackAutoScroll),q(document,"mousemove",this._handleFallbackAutoScroll)),Fo(),za(),Xh()},nulling:function(){Pa=ir=Vi=ar=Ui=sr=rr=null,ne.length=0},_handleFallbackAutoScroll:function(t){this._handleAutoScroll(t,!0)},_handleAutoScroll:function(t,a){var s=this,r=(t.touches?t.touches[0]:t).clientX,n=(t.touches?t.touches[0]:t).clientY,o=document.elementFromPoint(r,n);if(Pa=t,a||this.options.forceAutoScrollFallback||ji||Ze||Fi){nr(t,this.options,o,a);var l=nt(o,!0);ar&&(!Ui||r!==sr||n!==rr)&&(Ui&&Fo(),Ui=setInterval(function(){var c=nt(document.elementFromPoint(r,n),!0);c!==l&&(l=c,za()),nr(t,s.options,c,a)},10),sr=r,rr=n)}else{if(!this.options.bubbleScroll||nt(o,!0)===Ve()){za();return}nr(t,this.options,nt(o,!1),!1)}}},Ye(i,{pluginName:"scroll",initializeByDefault:!0})}function za(){ne.forEach(function(i){clearInterval(i.pid)}),ne=[]}function Fo(){clearInterval(Ui)}var nr=ko(function(i,e,t,a){if(e.scroll){var s=(i.touches?i.touches[0]:i).clientX,r=(i.touches?i.touches[0]:i).clientY,n=e.scrollSensitivity,o=e.scrollSpeed,l=Ve(),c=!1,d;ir!==t&&(ir=t,za(),Vi=e.scroll,d=e.scrollFn,Vi===!0&&(Vi=nt(t,!0)));var u=0,p=Vi;do{var _=p,m=re(_),f=m.top,y=m.bottom,b=m.left,k=m.right,w=m.width,E=m.height,A=void 0,C=void 0,M=_.scrollWidth,j=_.scrollHeight,F=P(_),I=_.scrollLeft,T=_.scrollTop;_===l?(A=w<M&&(F.overflowX==="auto"||F.overflowX==="scroll"||F.overflowX==="visible"),C=E<j&&(F.overflowY==="auto"||F.overflowY==="scroll"||F.overflowY==="visible")):(A=w<M&&(F.overflowX==="auto"||F.overflowX==="scroll"),C=E<j&&(F.overflowY==="auto"||F.overflowY==="scroll"));var N=A&&(Math.abs(k-s)<=n&&I+w<M)-(Math.abs(b-s)<=n&&!!I),R=C&&(Math.abs(y-r)<=n&&T+E<j)-(Math.abs(f-r)<=n&&!!T);if(!ne[u])for(var V=0;V<=u;V++)ne[V]||(ne[V]={});(ne[u].vx!=N||ne[u].vy!=R||ne[u].el!==_)&&(ne[u].el=_,ne[u].vx=N,ne[u].vy=R,clearInterval(ne[u].pid),(N!=0||R!=0)&&(c=!0,ne[u].pid=setInterval(function(){a&&this.layer===0&&z.active._onTouchMove(Pa);var J=ne[this.layer].vy?ne[this.layer].vy*o:0,ee=ne[this.layer].vx?ne[this.layer].vx*o:0;typeof d=="function"&&d.call(z.dragged.parentNode[Ae],ee,J,i,Pa,ne[this.layer].el)!=="continue"||Eo(ne[this.layer].el,ee,J)}.bind({layer:u}),24))),u++}while(e.bubbleScroll&&p!==l&&(p=nt(p,!1)));ar=c}},30),Do=function(e){var t=e.originalEvent,a=e.putSortable,s=e.dragEl,r=e.activeSortable,n=e.dispatchSortableEvent,o=e.hideGhostForTarget,l=e.unhideGhostForTarget;if(t){var c=a||r;o();var d=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:t,u=document.elementFromPoint(d.clientX,d.clientY);l(),c&&!c.el.contains(u)&&(n("spill"),this.onSpill({dragEl:s,putSortable:a}))}};function or(){}or.prototype={startIndex:null,dragStart:function(e){var t=e.oldDraggableIndex;this.startIndex=t},onSpill:function(e){var t=e.dragEl,a=e.putSortable;this.sortable.captureAnimationState(),a&&a.captureAnimationState();var s=Wt(this.sortable.el,this.startIndex,this.options);s?this.sortable.el.insertBefore(t,s):this.sortable.el.appendChild(t),this.sortable.animateAll(),a&&a.animateAll()},drop:Do},Ye(or,{pluginName:"revertOnSpill"});function lr(){}lr.prototype={onSpill:function(e){var t=e.dragEl,a=e.putSortable,s=a||this.sortable;s.captureAnimationState(),t.parentNode&&t.parentNode.removeChild(t),s.animateAll()},drop:Do},Ye(lr,{pluginName:"removeOnSpill"}),z.mount(new fp),z.mount(lr,or);class yp extends it{static get properties(){return{disabled:{type:Boolean},handleSelector:{type:String},draggableSelector:{type:String}}}constructor(){super(),this.disabled=!1,this.handleSelector=".handle",this.draggableSelector=".sortable-item",this._sortable=null}createRenderRoot(){return this}render(){return g` <slot></slot> `}connectedCallback(){super.connectedCallback(),this.disabled||this._createSortable()}disconnectedCallback(){super.disconnectedCallback(),this._destroySortable()}updated(e){e.has("disabled")&&(this.disabled?this._destroySortable():this._createSortable())}_createSortable(){if(this._sortable)return;const e=this.children[0];if(!e)return;const t={scroll:!0,forceAutoScrollFallback:!0,scrollSpeed:20,animation:150,draggable:this.draggableSelector,handle:this.handleSelector||void 0,fallbackTolerance:3,fallbackOnBody:!0,fallbackClass:"sortable-fallback",forceFallback:!0,onChoose:this._handleChoose.bind(this),onStart:this._handleStart.bind(this),onEnd:this._handleEnd.bind(this),onUpdate:this._handleUpdate.bind(this)};this._sortable=new z(e,t),this._stopBubble=a=>{a.target.closest&&a.target.closest("button, ha-icon, ha-svg-icon")||a.stopPropagation()},e.addEventListener("mousedown",this._stopBubble),e.addEventListener("touchstart",this._stopBubble,{passive:!0}),e.addEventListener("pointerdown",this._stopBubble),e.addEventListener("dragstart",this._stopBubble),e.addEventListener("dragend",this._stopBubble),e.addEventListener("drop",this._stopBubble)}_handleUpdate(e){this.dispatchEvent(new CustomEvent("item-moved",{detail:{oldIndex:e.oldIndex,newIndex:e.newIndex},bubbles:!0,composed:!0}))}_handleEnd(e){this._cleanupGhostElements(),e.item.placeholder&&(e.item.placeholder.replaceWith(e.item),delete e.item.placeholder),this.dispatchEvent(new CustomEvent("drag-end",{bubbles:!0,composed:!0}))}_handleStart(e){this._cleanupGhostElements(),this.dispatchEvent(new CustomEvent("drag-start",{bubbles:!0,composed:!0}))}_handleChoose(e){e.item.placeholder=document.createComment("sort-placeholder"),e.item.after(e.item.placeholder)}_cleanupGhostElements(){document.querySelectorAll(".sortable-fallback, .sortable-ghost").forEach(e=>{e.parentNode&&e.parentNode.removeChild(e)})}_destroySortable(){if(!this._sortable)return;this._sortable.destroy(),this._sortable=null;const e=this.children[0];e&&this._stopBubble&&(e.removeEventListener("mousedown",this._stopBubble),e.removeEventListener("touchstart",this._stopBubble),e.removeEventListener("pointerdown",this._stopBubble),e.removeEventListener("dragstart",this._stopBubble),e.removeEventListener("dragend",this._stopBubble),e.removeEventListener("drop",this._stopBubble)),this._cleanupGhostElements()}}customElements.define("yamp-sortable",yp);const Ro=Object.freeze([{value:"details",label:h("card.sections.details")},{value:"menu",label:h("card.sections.menu")},{value:"action_chips",label:h("card.sections.action_chips")},{value:"lyrics",label:h("card.sections.lyrics")}]),cr=Ro.map(i=>i.value),Oo=Object.freeze({select:{mode:"dropdown",options:[{value:"slider",label:"Slider"},{value:"stepper",label:"Stepper"},{value:"hidden",label:"Hidden"}]}}),Lo=Object.freeze({number:{min:.01,max:1,step:.01,unit_of_measurement:"",mode:"box"}});class vp extends it{static get properties(){return{hass:{},_config:{},_yamlConfig:{},_activeTab:{type:String},_entityEditorIndex:{type:Number},_actionEditorIndex:{type:Number},_actionMode:{type:String},_templateModes:{type:Object},_serviceItems:{type:Array}}}constructor(){super(),this._activeTab="entities",this._entityEditorIndex=null,this._actionEditorIndex=null,this._tempEntityIndex=null,this._tempActionIndex=null,this._isInternalUpdate=!1,this._yamlDraft=void 0,this._yamlError=null,this._yamlConfig={},this._serviceItems=[],this._templateModes={},this._artworkOverrides=[],this._preTemplateConfig=null}firstUpdated(){this._serviceItems=this._getServiceItems(),this.addEventListener("value-changed",e=>this._captureEditorIndex(e),!0),this.addEventListener("change",e=>this._captureEditorIndex(e),!0),this.addEventListener("click",e=>this._captureEditorIndex(e),!0)}_captureEditorIndex(e){const t=e.composedPath(),a=t.find(r=>r.classList?.contains?.("entity-group"));if(a){const r=Number(a.getAttribute("data-index"));if(Number.isInteger(r)){this._tempEntityIndex=r;return}}this._tempEntityIndex=null;const s=t.find(r=>r.classList?.contains?.("action-group"));if(s){const r=Number(s.getAttribute("data-index"));if(Number.isInteger(r)){this._tempActionIndex=r;return}}this._tempActionIndex=null}updated(e){if(e.has("hass")){const t=e.get("hass");this.hass?.services!==t?.services&&(this._serviceItems=this._getServiceItems()),this._fetchAspectRatios()}(e.has("_searchTerm")||this._searchTerm)&&this._applySearchFilter()}_supportsFeature(e,t){return!e||typeof e.attributes.supported_features!="number"?!1:(e.attributes.supported_features&t)!==0}_isGroupCapable(e){return e?this._supportsFeature(e,on)?!0:Array.isArray(e.attributes?.group_members):!1}_normalizeArtworkOverrides(e){if(!Array.isArray(e))return[];const t=["media_title","media_artist","media_album_name","media_content_id","media_channel","app_name","media_content_type","entity_id","aspect_ratio"];return e.map(a=>{if(!a||typeof a!="object")return{match_type:"media_title",match_value:"",image_url:"",size_percentage:void 0,object_fit:void 0};const s=a.size_percentage;if(a.missing_art_url!==void 0)return{match_type:"missing_art",match_value:"",image_url:a.missing_art_url??"",size_percentage:s,object_fit:a.object_fit,object_position:a.object_position};if(a.idle_image===!0||a.idle_image_url!==void 0)return{match_type:"idle_image",match_value:"",image_url:a.idle_image_url??a.image_url??"",size_percentage:s,object_fit:a.object_fit,object_position:a.object_position};let r="media_title",n="";for(const o of t){if(a[o]!==void 0){r=o,n=a[o]??"";break}const l=`${o}_equals`;if(a[l]!==void 0){r=o,n=a[l]??"";break}}return{match_type:r,match_value:n??"",image_url:a.image_url??"",size_percentage:s,object_fit:a.object_fit,object_position:a.object_position}})}_serializeArtworkOverride(e){if(!e)return null;const t=(e.image_url??"").trim(),a=e.object_fit==="default"?void 0:e.object_fit;if(e.match_type==="missing_art")return t?{missing_art_url:t,...e.size_percentage!==void 0?{size_percentage:Number(e.size_percentage)}:{},...a!==void 0?{object_fit:a}:{},...e.object_position!==void 0&&e.object_position!=="default"?{object_position:e.object_position}:{}}:null;if(e.match_type==="idle_image")return{idle_image:!0,...t?{idle_image_url:t}:{},...e.size_percentage!==void 0?{size_percentage:Number(e.size_percentage)}:{},...a!==void 0?{object_fit:a}:{},...e.object_position!==void 0&&e.object_position!=="default"?{object_position:e.object_position}:{}};const s=(e.match_value??"").trim();return s?{...t?{image_url:t}:{},[e.match_type]:s,...e.size_percentage!==void 0?{size_percentage:Number(e.size_percentage)}:{},...a!==void 0?{object_fit:a}:{},...e.object_position!==void 0&&e.object_position!=="default"?{object_position:e.object_position}:{}}:null}_writeArtworkOverrides(e){this._artworkOverrides=e;const t=e.map(a=>this._serializeArtworkOverride(a)).filter(a=>a);this._updateConfig("media_artwork_overrides",t.length?t:void 0)}_getServiceItems(){return this.hass?.services?Object.entries(this.hass.services).flatMap(([e,t])=>Object.keys(t).map(a=>({label:`${e}.${a}`,value:`${e}.${a}`}))):[]}_getEntityItems(e=[],t=[]){return()=>this.hass?.states?Object.keys(this.hass.states).filter(a=>{const s=a.split(".")[0];return!(e.length&&!e.includes(s)||t.includes(a))}).map(a=>{const s=this.hass.states[a];return{id:a,primary:s?.attributes?.friendly_name||a,secondary:a}}):[]}_entityValueRenderer(e){return e?this.hass?.states?.[e]?.attributes?.friendly_name||e:""}_entityRowRenderer(e){return g`
        ...
        >
          <div>
            <ha-selector
              ...
              .selector=${{select:{mode:"dropdown",options:Object.keys(bi).map(s=>({value:s,label:h(`editor.templates.${s}.label`)}))}}}
              .value=${e}
          ...
          <div class="form-row form-row-multi-column">
            ...
            <div class="grow-children">
              <ha-selector
                ...
                .selector=${{select:{mode:"dropdown",options:[{value:"top center",label:(h("editor.artwork_position.top")||"Top")+" (default)"},{value:"center center",label:h("editor.artwork_position.center")||"Center"},{value:"bottom center",label:h("editor.artwork_position.bottom")||"Bottom"}]}}}
                          ...
                          <div class="artwork-fields">
                            ...
                            ${a.match_type==="missing_art"?g`
                                    <div class="config-subtitle small">
                                      ${h("editor.descriptions.missing_art_match")}
                                    </div>
                                  `:a.match_type==="idle_image"?g`
                                      <div class="config-subtitle small">
                                        ${h("editor.descriptions.idle_image_match")}
                                      </div>
                                          ...
                                          >
                                            ${(()=>{const r=[];if(this._config?.entity&&r.push(this._config.entity),this._config?.entities&&Array.isArray(this._config.entities))for(const n of this._config.entities){const o=typeof n=="string"?n:n.entity||n.entity_id;o&&!r.includes(o)&&r.push(o)}return r.length>1?g`
                                                  ...
                                                  >
                                                    ...
                                                    ${r.map(n=>{const o=this.hass.states[n],l=o?.attributes?.entity_picture||o?.attributes?.entity_picture_local||o?.attributes?.album_art,c=o?.attributes?.friendly_name||n,d=this._entityRatios&&this._entityRatios[n],u=this._formatRatio(d);return g`<option
                                                        value="${n}"
                                                        ?disabled=${!l}
                                                      >
                                                        ${c}${u}
                            ...
                            ${a.match_type==="idle_image"?v:g`
                                    <div class="editor-field-wrapper">
                                      ${this._isTemplateMode(`artwork_image_url_${s}`,a.image_url)?g`
                                              ...
                                              >
                                                <span class="form-label"
                                                  >${a.match_type==="missing_art"?h("editor.fields.fallback_image_url"):h("editor.fields.image_url").replaceAll("*","")}</span
                                                >
                                                <ha-code-editor
                                                  lint
                                                  .hass=${this.hass}
                            ...
                            >
                              ...
                              <div class="grow-children" style="flex:1.5; min-width: 120px;">
                                <ha-selector
                                  ...
                                  label="${h("editor.fields.artwork_position")}"
                                  .required=${!1}
                                  .selector=${{select:{mode:"dropdown",options:[{value:"default",label:h("editor.artwork_position.default")||"Global"},{value:"top center",label:h("editor.artwork_position.top")||"Top"},{value:"center center",label:h("editor.artwork_position.center")||"Center"},{value:"bottom center",label:h("editor.artwork_position.bottom")||"Bottom"}]}}}
    ...
    `}_renderBehaviorTab(){return g`
      <div class="config-section">
        <div class="form-row">
          <ha-selector
            .hass=${this.hass}
            .selector=${{select:{mode:"dropdown",options:[{value:"default",label:h("editor.card_type_options.default")},{value:"search",label:h("editor.card_type_options.search")},{value:"group_players",label:h("editor.card_type_options.group_players")},{value:"up_next",label:h("editor.card_type_options.up_next")},{value:"remote_control",label:h("editor.card_type_options.remote_control")}]}}}
    ...
    `}_renderVisualTab(){return g`
      <div class="config-section">
        ...
        >
          <div
            title=${this._config.alternate_progress_bar||!this._isTemplateValue(this._config.always_collapsed)&&this._config.always_collapsed?h("editor.subtitles.not_available_alt_collapsed"):""}
          >
            <ha-switch
      ...
      <div class="config-section">
        ...
        <div
          ...
          title="${this._isTemplateValue(this._config.control_layout)||(this._config.control_layout??"classic")==="modern"?"":h("editor.subtitles.only_available_modern")}"
          }
        >
          <div>
            <ha-switch
        ...
        <div class="form-row">
          <div>
            <ha-switch
              ...
              .checked=${this._config.show_album??!0}
              @change=${e=>this._updateConfig("show_album",e.target.checked)}
            ></ha-switch>
            <span>${h("editor.labels.show_album")}</span>
          </div>
          <div class="config-subtitle">${h("editor.subtitles.show_album")}</div>
        </div>
        <div class="form-row">
          <div>
            <ha-switch
        ...
        <div class="form-row">
          <div class="full-width">
            ...
            <ha-selector
              .hass=${this.hass}
              .selector=${{select:{multiple:!0,options:Ro}}}
      ...
      <div class="config-section">
        ...
        >
          ...
          <div
            ...
            title="${this._isTemplateValue(this._config.always_collapsed)||!this._config.always_collapsed?"":h("editor.subtitles.not_available_collapsed")}"
          >
            <ha-switch
        ...
        <div
          ...
          class="form-row"
          style="${this._config.always_collapsed===!0&&!this._config.expand_on_search?"":"opacity: 0.5;"}"
          title="${this._config.always_collapsed===!0&&!this._config.expand_on_search?"":h("editor.subtitles.only_available_mini_menu")}"
        >
          <div style="display: flex; align-items: center; gap: 8px;">
            <ha-switch
              id="disable-mini-menu-toggle"
              .checked=${this._config.disable_mini_menu===!0}
              @change=${e=>this._updateConfig("disable_mini_menu",e.target.checked)}
              .disabled=${!(this._config.always_collapsed===!0&&!this._config.expand_on_search)}
            ></ha-switch>
            <span>${h("editor.labels.disable_mini_menu")}</span>
          </div>
        </div>
        <div class="form-row">
          <div class="config-subtitle">${h("editor.subtitles.disable_mini_menu")}</div>
        </div>
        <div class="form-row">
          <ha-selector
            .hass=${this.hass}
                    ...
                    <div class="action-row-actions">
                      ...
                      ${t?.action!=="sync_selected_entity"&&t?.action!=="select_entity"?g`
                              <ha-icon
                                ...
                                title="${(()=>{const s=t?.placement!==void 0?t.placement:t?.in_menu;return s==="hidden"?t?.card_trigger&&t.card_trigger!=="none"?h("editor.placements.hidden"):`${h("editor.placements.hidden")} (${h("editor.placements.not_triggerable")})`:h(s==="replace_search"||s==="replace_power"||s==="replace_mute"||s==="replace_favorite"?`editor.placements.${s}`:s==="menu"||s===!0?"editor.fields.move_to_main":"editor.fields.move_to_menu")})()}"
                                role="button"
                                aria-label="${(()=>{const s=t?.placement!==void 0?t.placement:t?.in_menu;return h(s==="replace_search"||s==="replace_power"||s==="replace_mute"||s==="replace_favorite"?`editor.placements.${s}`:s==="menu"||s===!0?"editor.fields.move_to_main":"editor.fields.move_to_menu")})()}"
          ...
          <div class="editor-field-wrapper">
            ${this._isTemplateMode("hide_remote_buttons",e?.hide_remote_buttons)?g`
                    <div class="grow-children">
                      ...
                      >
                        <span class="form-label"
                          >${h("editor.fields.hide_remote_buttons")}</span
                        >
                        <ha-code-editor
                          lint
                          id="hidden-remote-buttons-template-editor"
                          label="${h("editor.fields.hide_remote_buttons")}"
                          .hass=${this.hass}
                          mode="jinja2"
                          autocomplete-entities
                        ...
                        ></ha-code-editor>
                        <div class="help-text">
                          ${h("editor.subtitles.hide_remote_buttons")}
                        </div>
                      </div>
                    </div>
                  `:g`
                    <ha-selector
                      ...
                      label="${h("editor.fields.hide_remote_buttons")}"
                      helper="${h("editor.subtitles.hide_remote_buttons")}"
                      @value-changed=${r=>this._updateEntityProperty("hide_remote_buttons",r.detail.value)}
                    ></ha-selector>
                  `}
...
{% endif %}</pre>
        ...
        ${(()=>{if(this._isTemplateMode("music_assistant_entity",e?.music_assistant_entity))return v;const r=e?.entity_id,n=r?this.hass?.states?.[r]:void 0,o=n?xi(n):!1,l=e?.music_assistant_entity,c=this._looksLikeTemplate?.(l),d=typeof l=="string"&&!c?l:void 0,u=d?this.hass?.states?.[d]:void 0,p=u?xi(u):!1;return o||p?g`
            <div class="form-row">
              <ha-selector
                .hass=${this.hass}
                  ...
                  <div class="editor-field-wrapper">
                    ${this._isTemplateMode("remote_entity",e?.remote_entity)?g`
                            <div class="grow-children">
                              ...
                              >
                                <span class="form-label"
                                  >${h("editor.fields.remote_template")}</span
                                >
                                <ha-code-editor
                                  lint
                                  id="remote-template-editor"
                                  label="${h("editor.fields.remote_template")}"
                                  .hass=${this.hass}
                                  mode="jinja2"
                                  autocomplete-entities
                                ...
                                <div class="help-text">
                                  <ha-icon icon="mdi:information-outline"></ha-icon>
                                  ${h("editor.subtitles.jinja_template_remote_hint")}
                                  <pre style="margin:6px 0; white-space:pre-wrap;">
...
{% endif %}</pre>
                          ...
                          `:g`
                            <div class="grow-children">
                              <ha-generic-picker
                                ...
                                .label=${h("editor.fields.remote_entity")}
                                .valueRenderer=${r=>this._entityValueRenderer(r)}
                                .rowRenderer=${r=>this._entityRowRenderer(r)}
      ...
      `}_renderActionEditor(e,t=this._actionEditorIndex,a=!1){const s=this._actionMode??this._deriveActionMode(e),r=ra(e);return g`
        ${a?g`
                <div
        ...
        <div class="form-row form-row-multi-column">
          <div class="grow-children">
            <div class="editor-field-wrapper">
              ${this._isTemplateMode("placement",r)?g`
                      <div class="grow-children" style="flex-direction: column;">
                        ...
                        <ha-code-editor
                          ...
                          .value=${typeof e?.placement=="string"?e.placement:typeof e?.in_menu=="string"?e.in_menu:typeof r=="string"?r:""}
                          @value-changed=${n=>this._updateActionProperty("placement",n.detail.value)}
                        ></ha-code-editor>
                      </div>
                      <div class="field-actions">
                    ...
                    `:g`
                      <div class="grow-children">
                        <ha-selector
                          ...
                          .selector=${{select:{mode:"dropdown",options:[{value:"chip",label:h("editor.placements.chip")},{value:"menu",label:h("editor.placements.menu")},{value:"hidden",label:h("editor.placements.hidden")},{value:"replace_search",label:h("editor.placements.replace_search")},{value:"replace_power",label:h("editor.placements.replace_power")},{value:"replace_mute",label:h("editor.placements.replace_mute")},{value:"replace_favorite",label:h("editor.placements.replace_favorite")}]}}}
                          .value=${r}
        ...
        ${r==="hidden"&&(!e?.card_trigger||e?.card_trigger==="none")&&s!=="sync_selected_entity"&&s!=="select_entity"?g`
                <div class="help-text">
                        ...
                        <div class="form-row">
                          ...
                          >
                            ...
                            <ha-code-editor
                              ...
                              .hass=${this.hass}
                              mode="yaml"
                              .value=${this._yamlDraft!==void 0?this._yamlDraft:e?.service_data?Bh(e.service_data):""}
                              @value-changed=${n=>{if(this._yamlDraft!==n.detail.value){this._yamlDraft=n.detail.value;try{if(this._yamlDraft.trim()==="")this._yamlError=null,this._updateActionProperty("service_data",{});else{const o=nh(this._yamlDraft);o&&typeof o=="object"?(this._yamlError=null,this._updateActionProperty("service_data",o)):this._yamlError="Invalid YAML"}}catch(o){this._yamlError=o.message}}}}
                            ></ha-code-editor>
      ...
      <div class="entity-options-menu ${a?"chips-in-menu":""} ${s?"grid-menu":"entity-options-scroll"}" style="${s?"":"display:flex; flex-direction:column;"}">
        ${r(h("card.menu.more_info"),"mdi:information-outline",()=>{const n=this._getResolvedEntitiesForCurrentChip();n.length===1?(this._openMoreInfoForEntity(n[0]),this._showEntityOptions=!1):this._showResolvedEntities=!0,this.requestUpdate()})}
        ${r(h("common.search"),"mdi:magnify",()=>{this._showSearchSheetInOptions()})}

        ${Array.isArray(e)&&e.length>0?r(h("card.menu.source"),"mdi:import",()=>this._openSourceList()):v}
        
        ${this._canShowTransferQueueOption()?r(h("card.menu.transfer_queue"),"mdi:swap-horizontal",()=>this._openTransferQueue()):v}
        
        ${this._renderGroupingMenuOption(s)}
        
        ${this._hasRemoteControlSupport()?r(h("card.menu.remote_controls"),"mdi:remote",()=>this._openRemoteControl()):v}
        
        ${this._alwaysCollapsed?v:r(h(this._lyricsActive?"card.menu.hide_lyrics":"card.menu.show_lyrics"),"mdi:script-text-outline",()=>{this._lyricsActive=!this._lyricsActive,this._lyricsActive||(this._lastLyricsTrackId=null,this._lastLyricsEntityId=null,this._lastLyricsArtist=null,this._lastLyricsTitle=null),this._showEntityOptions=!1,this.requestUpdate()})}
        
        ${t.length?g`
          ${t.map(({action:n,idx:o})=>{const l=this._getActionLabel(n);return g`
                <button
                  class="entity-options-item menu-action-item"
                  @click=${()=>this._onMenuActionClick(o)}
                >
                  ${n.icon?g`
                    <ha-icon
    ...
    `}_renderGroupingMenuOption(e=!1){if(this.entityIds.length<=1)return v;const t=this.entityIds.reduce((o,l,c)=>{const d=this._getGroupingEntityId(c),u=this.hass.states[d];return o+(this._isGroupCapable(u)?1:0)},0),a=this._getGroupingEntityId(this._selectedIndex),s=this.hass.states[a],r=this.currentEntityId,n=this._getGroupKey(r)!==r;return t>1&&this._isGroupCapable(s)&&!n?e?g`
      ...
      `;const f=[...o].sort((y,b)=>{if(n){if(y.id===t)return-1;if(b.id===t)return 1}else{if(y.id===c)return-1;if(b.id===c)return 1}return y.isBusy===b.isBusy?0:y.isBusy?1:-1});return g`
      ...
      <div style="display:flex; align-items:center; gap:8px; margin-bottom:12px;">
        ...
        `:v}
        <button class="entity-options-item"
          @click=${()=>n?this._ungroupAll():this._groupAll()}
          style="flex:0 0 auto; min-width:140px; text-align:center; margin-left:auto;">
          ${h(n?"card.grouping.ungroup_all":"card.grouping.group_all")}
        </button>
      </div>
      <div class="group-list-scroll ${e?"grid-menu":""}">
        ${f.length===0?g`
          <div class="entity-options-item" style="padding:12px; opacity:0.75; text-align:center;">
            ${h("card.grouping.no_players")}
          </div>
        `:g`
          <div class="${e?"grid-menu-items":""}">
            ${f.map(y=>{const b=y.id,k=y.groupId,w=(Array.isArray(r?.attributes?.group_members)?r.attributes.group_members:[]).includes(k),E=this.getChipName(b),A=y.isBusy,C=y.busyLabel,M=this.entityIds.indexOf(b),j=this._getVolumeEntity(M)||k,F=this.hass.states[j],I=j?.startsWith&&j.startsWith("remote."),T=Number(F?.attributes?.volume_level||0),N=b===t,R=!N,V=b===c,J=t?this.getChipName(t):h("card.grouping.master");let ee=h(n?N?"card.grouping.master":w?"card.grouping.joined":"card.grouping.available":V?"card.grouping.current":"card.grouping.available");if(A&&(ee=C||"Unavailable"),e){const B=A||!R,L=w?h("card.grouping.unjoin_from").replace("{master}",J):h("card.grouping.join_with").replace("{master}",J);return g`
                  <button class="entity-options-item menu-action-item group-toggle-btn ${!R||w?"grid-active":""}" 
                    ?disabled=${B}
                    @click=${()=>!B&&this._toggleGroup(b)}
                    title=${A?h("card.grouping.unavailable"):R?L:ee}>
                    <ha-icon class="menu-action-icon" icon=${N?"mdi:star":w?"mdi:speaker-multiple":"mdi:speaker"}></ha-icon>
                    <span class="menu-action-label">${E}</span>
                  </button>
                `}return g`
                    ...
                    ">
                      <div style="flex:1; min-width:120px;">
                        ...
                        <div style="font-size:0.8em; opacity:0.7; text-align:left;">${ee}</div>
                      </div>
                      <div style="flex:1.8;display:flex;align-items:center;gap:4px;margin:0 6px; min-width:160px;">
                        ${I?g`
                            <div class="vol-stepper" style="display:flex;align-items:center;gap:4px;">
                              <button @click=${()=>this._onGroupVolumeStep(j,-1)} title="${h("common.vol_down")}" style="background:none;border:none;padding:0;width:28px;height:28px;display:flex;align-items:center;justify-content:center;color:inherit;">
                                <ha-icon icon="mdi:minus"></ha-icon>
                              </button>
                              <button @click=${()=>this._onGroupVolumeStep(j,1)} title="${h("common.vol_up")}" style="background:none;border:none;padding:0;width:28px;height:28px;display:flex;align-items:center;justify-content:center;color:inherit;">
                          ...
                          `:g`
                            <div class="volume-slider-container grouping-vol-slider-container" style="flex:1; padding: 0 4px; position: relative; display: flex; align-items: center;">
                              <div class="volume-percentage-indicator ${this._volumeDraggingEntity===b?"visible":""}" style="left: calc(13px + ${this._dragVolume} * (100% - 26px))">
                              ...
                              <input
                                ...
                                step="0.01"
                                .value=${T}
                                @mousedown=${B=>this._onVolumeDragStart(B,b)}
                                @touchstart=${B=>this._onVolumeDragStart(B,b)}
                                @input=${B=>this._onVolumeInput(B)}
                                @mouseup=${B=>this._onVolumeDragEnd(B)}
                                @touchend=${B=>this._onVolumeDragEnd(B)}
                                @change=${B=>this._onGroupVolumeChange(b,j,B)}
                                title="${h("common.volume")}"
                      ...
                      ${R?g`
                            <button class="group-toggle-btn"
                                    @click=${()=>!A&&this._toggleGroup(b)}
                                    title=${A?h("card.grouping.unavailable"):w?h("card.grouping.unjoin_from").replace("{master}",J):h("card.grouping.join_with").replace("{master}",J)}
    ...
    `}_renderTransferQueueSheet(){const e=this._isGridMode,t=this._getTransferQueueTargets();return g`
      <div class="entity-options-header">
        ...
        <div class="entity-options-divider"></div>
        ${e?v:g`<div class="entity-options-title" style="margin-bottom:12px;">${h("card.menu.transfer_to")}</div>`}
      </div>
      <div class="entity-options-scroll ${e?"grid-menu":""}">
        ${t.length?g`
          <div class="${e?"grid-menu-items":"transfer-queue-list"}">
            ${t.map(a=>e?g`
                  <button class="entity-options-item menu-action-item" 
                    ?disabled=${this._transferQueuePendingTarget===a.maEntityId}
                    @click=${()=>this._transferQueueTo(a)}>
                    <ha-icon class="menu-action-icon" .icon=${a.icon}></ha-icon>
                    <span class="menu-action-label">${a.name}</span>
                  </button>
                `:g`
                <button
                  ...
                  ?disabled=${this._transferQueuePendingTarget===a.maEntityId}
                  @click=${()=>this._transferQueueTo(a)}>
                  <ha-icon .icon=${a.icon} style="margin-right:4px;"></ha-icon>
                  <div style="display:flex;flex-direction:column;align-items:flex-start;">
                    <div>${a.name}</div>
                    <div style="font-size:0.82em;opacity:0.7;">${a.subtitle}</div>
                  </div>
                  ${a.state?g`<div style="margin-left:auto;font-size:0.82em;opacity:0.7;text-transform:capitalize;">${a.state}</div>`:v}
                </button>
              `)}
          </div>
        `:g`
    ...
    `}_renderResolvedEntitiesSheet(){const e=this._isGridMode;return g`
      <div class="entity-options-header">
        ...
        <div class="entity-options-resolved-entities" style="margin-top:12px;">
          ${e?v:g`<div class="entity-options-title">${h("card.menu.select_entity")}</div>`}
          <div class="entity-options-resolved-entities-list ${e?"grid-menu":""}">
            ${this._getResolvedEntitiesForCurrentChip().map(t=>{const a=this.hass?.states?.[t],s=a?.attributes?.friendly_name||t,r=a?.attributes?.icon||"mdi:help-circle",n=this._selectedIndex,o=this.entityObjs[n];let l="Main Entity",c=!1;if(o){const d=this._getActualResolvedMaEntityForState(n),u=this._getVolumeEntity(n);c=(this._getActivePlaybackEntityForIndex(n)||o.entity_id)===t,t===d&&d!==o.entity_id?l="Music Assistant Entity":t===u&&u!==o.entity_id&&u!==d&&(l="Volume Entity")}return e?g`
            <button class="entity-options-item menu-action-item" @click=${()=>{this._openMoreInfoForEntity(t),this._showEntityOptions=!1,this._showResolvedEntities=!1,this.requestUpdate()}}>
              <ha-icon class="menu-action-icon" .icon=${r}></ha-icon>
              <span class="menu-action-label">${c?`${s} (Active)`:s}</span>
            </button>
          `:g`
                <button class="entity-options-item" @click=${()=>{this._openMoreInfoForEntity(t),this._showEntityOptions=!1,this._showResolvedEntities=!1,this.requestUpdate()}}>
                  <ha-icon .icon=${r} style="margin-right: 8px;"></ha-icon>
                  <div style="display: flex; flex-direction: column; align-items: flex-start;">
                    <div>${c?`${s} (Active)`:s}</div>
    ...
    `}async _fetchLyrics(){if(!this._lyricsActive||this._isIdle||this.isAnyMenuOpen){this._fetchingLyrics=!1,this.requestUpdate();return}this._lyricsError=!1;let e=this.config.lyrics_source||"mass_lrclib";if(this.hass?.user?.is_admin!==!0&&e!=="lrclib")if(e==="mass"){console.warn(`YAMP: ${this.localize("lyrics.admin_only_mass")}`);const u=new Event("hass-notification",{bubbles:!0,composed:!0});u.detail={message:this.localize("lyrics.admin_only_mass")},this.dispatchEvent(u),this._fetchingLyrics=!1,this._lyricsError=!0,this.requestUpdate();return}else console.log(`YAMP: ${this.localize("lyrics.fallback_to_lrclib_non_admin")}`),e="lrclib";const t=this.metadataStateObj||this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj;if(!t){this._massLyrics=[],this.requestUpdate();return}const a=t.attributes.media_artist,s=t.attributes.media_title,r=t.attributes.media_album_name,n=t.attributes.media_duration,o=t.attributes.media_content_id,l=o?`${o}:${a}:${s}`:`${a}:${s}`;if(this._fetchingLyrics&&this._fetchingCacheKey===l)return;if(this._lyricsCache.has(l)){const u=this._lyricsCache.get(l);this._lyricsCache.delete(l),this._lyricsCache.set(l,u),this._massLyrics=u,this._fetchingLyrics=!1,this.requestUpdate();return}const c=Symbol();this._currentFetchToken=c,this._fetchingLyrics=!0,this._fetchingCacheKey=l,this._massLyrics=[],this.requestUpdate();let d;try{if(e==="mass")d=await this._getMassLyrics(t,c);else if(e==="lrclib")d=await this._getLrclibLyrics(a,s,r,n,c);else{const u=this._getMassLyrics(t,c),p=this._getLrclibLyrics(a,s,r,n,c),_=e==="mass_lrclib",m=async(b,k)=>{const w=await b;if(this._currentFetchToken!==c)return null;if(w&&w.length>0){const E=k==="mass"&&_||k==="lrclib"&&!_;(!this._massLyrics||this._massLyrics.length===0||E)&&(this._massLyrics=w||[],this._fetchingLyrics=!1,this.requestUpdate())}return w},[f,y]=await Promise.all([m(u,"mass"),m(p,"lrclib")]);if(this._currentFetchToken!==c)return;_?d=f&&f.length>0?f:y:d=y&&y.length>0?y:f}if(this._currentFetchToken===c){if(this._massLyrics=d||[],d&&d.length>0){if(this._lyricsCache.size>=kp){const u=this._lyricsCache.keys().next().value;this._lyricsCache.delete(u)}this._lyricsCache.set(l,d)}else d===null&&(this._lyricsError=!0);this._fetchingLyrics=!1,this._fetchingCacheKey=null,this.requestUpdate()}}catch(u){this._currentFetchToken===c&&(console.error("YAMP: Failed to fetch lyrics:",u),this._lyricsError=!0,this._fetchingLyrics=!1,this._fetchingCacheKey=null,this.requestUpdate())}}async _getMassLyrics(e,t){if(this._hasMassQueueIntegration===!1)return[];if(!this._massQueueAvailable){if(this._massQueueAvailable=await this._isMassQueueIntegrationAvailable(this.hass),this._hasMassQueueIntegration=this._massQueueAvailable,!this._massQueueAvailable)return[];if(this._currentFetchToken!==t)return[]}try{const a=this._getSearchEntityId(this._selectedIndex),s=await this._resolveTemplateAtActionTime(a,this.currentEntityId),r=await Si(this.hass,s);if(!r)return[];const n=e.attributes.media_content_id;if(!n||!n.includes("://"))return[];const o={type:"call_service",domain:"mass_queue",service:"send_command",service_data:{command:"music/item_by_uri",data:{uri:n},...r&&r!=="auto"&&{config_entry_id:r}},return_response:!0},l=await this.hass.connection.sendMessagePromise(o);if(this._currentFetchToken!==t)return[];const c=l?.response?.response||l?.response||l?.result;if(!c)return[];const d={type:"call_service",domain:"mass_queue",service:"send_command",service_data:{command:"metadata/get_track_lyrics",data:{track:c},...r&&r!=="auto"&&{config_entry_id:r}},return_response:!0},u=await this.hass.connection.sendMessagePromise(d);if(this._currentFetchToken!==t)return[];const p=u?.response?.response||u?.response||u?.result;if(p){let _="";return Array.isArray(p)?_=p[1]||p[0]||"":typeof p=="string"?_=p:typeof p=="object"&&(_=p.lyrics||p.text||""),_?bn(_):[]}}catch(a){console.warn("YAMP: MA Lyrics fetch failed:",a)}return[]}async _getLrclibLyrics(e,t,a,s,r){if(!e||!t)return[];const n=this._cleanTrackMetadata(e),o=this._cleanTrackMetadata(t),l=a?this._cleanTrackMetadata(a):"";try{const c={"Lrclib-Client":"yet-another-media-player/2026.9.0 (https://github.com/jianyu-li/yet-another-media-player)"};let d=`https://lrclib.net/api/get?artist_name=${encodeURIComponent(n)}&track_name=${encodeURIComponent(o)}`;l&&(d+=`&album_name=${encodeURIComponent(l)}`),s&&(d+=`&duration=${Math.round(s)}`);let u=await fetch(d,{headers:c});if(this._currentFetchToken!==r)return[];if(!u.ok&&u.status!==404)throw new Error(`LRCLIB error: ${u.status}`);let p=null;if(u.ok)p=await u.json();else{const _=`https://lrclib.net/api/search?artist_name=${encodeURIComponent(n)}&track_name=${encodeURIComponent(o)}`,m=await fetch(_,{headers:c});if(this._currentFetchToken!==r)return[];if(m.ok){const f=await m.json();f&&f.length>0&&(p=f[0])}}if(p){if(p.instrumental)return[{time:null,text:h("lyrics.instrumental")||"Instrumental Track"}];const _=p.syncedLyrics||p.plainLyrics||"";return _?bn(_):[]}}catch(c){console.warn("YAMP: LRCLIB Lyrics fetch failed:",c)}return[]}updated(e){this._updateHostAttributes(),this._idleImageTemplate&&e.has("hass")&&(this._idleImageTemplateNeedsResolve=!0);const t=JSON.stringify(this._getTemplateContext());if(this._syncTemplateSubscriptions("action_in_menu",t,this.config?.actions),this._syncTemplateSubscriptions("always_collapsed",t,this.config?.always_collapsed),this._syncTemplateSubscriptions("control_layout",t,this.config?.control_layout),this._syncTemplateSubscriptions("card_height",t,this.config?.card_height),this._syncEntityTemplateSubscriptions("ma",t),this._syncEntityTemplateSubscriptions("vol",t),this._syncEntityTemplateSubscriptions("remote",t),this._syncEntityTemplateSubscriptions("hidden_controls",t),e.has("_selectedIndex")&&(this._lastMediaTitle=null,this._searchResultsByType={},this._upcomingFilterActive&&(this._searchResults=[],this._refreshQueue({delayMs:50}))),(e.has("_selectedIndex")||e.has("hass"))&&this._updateTransferQueueAvailability({refresh:!1}),(e.has("hass")||e.has("config"))&&this._updateArtworkAspectRatios(),this.hass&&this._hasMassQueueIntegration===null&&!this._checkingMassQueueIntegration&&(this._checkingMassQueueIntegration=!0,this._isMassQueueIntegrationAvailable(this.hass).then(c=>{this._hasMassQueueIntegration=c,c&&(this._massQueueAvailable=this._massQueueAvailable||c)}).catch(()=>{this._hasMassQueueIntegration=!1}).finally(()=>{this._checkingMassQueueIntegration=!1,this.requestUpdate()})),this.hass&&this.entityIds){if(this._upcomingFilterActive){const p=this._getEntityForPurpose(this._selectedIndex,"metadata");if(p){const _=this.hass.states[p]?.attributes?.media_title;if(_&&_!==this._lastMediaTitle){const m=e.has("_selectedIndex");if(this._lastMediaTitle=_,this._upcomingFilterActive&&!m){const f=Date.now();this._latestManualShiftTime&&f-this._latestManualShiftTime<4e3||this._advanceQueueInUI(null,!1),this._refreshQueue({delayMs:2e4})}}}}const c=Date.now();for(let p=0;p<this.entityIds.length;p++){const _=this.entityIds[p],m=this.entityObjs[p];if(!m)continue;const f=m.entity_id,y=this._getActualResolvedMaEntityForState(p),b=this.hass.states[f]?.state,k=this._playerStateCache[f];if(b==="playing"?(this._playTimestamps[f]=c,this._lastActiveEntityIdByChip[p]=f):k==="playing"&&b!=="playing"&&(this._playTimestamps[f]=c),this._playerStateCache[f]=b,y&&y!==f){const E=this.hass.states[y]?.state,A=this._playerStateCache[y];E==="playing"?(this._playTimestamps[y]=c,this._lastActiveEntityIdByChip[p]=y):A==="playing"&&E!=="playing"&&(this._playTimestamps[y]=c),this._playerStateCache[y]=E}const w=this._getEntityForPurpose(p,"sorting");w&&this.hass.states[w]?.state==="playing"&&(this._playTimestamps[_]=c)}if(this._manualSelect&&this._pinnedIndex===null&&this._manualSelectPlayingSet){for(const p of[...this._manualSelectPlayingSet]){const _=this.hass.states[p];this._isEntityPlaying(_)||this._manualSelectPlayingSet.delete(p)}for(const p of this.entityIds){const _=this.hass.states[p];if(this._isEntityPlaying(_)&&!this._manualSelectPlayingSet.has(p)){this._manualSelect=!1,this._manualSelectPlayingSet=null;break}}}if(this._updateIdleState(e),!this._manualSelect&&!this.isAnyMenuOpen){const p=this.sortedEntityIds;if(p.length>0){let _=p[0];const m=_?(this.groupedSortedEntityIds||[]).find(A=>A.includes(_)):null;if(m&&m.length>1){const A=this._getActualGroupMaster(m);A&&(_=A)}const f=this.entityIds.indexOf(_),y=f>=0?this._getEntityForPurpose(f,"sorting"):null,b=y?this.hass.states[y]:null,k=this._isCurrentEntityPlaying(),w=this.entityObjs[this._selectedIndex]?.disable_auto_select,E=k&&!w;(this._isEntityPlaying(b)||w)&&this.entityIds[this._selectedIndex]!==_&&(!this._idleTimeout||!this._hasSeenPlayback)&&!E&&!this.entityObjs[f]?.disable_auto_select&&(this._selectedIndex=f)}}const d=this.entityIds[this._selectedIndex],u=d?(this.groupedSortedEntityIds||[]).find(p=>p.includes(d)):null;if(u&&u.length>1){const p=this._getActualGroupMaster(u);if(p&&p!==d){const _=this.entityIds.indexOf(p);_>=0&&!this.entityObjs[_]?.disable_auto_select&&(this._selectedIndex=_,this._lastGroupingMasterId=p)}}this._ensureResolvedMaForIndex(this._selectedIndex),this._ensureResolvedVolForIndex(this._selectedIndex),this._ensureResolvedHiddenControlsForIndex(this._selectedIndex),this._updateSelectedEntityHelper(),this._handleSelectEntityFromHelper()}this._handleVolumeOverlayDetection(e),e.has("_lyricsActive")&&this._adaptiveText&&(this._setAdaptiveTextVars(this._currentTextScale,void 0,this._currentDetailsScale),this._updateMarquee());const a=this.shadowRoot?.querySelector(".card-lower-content");this._lyricsActive||a&&a.offsetHeight>50&&(this._lastNonLyricsLowerContentHeight=a.offsetHeight);const s=this.shadowRoot?.querySelector(".details"),r=s||this.shadowRoot?.querySelector(".progress-bar-container:not(.alternate)")||this.shadowRoot?.querySelector(".controls-row")||this.shadowRoot?.querySelector(".volume-row");let n=0;if(a&&r&&a.contains(r)&&(n=a.offsetHeight-r.offsetTop),n<=0){s&&(n+=s.offsetHeight);const c=this.shadowRoot?.querySelector(".progress-bar-container:not(.alternate)");c&&(n+=c.offsetHeight);const d=this.shadowRoot?.querySelector(".controls-row");d&&(n+=d.offsetHeight);const u=this.shadowRoot?.querySelector(".volume-row");u&&(n+=u.offsetHeight)}if(n>30&&this._lowerControlsHeight!==n&&(this._lowerControlsHeight=n,this._lyricsActive&&this.requestUpdate()),this._lyricsActive){const c=this.metadataStateObj||this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj,d=c?.attributes?.media_content_id||null,u=c?.attributes?.media_artist||null,p=c?.attributes?.media_title||null,_=this.currentActivePlaybackEntityId||this.currentEntityId||null,m=!!(d||u||p),f=d!==this._lastLyricsTrackId||u!==this._lastLyricsArtist||p!==this._lastLyricsTitle||_!==this._lastLyricsEntityId;m&&f&&!this._isIdle&&!this.isAnyMenuOpen?(this._lastLyricsTrackId=d,this._lastLyricsArtist=u,this._lastLyricsTitle=p,this._lastLyricsEntityId=_,this._fetchingLyrics=!0,this._lyricsError=!1,this._lyricsFetchTimeout&&clearTimeout(this._lyricsFetchTimeout),this._lyricsFetchTimeout=setTimeout(()=>{this._fetchLyrics(),this._lyricsFetchTimeout=null},500)):!m&&f&&(this._lastLyricsTrackId=null,this._lastLyricsArtist=null,this._lastLyricsTitle=null,this._lastLyricsEntityId=_,this._lyricsFetchTimeout&&clearTimeout(this._lyricsFetchTimeout),this._massLyrics=[],this._fetchingLyrics=!1,this._lyricsError=!1,this.requestUpdate())}super.updated?.(e),this._progressTimer&&(clearInterval(this._progressTimer),this._progressTimer=null);const o=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj;if(this._isEntityPlaying(o)&&o.attributes.media_duration&&(this._progressTimer=setInterval(()=>{this.requestUpdate()},500)),this._alwaysCollapsed&&this._expandOnSearch&&this._showSearchInSheet){this._prevCollapsed!==!1&&(this._prevCollapsed=!1,this._notifyResize());return}const l=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;if(this._prevCollapsed!==l&&(this._prevCollapsed=l,this._notifyResize()),this._addGrabScroll(".chip-row"),this._addGrabScroll(".action-chip-row"),this._addGrabScroll(".search-filter-chips"),this._addVerticalGrabScroll(".floating-source-index"),this._lastRenderedCollapsed&&!this._lastRenderedHideControls){const c=this.renderRoot?.querySelector(".card-lower-content");if(c){const d=c.offsetHeight;if(d&&d>0){const u=typeof this.config?.card_height=="string"&&(this.config.card_height.includes("{{")||this.config.card_height.includes("{%")||this.config.card_height.trim().startsWith("[[["))?this._cardHeightResolveCache?.card?.value:this.config?.card_height,p=Number(u);Number.isFinite(p)&&p>0?(!this._collapsedBaselineHeight||d<this._collapsedBaselineHeight-1)&&(this._collapsedBaselineHeight=d):this._collapsedBaselineHeight=d}}}if(this._showSearchInSheet){const c=this._alwaysCollapsed&&this._expandOnSearch?300:200;setTimeout(()=>{const d=()=>{const _=this.renderRoot.querySelector("#search-input-box");return _?(_.focus(),this._searchInputAutoFocused=!0,!0):!1};!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&(d()||setTimeout(()=>{this._showSearchInSheet&&!this._disableSearchAutofocus&&!this._searchInputAutoFocused&&d()},200));const u=this._getVisibleSearchFilterClasses().join(",");if((!this._searchLoading||u)&&this._lastSearchChipClasses!==u){const _=this.renderRoot.querySelector(".search-filter-chips");_&&(_.scrollLeft=0);const m=this.renderRoot.querySelector(".entity-options-overlay");m&&(m.scrollTop=0);const f=this.renderRoot.querySelector(".entity-options-sheet");f&&(f.scrollTop=0),this._lastSearchChipClasses=u}const p=this.renderRoot.querySelector("#search-filter-chip-row");p&&(p.scrollWidth>p.clientWidth+2?p.style.justifyContent="flex-start":p.style.justifyContent="center")},c)}this._showSourceList&&setTimeout(()=>{const c=this.renderRoot.querySelector(".entity-options-overlay");c&&(c.scrollTop=0)},0),this.updateComplete.then(()=>this._updateMarquee())}_toggleSourceMenu(){this._showSourceMenu=!this._showSourceMenu,this._showSourceMenu?(this._manualSelect=!0,setTimeout(()=>{this._shouldDropdownOpenUp=!0,this.requestUpdate(),this._addSourceDropdownOutsideHandler()},0)):(this._manualSelect=!1,this._removeSourceDropdownOutsideHandler())}_addSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler||(this._sourceDropdownOutsideHandler=e=>{const t=this.renderRoot.querySelector(".source-dropdown"),a=this.renderRoot.querySelector(".source-menu-btn"),s=e.composedPath?e.composedPath():[];t&&s.includes(t)||a&&s.includes(a)||(this._showSourceMenu=!1,this._manualSelect=!1,this._removeSourceDropdownOutsideHandler(),this.requestUpdate())},window.addEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.addEventListener("touchstart",this._sourceDropdownOutsideHandler,!0))}_removeSourceDropdownOutsideHandler(){this._sourceDropdownOutsideHandler&&(window.removeEventListener("mousedown",this._sourceDropdownOutsideHandler,!0),window.removeEventListener("touchstart",this._sourceDropdownOutsideHandler,!0),this._sourceDropdownOutsideHandler=null)}_selectSource(e){const t=this.currentEntityId;!t||!e||(this.hass.callService("media_player","select_source",{entity_id:t,source:e}),this._closeEntityOptions())}_onPinClick(e){e.stopPropagation(),this._manualSelect=!1,this._pinnedIndex=null,this._manualSelectPlayingSet=null}_onChipClick(e){if(this._holdToPin&&this._justPinned){this._justPinned=!1;return}if(this._selectedIndex=e,this._isIdle){const t=this.entityIds[e],a=this._getEntityForPurpose(e,"sorting"),s=this.hass?.states?.[a]||this.hass?.states?.[t];this._isEntityPlaying(s)&&(this._setIdleState(!1),this._hasSeenPlayback=!0,this._idleTimeout&&(clearTimeout(this._idleTimeout),this._idleTimeout=null),this._resetIdleScreen())}if(this._lastActiveEntityId=null,clearTimeout(this._manualSelectTimeout),this._holdToPin)if(this._pinnedIndex!==null)this._manualSelect=!0;else{this._manualSelect=!0,this._manualSelectPlayingSet=new Set;for(const t of this.entityIds){const a=this.hass?.states?.[t];this._isEntityPlaying(a)&&this._manualSelectPlayingSet.add(t)}}else this._manualSelect=!0,this._pinnedIndex=e;this.requestUpdate()}_pinChip(e){this._justPinned=!0,clearTimeout(this._manualSelectTimeout),this._manualSelectPlayingSet=null,this._pinnedIndex=e,this._manualSelect=!0,this.requestUpdate()}async _onActionChipClick(e){const t=this.config.actions[e];t&&await this._handleAction(t)}async _handleAction(e){if(!e)return;if(e.menu_item){switch(this._quickMenuInvoke=!0,e.menu_item){case"more-info":this._openMoreInfo(),this._showEntityOptions=!1,this.requestUpdate();break;case"group-players":this._showEntityOptions=!0,this._showGrouping=!0,this.requestUpdate();break;case"search":this._openQuickSearchOverlay();break;case"search-recently-played":this._showEntityOptions=!0,this._showSearchSheetInOptions("recently-played"),setTimeout(()=>{this._notifyResize()},0);break;case"search-next-up":this._showEntityOptions=!0,this._showSearchSheetInOptions("next-up"),setTimeout(()=>{this._notifyResize()},0);break;case"source":this._showEntityOptions=!0,this._showSourceList=!0,this._showGrouping=!1,this.requestUpdate();break;case"transfer-queue":this._showEntityOptions=!0,this._openTransferQueue();break;case"main-menu":this._showGrouping=!1,this._showSourceList=!1,this._showSearchInSheet=!1,this._showResolvedEntities=!1,this._showTransferQueue=!1,await this._openEntityOptions();break}return}if(typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"){let r=(typeof e.navigation_path=="string"?e.navigation_path:e.path||"").trim();const n=e.navigation_new_tab===!0,o=this._getTemplateContext();let l=null;n&&(l=vt(this.hass,r,o)),l!=null?this._handleNavigate(l,n):(r=await ls(this.hass,r,o),this._handleNavigate(r,n));return}if(e.action==="toggle_lyrics"){this._lyricsActive=!this._lyricsActive,this.requestUpdate();return}if(e.action==="remote_control"){this._openRemoteControl();return}if(e.action==="prev_entity"||e.action==="next_entity"){const r=this.sortedEntityIds;if(r&&r.length>0){const n=this.entityIds[this._selectedIndex],o=r.indexOf(n);if(o!==-1){let l;if(e.action==="prev_entity"?l=Math.max(0,o-1):l=Math.min(r.length-1,o+1),l!==o){const c=r[l],d=this.entityIds.indexOf(c);d!==-1&&d!==this._selectedIndex&&this._onChipClick(d)}}}return}if(!e.service)return;const[t,a]=e.service.split(".");let s={...e.service_data||{}};if(t==="script"&&e.script_variable===!0){const r=this.currentEntityId,n=this._getSearchEntityId(this._selectedIndex),o=await this._resolveTemplateAtActionTime(n,r),l=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex),c=await this._resolveTemplateAtActionTime(l,r);(s.entity_id==="current"||s.entity_id==="$current"||s.entity_id==="this")&&delete s.entity_id,s.yamp_entity=o||r,s.yamp_main_entity=r,s.yamp_playback_entity=c}else if(!(t==="script"&&e.script_variable===!0)&&(s.entity_id==="current"||s.entity_id==="$current"||s.entity_id==="this"||!s.entity_id))if(t==="music_assistant"){const r=this._getSearchEntityId(this._selectedIndex);s.entity_id=await this._resolveTemplateAtActionTime(r,this.currentEntityId)}else if(t==="media_player"){const r=this.currentActivePlaybackEntityId||this._getPlaybackEntityId(this._selectedIndex);s.entity_id=await this._resolveTemplateAtActionTime(r,this.currentEntityId)}else s.entity_id=this.currentEntityId;this.hass.callService(t,a,s)}_onTapAreaPointerDown(e){this.isAnyMenuOpen||e.composedPath().some(t=>t.tagName==="BUTTON"||t.tagName==="HA-ICON"||t.tagName==="INPUT"||t.classList&&t.classList.contains("clickable-artist")||t.classList&&t.classList.contains("details")&&!this._isIdle)||(this._gestureActive=!0,this._gestureStartTime=Date.now(),this._gestureStartX=e.clientX,this._gestureStartY=e.clientY,this._gestureHoldTriggered=!1,this._gestureTapArea=e.currentTarget,this._cardTriggers?.hold&&(this._gestureHoldTimer=setTimeout(()=>{this._gestureActive&&(this._gestureHoldTriggered=!0,this._showGestureFeedback("hold",this._gestureStartX,this._gestureStartY),this._handleAction(this._cardTriggers.hold))},Vo)))}_onTapAreaPointerMove(e){if(this.isAnyMenuOpen||!this._gestureActive)return;const t=Math.abs(e.clientX-this._gestureStartX),a=Math.abs(e.clientY-this._gestureStartY);(t>Xt||a>Xt)&&clearTimeout(this._gestureHoldTimer)}_onTapAreaPointerUp(e){if(this.isAnyMenuOpen||!this._gestureActive||(this._gestureActive=!1,clearTimeout(this._gestureHoldTimer),this._gestureHoldTriggered)||Date.now()-this._gestureStartTime>Vo)return;const t=e.clientX-this._gestureStartX,a=e.clientY-this._gestureStartY,s=Math.abs(t),r=Math.abs(a);if(s>=Bo&&r<Bo){clearTimeout(this._tapTimer);const d=e.clientX,u=e.clientY;if(t<0&&this._cardTriggers?.swipe_left){this._showGestureFeedback("swipe_left",d,u),this._handleAction(this._cardTriggers.swipe_left);return}else if(t>0&&this._cardTriggers?.swipe_right){this._showGestureFeedback("swipe_right",d,u),this._handleAction(this._cardTriggers.swipe_right);return}}if(s>Xt||r>Xt)return;const n=Date.now(),o=n-(this._lastTapTime||0);this._lastTapTime=n;const l=e.clientX,c=e.clientY;o<Uo?(clearTimeout(this._tapTimer),this._cardTriggers?.double_tap&&(this._showGestureFeedback("double_tap",l,c),this._handleAction(this._cardTriggers.double_tap))):this._tapTimer=setTimeout(()=>{this._cardTriggers?.tap&&(this._showGestureFeedback("tap",l,c),this._handleAction(this._cardTriggers.tap))},$p)}_onTapAreaPointerCancel(e){this._gestureActive=!1,clearTimeout(this._gestureHoldTimer)}_onIdleTapAreaPointerDown(e){this._isIdle&&this._onTapAreaPointerDown(e)}_onIdleTapAreaPointerMove(e){this._isIdle&&this._onTapAreaPointerMove(e)}_onIdleTapAreaPointerUp(e){this._isIdle&&this._onTapAreaPointerUp(e)}_onIdleTapAreaPointerCancel(e){this._isIdle&&this._onTapAreaPointerCancel(e)}_hasGestureTriggers(){return!!(this._cardTriggers?.tap||this._cardTriggers?.hold||this._cardTriggers?.double_tap||this._cardTriggers?.swipe_left||this._cardTriggers?.swipe_right)}_getGestureStyles(e=!0){return e&&this._hasGestureTriggers()?"cursor:pointer; pointer-events:auto;":""}_showGestureFeedback(e,t,a){const s=this.shadowRoot?.querySelector(".yamp-card-inner"),r=this._gestureTapArea||this.shadowRoot?.querySelector(".card-artwork-spacer")||this.shadowRoot?.querySelector(".collapsed-artwork-container")||this.shadowRoot?.querySelector(".media-artwork-placeholder")||s;if(!r)return;const n=(r.shadowRoot||r.tagName==="YAMP-LYRICS-VIEW")&&s||r,o=n.getBoundingClientRect(),l=t-o.left,c=a-o.top,d=document.createElement("div");d.className=`gesture-ripple ${e}`,d.style.left=`${l}px`,d.style.top=`${c}px`;let u=n.querySelector(".gesture-feedback-container");u||(u=document.createElement("div"),u.className="gesture-feedback-container",n.appendChild(u)),d.addEventListener("animationend",()=>d.remove()),u.appendChild(d)}_onMenuActionClick(e){const t=this.config.actions?.[e];t&&(t.menu_item||(this._quickMenuInvoke=!0),this._onActionChipClick(e),t.menu_item||this._dismissWithAnimation())}_getActionLabel(e){if(!e)return"";if(typeof e.name=="string"&&e.name.trim()!=="")return e.name.trim();const t=!!e.icon;return e.menu_item?t?"":{search:h("card.menu.search"),"search-recently-played":h("search.recently_played"),"search-next-up":h("search.next_up"),source:h("card.menu.source"),"more-info":h("card.menu.more_info"),"group-players":h("card.menu.group_players"),"transfer-queue":h("card.menu.transfer_queue"),"main-menu":h("card.menu.main_menu")}[e.menu_item]??e.menu_item:typeof e.navigation_path=="string"&&e.navigation_path.trim()!==""||e.action==="navigate"?t?"":"Navigate":e.service?t?"":e.service:t?"":"Action"}async _onControlClick(e){const t=this._getEntityForPurpose(this._selectedIndex,"playback_control");if(!t)return;const a=this.hass?.states?.[t]||this.currentStateObj;switch(e){case"play_pause":this._isEntityPlaying(a)?(this.hass.callService("media_player","media_pause",{entity_id:t}),this._lastPlayingEntityIdByChip||(this._lastPlayingEntityIdByChip={}),this._lastPlayingEntityIdByChip[this._selectedIndex]=t,this._pauseTimestamps||(this._pauseTimestamps={}),this._pauseTimestamps[this._selectedIndex]=Date.now(),this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"paused",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)):(this.hass.callService("media_player","media_play",{entity_id:t}),this._lastPlayingEntityIdByChip&&delete this._lastPlayingEntityIdByChip[this._selectedIndex],this._pauseTimestamps&&delete this._pauseTimestamps[this._selectedIndex],this._controlFocusEntityId=t,this._optimisticPlayback={entity_id:t,state:"playing",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200));break;case"next":this._advanceQueueInUI(null,!0),this.hass.callService("media_player","media_next_track",{entity_id:t});break;case"prev":this.hass.callService("media_player","media_previous_track",{entity_id:t});break;case"stop":if(this.hass.callService("media_player","media_stop",{entity_id:t}),a){const s=t;this._optimisticPlayback={entity_id:s,state:"idle",ts:Date.now()},this.requestUpdate(),setTimeout(()=>{this._optimisticPlayback=null,this.requestUpdate()},1200)}break;case"shuffle":{const s=!!a.attributes.shuffle;this.hass.callService("media_player","shuffle_set",{entity_id:t,shuffle:!s});break}case"repeat":{let s=a.attributes.repeat||"off",r;s==="off"?r="all":s==="all"?r="one":r="off",this.hass.callService("media_player","repeat_set",{entity_id:t,repeat:r});break}case"power":{const s=this.currentEntityId,r=(this.hass?.states?.[s]||a)?.state==="off"?"turn_on":"turn_off";this.hass.callService("media_player",r,{entity_id:s});const n=this.entityObjs[this._selectedIndex];if(n&&n.sync_power){const o=this._getVolumeEntity(this._selectedIndex);o&&o!==n.entity_id&&this.hass.callService("media_player",r,{entity_id:o})}break}case"favorite":{const s=this._getFavoriteButtonEntity(),r=this.hass?.states?.[t]?.attributes?.media_content_id,n=this._isCurrentTrackFavorited(),o=await this._isMassQueueIntegrationAvailable(this.hass);if(n&&o){const l=this._getMusicAssistantState()?.entity_id;if(l)try{const c={type:"call_service",domain:"mass_queue",service:"unfavorite_current_item",service_data:{entity:l}};await this.hass.connection.sendMessagePromise(c),r&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[r]={isFavorited:!1}),this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(d=>{(d.includes("_favorites")||d==="favorites")&&delete this._searchResultsByType[d]}),this._checkingFavorites=null,this.requestUpdate()}catch(c){console.error("yamp: Failed to unfavorite current item:",c)}}else s&&(this.hass.callService("button","press",{entity_id:s}),r&&(this._favoriteStatusCache||(this._favoriteStatusCache={}),this._favoriteStatusCache[r]={isFavorited:!0},this._checkingFavorites=null,this._searchResultsByType&&Object.keys(this._searchResultsByType).forEach(l=>{(l.includes("_favorites")||l==="favorites")&&delete this._searchResultsByType[l]}),this.requestUpdate()));break}}}_onVolumeChange(e){this._suppressVolumeOverlay();const t=this._selectedIndex,a=this._getGroupingEntityId(t)||this.currentEntityId,s=this.hass.states[a],r=Number(e.target.value),n=this.entityObjs[t],o=typeof n.group_volume=="boolean"?n.group_volume:!0,l=this._isActiveChipGrouped(t);if(!o||!l){this.hass.callService("media_player","volume_set",{entity_id:this._getVolumeEntity(t),volume_level:r});return}if(this._isCurrentlyGrouped(s)){const c=this.entityObjs[t].entity_id,d=[...new Set([c,...s.attributes.group_members])],u=typeof this._groupBaseVolume=="number"?this._groupBaseVolume:Number(this.currentVolumeStateObj?.attributes.volume_level||0),p=r-u,_=new Set;for(const m of d){const f=this._resolveEntityIdxByGroupingId(m);if(f>=0&&f!==t){const w=this.entityObjs[f];if(w&&w.group_volume===!1)continue}const y=f>=0?this._getVolumeEntity(f):m;if(_.has(y))continue;_.add(y);const b=this.hass.states[y];if(!b)continue;let k=Number(b.attributes.volume_level||0)+p;k=Math.max(0,Math.min(1,k)),k=Math.round(k*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:y,volume_level:k})}this._groupBaseVolume=r}else{const c=this._getVolumeEntity(t);this.hass.callService("media_player","volume_set",{entity_id:c,volume_level:r})}}_onVolumeStep(e){this._suppressVolumeOverlay();const t=this._selectedIndex,a=this._getVolumeEntity(t);if(!a)return;const s=a.startsWith&&a.startsWith("remote."),r=this.currentVolumeStateObj;if(!r)return;if(s){this.hass.callService("remote","send_command",{entity_id:a,command:e>0?"volume_up":"volume_down"});return}const n=this._getGroupingEntityId(t)||this.currentEntityId,o=this.hass.states[n],l=this.entityObjs[t],c=typeof l.group_volume=="boolean"?l.group_volume:!0,d=this._isActiveChipGrouped(t);if(c&&d&&this._isCurrentlyGrouped(o)){const u=this.entityObjs[t].entity_id,p=[...new Set([u,...o.attributes.group_members])],_=this._getEffectiveVolumeStep()*e,m=new Set;for(const f of p){const y=this._resolveEntityIdxByGroupingId(f);if(y>=0&&y!==t){const E=this.entityObjs[y];if(E&&E.group_volume===!1)continue}const b=y>=0?this._getVolumeEntity(y):f;if(m.has(b))continue;m.add(b);const k=this.hass.states[b];if(!k)continue;let w=Number(k.attributes.volume_level||0)+_;w=Math.max(0,Math.min(1,w)),w=Math.round(w*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:b,volume_level:w})}}else{let u=Number(r.attributes.volume_level||0);u+=this._getEffectiveVolumeStep()*e,u=Math.max(0,Math.min(1,u)),u=Math.round(u*1e4)/1e4,this.hass.callService("media_player","volume_set",{entity_id:a,volume_level:u})}}_onMuteToggle(){this._suppressVolumeOverlay();const e=this._selectedIndex,t=this._getVolumeEntity(e);if(!t)return;const a=t.startsWith&&t.startsWith("remote."),s=this.currentVolumeStateObj;if(!s)return;const r=s.attributes.is_volume_muted??!1,n=s.attributes.volume_level??0;if(a){r?this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:.5}):this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});return}if(!this._supportsFeature(s,rs)){if(n>0)this._previousVolume=n,this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:0});else{const p=this._previousVolume??.5;this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:p}),this._previousVolume=null}return}const o=this._getGroupingEntityId(e)||this.currentEntityId,l=this.hass.states[o],c=this.entityObjs[e],d=typeof c.group_volume=="boolean"?c.group_volume:!0,u=this._isActiveChipGrouped(e);if(d&&u&&this._isCurrentlyGrouped(l)){const p=this.entityObjs[e].entity_id,_=[...new Set([p,...l.attributes.group_members])],m=new Set;for(const f of _){const y=this._resolveEntityIdxByGroupingId(f);if(y>=0&&y!==e){const w=this.entityObjs[y];if(w&&w.group_volume===!1)continue}const b=y>=0?this._getVolumeEntity(y):f;if(m.has(b))continue;m.add(b);const k=this.hass.states[b];k&&this._supportsFeature(k,rs)?this.hass.callService("media_player","volume_mute",{entity_id:b,is_volume_muted:!r}):(k?.attributes?.volume_level??0)>0?this.hass.callService("media_player","volume_set",{entity_id:b,volume_level:0}):this.hass.callService("media_player","volume_set",{entity_id:b,volume_level:.5})}}else this.hass.callService("media_player","volume_mute",{entity_id:t,is_volume_muted:!r})}_onVolumeDragStart(e,t="main"){if(!this.hass)return;const a=this.currentVolumeStateObj;this._groupBaseVolume=a?Number(a.attributes.volume_level||0):0,this._volumeDraggingEntity=t,this._dragVolume=Number(e.target.value)}_onVolumeDragEnd(e){this._groupBaseVolume=null,this._volumeDraggingEntity=null}_onVolumeInput(e){this._dragVolume=Number(e.target.value)}_handleVolumeOverlayDetection(e){if(this._showVolumeOverlay&&e.has("hass")&&this.hass&&!this.isAnyMenuOpen){const t=this._getVolumeEntity(this._selectedIndex),a=t?this.hass.states[t]:null,s=a?.attributes?.volume_level??null,r=a?.attributes?.is_volume_muted??!1;t!==this._lastTrackedVolEntityId?(this._lastTrackedVolumeLevel=s,this._lastTrackedVolEntityId=t):s!==null&&this._lastTrackedVolumeLevel!==null&&s!==this._lastTrackedVolumeLevel&&!this._internalVolumeChangeFlag&&!this._volumeDraggingEntity&&this._showVolumeOverlayBriefly(s,r),this._lastTrackedVolumeLevel=s}}_showVolumeOverlayBriefly(e,t){this._volumeOverlayValue=Math.round(e*100),this._volumeOverlayMuted=t,this._volumeOverlayActive=!0,this._volumeOverlayTimer&&clearTimeout(this._volumeOverlayTimer),this._volumeOverlayTimer=setTimeout(()=>{this._volumeOverlayActive=!1,this._volumeOverlayTimer=null,this.requestUpdate()},3e3),this.requestUpdate()}_suppressVolumeOverlay(){this._internalVolumeChangeFlag=!0,this._internalVolumeSuppressTimer&&clearTimeout(this._internalVolumeSuppressTimer),this._internalVolumeSuppressTimer=setTimeout(()=>{this._internalVolumeChangeFlag=!1,this._internalVolumeSuppressTimer=null},1500)}_getVolumeOverlayIcon(){return this._volumeOverlayMuted||this._volumeOverlayValue===0?"mdi:volume-off":this._volumeOverlayValue<20?"mdi:volume-low":this._volumeOverlayValue<50?"mdi:volume-medium":"mdi:volume-high"}_dismissVolumeOverlay(){this._volumeOverlayActive=!1,this._volumeOverlayTimer&&(clearTimeout(this._volumeOverlayTimer),this._volumeOverlayTimer=null),this.requestUpdate()}_onGroupVolumeChange(e,t,a){this._suppressVolumeOverlay();const s=Number(a.target.value);this.hass.callService("media_player","volume_set",{entity_id:t,volume_level:s}),this.requestUpdate()}_onGroupVolumeStep(e,t){this._suppressVolumeOverlay(),this.hass.callService("remote","send_command",{entity_id:e,command:t>0?"volume_up":"volume_down"}),this.requestUpdate()}_onSourceChange(e){const t=this.currentEntityId,a=e.target.value;!t||!a||this.hass.callService("media_player","select_source",{entity_id:t,source:a})}_openMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.currentEntityId},bubbles:!0,composed:!0}))}async _onProgressBarClick(e){try{e.stopPropagation();const t=this.currentEntityId,a=this._getActualResolvedMaEntityForState(this._selectedIndex),s=t?this.hass?.states?.[t]:null,r=a?this.hass?.states?.[a]:null;let n;if(this._controlFocusEntityId&&(this._controlFocusEntityId===a||this._controlFocusEntityId===t))n=this._controlFocusEntityId;else if(this._isEntityPlaying(r))n=a;else if(this._isEntityPlaying(s))n=t;else{const p=this._lastPlayingEntityIdByChip?.[this._selectedIndex];if(p&&(p===a||p===t))n=p;else{const _=this._getPlaybackEntityId(this._selectedIndex);n=await this._resolveTemplateAtActionTime(_,this.currentEntityId)}}const o=this.hass?.states?.[n]||this.currentStateObj;if(!n||!o||!o.attributes){console.warn("YAMP: Cannot seek - invalid target or state",n,o);return}const l=o.attributes.media_duration;if(!l)return;const c=e.target.getBoundingClientRect(),d=(e.clientX-c.left)/c.width,u=Math.floor(d*l);this._seekAnchor={position:u,timestamp:Date.now(),trackId:o.attributes.media_content_id||o.attributes.media_title},this._seekConvergenceLock=Date.now()+2e3,this._seekOffset=null,this.requestUpdate(),this.hass.callService("media_player","media_seek",{entity_id:n,seek_position:u})}catch(t){console.error("YAMP: Error in _onProgressBarClick",t)}}_resetSearchContext(){this._searchResultsByType={},this._favoritesFilterActive=!1,this._recentlyPlayedFilterActive=!1,this._upcomingFilterActive=!1,this._recommendationsFilterActive=!1,this._initialFavoritesLoaded=!1,this._loadingSearchRowMenuId=null,this._errorSearchRowMenuId=null}_showSearchSuccessToast(e=null,t=null){this._showQueueSuccessMessage=!0,e&&(this._successSearchRowMenuId=e),t&&(this._successSearchRowType=t),this.requestUpdate(),this._successToastHandle&&clearTimeout(this._successToastHandle),this._successToastHandle=setTimeout(()=>{this._showQueueSuccessMessage=!1,this._successSearchRowMenuId=null,this._successSearchRowType=null,this._successToastHandle=null,this.requestUpdate()},qo)}render(){if(!this.hass||!this.config)return v;const e=typeof this.config.card_height=="string"&&(this.config.card_height.includes("{{")||this.config.card_height.includes("{%")||this.config.card_height.trim().startsWith("[[["))?this._cardHeightResolveCache?.card?.value:this.config.card_height,t=typeof e=="string"&&e.includes("px")?parseFloat(e):Number(e),a=typeof t=="number"&&Number.isFinite(t)&&t>0||typeof t=="string"&&t.trim()!=="",s=this._collapsedBaselineHeight||220,r=this.entityObjs.length===1,n=r&&this._alwaysCollapsed&&this.config.expand_on_search!==!0,o=this.config.pin_search_headers===!0&&!n,l=!(this.config.hide_search_headers_on_idle===!0&&this._isIdle),c=this.config.show_chip_row||"auto",d=this.entityObjs.length>1,u=(c==="in_menu"||c==="in_menu_on_idle"&&this._isIdle)&&d,p=c!=="in_menu"&&(d||c==="always"),_=c==="in_menu_on_idle"&&this._isIdle&&d,m=c==="in_menu_on_idle"&&d&&!this._showSearchInSheet,f=(this.config.actions??[]).map((x,H)=>({action:x,idx:H})).filter(({action:x})=>x?.action!=="sync_selected_entity"&&x?.action!=="select_entity");let y=null;const b=(x,H)=>{let se=ra(x);if(typeof se=="string"&&(se.includes("{{")||se.includes("{%")||se.trim().startsWith("[[["))){const Ie=this._actionInMenuResolveCache?.[H]?.value;if(Ie!==void 0)se=Ie;else if(se.trim().startsWith("[[[")){const Ge=this._evaluateJsTemplate(se);Ge!==void 0&&(se=Ge)}else{y||(y={...this._getTemplateContext(),state:this.hass?.states[this.currentEntityId]?.state||"unknown",attributes:this.hass?.states[this.currentEntityId]?.attributes||{}});const Ge=vt(this.hass,se,y);Ge!==null&&(se=Ge)}}return typeof se=="string"?(se=se.trim(),se):se===!0?"menu":"chip"},k=f.filter(({action:x,idx:H})=>b(x,H)==="chip"),w=f.filter(({action:x,idx:H})=>b(x,H)==="menu"),E=f.find(({action:x})=>x?.card_trigger==="tap"),A=f.find(({action:x})=>x?.card_trigger==="hold"),C=f.find(({action:x})=>x?.card_trigger==="double_tap"),M=f.find(({action:x})=>x?.card_trigger==="swipe_left"),j=f.find(({action:x})=>x?.card_trigger==="swipe_right");this._cardTriggers={tap:E?.action,hold:A?.action,double_tap:C?.action,swipe_left:M?.action,swipe_right:j?.action};const F=this.currentActivePlaybackStateObj||this.currentPlaybackStateObj||this.currentStateObj,I=this.getChipName(this.currentEntityId);if(!F)return g`<div class="details">${h("common.not_found")}</div>`;const T=this._getHiddenControlsForCurrentEntity(),N=!!this._getFavoriteButtonEntity()&&!T.favorite,R=this._isCurrentTrackFavorited(),V=!T.power&&(this._supportsFeature(F,os)||this._supportsFeature(F,ns)),J=this._controlLayout==="modern"&&V,ee=this._controlLayout==="modern"&&N,B=f.find(({action:x,idx:H})=>b(x,H)==="replace_search"),L=f.find(({action:x,idx:H})=>b(x,H)==="replace_power"),Y=f.find(({action:x,idx:H})=>b(x,H)==="replace_mute"),X=f.find(({action:x,idx:H})=>b(x,H)==="replace_favorite"),K=({action:x,idx:H})=>{if(!x)return v;const se=this._getActionLabel(x);let Ie=x.icon_color||"";return typeof Ie=="string"&&(Ie.includes("{{")||Ie.includes("{%")||Ie.trim().startsWith("[[["))&&(Ie=vt(this.hass,Ie,this._getTemplateContext())||""),g`
      ...
      `};let Q=v;J?L?Q=K(L):Q=g`
        ...
        `:this._controlLayout==="modern"&&(B?Q=K(B):Q=g`
          <button
      ...
      `);let je=v;Y&&(je=K(Y));const Je=F.attributes.source_list||[],It=new Set(Je.map(x=>x&&x[0]?x[0].toUpperCase():"")),ct="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");this._idleImageTemplate&&this._idleImageTemplateNeedsResolve&&!this._resolvingIdleImageTemplate&&this._isIdle&&this._resolveIdleImageTemplate();const Ue=typeof this.config.idle_image=="string"&&this.config.idle_image.trim().startsWith("[[[")?this._evaluateJsTemplate(this.config.idle_image):this._idleImageTemplate?this._idleImageTemplateResult:this.config.idle_image,dt=this._normalizeImageSourceValue(Ue),Ko=this._getEntityForPurpose(this._selectedIndex,"playback_control"),Xe=this.hass?.states?.[Ko],Zo=this._isEntityPlaying(Xe),ti=this.config.show_idle_artwork_when_not_playing===!0&&!Zo&&dt;let Oe=null;if(dt&&(this._isIdle||ti))if(this.hass.states[dt]){const x=this.hass.states[dt];Oe=x.attributes.entity_picture_local||x.attributes.entity_picture||(x.state&&typeof x.state=="string"&&x.state.startsWith("http")?x.state:null)}else(dt.startsWith("http")||dt.startsWith("/"))&&(Oe=dt);const ur=!!Oe,et=this._idleTimeoutMs===0?!1:this._isIdle,Jo=this._idleTimeoutMs===0?!1:this._isIdle,Xo=this._artworkObjectFit==="scaled-contain"||this._artworkObjectFit==="scaled-contain-alternate",Ra=this.config.extend_artwork===!0||_||Xo||this._lyricsActive,hr=this.currentStateObj,ii=this._getActualResolvedMaEntityForState(this._selectedIndex),el=ii?this.hass?.states?.[ii]:null,tl=this._lastMainState,pr=this._lastMaState;this._lastMainState=hr?.state,this._lastMaState=el?.state;const Ee=this._selectedIndex;if(pr==="playing"&&this._lastMaState!=="playing"){const x=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[Ee]={entityId:ii,until:Date.now()+x}}if(pr==="playing"&&this._lastMaState==="paused"&&this._lastPlayingEntityIdByChip?.[Ee]===ii||tl==="playing"&&this._lastMainState==="paused"&&this._lastPlayingEntityIdByChip?.[Ee]===hr?.entity_id){const x=this._lastPlayingEntityIdByChip[Ee],H=Math.max(Number(this._idleTimeoutMs||this.config?.idle_timeout_ms||6e4),500);this._playbackLingerByIdx[Ee]={entityId:x,until:Date.now()+H}}this._lastMaState==="playing"&&this._playbackLingerByIdx?.[Ee]&&delete this._playbackLingerByIdx[Ee];const il=this.config.entities[Ee]?.music_assistant_entity,al=this._getEntityForPurpose(Ee,"ma_resolve"),ai=this._lastPlayingEntityIdByChip?.[Ee],sl=this._maResolveCache?.[Ee]?.id,rl=!!(ai&&(ai===sl||ai===al||ai===il||ai===ii));this._lastMainState==="playing"&&this._playbackLingerByIdx?.[Ee]&&!rl&&delete this._playbackLingerByIdx[Ee];const ut=Xe,nl=!!ut?.attributes?.shuffle,ol=ut?.attributes?.repeat&&ut?.attributes?.repeat!=="off",si=this.metadataStateObj,ri=this._idleTimeoutMs===0?this._isEntityPlaying(Xe):!this._isIdle&&this._isEntityPlaying(Xe),Mt=this.currentStateObj,ll=this._getArtworkUrl(si,ti),Oa=this._getArtworkUrl(Xe,ti),La=this._getArtworkUrl(Mt,ti),Bi=si?.attributes?.media_title||ut?.attributes?.media_title||Mt?.attributes?.media_title;let le=ll;Bi&&(!le||!le.url)&&Oa?.url&&Xe?.attributes?.media_title===Bi&&(le=Oa),Bi&&(!le||!le.url)&&La?.url&&Mt?.attributes?.media_title===Bi&&(le=La),le||(le=Oa||La||null);const Be=this._idleTimeoutMs===0?!0:ri,ye=si?.attributes?.media_title?si:ut?.attributes?.media_title?ut:Mt?.attributes?.media_title?Mt:si||ut||Mt,ni=Be&&ye?.attributes?.media_title||"",Hi=Be&&(ye?.attributes?.media_artist||ye?.attributes?.media_series_title||ye?.attributes?.app_name)||"",cl=this.config.show_album!==!1,oi=Be&&cl&&ye?.attributes?.media_album_name||"",li=!!(ye?.attributes?.media_artist||F?.attributes?.media_artist),_r=h("search.search_album")||h("search.browse_album",{"{album}":oi}),mr=li?h("search.search_artist"):"";this._adaptiveText&&this._updateAdaptiveTextScale(!0);let ht=ye?.attributes?.media_position||0;const ci=ye?.attributes?.media_duration||0;let Gi=ht;if(ri&&ye){const x=ye.attributes?.media_position_updated_at?Date.parse(ye.attributes.media_position_updated_at):ye.last_changed?Date.parse(ye.last_changed):Date.now(),H=(Date.now()-x)/1e3;Gi+=H}const dl=ye?.attributes?.media_content_id||ye?.attributes?.media_title,gr=Date.now();if(this._seekAnchor&&this._seekAnchor.trackId===dl){let x=this._seekAnchor.position;ri&&(x+=(gr-this._seekAnchor.timestamp)/1e3);const H=this._seekConvergenceLock&&gr<this._seekConvergenceLock,se=Math.abs(Gi-x);!H&&se<2?(this._seekAnchor=null,this._seekConvergenceLock=null,ht=Gi):ht=x}else this._seekAnchor=null,this._seekConvergenceLock=null,ht=Gi;const fr=ci?Math.min(1,ht/ci):0,qa=this._getVolumeEntity(Ee),ul=qa&&qa.startsWith&&qa.startsWith("remote."),hl=Number(this.currentVolumeStateObj?.attributes.volume_level||0),pl=this._getEffectiveVolumeMode()!=="stepper";let Z;this._alwaysCollapsed&&this._expandOnSearch&&this._showSearchInSheet?Z=!1:Z=this._alwaysCollapsed?!0:this._collapseOnIdle?this._isIdle:!1;const Na=Z&&this._alwaysCollapsed&&a?t-s:0,_l=Z&&p?48:0,ml=Z&&k.length>0?40:0,yr=_l+ml,gl=a?Math.max(100,t-yr):this._collapsedBaselineHeight||220;let Se=Math.round(gl*.48);this.config.hide_collapsed_artwork===!0&&(Se=0);const fl=this.offsetWidth||0;if(a&&Se>0)if(t<230)Se=0;else{const x=this._getMaxCollapsedArtworkWidth(fl);Se=Math.max(40,Math.min(x,Se)),t>=320&&(Se=Math.max(102,Se))}else!a&&Se>0&&(Se=102);const di=Math.max(-60,Na-yr),Va=48,yl=di>0?Math.min(di*.45,96):0,vl=di>0?Math.round(Va+yl):di<-20?36:Va,bl=this._adaptiveTextTargets?.has("details")&&!this._lyricsActive&&this._currentDetailsScale||1,xl=Math.round((Z?vl:Va)*bl);let Ua;const vr=350,wl=(Z?a?t:this._collapsedBaselineHeight||220:vr)>=vr,Ba=this.config.hide_menu_player===!0?!1:!Z||wl,Ha=a&&t<280,ui=a&&t<320&&!this._alwaysCollapsed,Qi=et||this._showEntityOptions||ui;let ce=null,Wi=null,Ga=this._artworkObjectFit,Yi;if(!this._isIdle&&!ti){const x=le;ce=x?.url||null,Wi=x?.sizePercentage,x?.objectFit&&(Ga=x.objectFit),x?.objectPosition&&(Yi=x.objectPosition)}else le?.url&&(Oe=le.url),le?.objectFit&&(Ga=le.objectFit),le?.objectPosition&&(Yi=le.objectPosition),le?.sizePercentage!==void 0&&(Wi=le.sizePercentage);Ua=Z&&!ce&&!Oe&&di>=40,Z&&ce&&ce!==this._lastArtworkUrl&&(this._extractDominantColor(ce).then(x=>{this._collapsedArtDominantColor=x,this.requestUpdate()}),this._lastArtworkUrl=ce);const br=et?Z?this._collapsedBaselineHeight||220:325:null;this._lastRenderedCollapsed=Z,this._lastRenderedHideControls=et;const He=Ga||this._artworkObjectFit,Qa=He==="scaled-contain-alternate",pt=(He==="scaled-contain"||Qa)&&!Z&&!this._alwaysCollapsed&&!this._lyricsActive,kl=pt&&ce||!pt&&!ce&&!Oe,El=(He==="scaled-contain"||Qa)&&(c==="in_menu"||r&&c!=="always");let xr=this._getBackgroundSizeForFit(He);Wi&&(xr=`${Wi}%`);const wr=He==="no_artwork"?"none":Oe||Qa&&!this._lyricsActive?Oe?`url('${Oe}')`:"none":ce?`url('${ce}')`:"none",kr=wr!=="none",Sl=ce&&(this._lyricsActive||this.config.blurred_artwork===!0||this.config.blurred_artwork!==!1&&(Z||pt&&He==="scaled-contain"))?"blur(18px) brightness(0.7) saturate(1.15)":"none";let _t=(typeof Yi<"u"?Yi:null)||this.config.artwork_position||"top center";Ra&&(_t==="top center"||_t==="center top"?_t="center 50px":(_t==="bottom center"||_t==="center bottom")&&(_t="center calc(100% - 50px)"));const Er=[`background-image: ${wr}`,`background-size: ${pt?"cover":xr}`,`background-position: ${_t}`,"background-repeat: no-repeat",`filter: ${Sl}`].join("; "),Sr=et||this._getEffectiveVolumeMode()==="hidden"||ui||a&&t<260&&Z,Al=Qi||Sr,$l=this._controlLayout==="modern",hi=Sr&&!ui&&!(Q!==v&&Q!==void 0&&Q!==null)&&!$l,Cl=this._adaptiveTextTargets?.has("details")&&!this._lyricsActive;this._lastSpacerRendered=!!(Ua||!Z&&(!Cl||kl)),this._lastVolumeRendered=!hi;const Ar=this._lowerControlsHeight||72+(this._alternateProgressBar?0:24)+(et?0:56)+(hi?0:56);return g`
        <ha-card class="yamp-card" 
          style=${a&&(!Z||this._alwaysCollapsed)?`height:${t}px;`:v}>
          <div
            data-match-theme="${String(this.config.match_theme===!0)}"
            data-artwork-fit="${He}"
            data-lyrics-active="${String(this._lyricsActive===!0)}"
            class=${is({"yamp-card-inner":!0,"compact-collapsed":Ha&&Z,"dim-idle":Jo,"no-chip-dim":this.config.dim_chips_on_idle===!1,collapsed:Z})}
          >
            ${Ra&&kr?g`
              <div class="full-bleed-artwork-bg" style="${Er}"></div>
              ${ur||this._isIdle?v:g`<div class="full-bleed-artwork-fade"></div>`}
            `:v}
            ${!pt&&!ce&&!Oe?g`
            ...
            ${this._lyricsActive&&!this._isIdle?g`
              <yamp-lyrics-view
                ...
                .activeThemeColor=${this.config.match_theme===!0?"var(--custom-accent, var(--state-media_player-active-color, var(--primary-color, #ffffff)))":"var(--custom-accent, #ffffff)"}
                ...
                @pointerup=${this._onTapAreaPointerUp}
                @pointercancel=${this._onTapAreaPointerCancel}
                style="${[`--yamp-lyrics-top-offset: ${p?48:0}px`,`--yamp-lyrics-bottom-offset: ${Ar}px`,this._getGestureStyles()].filter(Boolean).join("; ")}"
              ></yamp-lyrics-view>
            `:v}
            ...
            `:v}
            <div class="card-lower-content-container" style="${br?`min-height:${br}px;`:""}">
              <div class="card-lower-content-bg"
                style="${(()=>{const x=[];return Ra&&kr?x.push("background-image: none","filter: none"):x.push(Er),x.push(`min-height: ${Z?et?`${this._collapsedBaselineHeight||220}px`:"0px":a?`${t}px`:"350px"}`),x.push("transition: min-height 0.4s cubic-bezier(0.6,0,0.4,1), background 0.4s"),x.join("; ")})()}"
              ></div>
              ${!(ur||this._isIdle)&&(!pt||He==="scaled-contain"||this._lyricsActive)?g`<div class="card-lower-fade" style="--yamp-lyrics-bottom-offset: ${Ar}px;"></div>`:v}
              <div class="card-lower-content${Z?" collapsed transitioning":" transitioning"}${Z&&ce&&Se>0?" has-artwork":""}" style="${!et&&!this._lyricsActive?"":Z?`min-height: ${this._collapsedBaselineHeight||220}px;`:`min-height: ${a?`${t}px`:`${this._lastNonLyricsLowerContentHeight||350}px`};`}">
                ${Z&&ce&&Se>0&&wi(ce)?g`
                  <div
                    ...
                    @pointerup=${this._onTapAreaPointerUp}
                    @pointercancel=${this._onTapAreaPointerCancel}
                    style="${[`background: linear-gradient(120deg, ${this._collapsedArtDominantColor}bb 60%, transparent 100%)`,Na>0?`width:${Math.round(Se+8)}px`:"",Ha&&Z?"top: -2px; height: auto !important; overflow: visible !important;":"",this._getGestureStyles()].filter(Boolean).join("; ")}"
                  >
                    <img
                      class="collapsed-artwork"
                      src="${ce}" 
                      style="${[this._getCollapsedArtworkStyle(),Na>0?`width:${Math.round(Se)}px; height:${Math.round(Se)}px;`:""].filter(Boolean).join(" ")}" 
                      onload="this.style.display='block'"
                      onerror="this.style.display='none'" />
                  </div>
                `:v}
                ${this._lastSpacerRendered?g`
                  <div class="card-artwork-spacer${Ua?" show-placeholder":""}"
                    @pointerdown=${this._lyricsActive?v:this._onTapAreaPointerDown}
                    @pointermove=${this._lyricsActive?v:this._onTapAreaPointerMove}
                    @pointerup=${this._lyricsActive?v:this._onTapAreaPointerUp}
                    @pointercancel=${this._lyricsActive?v:this._onTapAreaPointerCancel}
                    style="${[this._lyricsActive?"min-height: 0; pointer-events: none;":"",this._getGestureStyles(!this._lyricsActive)].filter(Boolean).join("; ")}"
                  >
                    ${pt&&ce?g`
                      <div style="position: absolute; ${El?"top: 20px; right: 0; bottom: 0; left: 0;":"inset: 0;"} display: flex; align-items: center; justify-content: center; pointer-events: none; box-sizing: border-box; padding: 0 5px;">
                        <img 
                          class="inset-artwork"
                          src="${ce}" 
                ...
                ${this.config.details_alignment!=="none"?g`
                  <div class="details" 
                    ...
                    style="${Ha&&Z?"margin-top: -12px; padding-bottom: 2px; min-height: 0; gap: 1px;":""} ${(()=>{const x=[];this._showEntityOptions&&(x.push("opacity:0"),x.push("pointer-events:none")),x.push(`min-height:${xl}px`),Be||x.push("opacity:0"),this._lastSpacerRendered||(this._lyricsActive?x.push("margin-top: auto"):x.push("flex: 1"),x.push("justify-content: flex-end"));const H=this._getGestureStyles(this._isIdle);return H&&!this._showEntityOptions&&x.push(H),x.join(";")})()}">
                    ...
                    `:g`
                      <div class="title track-options-title" @click=${x=>{Be&&ni&&(x.stopPropagation(),this._showMediaTitleOptions=!0)}} style="${Be&&ni?"cursor: pointer;":""}" title="${Be&&ni?h("search.show_track_options"):""}">
                        <span class="marquee-inner">${Be&&ni?ni:g`&nbsp;`}</span>
                      </div>
                    `}
                    <div class="artist">
                      <span class="marquee-inner">${Be?Hi&&oi?g`
                          <span
                            class="artist-name ${li?"clickable-artist":""}"
                            @click=${x=>{li&&(x.stopPropagation(),this._searchArtistFromNowPlaying())}}
                            title=${mr}
                          >${Hi}</span><span class="artist-album-separator"> - </span><span
                            class="album-name clickable-album"
                            @click=${x=>{x.stopPropagation(),this._searchAlbumFromNowPlaying()}}
                            title=${_r}
                          >${oi}</span>
                        `:Hi?g`
                          <span
                ...
                `:v}
                ${!Z&&!this._alternateProgressBar?na(ri&&ci?{progress:fr,seekEnabled:!0,onSeek:x=>this._onProgressBarClick(x),collapsed:!1,style:this._showEntityOptions?"visibility:hidden; opacity:0":"",displayTimestamps:this._displayTimestamps,currentTime:ht,duration:ci,customHeight:this.config.progress_bar_height??Ft}:{progress:0,seekEnabled:!1,collapsed:!1,style:"visibility:hidden; opacity:0",displayTimestamps:this._displayTimestamps,currentTime:0,duration:0,customHeight:this.config.progress_bar_height??Ft}):v}
                ${Z||this._alternateProgressBar?na(ri&&ci?{progress:fr,collapsed:!0,style:this._showEntityOptions?"visibility:hidden; opacity:0":"",customHeight:this.config.progress_bar_height??Ft}:{progress:0,collapsed:!0,style:"visibility:hidden; opacity:0",customHeight:this.config.progress_bar_height??Ft}):v}

                <div style="${et||this._showEntityOptions?"visibility:hidden; opacity:0; pointer-events:none;":""}">
                    ${Zc({stateObj:Xe,showStop:this._shouldShowStopButton(Xe),shuffleActive:nl,repeatActive:ol,onControlClick:x=>this._onControlClick(x),supportsFeature:(x,H)=>this._supportsFeature(x,H),showFavorite:N,favoriteActive:R,hiddenControls:T,adaptiveControls:this._adaptiveControls,controlLayout:this._controlLayout,swapPauseForStop:this._controlLayout==="modern"&&this._swapPauseForStop})}
                </div>
                ${Jc({isRemoteVolumeEntity:ul,showSlider:pl,vol:hl,isDragging:this._volumeDraggingEntity==="main",dragVol:this._dragVolume,isMuted:this.currentVolumeStateObj?.attributes?.is_volume_muted??!1,supportsMute:this.currentVolumeStateObj?this._supportsFeature(this.currentVolumeStateObj,rs):!1,onVolumeDragStart:x=>this._onVolumeDragStart(x),onVolumeDragEnd:x=>this._onVolumeDragEnd(x),onVolumeInput:x=>this._onVolumeInput(x),onVolumeChange:x=>this._onVolumeChange(x),onVolumeStep:x=>this._onVolumeStep(x),onMuteToggle:()=>this._onMuteToggle(),leadingControlTemplate:Qi?Q!==v?g`<div style="visibility:hidden; opacity:0; pointer-events:none;">${Q}</div>`:v:Q,reserveLeadingControlSpace:this._controlLayout==="modern",showRightPlaceholder:this._controlLayout==="modern",rightSlotTemplate:Qi?oe!==v?g`<div style="visibility:hidden; opacity:0; pointer-events:none;">${oe}</div>`:v:oe,muteSlotTemplate:Qi?je!==v?g`<div style="visibility:hidden; opacity:0; pointer-events:none;">${je}</div>`:v:je,hideVolume:Al,collapseRow:hi,moreInfoMenu:!this._showEntityOptions&&!ui&&!hi?g`
        ...
        `:v})}
            ${hi&&!this._showEntityOptions&&!ui?g`
            ...
            `:v}
            ${u&&!this._hideActiveEntityLabel&&!(this._hideActiveEntityLabelOnIdle&&this._isIdle)?g`
              <div class="in-menu-active-label" style="${this._showEntityOptions?"visibility:hidden; opacity:0; pointer-events:none;":""}">${I}</div>
            `:v}
          </div>
        </div>
      ...
      <div class="entity-options-overlay entity-options-overlay-opening" @click=${x=>this._closeEntityOptions(x)}>
        <div class="entity-options-container entity-options-container-opening" style="${this._showSearchInSheet?"height:100%;":""}">
          <div class="entity-options-sheet${u||m?" chips-mode":""} entity-options-sheet-opening" 
            ...
            `:v}
              ${!this._showGrouping&&!this._showSourceList&&!this._showSearchInSheet&&!this._showResolvedEntities&&!this._showTransferQueue&&!this._showRemoteControl?this._renderMainMenu(Je,w,u):this._showRemoteControl?this._renderRemoteControlSheet():this._showGrouping?this._renderGroupingSheet():this._showTransferQueue?this._renderTransferQueueSheet():this._showResolvedEntities?this._renderResolvedEntitiesSheet():this._showSearchInSheet?this._renderSearchInOptions(l,o):this._renderSourceListSheet(Je,ct,It)}
              </div>
            </div>
            ...
            ${Ba?g`
              <div class="persistent-media-controls" @click=${x=>x.stopPropagation()}>
                <div class="persistent-controls-artwork">
                  ${(()=>{const x=le;return x?.url&&wi(x.url)?g`
                ...
                <div class="persistent-controls-buttons" style="position: relative;">
                  ...
                  `:v}
                  ${this._lyricsActive&&!this._isIdle&&this._fetchingLyrics?g`
                    <div class="queue-ops-progress" style="position: absolute !important; bottom: -20px !important; left: 50% !important; transform: translate(-50%, 0) !important; z-index: 1000 !important; width: max-content !important; pointer-events: none !important; color: var(--search-text-secondary) !important;">
                      ${h("lyrics.finding")}
                    </div>
                  `:v}
                </div>
                ${(()=>{const x=this._selectedIndex,H=this._getVolumeEntity(x);if(!H)return v;const se=H.startsWith&&H.startsWith("remote."),Ie=this.currentVolumeStateObj,Ge=Number(Ie?.attributes?.volume_level??0),$r=se?null:`${Math.round((Ge||0)*100)}%`;return this._getEffectiveVolumeMode()==="hidden"?v:g`
                    <div class="persistent-volume-stepper">
                      <button class="stepper-btn" @click=${()=>this._onVolumeStep(-1)} title="${h("common.vol_down")}">–</button>
                      ${$r?g`<span class="stepper-value">${$r}</span>`:v}
        ...
        `:v}
          ${this._searchActiveOptionsItem?od({item:this._searchActiveOptionsItem,onClose:()=>{this._searchActiveOptionsItem=null,this.requestUpdate()},onPlayOption:(x,H)=>this._performSearchOptionAction(x,H),massQueueAvailable:this._massQueueAvailable}):v}
          ${!Ba&&!this.config.hide_reorder_progress&&!this.config.hide_menu_player&&this._queueOpsTotal>0?g`
          ...
          `:""}
          ${(!this._showEntityOptions||!Ba)&&this._lyricsActive&&!this._isIdle&&this._fetchingLyrics?g`
  ...
  `}_getCardHeightMetrics(e){const t=this._cardHeight,a=typeof t=="string"?parseFloat(t):Number(t),s=typeof a=="number"&&Number.isFinite(a)&&a>0;return{customCardHeight:a,hasCustomCardHeight:s}}_getMaxCollapsedArtworkWidth(e){const t=e>0?Math.max(64,e-220):102;return Math.min(t,160)}_setHostDataAttributes(e,t,a){const s=this._appearance||"automatic";e.setAttribute("data-match-theme",String(t.match_theme===!0)),e.setAttribute("data-appearance",s),e.setAttribute("data-always-collapsed",String(this._alwaysCollapsed));const r=(this.entityObjs||[]).length>1,n=this._alwaysCollapsed&&!r&&!this._showGrouping;e.setAttribute("data-hide-menu-player",String(t.hide_menu_player===!0||n)),e.setAttribute("data-extend-artwork",String(this._extendArtwork)),e.setAttribute("data-control-layout",this._controlLayout||"classic"),e.setAttribute("data-details-alignment",t.details_alignment||"left");const o=(this.entityObjs||[]).length===1&&this._alwaysCollapsed&&t.expand_on_search!==!0,l=t.pin_search_headers===!0&&!o;e.setAttribute("data-pin-search-headers",String(l)),a?e.setAttribute("data-has-custom-height","true"):e.removeAttribute("data-has-custom-height")}_getPlaybackAndCollapseState(e){const t=this._getEntityForPurpose(this._selectedIndex,"playback_control"),a=this.hass&&this.hass.states&&t?this.hass.states[t]:void 0,s=a?this._isEntityPlaying(a):!1,r=typeof e.idle_image=="string"&&e.idle_image.trim().startsWith("[[[")?this._evaluateJsTemplate(e.idle_image):this._idleImageTemplate?this._idleImageTemplateResult:e.idle_image?vt(this.hass,e.idle_image,this._getTemplateContext()):null,n=this._normalizeImageSourceValue(r),o=e.show_idle_artwork_when_not_playing===!0&&!s&&n,l=this._isCurrentEntityPlaying(),c=this._alwaysCollapsed||this._isIdle&&e.collapse_on_idle===!0&&!l;return{playbackStateObj:a,collapsed:c,forceIdleImage:o}}_updatePersistentControlsVisibility(e,t,a,s,r){const n=(a?r?s:this._collapsedBaselineHeight||220:350)>=350;t.hide_menu_player!==!0&&(!a||n)?e.removeAttribute("data-hide-persistent-controls"):e.setAttribute("data-hide-persistent-controls","true")}_updateHostLayoutStyles(e,t,a,s,r){const n=r&&s<280,o=t.show_chip_row||"auto",l=(this.entityObjs||[]).length>1,c=(o==="in_menu"||o==="in_menu_on_idle"&&this._isIdle)&&l,d=o!=="hidden"&&!c&&l,u=t.action_chips&&t.action_chips.length>0,p=this.offsetWidth||0,_=d?58:0,m=_+(u?42:0),f=r?Math.max(0,s-m):0,y=[p,s,a,o,l,this._isIdle,u,this._artworkObjectFit,this._collapsedBaselineHeight,this._alwaysCollapsed,this._getEffectiveVolumeMode(),this._showEntityOptions].join("_");if(this._lastLayoutStateKey!==y)if(this._lastLayoutStateKey=y,a){let b;if(r){const J=this._getMaxCollapsedArtworkWidth(p);b=Math.max(0,Math.min(J,Math.round((s-(n?90:130))*.95)))}else b=this._artworkObjectFit==="no_artwork"?0:64;const k=this._collapsedBaselineHeight||220,w=r?s-k:0,E=b>0?Math.round(b+(n?12:24)+Math.min(40,Math.max(0,w)*.12)):0,A=r?s-240:0,C=Math.max(0,A-_),M=Math.min(90,C*.45),j=(C>0?Math.max(0,C-M):0)>=48?0:E,F=p>380?Math.min(1.6,1+(p-380)/520):1,I=w>0?Math.min(1.45,1+C/180):n?.9:1,T=I>1||F>1?Math.min(1.6,Math.max(I,F)):n?.95:1,N=n?.85:Math.min(1.5,Math.max(I*.92,F*.92)),R=r&&s<320&&!this._alwaysCollapsed,V=this._getEffectiveVolumeMode()==="hidden"||R||r&&s<260&&!this._showEntityOptions?54:100;w!==0||n?(e.style.setProperty("--yamp-collapsed-details-offset",`${E}px`),e.style.setProperty("--yamp-collapsed-controls-offset",`${j}px`),e.style.setProperty("--yamp-collapsed-title-scale",T.toFixed(3)),e.style.setProperty("--yamp-collapsed-artist-scale",N.toFixed(3)),e.style.setProperty("--yamp-collapsed-artwork-size",`${b}px`),e.style.setProperty("--yamp-collapsed-artwork-clearance",`${V}px`)):(e.style.removeProperty("--yamp-collapsed-controls-offset"),e.style.removeProperty("--yamp-collapsed-details-offset"),e.style.removeProperty("--yamp-collapsed-artwork-size"),e.style.removeProperty("--yamp-collapsed-title-scale"),e.style.removeProperty("--yamp-collapsed-artist-scale"),e.style.removeProperty("--yamp-collapsed-artwork-clearance"))}else{if(r){let b=70,k=50,w=42,E=36,A=28,C=24,M="16px",j="20px",F="10px 16px 14px 16px";if(f<380){const I=Math.max(.6,f/380);b=Math.max(48,Math.round(70*I)),k=Math.max(36,Math.round(50*I)),w=Math.max(32,Math.round(42*I)),E=Math.max(24,Math.round(36*I)),A=Math.max(20,Math.round(28*I)),C=Math.max(18,Math.round(24*I)),M=`${Math.max(4,Math.round(16*I))}px 16px`,j=`${Math.max(8,Math.round(20*I))}px`,F=`${Math.max(4,Math.round(10*I))}px 16px ${Math.max(8,Math.round(14*I))}px 16px`}e.style.setProperty("--yamp-modern-primary-size",`${b}px`),e.style.setProperty("--yamp-modern-medium-size",`${k}px`),e.style.setProperty("--yamp-modern-small-size",`${w}px`),e.style.setProperty("--yamp-modern-primary-icon-size",`${E}px`),e.style.setProperty("--yamp-modern-medium-icon-size",`${A}px`),e.style.setProperty("--yamp-modern-small-icon-size",`${C}px`),e.style.setProperty("--yamp-modern-padding",M),e.style.setProperty("--yamp-modern-gap",j),e.style.setProperty("--yamp-volume-row-padding",F)}else e.style.removeProperty("--yamp-modern-primary-size"),e.style.removeProperty("--yamp-modern-medium-size"),e.style.removeProperty("--yamp-modern-small-size"),e.style.removeProperty("--yamp-modern-primary-icon-size"),e.style.removeProperty("--yamp-modern-medium-icon-size"),e.style.removeProperty("--yamp-modern-small-icon-size"),e.style.removeProperty("--yamp-modern-padding"),e.style.removeProperty("--yamp-modern-gap"),e.style.removeProperty("--yamp-volume-row-padding");e.style.removeProperty("--yamp-collapsed-controls-offset"),e.style.removeProperty("--yamp-collapsed-details-offset"),e.style.removeProperty("--yamp-collapsed-artwork-size"),e.style.removeProperty("--yamp-collapsed-title-scale"),e.style.removeProperty("--yamp-collapsed-artist-scale"),e.style.removeProperty("--yamp-collapsed-artwork-clearance")}}_updateHostArtworkStyles(e,t,a){const s=this.metadataStateObj,r=this._getArtworkUrl(s,a),n=this._getArtworkUrl(t,a),o=this.currentStateObj,l=this._getArtworkUrl(o,a),c=s?.attributes?.media_title||t?.attributes?.media_title||o?.attributes?.media_title;let d=r;c&&(!d||!d.url)&&n?.url&&t?.attributes?.media_title===c&&(d=n),c&&(!d||!d.url)&&l?.url&&o?.attributes?.media_title===c&&(d=l),d||(d=n||l||null);let u=this._artworkObjectFit;d?.objectFit&&(u=d.objectFit);const p=u||"cover",_=this._getBackgroundSizeForFit(p);e.style.setProperty("--yamp-artwork-fit",p),e.style.setProperty("--yamp-artwork-bg-size",_),d?.objectPosition?e.style.setProperty("--yamp-artwork-position",d.objectPosition):this.config?.artwork_position?e.style.setProperty("--yamp-artwork-position",this.config.artwork_position):e.style.setProperty("--yamp-artwork-position","top center")}_updateHostAttributes(){if(!this.shadowRoot||!this.shadowRoot.host||!this.hass||!this.config)return;const e=this.shadowRoot.host,t=this.config,{customCardHeight:a,hasCustomCardHeight:s}=this._getCardHeightMetrics(t);this._setHostDataAttributes(e,t,s);const{playbackStateObj:r,collapsed:n,forceIdleImage:o}=this._getPlaybackAndCollapseState(t);this._updatePersistentControlsVisibility(e,t,n,a,s),this._updateHostLayoutStyles(e,t,n,a,s),this._updateHostArtworkStyles(e,r,o)}_renderSearchSubFilters(e){return!e||!this._usingMusicAssistant||this._searchLoading?v:g`
    ...
    `}_renderSearchInOptions(e,t=!1){return g`
      <div class="entity-options-search" style="margin-top:${this._cardType==="up_next"?"0":"12px"};">
        ...
        ${(()=>{const a=this._upcomingFilterActive&&this._massQueueAvailable,s=this._getDisplaySearchResults(),r=this.config.search_view==="card"||this.config.search_view==="card_minimal",n=this.config.search_view==="card_minimal",o=this._isGridMode,l=c=>nd({item:c,isCard:r,isMinimal:n,isGridMode:o,activeSearchRowMenuId:this._activeSearchRowMenuId,loadingSearchRowMenuId:this._loadingSearchRowMenuId,errorSearchRowMenuId:this._errorSearchRowMenuId,successSearchRowMenuId:this._successSearchRowMenuId,successSearchRowType:this._successSearchRowType,isSelectionFlow:this._isSelectionFlow,massQueueAvailable:this._massQueueAvailable,upcomingFilterActive:!!this._upcomingFilterActive,recentlyPlayedFilterActive:!!this._recentlyPlayedFilterActive,recommendationsFilterActive:!!this._recommendationsFilterActive,searchMediaClassFilter:this._searchMediaClassFilter,queueControlsStyle:this.config.queue_controls_style||"drag_handle",onPlay:(d,u)=>this._playMediaFromSearch(d,u),onResultClick:(d,u)=>this._handleSearchResultClick(d,u),onResultTouch:(d,u)=>this._handleSearchResultTouch(d,u),onOptionsToggle:d=>{this._activeSearchRowMenuId=d?.media_content_id||null,this.requestUpdate()},onPlayOption:(d,u)=>this._performSearchOptionAction(d,u),onMoveUp:d=>this._moveQueueItemUp(d.queue_item_id),onMoveDown:d=>this._moveQueueItemDown(d.queue_item_id),onMoveNext:d=>this._moveQueueItemNext(d.queue_item_id),onRemove:d=>this._removeQueueItem(d.queue_item_id),isMusicAssistant:this._isMusicAssistantEntity(),isValidArtwork:d=>wi(d),getClickTitle:d=>this._getSearchResultClickTitle(d),artworkHostname:this.config?.artwork_hostname||""});if(this._searchAttempted&&s.length===0&&!this._searchLoading)return g`
              <div class="${this._showSearchInSheet?"search-sheet-results":"entity-options-search-results"}">
                <div class="entity-options-search-empty">${h("common.no_results")}</div>
              </div>
            `;if(a)return g`
              <div class="${this._showSearchInSheet?"search-sheet-results":"entity-options-search-results"} queue-results-wrapper ${o?"grid-mode":""}"
                   style="${this.config.search_view==="card"||this.config.search_view==="card_minimal"||o?`--search-card-columns: ${o?5:this.config.search_card_columns||4};`:""}">
                <div class="queue-sortable-container ${r||o?"is-card-layout":""} ${o?"grid-mode":""}"
            ...
            `;if(!this._cachedSearchGridLayout||this._cachedSearchGridLayoutColumns!==(o?5:this.config.search_card_columns||4)||this._cachedSearchGridLayoutIsMinimal!==n||this._cachedSearchGridLayoutIsGridMode!==o){const c=o?5:this.config.search_card_columns||4;this._cachedSearchGridLayoutColumns=c,this._cachedSearchGridLayoutIsMinimal=n,this._cachedSearchGridLayoutIsGridMode=o,this._cachedSearchGridLayout=Mc({columns:c,gap:o?"0px":"12px",padding:o?"0px":"12px",itemSize:o?{width:70,height:85}:n?{width:150,height:150}:{width:150,height:244}})}return g`
            <div class="${this._showSearchInSheet?"search-sheet-results":"entity-options-search-results"} virtualized-results-wrapper ${o?"grid-mode":""}"
                 style="${this.config.search_view==="card"||this.config.search_view==="card_minimal"||o?`--search-card-columns: ${o?5:this.config.search_card_columns||4};`:""}">
              ${Xr(r||o?{items:s,renderItem:l,layout:this._cachedSearchGridLayout,scroller:t}:{items:s,renderItem:l,scroller:t})}
            </div>
          `})()}
        </div>
      </div>
    `}_renderSourceListSheet(e,t,a){const s=this._isGridMode;return g`
      <div class="entity-options-header">
      ...
      <div class="entity-options-scroll source-list-centering-wrapper">
        <div class="source-list-sheet">
          <div class="source-list-scroll ${s?"grid-menu":""}">
            ${e.map(r=>s?g`
                  <button class="entity-options-item menu-action-item" @click=${()=>this._selectSource(r)}>
                    <ha-icon class="menu-action-icon" icon="mdi:login"></ha-icon>
                    <span class="menu-action-label">${r}</span>
                  </button>
                `:g`
      ...
      ${s?v:g`
        <div class="floating-source-index">
          ${t.map((r,n)=>{const o=a.has(r),l=this._hoveredSourceLetterIndex;let c="";if(o&&l!==null&&l!==void 0){const d=Math.abs(l-n);d===0?c="max":d===1?c="large":d===2&&(c="med")}return g`
              <button
                class="source-index-letter"
                ?disabled=${!o}
                data-scale=${c}
                @mouseenter=${o?()=>{this._hoveredSourceLetterIndex=n,this.requestUpdate()}:v}
                @mouseleave=${()=>{this._hoveredSourceLetterIndex=null,this.requestUpdate()}}
                @click=${o?()=>this._scrollToSourceLetter(r):v}
              >
                ${r}
              </button>
            `})}
      ...
      <div class="entity-options-scroll remote-control-container">
        ...
        <div class="remote-dpad-wrapper">
          <div class="remote-dpad-cross">
            <button class="dpad-btn dpad-up" @click=${()=>this._sendRemoteCommand("up")} title="${h("card.remote.up")}">
              <ha-icon icon="mdi:chevron-up"></ha-icon>
            </button>
            <button class="dpad-btn dpad-down" @click=${()=>this._sendRemoteCommand("down")} title="${h("card.remote.down")}">
              <ha-icon icon="mdi:chevron-down"></ha-icon>
            </button>
            <button class="dpad-btn dpad-left" @click=${()=>this._sendRemoteCommand("left")} title="${h("card.remote.left")}">
              <ha-icon icon="mdi:chevron-left"></ha-icon>
            </button>
            <button class="dpad-btn dpad-right" @click=${()=>this._sendRemoteCommand("right")} title="${h("card.remote.right")}">
              <ha-icon icon="mdi:chevron-right"></ha-icon>
            </button>
            <button class="dpad-btn dpad-center" @click=${()=>this._sendRemoteCommand("select")} title="${h("card.remote.select")}">
              ${h("card.remote.select")}
            </button>
          </div>
        </div>
